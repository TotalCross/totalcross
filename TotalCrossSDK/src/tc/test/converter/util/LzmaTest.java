...
// $Id: LzmaTest.java,v 1.16 2011-01-04 13:19:25 guich Exp $
...
public class LzmaTest extends TestCase
{
   ...
   public void testRun()
   {
      ...
      // decompress it
      if (REGEN) try {uncompressed.skipBytes(uncompressed.available()); Storage.compressAndWrite(uncompressed, new DataStream(saved)); dumpBas(saved); System.exit(0);} catch (Exception e) {e.printStackTrace();}
      try
      {
