...
public class ReflectionTest extends MainWindow
{
   // ui
   ListBox lb;
   Button btAdd;
   ...
   {
      super("Reflection Test",VERTICAL_GRADIENT);
   ...
   public void initUI()
   {
      try
      {
         ...
         add(alc,LEFT,TOP+50,FILL,PREFERRED);
         ...
         add(btAdd = new Button("ADD"),CENTER,AFTER+50,PARENTSIZE+50,PREFERRED+25);
         add(new Label("Constructed and retrieved using reflection:"),LEFT,AFTER+50);
         add(lb = new ListBox(),LEFT,AFTER,FILL,FILL);
         // get access to Data's fields
         Class data = Class.forName("tc.samples.lang.reflection.Data");
