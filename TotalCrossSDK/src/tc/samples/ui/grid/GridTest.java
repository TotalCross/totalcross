...
// $Id: GridTest.java,v 1.35 2011-03-21 18:52:29 guich Exp $
...
public class GridTest extends MainWindow
{
   ...
   {
      if (e.type == ControlEvent.PRESSED && e.target == mbar)
   ...
   private class Grid5 extends Container
   {
      ...
      public void initUI()
      {
         try
         {
            ...
            String items[][] =
            {
               {"10",  "3000.5",   new Date(19700325).toString(), "Guich"},
               {"1",   "1e4",      new Date(19750612).toString(), "Michelle"},
               {"999", "-100.10",  new Date(19720519).toString(), "Renato"},
   ...
   private class Grid6 extends Container
   {
      ...
      {
         String[] choices0 = {"Verinha","Michelle","Barbara"};
