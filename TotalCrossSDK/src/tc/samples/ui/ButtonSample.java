...
public class ButtonSample extends BaseContainer
{
   ...
   {
      Image[] images = {new Image("images/cancel.png"), new Image("images/ok.png")}; // images are 300x300
      int imgRes = 2048;
   ...
   {
      Button btn = new Button("Rect", new Image("images/buttontemplate.png"), CENTER, 6);
