...
// $Id: Bytecode2TCCode.java,v 1.140 2011-01-04 13:19:24 guich Exp $
   ...
   public static Instruction convert(ByteCode[] bcs, ByteCode i, OperandStack stack, Vector vcode, boolean isStaticInitializer, String signature)
   {
      ...
      switch (op)
      {
         ...
         case JSR_W: //201
         {
            ...
            if (J2TC.dumpBytecodes) System.out.println(i + " -> " + c1);
         ...
         case GETSTATIC: //178
         {
            ...
            if (!isStaticInitializer) htStaticFieldIndexes.put(index, index);
         ...
         case INVOKEINTERFACE: //185
         {
            ...
            if (ji.name.equals("forName")) // keep track of the list of classes used in forName
            {
               ...
               if (!signature.equals("class$(Ljava/lang/String;)")) // this method is used for instantiating .class references
