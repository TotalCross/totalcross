...
// $Id: OperandKind.java,v 1.14 2011-01-04 13:19:18 guich Exp $
...
public class OperandKind implements TCConstants
{
   public static final boolean isConstant(int opr)
   {
      switch (opr)
      {
         case opr_s6I: case opr_s6D: case opr_s6L:
         case opr_s12I: case opr_s12D: case opr_s12L:
         case opr_s16I: case opr_s16D: case opr_s16L:
         case opr_u16:
         case opr_s18I: case opr_s18D: case opr_s18L:
         case opr_s24I: case opr_s24D: case opr_s24L:
         case opr_s32I: case opr_s32D: case opr_s32L:
         case opr_s64L: case opr_s64D:
            return true;
      }
   ...
   public static final boolean isConstantI(int opr)
   {
      switch (opr)
      {
         case opr_s6I:  case opr_s12I: case opr_s16I: case opr_u16:
         case opr_s18I: case opr_s24I: case opr_s32I:
            return true;
      }
   ...
   public static final boolean isNumerical(int opr)
   {
      switch (opr)
      {
         case opr_regI: case opr_regD: case opr_regL:
         case opr_fieldI: case opr_fieldD: case opr_fieldL:
         case opr_staticI: case opr_staticD: case opr_staticL:
         case opr_symI: case opr_symD: case opr_symL:
         case opr_regIb: case opr_regIs: case opr_regIc:
         case opr_aruI: case opr_aruD: case opr_aruL:
         case opr_arcI: case opr_arcD: case opr_arcL:
         case opr_arlen:
            return true;
      }
   ...
   public static final boolean isSuffixL(int opr)
   {
      switch (opr)
      {
         case opr_regL: case opr_fieldL:
         case opr_staticL: case opr_symL:
         case opr_aruL: case opr_arcL:
            return true;
      }
   ...
   public static final boolean isTypeIExceptARU_I_ARC_I(int opr)
   {
      ...
      {
         case opr_regI:
         case opr_fieldI: case opr_staticI:
         case opr_symI:
         case opr_regIb: case opr_regIs: case opr_regIc:
         case opr_s6I: case opr_s12I: case opr_s18I: case opr_s24I: case opr_s32I: case opr_s16I: case opr_u16:
         case opr_arlen:
            return true;
      }
   ...
   public static final boolean isSymI_s24_s32(int opr)
   {
      switch (opr)
      {
         case opr_symI: case opr_s24I: case opr_s32I:
            return true;
      }
