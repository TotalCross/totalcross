...
// $Id: OperandReg.java,v 1.28 2011-01-04 13:19:18 guich Exp $
...
public class OperandReg extends Operand
{
         ...
         for (int i=0; i<params.length; i++)
         {
            switch (params[i].charAt(0))
            {
               case 'Z': case 'C': case 'B': case 'S': case 'I': // boolean, char, byte, short, int
                  ...
                  break;
               case 'J': case 'F': case 'D': // long, float, double
   ...
   public OperandReg(int kind)
   {
      ...
      switch (kind)
      {
         ...
         case opr_regIb:
         case opr_regIs:
         case opr_regIc: index = nextRegI++; break;

         case opr_regL:
         case opr_regD: index = nextReg64++; break;

         case opr_regO: index = nextRegO++;  break;
      }
   }
