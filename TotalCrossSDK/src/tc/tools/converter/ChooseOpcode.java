...
// $Id: ChooseOpcode.java,v 1.32 2011-01-04 13:19:24 guich Exp $
...
public class ChooseOpcode implements TCConstants
{
   public static int chooseOp(int prefix)
   {
      switch(prefix)
      {
         case pref_ARRAYLEN      : return MOV_regI_arlen;
         case pref_SWITCH        : return SWITCH;
         case pref_NEWOBJ        : return NEWOBJ;
      }
   ...
   public static int chooseOp(int prefix, int opr)
   {
      switch(prefix)
      {
         case pref_JUMP     : return JUMP_s24;
         case pref_NEWARRAY : return opr == opr_s6I ? NEWARRAY_len : NEWARRAY_regI;
         case pref_RETURNI  : return Return(opr_regI, opr); // target, source
         case pref_RETURNO  : return Return(opr_regO, opr);
         case pref_RETURND  : return Return(opr_regD, opr);
         case pref_RETURNL  : return Return(opr_regL, opr);
      }
      return INSTRUCTION_NOT_FOUND;
   }
   ...
   public static int chooseOp(int prefix, int opr1, int opr2)
   {
      switch(prefix)
      {
         case pref_MOV       : return mov (opr1, opr2);
         case pref_CONV      : return conv(opr1, opr2);
         case pref_JEQ       : return jeq (opr1, opr2);
         case pref_JNE       : return jne (opr1, opr2);
         case pref_JLT       : return jlt (opr1, opr2);
         case pref_JGT       : return jgt (opr1, opr2);
         case pref_JLE       : return jle (opr1, opr2);
         case pref_JGE       : return jge (opr1, opr2);
         case pref_CHECKCAST : return CHECKCAST;
         case pref_NEWOBJ    : return NEWOBJ;
      }
      return INSTRUCTION_NOT_FOUND;
   }
   ...
   public static int chooseOp(int prefix, int opr1, int opr2, int opr3)
   {
      switch(prefix)
      {
         case pref_ADD       : return add (opr1, opr2, opr3);
         case pref_SUB       : return sub (opr1, opr2, opr3);
         case pref_MUL       : return mul (opr1, opr2, opr3);
         case pref_AND       : return and (opr1, opr2, opr3);
         case pref_DIV       : return div (opr1, opr2, opr3);
         case pref_MOD       : return mod (opr1, opr2, opr3);
         case pref_SHL       : return shl (opr1, opr2, opr3);
         case pref_SHR       : return shr (opr1, opr2, opr3);
         case pref_USHR      : return ushr(opr1, opr2, opr3);
         case pref_OR        : return or  (opr1, opr2, opr3);
         case pref_XOR       : return xor (opr1, opr2, opr3);
         case pref_NEWARRAY  : return chooseOp(prefix, opr3);
         case pref_INSTANCEOF: return INSTANCEOF;
         case pref_JEQ       : return jeq (opr1, opr2);
         case pref_JNE       : return jne (opr1, opr2);
         case pref_JLT       : return jlt (opr1, opr2);
         case pref_JGT       : return jgt (opr1, opr2);
      ...
      switch (target)
      {
         ...
         case opr_regI:
         {
            switch (src)
            {
               ...
               case opr_regIs:
               case opr_reg16:
               case opr_regI      : return MOV_regI_regI;
               case opr_fieldI    : return MOV_regI_field;
               case opr_staticI   : return MOV_regI_static;
               case opr_aruI      : return MOV_regI_aru;
               case opr_arcI      : return MOV_regI_arc;
               case opr_arlen     : return MOV_regI_arlen;
               default:
               {
                  if (OperandKind.isConstantFitIn18Bits(src)) return MOV_regI_s18;
                  if (OperandKind.isSymI_s24_s32(src))        return MOV_regI_sym;
                  if (OperandKind.isTypeD(src))               return CONV_regI_regD;
                  if (OperandKind.isTypeL(src))               return CONV_regI_regL;
               }
            }
            break;
         }
         ...
         case opr_regD:
         {
            switch (src)
            {
               case opr_regD              : return MOV_reg64_reg64;
               case opr_fieldD            : return MOV_reg64_field;
               case opr_staticD           : return MOV_reg64_static;
               case opr_aruD              : return MOV_reg64_aru;
               case opr_arcD              : return MOV_reg64_arc;
               case opr_symD              : return MOV_regD_sym;
               default:
               {
                  if (OperandKind.isConstantFitIn18Bits(src))    return MOV_regD_s18;
                  if (OperandKind.isConstantNotFitIn18Bits(src)) return MOV_regD_sym;
                  if (OperandKind.isTypeIExceptConstants(src))   return CONV_regD_regI;
                  if (OperandKind.isSuffixL(src))                return CONV_regD_regL;
               }
            }
            break;
         }
         ...
         case opr_regL:
         {
            switch (src)
            {
               case opr_regL              : return MOV_reg64_reg64;
               case opr_fieldL            : return MOV_reg64_field;
               case opr_staticL           : return MOV_reg64_static;
               case opr_aruL              : return MOV_reg64_aru;
               case opr_arcL              : return MOV_reg64_arc;
               case opr_symL              : return MOV_regL_sym;
               default:
               {
                  if (OperandKind.isConstantFitIn18Bits(src))    return MOV_regL_s18;
                  if (OperandKind.isConstantNotFitIn18Bits(src)) return MOV_regL_sym;
                  if (OperandKind.isTypeIExceptConstants(src))   return CONV_regL_regI;
                  if (OperandKind.isTypeD(src))                  return CONV_regL_regD;
               }
            }
            break;
         }
         ...
         case opr_regO:
         {
            switch (src)
            {
               case opr_regO                  : return MOV_regO_regO;
               case opr_fieldO                : return MOV_regO_field;
               case opr_staticO               : return MOV_regO_static;
               case opr_aruO                  : return MOV_regO_aru;
               case opr_arcO                  : return MOV_regO_arc;
               case opr_symO                  : return MOV_regO_sym;
               case opr_null                  : return MOV_regO_null;
               default: ;
            }
            break;
         }
         ...
         case opr_fieldI:
         {
            if (OperandKind.isNumerical(src)) return MOV_field_regI;
            break;
         }
         ...
         case opr_fieldD:
         {
            if (OperandKind.isNumerical(src)) return MOV_field_reg64;
            break;
         }
         ...
         case opr_fieldO:
         {
            if (OperandKind.isTypeO(src)) return MOV_field_regO;
            break;
         }
         ...
         case opr_staticI:
         {
            if (OperandKind.isNumerical(src)) return MOV_static_regI;
            break;
         }
         ...
         case opr_staticD:
         {
            if (OperandKind.isNumerical(src)) return MOV_static_reg64;
            break;
         }
         ...
         case opr_staticO:
         {
            if (OperandKind.isTypeO(src)) return MOV_static_regO;
            break;
         }
         ...
         case opr_regIb:
         {
             switch (src)
             {
                case opr_aruI                      : return MOV_regIb_aru;
                case opr_arcI                      : return MOV_regIb_arc;
                default:
                   if (OperandKind.isTypeIExceptARU_I_ARC_I(src)) return CONV_regIb_regI;
             }
             break;
         }
         ...
         case opr_reg16:
         {
             switch (src)
             {
                case opr_arcI                      : return MOV_reg16_arc;
                case opr_aruI                      : return CONV_regIs_regI;
                default:
                   if (OperandKind.isTypeIExceptARU_I_ARC_I(src)) return CONV_regIs_regI;
             }
             break;
         }
         ...
         case opr_regIc:
         {
             switch (src)
             {
                case opr_aruI                      : return MOV_reg16_aru;
                case opr_arcI                      : return MOV_reg16_arc;
                default:
                   if (OperandKind.isTypeIExceptARU_I_ARC_I(src)) return CONV_regIc_regI;
             }
             break;
         }
         ...
         case opr_aruI:
         {
             switch (src)
             {
                case opr_regIb                       : return MOV_aru_regIb;
                case opr_regIc                       : return MOV_aru_reg16;
                case opr_regIs                       : return MOV_aru_regI;
                default:
                   if (OperandKind.isNumericalExceptRegIx(src)) return MOV_aru_regI;
             }
             break;
         }

         /////////////////////////// MOV_aruIb_? /////////////////////////////
         case opr_aruIb: return MOV_aru_regIb;
         ...
         case opr_aruD:
         {
            if (OperandKind.isNumerical(src)) return MOV_aru_reg64;
            break;
         }
         ...
         case opr_aruO:
         {
            if (OperandKind.isTypeO(src)) return MOV_aru_regO;
            break;
         }
         ...
         case opr_arcI:
         {
             switch (src)
             {
                case opr_regIb                       : return MOV_arc_regIb;
                case opr_regIs                       : return MOV_arc_reg16;
                case opr_regIc                       : return MOV_arc_reg16;
                default:
                   if (OperandKind.isNumericalExceptRegIx(src)) return MOV_arc_regI;
             }
             break;
         }

         /////////////////////////// MOV_arcIb_? /////////////////////////////
         case opr_arcIb: return MOV_arc_regIb;
         ...
         case opr_arcD:
         {
            if (OperandKind.isNumerical(src)) return MOV_arc_reg64;
            break;
         }
         ...
         case opr_arcO:
         {
            if (OperandKind.isTypeO(src)) return MOV_arc_regO;
            break;
         }
         default: ;
      }
...
//   Given operands target and src (source) of a CONV operation, choose and return the opcode.
   private static int conv(int target, int src)
   {
      switch (target)
      {
         ...
         case opr_regI:
         {
            if (OperandKind.isTypeI(src)) return mov(target, src);
            if (OperandKind.isTypeL(src)) return CONV_regI_regL;
            if (OperandKind.isTypeD(src)) return CONV_regI_regD;
            break;
         }
         ...
         case opr_regL:
         {
            if (OperandKind.isTypeI(src)) return CONV_regL_regI;
            if (OperandKind.isTypeL(src)) return mov(target, src);
            if (OperandKind.isTypeD(src)) return CONV_regL_regD;
            break;
         }
         ...
         case opr_regD:
         {
            if (OperandKind.isTypeI(src)) return CONV_regD_regI;
            if (OperandKind.isTypeL(src)) return CONV_regD_regL;
            if (OperandKind.isTypeD(src)) return mov(target, src);
            break;
         }
         ...
         case opr_regIb:
         {
            if (OperandKind.isTypeI(src)) return CONV_regIb_regI;
            if (OperandKind.isTypeL(src)) return CONV_regIb_regI;
            if (OperandKind.isTypeD(src)) return CONV_regIb_regI;
            break;
         }
         ...
         case opr_regIc:
         {
            if (OperandKind.isTypeI(src)) return CONV_regIc_regI;
            if (OperandKind.isTypeL(src)) return CONV_regIc_regI;
            if (OperandKind.isTypeD(src)) return CONV_regIc_regI;
            break;
         }
         ...
         case opr_regIs:
         {
            if (OperandKind.isTypeI(src)) return CONV_regIs_regI;
            if (OperandKind.isTypeL(src)) return CONV_regIs_regI;
            if (OperandKind.isTypeD(src)) return CONV_regIs_regI;
            break;
         }
         default: ;
      }
...
//   Given operands target and sources (src1 and src2) of an ADD operation, choose and return the opcode.
   private static int add (int target, int src1, int src2)
   {
      switch (target)
      {
         ...
         {
             //specific cases
             if (src1 == opr_arcI && src2 == opr_s6I) return ADD_regI_arc_s6;
             if (src1 == opr_s6I && src2 == opr_arcI) return (- ADD_regI_arc_s6); //swap src1 <-> src2
             if (src1 == opr_aruI && src2 == opr_s6I) return ADD_regI_aru_s6;
             if (src1 == opr_s6I && src2 == opr_aruI) return (- ADD_regI_aru_s6); //swap src1 <-> src2
             if (src2 == opr_s6I || src2 == opr_s12I)  return ADD_regI_s12_regI;
             if (src1 == opr_s6I || src1 == opr_s12I)  return ( - ADD_regI_s12_regI); //swap src1 <-> src2

             switch (src2)
             {
                case opr_s18I: case opr_s24I: case opr_s32I: case opr_s16I: case opr_u16: case opr_symI: return ADD_regI_regI_sym;
                default: ;
             }
             switch (src1)
             {
                case opr_s18I: case opr_s24I: case opr_s32I: case opr_s16I: case opr_u16: case opr_symI: return ( - ADD_regI_regI_sym); //swap
                default: ;
             }
         ...
         case opr_aruO:
         {
             if (src2 == opr_s6I) return ADD_aru_regI_s6;
             if (src1 == opr_s6I) return ( - ADD_aru_regI_s6); //swap
...
//   Given operands target and sources (src1 and src2) of an SUB operation, choose and return the opcode.
   private static int sub (int target, int src1, int src2)
   {
      switch (target)
      {
         ...
         {
             //specific cases
             if (src1 == opr_s6I || src1 == opr_s12I)  return SUB_regI_s12_regI;
...
//   Given operands target and sources (src1 and src2) of an MUL operation, choose and return the opcode.
   private static int mul (int target, int src1, int src2)
   {
      switch (target)
      {
         ...
         {
             //specific cases
             if (src2 == opr_s6I || src2 == opr_s12I)  return MUL_regI_regI_s12;
             if (src1 == opr_s6I || src1 == opr_s12I)  return ( - MUL_regI_regI_s12); //swap
...
//   Given operands target and sources (src1 and src2) of an AND operation, choose and return the opcode.
   private static int and (int target, int src1, int src2)
   {
      switch (target)
      {
         ...
         {
            //specific cases
            if (src1 == opr_aruI && src2 == opr_s6I) return AND_regI_aru_s6;
            if (src1 == opr_s6I && src2 == opr_aruI) return (- AND_regI_aru_s6); //swap src1 <-> src2
            if (src2 == opr_s6I || src2 == opr_s12I)  return AND_regI_regI_s12;
            if (src1 == opr_s6I || src1 == opr_s12I)  return ( - AND_regI_regI_s12); //swap
...
//////////////////////////////////////////////////////////////////////////////////////////////////   //
   ...
   private static int jle (int src1, int src2)
   {
      if (src2 == opr_s6I)
      {
         if (OperandKind.isTypeI(src1)) return JLE_regI_s6;
      }
      if (src1 == opr_s6I)
      {
         if (OperandKind.isTypeI(src2)) return ( - JGE_regI_s6);
      }
      if (OperandKind.isTypeI(src1))
      {
         if (OperandKind.isTypeL(src2)) return JLE_regL_regL;
         if (OperandKind.isTypeD(src2)) return JLE_regD_regD;
...
//////////////////////////////////////////////////////////////////////////////////////////////////   //
   ...
   private static int jge (int src1, int src2)
   {
      if (src2 == opr_s6I)
      {
         if (OperandKind.isTypeI(src1)) return JGE_regI_s6;
      }
      if (src1 == opr_s6I)
      {
         if (OperandKind.isTypeI(src2)) return ( - JLE_regI_s6);
      }
      if (src2 == opr_arlen)
      {
         if (OperandKind.isTypeI(src1)) return JGE_regI_arlen;
      }
      if (OperandKind.isTypeI(src1))
      {
         if (OperandKind.isTypeL(src2)) return JGE_regL_regL;
         if (OperandKind.isTypeD(src2)) return JGE_regD_regD;
...
//////////////////////////////////////////////////////////////////////////////////////////////////   //
   ...
   private static int Return(int target, int src)
   {
      switch (src)
      {
         case opr_null: case opr_s6I: case opr_s12I: case opr_u16: case opr_s16I: case opr_s18I: case opr_s24I:
         {
            switch (target)
            {
               case opr_regI: return RETURN_s24I;
               case opr_regO: return RETURN_null;
               case opr_regD: return RETURN_s24D;
               case opr_regL: return RETURN_s24L;
            }
            break;
         }
         ...
         case opr_s32I:
         {
            switch (target)
            {
               case opr_regI: return RETURN_symI;
               case opr_regD: return RETURN_symD;
               case opr_regL: return RETURN_symL;
            }
            break;
         }
         ...
         case opr_symO: return RETURN_symO;
         case opr_symD: return RETURN_symD;
      }
      ...
      switch (target)
      {
         ...
         default: System.out.println( "ERROR: return not implemented for type " + target);
      }
