...
// $Id: TCClass.java,v 1.27 2011-01-04 13:19:25 guich Exp $
...
public final class TCClass
{
   ...
   public void write(DataStreamLE ds) throws totalcross.io.IOException
   {
      ...
      if (className.equals("java/lang/Object")) superClass = null; // java.lang.Object must have no superclass!
      int i;
      ...
      {
         if (J2TC.dump) System.out.print("implements: ");
         for (i = 0; i < interfacesCount; i++)
         {
            if (J2TC.dump) System.out.print(interfaces[i]+" ");
