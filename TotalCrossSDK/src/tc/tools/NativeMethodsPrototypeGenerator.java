...
public class NativeMethodsPrototypeGenerator
{
   ...
   private static void parseNative(String className, String method)
   {
      ...
      while (tok.equalsIgnoreCase("private") || tok.equalsIgnoreCase("public") || tok.equalsIgnoreCase("protected") ||
             tok.equalsIgnoreCase("static")  || tok.equalsIgnoreCase("native") || tok.equalsIgnoreCase("final")) // just ignore
         tok = st.nextToken();
      if (tok.indexOf(".") != -1) // does it have a package?
      {
         ...
         methodRet = "L"+tok+";";
         if (isArray) methodRet = "["+methodRet;
      }
      else
      {
      ...
      while (st.hasMoreTokens())
      {
         ...
         else
         {
            ...
            if (Character.isUpperCase(tok.charAt(0))) // i expect that people use the java coding scheme and only class names starts with capitalized letters!
   ...
   private static String createMethodSignature(String className, String methodName, String d)
   {
      ...
      if (fn.length() > 32) // cut the name if too long
         fn.setLength(32);
      return fn.toString();
   }
   //////////////////////////////////////////////////////////////////////////////////
   ...
   private static void println(String s)
   {
      try
      {
         if (fos == null) fos = new FileOutputStream("NativeMethodsPrototypes.txt");
