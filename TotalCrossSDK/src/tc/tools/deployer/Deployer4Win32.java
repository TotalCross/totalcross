...
// $Id: Deployer4Win32.java,v 1.17 2011-01-04 13:19:05 guich Exp $
...
public class Deployer4Win32
{
   ...
   public Deployer4Win32() throws Exception
   {
      ...
      if (args.length > DeploySettings.defaultArgument.length)
         throw new IllegalArgumentException("Error: command line for Win32 too long. It has "+args.length+", while the maximum allowed is "+DeploySettings.defaultArgument.length);
