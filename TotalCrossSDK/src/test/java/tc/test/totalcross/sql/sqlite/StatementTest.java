...
public class StatementTest extends TestCase {
  ...
  public void executeUpdate() {
    try {
      Vm.gc();
      stat.execute("DROP TABLE IF EXISTS s1");
      ...
      assertEquals(stat.executeUpdate(
          "delete from s1 where c1 = 21;" + "delete from s1 where c1 = 22;" + "delete from s1 where c1 = 23"), 2);
  ...
  public void tempTable() {
    try {
      Vm.gc();
      stat.execute("DROP TABLE IF EXISTS myTemp");
  ...
  public void insert1000() {
    try {
      Vm.gc();
      stat.execute("DROP TABLE IF EXISTS in1000");
  ...
  public void batch() {
    try {
      Vm.gc();
      stat.execute("DROP TABLE IF EXISTS batch");
  ...
  public void blobTest() {
    try {
      Vm.gc();
      stat.execute("DROP TABLE IF EXISTS Foo");
  ...
  public void dateTimeTest() {
    try {
      ...
      Vm.gc();
      stat.execute("DROP TABLE IF EXISTS day");
