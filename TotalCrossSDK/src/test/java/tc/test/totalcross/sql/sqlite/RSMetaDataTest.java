...
public class RSMetaDataTest extends TestCase {
  ...
  public void connect() throws Exception {
    ...
    Vm.gc();
    stat.execute("DROP TABLE IF EXISTS people");
  ...
  public void columnTypes() {
    try {
      Vm.gc();
      stat.execute("DROP TABLE IF EXISTS tbl");
      stat.executeUpdate("create table tbl (col1 INT, col2 INTEGER, col3 TINYINT, "
      ...
      stat.executeUpdate("insert into tbl values (1, 2, 3, 4, 5, 6, 7, 8, 9,"
          + "'c', 'varchar', 'varying', 'n', 'n','nvarchar', 'text', 'clob',"
          + "null, 1.1, 1.2, 1.3, 1.4, 1.5, 1.6, 0, 12345, 123456)");
      meta = stat.executeQuery("select col1, col2, col3, col4, col5, col6, col7, col8, col9, "
          + "col10, col11, col12, col13, col14, col15, col16, col17, col18, "
          + "col19, col20, col21, col22, col23, col24, col25, col26, col27, " + "cast(col1 as boolean) from tbl")
          .getMetaData();
