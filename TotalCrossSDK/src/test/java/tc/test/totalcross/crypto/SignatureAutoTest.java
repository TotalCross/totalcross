...
public class SignatureAutoTest extends MainWindow {
  ...
  public void initUI() {
    try {
      signatures = new Signature[] { new PKCS1Signature(new MD5Digest()), new PKCS1Signature(new SHA1Digest()),
          new PKCS1Signature(new SHA256Digest()) };
    ...
    if (!testSignature(signatures[0], sigKeys[0], verKeys[0]).equals(
        "033DD980F2D1EE9639B9C5A2C59CB23740DE224D03C3BD6994863D6305E750418A7EDE548C2BCE1169521BE25733E0E05620BD26D1CFA4F21D3909A795E608C4")) {
      throw new RuntimeException();
    }
    if (!testSignature(signatures[1], sigKeys[1], verKeys[1]).equals(
        "8A1431BF28D9365C54561B555804CB409E1559275FCA4CAC665D7517939E769A95404BAD8005F44D198D7E748E61F9CAA7F32365406913BBE4DF7F01F5170C78")) {
      throw new RuntimeException();
    }
    if (!testSignature(signatures[2], sigKeys[2], verKeys[2]).equals(
        "4A39BA9164E0EB9FB3B9C5A5430524C482840DEB9D233B3AF7FD30F2D1C98E7407B07D7EB4205B3276C98DAB3631CEAB5D6D69AAFA32232D025B4CC01BF068A2")) {
      throw new RuntimeException();
    }
