...
public class TestArrays extends TestCase {
  ...
  public void testRun() {
    ...
    assertTrue(
        Arrays.equals(new Object[] { "a", "b", "c", "d", "e", "f", "g" }, Arrays.copyOf(objects, 7, String[].class)));
    assertTrue(Arrays.equals(new Object[] { "a", "b", "c", "d", "e", "f", "g" },
        Arrays.copyOfRange(objects, 0, 7, String[].class)));
  }
