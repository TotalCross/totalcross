...
// $Id: XmlTokenizer4D.java,v 1.10 2011-01-04 13:19:11 guich Exp $
...
public class XmlTokenizer4D
{
   ...
   public final void tokenize(Stream input, byte[] buffer, int start, int end, int pos) throws SyntaxException, totalcross.io.IOException
   {
      ofsStart = start;
      ofsCur = start;
      ofsEnd = end;
