...
// $Id: Multipart.java,v 1.12 2011-01-04 13:18:59 guich Exp $
...
public class Multipart
{
   ...
   public void writeTo(Stream stream) throws IOException, MessagingException
   {
      ...
      stream.writeBytes("MIME Multipart Media Encapsulation, Type: multipart/" + subType + ", Boundary: \"" + new String(boundary) + "\"");
