 ...
 * Added new field: Stream in, which holds the underlying stream used by this class.<br>
 ...
 * @since 1.1
 */
public class InflaterInputStream4B
{
   protected Stream in;
   /**
    * Decompressor for this filter
    */
   protected Inflater4B inf;
    ...
    */
   public InflaterInputStream4B(Stream in)
   {
      this(in, new Inflater4B(), 4096);
   }
    ...
    */
   public InflaterInputStream4B(Stream in, Inflater4B inf)
   {
      this(in, inf, 4096);
   }
    ...
    */
   public InflaterInputStream4B(Stream in, Inflater4B inf, int size)
   {
      //    super(in);
      this.in = in;
   ...
   protected void fill() throws IOException
   {
      ...
      len = in.readBytes(buf, 0, buf.length);
