...
// $Id: StreamManipulator4B.java,v 1.3 2011-01-04 13:19:09 guich Exp $
...
class StreamManipulator4B
{
   ...
   /**
    * Get the next n bits but don't increase input pointer. n must be less or equal 16 and if you if this call succeeds,
    * you must drop at least n-8 bits in the next call.
    * 
   ...
   public int copyBytes(byte[] output, int offset, int length)
   {
      ...
      if (length > avail)
         length = avail;
      Vm.arrayCopy(window, window_start, output, offset, length);
      window_start += length;
