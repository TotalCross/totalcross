...
// $Id: ZipEntry4B.java,v 1.4 2011-01-04 13:19:09 guich Exp $
 ...
 */
public class ZipEntry4B implements ZipConstants4B
{
   ...
   {
      return (known & KNOWN_CSIZE) != 0 ? csize & 0xffffffffL : -1L;
   }
    ...
    * @see ZipStream#DEFLATED
    * @see ZipStream#STORED
    */
