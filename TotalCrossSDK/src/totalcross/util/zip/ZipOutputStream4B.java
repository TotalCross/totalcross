 ...
 * Added byte array buffer to be used by writeLeShort and writeLeInt.<br>
 * Changed implementation of the methods and writeLeShort, writeLeInt.<br>
 * Using TotalCross Vector.<br>
 * Removed usage of Enumeration because it is not supported by TotalCross.<br>
 * Replaced Long.toHexString by Convert.toString(value, 16).<br>
 * 
 * @author Jochen Hoenicke
 */
public class ZipOutputStream4B extends DeflaterOutputStream4B implements ZipConstants4B
{
    ...
    */
   public ZipOutputStream4B(Stream out)
   {
      super(out, new Deflater4B(Deflater4B.DEFAULT_COMPRESSION, true));
   }
   ...
   private final void writeLeShort(int value) throws IOException
   {
      ...
      byte[] b = buffer;
      b[0] = (byte) value;
      value >>= 8; // guich@300_40
      b[1] = (byte) value;
      out.writeBytes(b, 0, 2);
   }
   ...
   public void closeEntry() throws IOException
   {
      ...
      if (curEntry.getCrc() < 0)
         ...
         throw new ZipException("crc was " + Convert.toString(crc.getValue(), 16)
               + ", but I expected "
               + Convert.toString(curEntry.getCrc(), 16));
   ...
   public void finish() throws IOException
   {
      ...
      //      while (enum.hasMoreElements())
      {
         ...
         ZipEntry entry = (ZipEntry) entries.items[i];
