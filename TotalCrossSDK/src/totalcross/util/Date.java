...
// $Id: Date.java,v 1.22 2011-01-04 13:19:18 guich Exp $
...
public class Date implements Comparable
{
   ...
   public static String monthNames[] = {"","January","February","March","April","May","June","July","August","September","October","November","December"}; // guich@230_15
   private int day;
   private int month;
   private int year;
   ...
   {
      if (strDate == null || strDate.length() == 0) // guich@tc124_10: now computing the value on the fly
         throw new InvalidDateException(strDate == null ? "Error: date cannot be null" : "Error: date cannot have length 0");
      try
      {
   ...
   */
   ...
   {
      if (sentDate < 10000101 || sentDate > 29991231) // flsobral@tc100b4: Makes sure the argument is within the expected range.
