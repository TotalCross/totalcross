...
package totalcross.zxing.maxicode;
...
import totalcross.zxing.maxicode.decoder.Decoder;
...
public final class MaxiCodeReader implements Reader {
   ...
   * case.
   *
   * @see totalcross.zxing.datamatrix.DataMatrixReader#extractPureBits(BitMatrix)
   * @see totalcross.zxing.qrcode.QRCodeReader#extractPureBits(BitMatrix)
   */
