...
// $Id: RemotePDBFile.java,v 1.27 2011-01-04 13:19:01 guich Exp $
...
public final class RemotePDBFile
{
   ...
   native void create4D() throws totalcross.io.IllegalArgumentIOException, totalcross.io.FileNotFoundException, totalcross.io.IOException;
   ...
   native public void delete4D() throws totalcross.io.IOException;
   ...
   native public int getRecordCount4D() throws totalcross.io.IOException;
   ...
   native int rwRecord4D(int idx, totalcross.io.ByteArrayStream bas, boolean read);
   ...
   native public void deleteRecord4D(int index) throws totalcross.io.IllegalArgumentIOException, totalcross.io.IOException;
   ...
   final public int getNextModifiedRecordIndex() throws totalcross.io.IOException
   {
      ...
      for (int i = pdbFile.getRecordPos(); i < n; i++)
         if ((pdbFile.getRecordAttributes(i) & PDBFile.REC_ATTR_DIRTY) != 0) // guich@570_13: replaced by the correct record attribute
            return i;
      return -1;
   }

   native public int getNextModifiedRecordIndex4D();
   ...
   native public void close4D() throws totalcross.io.IOException;
   ...
   native public static String[] listPDBs4D(int crtr, int type);
