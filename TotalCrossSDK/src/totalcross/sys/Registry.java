...
// $Id: Registry.java,v 1.16 2011-01-08 19:50:39 guich Exp $
 ...
 * <pre>
   ...
   public void initUI()
   {
      ...
      try
      {
         ...
         Registry.set(Registry.HKEY_CURRENT_USER, "Software\\TotalCross\\appSettings\\Test","StringKey","Bárbara");
         log("added. now retrieving...");
 ...
 * <pre>
   ...
   public void initUI()
   {
      ...
      try
      {
         ...
         log("adding string \"Bárbara\"");
         Registry.set(Registry.UNSAVED_PREFERENCES, Settings.applicationId,"2","Bárbara");
         log("added. now retrieving...");
...
public class Registry
{
   ...
   native public static int getInt4D(int hk, String key, String value) throws totalcross.util.ElementNotFoundException;
   native public static String getString4D(int hk, String key, String value) throws totalcross.util.ElementNotFoundException;
   native public static byte[] getBlob4D(int hk, String key, String value) throws totalcross.util.ElementNotFoundException;
   native public static void set4D(int hk, String key, String value, int data) throws Exception;
   native public static void set4D(int hk, String key, String value, String data) throws Exception;
   native public static void set4D(int hk, String key, String value, byte[] data) throws Exception;
   native public static boolean delete4D(int hk, String key, String value);
   native public static String[] list4D(int hk, String key);
}
