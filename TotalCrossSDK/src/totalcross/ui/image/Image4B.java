...
public class Image4B extends GfxSurface
{
   ...
   public Image4B(int width, int height)
   {
   ...
   public Image4B getScaledInstance(int newWidth, int newHeight) // guich@350_22
   {
   ...
   public Image4B getSmoothScaledInstance(int newWidth, int newHeight, int backColor) // guich@350_22
   {
   ...
   public Image4B scaledBy(double scaleX, double scaleY) // guich@402_6
   {
   ...
   public Image4B smoothScaledBy(double scaleX, double scaleY, int backColor) // guich@402_6
   {
   ...
   public Image4B getRotatedScaledInstance(int scale, int angle, int fillColor)
   {
      if (scale <= 0) scale = 1;
   ...
   public Image4B getTouchedUpInstance(byte brightness, byte contrast)
   {
   ...
   ////////////////////////////////////////////////////////////////////////////////////
   Image4B imageGetRotatedScaledInstance(int scale, int angle, int fillColor)
   {
   ...
   final public Image4B getFrameInstance(int frame)
   {
   ...
   final public Image4B smoothScaledFromResolution(int originalRes, int backColor) // guich@tc112_23
   {
