...
// $Id: EscapeHtml.java,v 1.16 2011-01-04 13:19:20 guich Exp $
   ...
   public static final String escape(String s)
   {
      ...
      for (int i = 0, n = s.length(); i < n; i++)
      {
         ...
         switch (c)
         {
            ...
            case 208 : sb.append(amp).append("ETH;"); break;      // 'Ð'
            case 240 : sb.append(amp).append("eth;"); break;      // 'ð'
            ...
            case 254 : sb.append(amp).append("thorn;"); break;    // 'þ'
            case 222 : sb.append(amp).append("THORN;"); break;    // 'Þ'
            ...
            case 253 : sb.append(amp).append("yacute;"); break;   // 'ý'
            case 221 : sb.append(amp).append("Yacute;"); break;   // 'Ý'
