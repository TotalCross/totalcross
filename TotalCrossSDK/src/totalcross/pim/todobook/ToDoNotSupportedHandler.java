...
// $Id: ToDoNotSupportedHandler.java,v 1.7 2011-01-04 13:18:59 guich Exp $
...
public interface ToDoNotSupportedHandler
{
    ...
    * @param tr the respective <code>ToDoRecord</code>
    */
    ...
    * @return Vector of all fields (supported and not supported) of this <code>ToDoRecord</code>
    */
