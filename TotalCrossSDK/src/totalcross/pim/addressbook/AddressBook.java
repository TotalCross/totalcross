...
/**
 * An interface describing the functionality and implementation <code>AddressBook</code> must provide.
...
{
   /**
    * Reads stored <code>AddressRecord</code>s from the device. The returned Vector will be adapted, when records are deleted or created later on.
    * @return RecordList of <code>AddressRecords</code> stored on this device
    */
   public RecordList getAddressRecords();
   /**
    * Creates a new <code>AddressRecord</code>
    * @return The created AddressRecord
   ...
   /**
    * Deletes an <code>AddressRecord</code> from the device
    * @param addressRecord <code>AddressRecord</code> to delete
    */
