...
// $Id: Launcher.java,v 1.191 2011-03-25 14:11:53 guich Exp $
...
public class Launcher extends java.applet.Applet implements WindowListener, KeyListener, java.awt.event.MouseListener, MouseMotionListener
{
   ...
   public UserFont getFont(totalcross.ui.font.Font f, char c)
   {
      ...
      try
      {
         ...
         {
            System.err.println("No fonts found! be sure to place the file TCFont.tcz in the same directory from where you're running your application"+(isApplication ? " or put a reference to TotalCrossSDK/etc folder in the classpath!" : "or in your applet's codebase or in a jar file!"));
            System.exit(2);
         }
