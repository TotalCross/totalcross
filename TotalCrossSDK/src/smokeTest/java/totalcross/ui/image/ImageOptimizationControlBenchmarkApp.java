...
public class ImageOptimizationControlBenchmarkApp extends MainWindow {
  ...
  public void initUI() {
    ...
    try {
      ...
      for (int sample = 1; sample <= samples; sample++) {
        ...
        System.out.println("sample=" + sample + ",elapsed_ms=" + elapsed
            ...
            + ",geometry_materialization=" + Image.nativeGeometryMaterializationCountForTest());
        System.out.flush();
    ...
    System.out.println("fixture=ImageOptimizationControlBenchmarkApp,scenario=" + scenario
