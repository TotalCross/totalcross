    ...
    try {
      ...
      for (int sample = 1; sample <= samples; sample++) {
        ...
        System.out.println("sample=" + sample + ",elapsed_ms=" + elapsed
            ...
            + ",write_pixels_attempts=" + ImageCompactFormatsBenchmarkSupport.metric("writePixelsAttemptsForTest")
            + ",write_pixels_hits=" + ImageCompactFormatsBenchmarkSupport.metric("writePixelsHitsForTest")
            + ",write_pixels_fallbacks=" + ImageCompactFormatsBenchmarkSupport.metric("writePixelsFallbacksForTest")
            + ",write_pixels_copied_bytes=" + ImageCompactFormatsBenchmarkSupport.metric("writePixelsCopiedBytesForTest")
