 ...
 * @since 1.4
 */
public final class StackTraceElement4D implements Serializable
{
   ...
   * @since 1.5
   */
  public StackTraceElement4D(String cls, String method, String file, int line)
  {
    super();
   ...
   * </p>
   */
  private StackTraceElement4D() { super(); }
  ...
  {
    if (!(obj instanceof StackTraceElement4D)) {
      return false;
    }
    StackTraceElement4D castObj = (StackTraceElement4D)obj;
