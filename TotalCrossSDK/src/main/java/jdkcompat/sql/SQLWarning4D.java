...
public class SQLWarning4D extends SQLException
{
  ...
  public SQLWarning4D(String reason) { super(reason); }

  public SQLWarning4D() { super(); }

  public SQLWarning4D getNextWarning() { return next; }

  public void setNextException(SQLWarning4D ex) { next = ex; }
}
