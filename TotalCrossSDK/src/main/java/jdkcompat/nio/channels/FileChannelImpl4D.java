...
public class FileChannelImpl4D extends FileChannel
{
  ...
  FileChannelImpl4D(int fd) { this.nfd = fd; }
  ...
  @Override public int read(ByteBuffer dst) throws IOException { return 0; }
  ...
  native public int write(byte[] src, int offset, int length)
    throws IOException;
  ...
  @Override protected native void implCloseChannel() throws IOException;
}
