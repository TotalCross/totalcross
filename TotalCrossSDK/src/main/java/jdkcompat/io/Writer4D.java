...
public abstract class Writer4D implements Closeable, Flushable
{
  ...
  public void append(char c) throws IOException { write(c); }

  public void append(String str) throws IOException { write(str); }
  ...
  public abstract void write(char[] buff, int offset, int length)
    throws IOException;
}
