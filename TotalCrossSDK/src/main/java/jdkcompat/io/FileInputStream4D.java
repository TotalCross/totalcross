...
public class FileInputStream4D extends InputStream
{
  ...
  @Override public int read() throws IOException { return fileChannel.read(); }

  @Override public int read(byte[] dst) throws IOException
  {
  ...
  @Override public void close() throws IOException { fileChannel.close(); }
  ...
  @Override protected void finalize() throws IOException { this.close(); }
}