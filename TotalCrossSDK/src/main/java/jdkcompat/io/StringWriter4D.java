...
public class StringWriter4D extends Writer
{
  ...
  public StringWriter4D() { strBuffer = new StringBuffer(); }
  ...
  @Override public void write(int charEquiv) throws IOException
  {
    char c = (char)(0xffff & charEquiv);
    strBuffer.append(c);
  }

  @Override public void write(char[] buff) throws IOException
  {
