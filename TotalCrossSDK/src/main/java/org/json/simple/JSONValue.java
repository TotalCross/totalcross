...
public class JSONValue
{
   ...
   * instead
   */
  @Deprecated public static Object parse(Reader in)
  {
    try {
   ...
   * instead
   */
  @Deprecated public static Object parse(String s)
  {
   ...
   * JSONAware, JSONStreamAware or JSONAware will be considered firstly. <p> DO
   * NOT call this method from writeJSONString(Writer) of a class that
   ...
   * will be considered firstly. <p> DO NOT call this method from toJSONString()
   * of a class that implements both JSONAware and Map or List with "this" as
   * the parameter, use JSONObject.toJSONString(Map) or
