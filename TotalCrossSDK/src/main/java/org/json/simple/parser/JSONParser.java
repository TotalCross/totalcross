...
public class JSONParser
{
   ...
   */
  public int getPosition() { return lexer.getPosition(); }
    ...
    throws ParseException
  {
    ...
    try {
      ...
      throw new ParseException(
        -1, ParseException.ERROR_UNEXPECTED_EXCEPTION, ie);
    }
  }
   ...
   * parameter 'in' will be ignored. If this method is called for the first time
