...
public final class Time {
	...
	public Time(char[] sqlTime) throws InvalidDateException {
		try {
			...
			InvalidDateException ide = new InvalidDateException("Invalid date: \"" + new String(
						sqlTime) + "\"");
			ide.initCause(e);
			throw ide;
		}
	...
	public long getTime() throws InvalidDateException {
		return new Date(this).getTime() + hour * 60L * 60L * 1000L + (minute - Settings.timeZoneMinutes) *
			   60L * 1000L
			   + second * 1000L + millis;
	}
	 ...
	 */
	public Time(String time, boolean hasYear, boolean hasMonth, boolean hasDay, boolean hasHour,
				boolean hasMinute,
	...
	public long getSQLLong() {
		return year * 10000000000000L + month * 100000000000L + day * 1000000000L + hour * 10000000L +
			   minute * 100000L
			   + second * 1000L + millis;
	}
	 ...
	 */
	public StringBuffer dump(StringBuffer sb, String timeSeparator,
							 boolean includeMillis) { // guich@tc123_62
