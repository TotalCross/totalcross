...
public class POP3Store extends Store
{
  ...
  public void connect() throws AuthenticationException, MessagingException
  {
    try {
      socketFactory =
        (SocketFactory)Class.forName("totalcross.net.SocketFactory")
          .newInstance();
  ...
  @Override public Folder getDefaultFolder() { return new POP3Folder(this); }

  /**
   * Only the name "INBOX" is supported.
   */
  @Override public Folder getFolder(String name)
  {
    if (!name.equals(ROOT)) {
      return null;
    }
