 ...
 * The typical address syntax is of the form <code>user@host.domain</code> or
 * <code>Personal Name <user@host.domain></code>.
 *
...
public class Address
{
  ...
  /**
   * Creates a new <code>Address</code> object, which represents an Internet
   * email address.
   *
   * @param address The address in the RFC822 format.
   * @param personal The personal name.
   * @throws AddressException If the given address is <code>null</code>, or does
   *     not contain the character <code>@</code>.
   * @since TotalCross 1.13
   */
