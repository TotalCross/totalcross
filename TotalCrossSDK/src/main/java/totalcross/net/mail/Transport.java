...
public abstract class Transport extends Service {
	 ...
	 * @since TotalCross 1.13
	 */
	public static void send(Message message, MailSession session) throws MessagingException,
		...
		int connectionTimeout = ((Properties.Int) session.getNotNull(
									 MailSession.SMTP_CONNECTIONTIMEOUT)).value;
