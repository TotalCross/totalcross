 ...
 *
 * <P>
 * The SMTP protocol provider supports the following properties, which may be
 * set in the <code>MailSession</code> object. The properties are always set as
 * strings; the Type column describes how the string is interpreted. For
 * example, use
 *
 * <PRE>
 ...
 * <TD>int</TD>
 * <TD>Socket connection timeout value in milliseconds. Default is 5000
 * milliseconds.</TD>
 * </TR>
 *
 * <TR>
 ...
 * <TD>int</TD>
 * <TD>Socket I/O timeout value in milliseconds. Default is 2000
 * milliseconds.</TD>
 * </TR>
 *
 * <TR>
 ...
 * <TD>String</TD>
 * <TD>Email address to use for SMTP MAIL command. This sets the envelope return
 * address. Defaults to msg.getFrom()[0] or ConnectionManager.getLocalHost().
 * NOTE: mail.smtp.user was previously used for this.</TD>
 * </TR>
 *
 * <TR>
 ...
 * <TD>boolean</TD>
 * <TD>
 * If true, enables the use of the <code>STARTTLS</code> command (if supported
 * by the server) to switch the connection to a TLS-protected connection before
 ...
 * <TD>int</TD>
 * <TD>
 * The SMTP server port to connect to when STARTTLS is enabled, if the connect()
 * method doesn't explicitly specify one. Defaults to 587.</TD>
 * </TR>
 *
 * <TR>
 ...
 * totalcross.net.ssl.SSLSocketFactory class. This class will be used to create
 * SMTP SSL sockets.</TD>
 * </TR>
 *
 * </TABLE>
 ...
 *
 * <P>
 * The POP3 protocol provider supports the following properties, which may be
 * set in the <code>MailSession</code> object. The properties are always set as
 * strings; the Type column describes how the string is interpreted. For
 * example, use
 *
 ...
 * <TD>int</TD>
 * <TD>Socket connection timeout value in milliseconds. Default is infinite
 * timeout.</TD>
 * </TR>
 *
 * <TR>
 ...
 * <TD>int</TD>
 * <TD>Socket I/O timeout value in milliseconds. Default is infinite
 * timeout.</TD>
 * </TR>
 *
 * </TABLE>
...
public class MailSession extends Properties
{
  ...
  /**
   * Socket connection timeout value in milliseconds. Default is 2000
   * milliseconds.
   */
  public static final String SMTP_CONNECTIONTIMEOUT =
   ...
   * connect() method doesn't explicitly specify one. Defaults to 587.
   */
  public static final String SMTP_SSL_PORT = "mail.smtp.ssl.port";
  /**
   * If set, specifies the name of a class that extends the
   * totalcross.net.ssl.SSLSocketFactory class. This class will be used to
   * create SMTP SSL sockets.
   */
  public static final String SMTP_SSL_SOCKET_FACTORY_CLASS =
  ...
  public static final String POP3_CONNECTIONTIMEOUT =
   ...
   * @since TotalCross 1.13
   */
  public static MailSession getInstance() { return new MailSession(); }

  /**
   * Returns a static instance of MailSession, which may be initialized during
   * the application startup.
   *
   * @return the static instance of MailSession.
   * @since TotalCross 1.13
   */
  public static MailSession getDefaultInstance() { return defaultInstance; }

  /**
   * Get a Store object that implements the specified protocol. If an
   * appropriate Store object cannot be obtained, null is returned.
   *
   * @param protocol
   * @return a Store object, or null if a provider for the given protocol is not
   *     found.
   * @since TotalCross 1.13
   */
  ...
  /**
   * Load properties from the given DataStream, but unlike Properties, the
   * contents of the MailSession are not cleared before reading from the
   * DataStream.
   */
  ...
  /**
   * Retrieves the value of the property mapped to the given key, throwing a
   * NullPointerException if the key is not mapped to any value.
   *
   * @param key
   * @return
   */
