...
public class Socket4D extends Stream {
	...
	native private int readWriteBytes(byte buf[], int start, int count,
									  boolean isRead) throws totalcross.io.IOException;

	protected Socket4D() {
	}

	public Socket4D(String host, int port) throws totalcross.net.UnknownHostException,
	...
	public String readLine() throws totalcross.io.IOException {
		...
		return (pos > 0
				|| r == 1) ? new String(buf, 0, pos) : null; // brunosoares@582_11 - charConverter is already used
	}
