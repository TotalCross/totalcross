...
public class ConnectionManager4D
{
  ...
  private ConnectionManager4D() { loadResources(); }

  native private void loadResources();

  native public static void setDefaultConfiguration(int type, String cfg)
    throws IOException;
  ...
  public static void open() throws IOException
  {
    ...
    throw firstEx == null ? new IOException("No connections available")
                          : firstEx;
  }
  ...
  /*
   * flsobral@tc123_20
   *    fixed bug in ConnectionManager.close implementation for PalmOS: Using
   * this method without first closing all open socket connections would
   * eventually lead to an unrecoverable error, usually causing the device to
   * reset.
   */
  public static void close() throws IOException { nativeClose(); }
  ...
  native public static String getHostAddress(String host)
    throws UnknownHostException;

  native public static String getHostName(String host)
    throws UnknownHostException;
