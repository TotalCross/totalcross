...
public class SSLUtil
{
  ...
  @ReplacedByNativeOnDeploy public static int getConfig(int which)
  {
    switch (which) {
   ...
   * - SSL_BUILD_FULL_MODE
   */
  public static int buildMode() { return getConfig(Constants.SSL_BUILD_MODE); }
   ...
   */
  @ReplacedByNativeOnDeploy public static void displayError(int error_code)
  {
   ...
   */
  @ReplacedByNativeOnDeploy public static String version()
  {
    return "1.0/1.1.5";
  }
}
