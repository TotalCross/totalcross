...
public class SSLCTX {
	...
	final public SSL newServer(Socket socket) throws IOException, NoSuchAlgorithmException,
		CryptoException {
		SSLSocketFactory sf = prepareSecurity();
		java.net.Socket ns = (java.net.Socket) socket.getNativeSocket();
	...
	private SSLSocketFactory prepareSecurity() throws IOException, NoSuchAlgorithmException,
		CryptoException {
		try {
			if (ctx_ssl == null) {
				return null;
