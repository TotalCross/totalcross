...
public class Socket extends Stream {
	 ...
	 */
	public Socket(String host, int port) throws totalcross.net.UnknownHostException,
	...
	public String readLine() throws totalcross.io.IOException {
		...
		return (pos > 0
				|| r == 1) ? new String(Convert.charConverter.bytes2chars(buf, 0,
										pos)) : null; // brunosoares@582_11
	}
