...
public class JSONFactory {
	public static <T> List<T> asList(String json, Class<T> classOfT) throws InstantiationException,
		...
		ArrayIndexOutOfBoundsException, NoSuchMethodException, SecurityException {
	...
	public static <T> T parse(String json, Class<T> classOfT) throws InstantiationException,
	...
	private static <T> T parse(Object outerObject, JSONArray jsonArray,
							   Class<T> classOfT) throws InstantiationException,
		IllegalAccessException, IllegalArgumentException, InvocationTargetException, JSONException,
		ArrayIndexOutOfBoundsException, NoSuchMethodException, SecurityException {
		if (classOfT.isArray()) {
			T array;
	...
	private static <T> T parse(Object outerObject, JSONObject jsonObject,
							   Class<T> classOfT) throws InstantiationException,
		IllegalAccessException, IllegalArgumentException, InvocationTargetException, JSONException,
		NoSuchMethodException, SecurityException {
		if (classOfT.isArray()) {
		...
		for (Method method : methods) {
			...
			if (paramTypes != null && paramTypes.length == 1 && methodName.length() > 3
