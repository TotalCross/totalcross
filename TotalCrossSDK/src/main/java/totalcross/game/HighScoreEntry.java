 ...
 * <br>
 * This class represents one entry in the game highscores database. A highscore
 * entry has a given rank and is composed by a score and a performer name.
 * @see HighScores
 */
public class HighScoreEntry
{
  ...
  protected HighScoreEntry(HighScores parent) { this.parent = parent; }
