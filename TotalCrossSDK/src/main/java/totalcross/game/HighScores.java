 ...
 *
 *       Vm.debug(&quot;name: &quot;+entry.name+&quot;
 * score=&quot;+Convert.toString(entry.score));
 *     }
 *
 *   }
 *
...
public class HighScores extends PDBFile
{
  ...
  {
    super(engine.gameName + dbName_suffix + engine.gameCreatorID + dbType,
          PDBFile.CREATE);
   ...
   */
  public final int size() { return entries.length; }
   ...
   */
  public final HighScoreEntry[] getEntries() { return entries; }
