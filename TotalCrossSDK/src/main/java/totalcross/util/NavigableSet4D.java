 ...
 * @since 1.6
 */
public interface NavigableSet4D<E> extends SortedSet<E> {
  /**
   ...
   * Collections.reverseOrder}(comparator())</tt>. The expression {@code
   * s.descendingSet().descendingSet()} returns a view of {@code s} essentially
   * equivalent to {@code s}.
   *
