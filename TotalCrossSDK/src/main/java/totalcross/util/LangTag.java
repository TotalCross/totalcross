...
import totalcross.util.regex.Matcher; // Copyright 2018 Totalcross/Italo Yeltsin
import totalcross.util.regex.Pattern; // Copyright 2018 Totalcross/Italo Yeltsin
 ...
 * 4646</a></li> <li>Matching Language tags: <a
 * href="http://www.ietf.org/rfc/rfc4647.txt">RFC 4647</a></li> <li>Language
 * tags syntax (BCP 47): <a href="http://www.ietf.org/rfc/rfc5646.txt">RFC
 * 5646</a></li>
 * </ul>
 */
...
public class LangTag
{
   ...
   * registration ; Note: i is the only singleton ; that starts a grandfathered
   * tag
   *
  ...
  private static final String language =
    languageRE_1 + "|" + languageRE_2 + "|" + languageRE_3;
   ...
   * the return array.
   *
   * @return Langtag parts, or null if the input string does not parse as a lang
   *     tag.
   */
  public static String[] parse(String languageTag)
  {
    ...
    parts[idxLanguage] =
      parts[idxLanguage]
        .toLowerCase(); // Copyright 2018 Totalcross/Italo Yeltsin
  ...
  //    /** Canonicalize with the rules of RFC 4646, or RFC5646 without
  //    replacement of preferred form. */ public static String canonical(String
  //    str) {
  //        if ( str == null )
  //            return null ;
  ...
  //     non-initial
  //     * two-letter subtags are uppercase, all non-initial four-letter subtags
  //     are
