...
public final class Objects
{
  ...
  public static boolean deepEquals(Object a, Object b)
  {
    if (a == b) {
      ...
      // thus a == null || b == null guarantees that one is null, while the
      // other isn't
      return false;
    }
    ...
    if (a.getClass().isArray() && b.getClass().isArray()) {
      return Arrays.deepEquals(
        (Object[])a,
        (Object[])b); // there exists Arrays4D.deepEquals(O[], O[])
    }
    return a.equals(b);
  }
  ...
  public static String toString(Object o)
  {
    return String.valueOf(
      o); // String4D.valueOf(O) returns constant "null" if arg is null
  }
