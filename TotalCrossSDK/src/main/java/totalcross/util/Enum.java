 ...
 * <pre>
    public static class DatePrecision extends Enum
    {
        ...
        public static final DatePrecision SECONDS = new
 DatePrecision("SECONDS"); public static final DatePrecision MILLISECONDS = new
...
public class Enum
{
  ...
  protected Enum(String name) { this(Convert.MIN_INT_VALUE, name); }
