...
public class Indentifiers
{
  ...
  {
    int m =
      Settings.daylightSavingsMinutes /*c.get(Calendar.DST_OFFSET) / 60000*/;
    int dts_h = m / 60;
    int dts_m = m % 60;
    String sign = m > 0 ? "+" : "-";
    return "(D:" + Convert.spacePad(Convert.toString(date.year), 40, true) +
  ...
  public static String generateId() { return calculateMd5(encode(new Time())); }

  public static String generateId(String data) { return calculateMd5(data); }
}
