...
public class Pages
{
  ...
  public Pages(PDFDocument document, int pageWidth, int pageHeight)
  {
    ...
    mMediaBox = new Array();
    String content[] = {
      "0", "0", Integer.toString(pageWidth), Integer.toString(pageHeight)
    };
  ...
  public Page getPageAt(int position) { return mPageList.get(position); }

  public int getCount() { return mPageList.size(); }
