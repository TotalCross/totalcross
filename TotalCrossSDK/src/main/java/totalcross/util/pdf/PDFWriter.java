...
public class PDFWriter
{
  ...
  public PDFWriter() { newDocument(PaperSize.A4_WIDTH, PaperSize.A4_HEIGHT); }
  ...
  public int getPageCount() { return mPages.getCount(); }
  ...
  public void addText(int leftPosition,
                      ...
                      String text)
  {
    addText(leftPosition,
            topPositionFromBottom,
            fontSize,
            text,
  ...
  {
    mCurrentPage.addText(
      leftPosition, topPositionFromBottom, fontSize, text, transformation);
  }
  ...
  public void addTextAsHex(int leftPosition,
                           ...
                           String transformation)
  {
    mCurrentPage.addTextAsHex(
      leftPosition, topPositionFromBottom, fontSize, hex, transformation);
  }
  ...
  public void addImage(int fromLeft, int fromBottom, Image Image)
    throws IOException
  {
                       ...
                       String transformation) throws IOException
  {
    ...
    mCurrentPage.addImage(fromLeft,
                          fromBottom,
                          xImage.getWidth(),
                          xImage.getHeight(),
                          xImage,
                       ...
                       String transformation) throws IOException
  {
    mCurrentPage.addImage(fromLeft,
                          ...
                          toLeft,
                          toBottom,
                          new XObjectImage(mDocument, Image),
                          transformation);
  }

  public void addImageKeepRatio(int fromLeft,
                                int fromBottom,
                                int width,
                                int height,
                                Image Image) throws IOException
  {
    addImageKeepRatio(fromLeft,
                      fromBottom,
                      width,
                      height,
                      Image,
                                ...
                                String transformation) throws IOException
  {
    ...
    mCurrentPage.addImage(
      fromLeft, fromBottom, width, height, xImage, transformation);
  }
