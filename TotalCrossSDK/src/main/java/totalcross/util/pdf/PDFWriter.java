...
public class PDFWriter {
  ...
  public void addImage(int fromLeft, int fromBottom, int toLeft, int toBottom, Image Image, String transformation)
      throws IOException {
  ...
  public void addImageKeepRatio(int fromLeft, int fromBottom, int width, int height, Image Image, String transformation)
      throws IOException {
    final XObjectImage xImage = new XObjectImage(mDocument, Image);
