...
public class Properties
{
  ...
  public Properties() { props = new Hashtable(13); }
  ...
  public static class Str extends Value
  {
     ...
     * only if the argument is not null and is a String object, or another Str
  ...
  public static class Double extends Value
  {
    ...
    /**
     * Returns a hash code for this <code>Double</code> object. The result is
     * the exclusive OR of the two halves of the <code>long</code> integer bit
     * representation, exactly as produced by the method
     * {@link Convert#doubleToLongBits(double) doubleToLongBits(double)}, of the
     * primitive <code>double</code> value represented by this
     ...
     * and is a <code>Double</code> object that represents a <code>double</code>
     * that has the same value as the <code>double</code> represented by this
     * object. For this purpose, two <code>double</code> values are considered
     * to be the same if and only if the method {@link
     * Convert#doubleToLongBits(double) doubleToLongBits(double)} returns the
     * identical <code>long</code> value when applied to each. <p> Note that in
     * most cases, for two instances of class <code>Double</code>,
     ...
     * <code>Convert.DOUBLE_NAN_BITS</code>, then the <code>equals</code> method
     * returns <code>true</code>, even though
     * <code>Convert.doubleToLongBits(Convert.DOUBLE_NAN_BITS) ==
     * Convert.doubleToLongBits(Convert.DOUBLE_NAN_BITS)</code> has the value
     * <code>false</code>. <li>If <code>d1</code> represents <code>+0.0</code>
     * while <code>d2</code> represents <code>-0.0</code>, or vice versa, the
     * <code>equal</code> test has the value <code>false</code>, even though
     * <code>+0.0==-0.0</code> has the value <code>true</code>.
     * </ul>
    ...
    @Override public boolean equals(Object obj)
    {
      ...
      if (obj instanceof Double) {
        return Convert.doubleToLongBits(value) ==
          Convert.doubleToLongBits(((Double)obj).value);
      }
      return false;
    }
  }
  ...
  public static class Boolean extends Value
  {
    ...
    @Override public String toString() { return value ? "1" : "0"; }

    /**
     * Returns a hash code for this Boolean object.
     *
     * @return the integer 1231 if this object represents true; returns the
     *     integer 1237 if this object represents
     *         false.
     * @since TotalCross 1.25
     */
    @Override public int hashCode() { return value ? 1231 : 1237; }
  ...
  /**
   * Load properties from the given DataStream. If cleanBeforeLoad is true, the
   * contents of this object will be cleared before reading from the DataStream.
   *
   * @param ds
   * @param cleanBeforeLoad
   * @throws totalcross.io.IOException
   */
  public void load(DataStream ds, boolean cleanBeforeLoad)
    throws totalcross.io.IOException
  {
    if (cleanBeforeLoad) {
      props.clear();
  ...
  /**
   * Dumps the keys and values into the given StringBuffer. The values are
   * dumped as Strings, exactly like the Hashtable implementation.
   *
   * @param sb
