...
public class IntVector {
	...
	public void insertElementAt(int obj, int index) {
		...
		if (count == items.length) {
			...
			int newSize = (Settings.onJavaSE ? items.length * 2 : items.length * 12 / 10) +
	...
	public void setSize(int newSize) throws
		ArrayIndexOutOfBoundsException { //flsobral@tc112_11: removed boolean argument "copyOldData". The original content is always kept now.
		if (newSize < 0) {
