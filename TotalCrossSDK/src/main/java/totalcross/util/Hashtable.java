...
public class Hashtable {
	...
	private void init(int initialCapacity, double loadFactor) { // guich@tc114_27
		...
		initialCapacity = (int)(initialCapacity / loadFactor +
								1);  // guich@tc100: since most users just pass the number of element, compute the desired initial capacity based in the load factor
	...
	public Object put(Object key, Object value) {
		...
		int hash =
			key.hashCode(); // flsobral@tc100b4_23: this operation throws NPE if key is null, no need to explicitly test that.
	...
	protected void rehash() {
		...
		int newCapacity = (((oldCapacity << 1) + oldCapacity) >> 1) +
						  1; // guich@120 - grows 50% instead of 100% - guich@200b4_198: added Peter Dickerson and Andrew Chitty changes to correct the optimization i made with << and >>
	 ...
	 */
	public StringBuffer dumpKeysValues(StringBuffer sb, String keyvalueSeparator,
