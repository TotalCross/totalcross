...
/**
 * I18N is entity that supports internationalized applications. Its structure
 * contains a Map of all values registred in an xml file. For instance, if you
 * want to define values for Portguese language whose ISO 639 code is pt, then
 * create a xml file with the path <i>&lt;source
 * patch&lt;/resources/i18n/pt.xml</i>. contaning the following format: <pre>
 * &lt;resources&gt;
 * 	&lt;string name="hello_world"&gt;Olá mundo!&lt;/string&gt;
 * &lt;/resources&gt;
 * </pre>
 *
 * Then initialize values on the MainWindow Constructor an get
 * <i>hello_world</i> value as follow: <pre> public class App extends MainWindow
 * { public App() { I18N.initialize();
 *     }
 *
 *     &#64;Override
 *     public void initUI() {
...
public class I18N
{
  ...
  private I18N(String iso639Code)
  {
    ...
    if (file == null) {
      ...
      rdr.setContentHandler(new ContentHandler() {
        ...
        String att_value;
        String value;
        @Override public void startElement(int tag, AttributeList atts)
        {
        ...
        @Override public void endElement(int tag)
        {
          if (this.tag == tag) {
        ...
        @Override public void characters(String s) { value = s; }
      });
      try {
  ...
  /**
   * Returns I18N for the device default language. If there is no xml file for
   * this language, this function will return an I18N instance with values
   * defined in <i> &lt;source path&gt;/resources/i18n/default.xml</i>
