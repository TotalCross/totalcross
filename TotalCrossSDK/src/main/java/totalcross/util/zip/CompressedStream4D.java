...
public abstract class CompressedStream4D extends Stream {
	...
	protected CompressedStream4D(Stream stream, int mode,
								 int compressionType) { //flsobral@tc114_82: Subclasses of CompressedStream4D must now inform the type of compression to be used by the ZLib library.
		if (stream == null) {
