...
@Deprecated public class ZipFile
{
  ...
  public ZipEntry[] entries()
  {
    ...
    for (int i = 0; e.hasMoreElements(); i++) {
      entries[i] =
        new ZipEntry(((java.util.zip.ZipEntry)e.nextElement()).getName());
    }
  ...
  public String getName() { return nativeFile.getName(); }

  public int size() { return nativeFile.size(); }
