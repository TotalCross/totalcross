...
public class ZipEntry
{
   ...
   * @since TotalCross 1.20
   */
  public ZipEntry(String name) { zipEntry = new java.util.zip.ZipEntry(name); }
   ...
   * @since TotalCross 1.23
   */
  public long getTime() { return ((java.util.zip.ZipEntry)zipEntry).getTime(); }
   ...
   * @since TotalCross 1.23
   */
  public long getSize() { return ((java.util.zip.ZipEntry)zipEntry).getSize(); }
   ...
   * @since TotalCross 1.23
   */
  public long getCrc() { return ((java.util.zip.ZipEntry)zipEntry).getCrc(); }
  ...
  /**
   * Returns a string representation of the ZIP entry. This is just the name as
   * returned by getName().
   *
   * @since TotalCross 1.23
   */
  ...
  /**
   * Returns the hash code value for this entry. This is just the hashCode of
   * the name returned by getName().<br> Note that the equals method isn't
   * changed, though.
   *
   * @since TotalCross 1.23
   */
