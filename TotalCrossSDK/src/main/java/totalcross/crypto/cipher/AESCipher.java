...
public class AESCipher extends Cipher
{
   ...
   * @return "AES".
   */
  @Override public final String getAlgorithm() { return "AES"; }
   ...
   */
  @Override public final int getBlockLength()
  {
    ...
    throws NoSuchAlgorithmException, CryptoException
  {
    ...
    try {
      ...
      int mode = operation == OPERATION_ENCRYPT
                   ? javax.crypto.Cipher.ENCRYPT_MODE
                   : javax.crypto.Cipher.DECRYPT_MODE;
      cipher.init(mode,
                  (java.security.Key)keyRef,
  ...
  @Override protected final boolean isKeySupported(Key key, int operation)
  {
    return key instanceof AESKey;
  }

  @Override protected final boolean isChainingSupported(int chaining)
  {
    return chaining == CHAINING_ECB || chaining == CHAINING_CBC;
  }

  @Override protected final boolean isPaddingSupported(int padding)
  {
    return padding == PADDING_PKCS5;
  }

  @ReplacedByNativeOnDeploy private void init() {}
}
