...
public class SHA1Digest extends Digest
{
   ...
   *     algorithm.
   */
  public SHA1Digest() throws NoSuchAlgorithmException { init(); }
   ...
   * @return "SHA-1".
   */
  @Override public final String getAlgorithm() { return "SHA-1"; }
   ...
   * @return 20.
   */
  @Override public final int getDigestLength() { return 20; }
