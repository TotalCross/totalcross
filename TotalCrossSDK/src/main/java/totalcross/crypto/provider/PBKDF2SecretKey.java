...
public class PBKDF2SecretKey implements PBEKey
{
  ...
  @Override public String getAlgorithm() { return "PBKDF2WithHmacSHA1"; }
  ...
  @Override public char[] getPassword() { return keySpec.getPassword(); }

  @Override public byte[] getSalt() { return keySpec.getSalt(); }
}
