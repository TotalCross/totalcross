 ...
 * that something has happened in the background.
 *
 * @author Fábio Sobral
...
public class NotificationManager
{
   ...
   * @param notification
   */
  @ReplacedByNativeOnDeploy public void notify(Notification notification)
  {
    ...
    trayIcon.displayMessage(
      notification.title(), notification.text(), MessageType.INFO);
  }
}
