 ...
 *
 * <p>Notifications can only be created by using the The {@link
...
public class Notification
{
  ...
  public static class Builder
  {
    ...
    /**
     * Set the first line of text (usually properly emphasized as a title) in
     * the platform notification template.
     *
     * @param title
     * @return
     */
    ...
    /**
     * Set the second line of text (the content of the notification) in the
