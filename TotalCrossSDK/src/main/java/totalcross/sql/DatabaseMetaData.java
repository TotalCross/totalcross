...
public interface DatabaseMetaData {
  ...
  /**
   * This method tests whether or not the extended grammer for ODBC is
   * supported.
   *
  ...
  /**
   * This method tests whether a catalog name can appear in privilege
   * definitions.
   *
   ...
   * <code>procedureNullable</code>, or
   * <code>procedureNullableUnknown</code>)</li> <li>REMARKS - A description of
   * the column.</li>
   * </ol>
   *
   * @param catalog The name of the catalog to return stored procedured from,
   ...
   * <code>null</code>.</li> <li>TABLE_SCHEM - The schema the table is in, which
   * may be <code>null</code>.</li> <li>TABLE_NAME - The name of the table.</li>
   ...
   * <li>COLUMN_DEF - The default value for the column, may be
   * <code>null</code>.</li> <li>SQL_DATA_TYPE - Unused</li>
   ...
   * to return entities not associated with a catalog, or <code>null</code>
   * to return information from all catalogs.
   * @param schemaPattern The schema to retrieve information from, or the empty
   *     string
   * to return entities not associated with a schema.
   ...
   *
   * <ol>
   * <li>TABLE_CAT - The catalog of the table, which may be
   * <code>null</code>.</li> <li>TABLE_SCHEM - The schema of the table, which
   * may be <code>null</code>.</li> <li>TABLE_NAME - The name of the table.</li>
   * <li>COLUMN_NAME - The name of the column.</li>
   * <li>KEY_SEQ - The sequence number of the column within the primary
   * key.</li> <li>PK_NAME - The name of the primary key, which may be
   * <code>null</code>.</li>
   * </ol>
   *
   * @param catalog The catalog to retrieve information from, or the empty
   ...
   * <li>KEY_SEQ - The sequence number of the column within the foreign
   * key.</li> <li>UPDATE_RULE - How the foreign key behaves when the primary
   * key is updated. This is one of the constants defined in this class
   ...
   * (<code>importedNoAction</code>, <code>importedKeyCascade</code>,
   * <code>importedKeySetNull</code>, or
   * <code>importedKeySetDefault</code>)</li> <li>FK_NAME - The name of the
   * foreign key.</li> <li>PK_NAME - The name of the primary key.</li>
   ...
   * <li>AUTO_INCREMENT - Whether or not this type supports
   * auto-incrementing.</li> <li>LOCAL_TYPE_NAME - A localized name for this
   * data type.</li> <li>MINIMUM_SCALE - The minimum scale supported by this
   * type.</li> <li>MAXIMUM_SCALE - The maximum scale supported by this
   * type.</li> <li>SQL_DATA_TYPE - Unused.</li> <li>SQL_DATETIME_SUB -
   * Unused.</li> <li>NUM_PREC_RADIX - The radix of this data type.</li>
   * </ol>
   *
   ...
   * <code>tableIndexStatistic</code>.</li> <li>COLUMN_NAME - The name of this
   * column in the index.</li> <li>ASC_OR_DESC - "A" for an ascending sort
   * sequence, "D" for a descending sort sequence or <code>null</code> if a sort
   * sequence is not supported.</li> <li>CARDINALITY - The number of unique rows
   * in the index, or the number of rows in the table if the index type is
   * <code>tableIndexStatistic</code>.</li> <li>PAGES - The number of pages used
   * for the index, or the number of pages in the table if the index type is
   * <code>tableIndexStatistic</code>.</li> <li>FILTER_CONDITION - The filter
   * condition for this index, which may be <code>null</code>.</li>
   * </ol>
   *
   * @param catalog The catalog to retrieve information from, or the empty
   *     string
  ...
  ResultSet getAttributes(String catalog,
                          String schemaPattern,
                          String typePattern,
                          String attributePattern) throws SQLException;
