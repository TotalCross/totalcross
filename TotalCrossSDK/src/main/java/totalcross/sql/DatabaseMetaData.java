...
public interface DatabaseMetaData {
	 ...
	 * @exception SQLException If an error occurs.
	 */
	ResultSet getProcedureColumns(String catalog, String schemaPattern, String procedurePattern,
	 ...
	 * @exception SQLException If an error occurs.
	 */
	ResultSet getTables(String catalog, String schemaPattern, String tablePattern,
	 ...
	 * @exception SQLException If an error occurs.
	 */
	ResultSet getColumns(String catalog, String schemaPattern, String tablePattern,
						 String columnPattern)
	throws SQLException;
	 ...
	 * @exception SQLException If an error occurs.
	 */
	ResultSet getBestRowIdentifier(String catalog, String schema, String tableName, int scope,
								   boolean nullable)
	throws SQLException;
	 ...
	 * @exception SQLException If an error occurs.
	 */
	ResultSet getIndexInfo(String catalog, String schema, String tableName, boolean unique,
						   boolean approximate)
	throws SQLException;
	 ...
	 * @exception SQLException If an error occurs.
	 */
	ResultSet getUDTs(String catalog, String schemaPattern, String typePattern,
	 ...
	 * @since 1.4
	 */
	ResultSet getAttributes(String catalog, String schemaPattern, String typePattern,
