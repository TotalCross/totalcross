...
public class SQLite4JResultSet implements ResultSet
{
  ...
  public SQLite4JResultSet(java.sql.ResultSet rs) { this.rs = rs; }

  @Override public boolean next() throws SQLException { return rs.next(); }
  ...
  @Override public String getString(String columnName) throws SQLException
  {
    return rs.getString(columnName);
  }

  @Override public boolean getBoolean(String columnName) throws SQLException
  {
    return rs.getBoolean(columnName);
  }

  @Override public byte getByte(String columnName) throws SQLException
  {
    return rs.getByte(columnName);
  }

  @Override public short getShort(String columnName) throws SQLException
  {
    return rs.getShort(columnName);
  }

  @Override public int getInt(String columnName) throws SQLException
  {
    return rs.getInt(columnName);
  }

  @Override public long getLong(String columnName) throws SQLException
  {
  ...
  @Override public double getDouble(String columnName) throws SQLException
  {
  ...
  @Override public byte[] getBytes(String columnName) throws SQLException
  {
    return rs.getBytes(columnName);
  }

  @Override public Date getDate(String columnName) throws SQLException
  {
    return SQLConvert.date(rs.getDate(columnName));
  }

  @Override public Time getTime(String columnName) throws SQLException
  {
    return SQLConvert.time(rs.getString(columnName));
  }

  @Override public Timestamp getTimestamp(String columnName) throws SQLException
  {
  ...
  {
    return rsmd == null ? rsmd = new SQLite4JResultSetMetaData(rs.getMetaData())
                        : rsmd;
  }
  ...
  @Override public int findColumn(String columnName) throws SQLException
  {
  ...
  {
    return tcstat != null ? tcstat
                          : (tcstat = new SQLite4JStatement(rs.getStatement()));
  }
}
