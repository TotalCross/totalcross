...
public class SQLite4JStatement implements Statement
{
  ...
  public SQLite4JStatement(java.sql.Statement stat) { this.stat = stat; }
  ...
  @Override public void close() throws SQLException { stat.close(); }
  ...
  @Override public java.sql.SQLWarning getWarnings() throws SQLException
  {
  ...
  @Override public void clearBatch() throws SQLException { stat.clearBatch(); }
  ...
  @Override public Connection getConnection() throws SQLException
  {
    return new SQLite4JConnection(
      (org.sqlite.SQLiteConnection)stat.getConnection());
  }
}
