...
public class SQLite4JDatabaseMetaData implements DatabaseMetaData
{
  ...
  {
    return new SQLite4JResultSet(
      metadata.getProcedures(catalog, schemaPattern, procedurePattern));
  }
  ...
  {
    return new SQLite4JResultSet(metadata.getProcedureColumns(
      catalog, schemaPattern, procedurePattern, columnPattern));
  }
  ...
  {
    return new SQLite4JResultSet(
      metadata.getTables(catalog, schemaPattern, tablePattern, types));
  }
  ...
  {
    return new SQLite4JResultSet(
      metadata.getColumns(catalog, schemaPattern, tablePattern, columnPattern));
  }
  ...
  {
    return new SQLite4JResultSet(
      metadata.getColumnPrivileges(catalog, schema, tableName, columnPattern));
  }
  ...
  {
    return new SQLite4JResultSet(
      metadata.getTablePrivileges(catalog, schemaPattern, tablePattern));
  }
  ...
  {
    return new SQLite4JResultSet(metadata.getBestRowIdentifier(
      catalog, schema, tableName, scope, nullable));
  }
  ...
  {
    return new SQLite4JResultSet(
      metadata.getVersionColumns(catalog, schema, tableName));
  }
  ...
  {
    return new SQLite4JResultSet(
      metadata.getExportedKeys(catalog, schema, tableName));
  }
  ...
  public ResultSet getCrossReference(String primaryCatalog,
    ...
    throws SQLException
  {
    return new SQLite4JResultSet(metadata.getCrossReference(primaryCatalog,
                                                            primarySchema,
                                                            primaryTableName,
                                                            foreignCatalog,
                                                            foreignSchema,
  ...
  {
    return new SQLite4JResultSet(
      metadata.getIndexInfo(catalog, schema, tableName, unique, approximate));
  }
  ...
  {
    return new SQLite4JResultSet(
      metadata.getUDTs(catalog, schemaPattern, typePattern, types));
  }
  ...
  {
    return new SQLite4JResultSet(
      metadata.getSuperTypes(catalog, schemaPattern, typePattern));
  }
  ...
  {
    return new SQLite4JResultSet(
      metadata.getSuperTables(catalog, schemaPattern, tablePattern));
  }
  ...
  {
    return new SQLite4JResultSet(metadata.getAttributes(
      catalog, schemaPattern, typePattern, attributePattern));
  }
