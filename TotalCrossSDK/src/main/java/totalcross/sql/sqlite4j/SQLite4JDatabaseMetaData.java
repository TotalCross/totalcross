...
public class SQLite4JDatabaseMetaData implements DatabaseMetaData {
	...
	public ResultSet getProcedureColumns(String catalog, String schemaPattern, String procedurePattern,
		...
		return new SQLite4JResultSet(metadata.getProcedureColumns(catalog, schemaPattern, procedurePattern,
									 columnPattern));
	}

	@Override
	public ResultSet getTables(String catalog, String schemaPattern, String tablePattern,
							   String[] types)
	throws SQLException {
	...
	@Override
	public ResultSet getColumns(String catalog, String schemaPattern, String tablePattern,
								String columnPattern)
	throws SQLException {
		return new SQLite4JResultSet(metadata.getColumns(catalog, schemaPattern, tablePattern,
									 columnPattern));
	}

	@Override
	public ResultSet getColumnPrivileges(String catalog, String schema, String tableName,
										 String columnPattern)
	throws SQLException {
		return new SQLite4JResultSet(metadata.getColumnPrivileges(catalog, schema, tableName,
									 columnPattern));
	}
	...
	@Override
	public ResultSet getBestRowIdentifier(String catalog, String schema, String tableName, int scope,
										  boolean nullable)
	throws SQLException {
		return new SQLite4JResultSet(metadata.getBestRowIdentifier(catalog, schema, tableName, scope,
									 nullable));
	}
	...
	public ResultSet getCrossReference(String primaryCatalog, String primarySchema,
		...
		return new SQLite4JResultSet(metadata.getCrossReference(primaryCatalog, primarySchema,
									 primaryTableName, foreignCatalog, foreignSchema, foreignTableName));
	}
	...
	public ResultSet getIndexInfo(String catalog, String schema, String tableName, boolean unique,
								  boolean approximate)
	throws SQLException {
		return new SQLite4JResultSet(metadata.getIndexInfo(catalog, schema, tableName, unique,
									 approximate));
	}
	...
	throws SQLException {
		return new SQLite4JResultSet(metadata.getAttributes(catalog, schemaPattern, typePattern,
									 attributePattern));
	}
