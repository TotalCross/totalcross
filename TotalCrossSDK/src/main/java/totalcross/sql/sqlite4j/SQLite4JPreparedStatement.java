...
public class SQLite4JPreparedStatement
  extends SQLite4JStatement implements PreparedStatement
{
  ...
  @Override public void setDate(int parameterIndex, Date x) throws SQLException
  {
    ps.setString(
      ...
      x == null
        ? null
        : x.getSQLString()); // ps.setDate(parameterIndex,SQLConvert.date(x));
  }
  ...
  @Override public void setTime(int parameterIndex, Time x) throws SQLException
  {
    ps.setString(
      ...
      x == null
        ? null
        : x.getSQLString()); // ps.setTime(parameterIndex,SQLConvert.time(x));
  }
  ...
  @Override public void addBatch() throws SQLException { ps.addBatch(); }
