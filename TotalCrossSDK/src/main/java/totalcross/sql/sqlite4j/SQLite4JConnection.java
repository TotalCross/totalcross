...
public class SQLite4JConnection implements Connection
{
  ...
  public SQLite4JConnection(org.sqlite.SQLiteConnection con) { this.con = con; }
  ...
  @Override public String nativeSQL(String sql) { return con.nativeSQL(sql); }
  ...
  @Override public void close() throws SQLException { con.close(); }
  ...
  public PreparedStatement prepareStatement(String sql,
    ...
    throws SQLException
  {
    return new SQLite4JPreparedStatement(
