 ...
 * an OutOfMemoryError, try calling the flush method. Note that doing this often
 * may slowdown the whole program.
 *
...
public class Resources
{
  ...
  // SWITCH
  public static Image switchBrdAnd, switchBack, switchBtnAnd, switchBtnIos,
    switchBrdIos, switchBtn,
    switchBrd; // material last 2

  public static String chimeMP3 = "device/chime.mp3";

  private static boolean uiMat;

  private static void loadImages(String folder)
  ...
  /**
   * Flush all resources held in the hashtables of the classes used by the
   * Android user interface style. Does nothing when the style is another one.
   */
