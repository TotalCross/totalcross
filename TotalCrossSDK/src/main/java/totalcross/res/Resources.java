...
public class Resources
{
  ...
  private static void loadImages(String folder) throws ImageException, IOException
  {
    ...
    if (progressHandle == null){
      try {progressHandle = new Image(folder+"progressHandle.png");  } catch (ImageException e) {}
    }
    if (warning        == null){
      try {warning        = new Image(folder+"warning.png");         } catch (ImageException e) {}
    }
    if (button         == null){
      try {button         = new Image(folder+"button.png");          } catch (ImageException e) {}
    }
    if (!uiMat && edit == null){
      try {edit           = new Image(folder+"edit.png");            } catch (ImageException e) {}
    }
    if (combobox       == null){
      try {combobox       = new Image(folder+"combobox.png");        } catch (ImageException e) {}
    }
    if (listbox        == null){
      try {listbox        = new Image(folder+"listbox.png");         } catch (ImageException e) {}
    }
    if (!uiMat && multiedit == null){
      try {multiedit = new Image(folder+"multiedit.png");       } catch (ImageException e) {}
    }
    if (progressbarv   == null){
      try {progressbarv   = new Image(folder+"progressbarV.png");    } catch (ImageException e) {}
    }
    if (scrollposh     == null){
      try {scrollposh     = new Image(folder+"scrollposH.png");      } catch (ImageException e) {}
    }
    if (scrollposv     == null){
      try {scrollposv     = new Image(folder+"scrollposV.png");      } catch (ImageException e) {}
    }
    if (tab            == null){
      try {tab            = new Image(folder+"tab.png");             } catch (ImageException e) {}
    }
    if (tab2           == null){
      try {tab2           = new Image(folder+"tab2.png");            } catch (ImageException e) {}
    }
    if (grid           == null){
      try {grid           = new Image(folder+"grid.png");            } catch (ImageException e) {}
    }
    if (exit           == null){
      try {exit           = new Image(folder+"exit.png");            } catch (ImageException e) {}
    }
    if (back           == null){
      try {back           = new Image(folder+"back.png");            } catch (ImageException e) {}
    }
    if (menu           == null){
      try {menu           = new Image(folder+"menu.png");            } catch (ImageException e) {}
    }
    if (comboArrow     == null){
      try {comboArrow     = new Image(folder+"comboArrow.png");      } catch (ImageException e) {}
    }
    if (comboArrow2    == null){
      try {comboArrow2    = new Image(folder+"comboArrow2.png");     } catch (ImageException e) {}
    }
    if (!uiMat && switchBack     == null){
      try {switchBack     = new Image(folder+"switch_bck.png");      } catch (ImageException e) {}
    }
    if (!uiMat && switchBtnAnd   == null){
      try {switchBtnAnd = new Image(folder+"switch_btn_and.png");  } catch (ImageException e) {}
    }
    if (!uiMat && switchBtnIos   == null){
      try {switchBtnIos = new Image(folder+"switch_btn_ios.png");  } catch (ImageException e) {}
    }
    if (!uiMat && switchBrdAnd   == null){
      try {switchBrdAnd = new Image(folder+"switch_brd_and.png");  } catch (ImageException e) {}
    }
    if (!uiMat && switchBrdIos   == null){
      try {switchBrdIos = new Image(folder+"switch_brd_ios.png");  } catch (ImageException e) {}
    }
    if (uiMat && switchBtn == null){
      try {switchBtn  = new Image(folder+"switch_btn.png");  } catch (ImageException e) {}
    }
    if (uiMat && switchBrd == null){
      try {switchBrd  = new Image(folder+"switch_brd.png");  } catch (ImageException e) {}
    }
    if (checkBkg       == null){
      try {checkBkg       = new TristateImage(folder+"checkBkg.png");} catch (ImageException e) {}
    }
    if (checkSel       == null){
      try {checkSel       = new TristateImage(folder+"checkSel.png");} catch (ImageException e) {}
    }
    if (radioBkg       == null){
      try {radioBkg       = new TristateImage(folder+"radioBkg.png");} catch (ImageException e) {}
    }
    if (radioSel       == null){
      try {radioSel       = new TristateImage(folder+"radioSel.png");} catch (ImageException e) {}
    }
  ...
  public static void uiStyleChanged()
  {
    try
    {
      ...
      try {if (!new File("device/chime.mp3").exists()) {
