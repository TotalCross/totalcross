...
public class ExtendedCommand
{
   ...
   *      backup sourceDatabaseName to destinationFileName OR restore
   * targetDatabaseName from sourceFileName
   * @return BackupCommand object if the argument is a backup command;
   *     RestoreCommand object if
  ...
  public static class BackupCommand implements SQLExtension
  {
    ...
    /**
     * Constructs a BackupCommand instance that backup the database to a target
     * file.
    ...
    @Override public void execute(DB db) throws SQLException
    {
  ...
  public static class RestoreCommand implements SQLExtension
  {
    ...
    /**
     * Constructs a RestoreCommand instance that restores the database from a
     * given source file.
    ...
    /**
     * Parses SQLite database restore command and creates a RestoreCommand
     * object.
