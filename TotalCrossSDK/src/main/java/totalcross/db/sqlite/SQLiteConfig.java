...
public class SQLiteConfig
{
  ...
  /* Date storage class*/
  public final static String DEFAULT_DATE_STRING_FORMAT =
   ...
   * Default constructor.
   */
  public SQLiteConfig() { this(new Hashtable(10)); }
  ...
  public SQLiteConfig(Hashtable prop)
  {
    ...
    transactionMode = TransactionMode.getMode((String)pragmaTable.get(
      Pragma.TRANSACTION_MODE.pragmaName, TransactionMode.DEFFERED.name));

    dateClass = DateClass.getDateClass((String)pragmaTable.get(
      Pragma.DATE_CLASS.pragmaName, DateClass.INTEGER.name));
    datePrecision = DatePrecision.getPrecision((String)pragmaTable.get(
      Pragma.DATE_PRECISION.pragmaName, DatePrecision.MILLISECONDS.name));
    dateMultiplier = datePrecision == DatePrecision.MILLISECONDS ? 1L : 1000L;
    dateStringFormat = (String)pragmaTable.get(
      Pragma.DATE_STRING_FORMAT.pragmaName, DEFAULT_DATE_STRING_FORMAT);
  ...
  {
    return pragmaTable.exists(pragma.pragmaName)
      ? "true".equalsIgnoreCase((String)pragmaTable.get(pragma.pragmaName))
      : defaultValue;
  }
   ...
   */
  public int getOpenModeFlags() { return openModeFlag; }
  ...
  {
    pragmaTable.put(Pragma.OPEN_MODE.pragmaName,
                    Convert.toString(openModeFlag));
    pragmaTable.put(Pragma.TRANSACTION_MODE.pragmaName,
                    transactionMode.getValue());
  ...
  private static class Pragma extends Enum
  {
    ...
    public static final Pragma MAX_PAGE_COUNT =
      new Pragma("MAX_PAGE_COUNT", "max_page_count");
    public static final Pragma READ_UNCOMMITED =
      new Pragma("READ_UNCOMMITED", "read_uncommited", OnOff);
    public static final Pragma RECURSIVE_TRIGGERS =
      new Pragma("RECURSIVE_TRIGGERS", "recursive_triggers", OnOff);
    public static final Pragma REVERSE_UNORDERED_SELECTS =
      new Pragma("REVERSE_UNORDERED_SELECTS",
                 "reverse_unordered_selects",
                 OnOff);
    public static final Pragma SHORT_COLUMN_NAMES =
      new Pragma("SHORT_COLUMN_NAMES", "short_column_names", OnOff);
    ...
    public static final Pragma DATE_CLASS = new Pragma(
      "DATE_CLASS",
      "date_class",
    ...
    public static final Pragma DATE_STRING_FORMAT = new Pragma(
      "DATE_STRING_FORMAT",
      "date_string_format",
    ...
    public static final Pragma BUSY_TIMEOUT =
      new Pragma("BUSY_TIMEOUT", "busy_timeout", null);

    public final String pragmaName;
    public final String[] choices;
    public final String description;

    private Pragma(String id, String pragmaName) { this(id, pragmaName, null); }
   ...
   */
  public void setOpenMode(SQLiteOpenMode mode) { openModeFlag |= mode.value; }
  ...
  {
    private PragmaValue(String s) { super(s); }

    private PragmaValue(int v, String s) { super(v, s); }
  ...
  public static class Encoding extends PragmaValue
  {
    ...
    public static final Encoding UTF16_LITTLE_ENDIAN =
      new Encoding("'UTF-16le'");
    ...
    public static final Encoding UTF_16LE =
      new Encoding(UTF16_LITTLE_ENDIAN.name); // UTF-16le
    public static final Encoding UTF_16BE =
      new Encoding(UTF16_BIG_ENDIAN.name); // UTF-16be

    private Encoding(String typeName) { super(typeName); }

    public static Encoding getEncoding(String value)
    {
      return (Encoding)get(Encoding.class,
  ...
  public static class JournalMode extends PragmaValue
  {
    ...
    private JournalMode(String n) { super(n); }
  }
   ...
   */
  public void enableFullSync(boolean enable) { set(Pragma.FULL_SYNC, enable); }
  ...
  public static class LockingMode extends PragmaValue
  {
    ...
    private LockingMode(String s) { super(s); }
  }
   ...
   */
  public void setPageSize(int numBytes) { set(Pragma.PAGE_SIZE, numBytes); }
  ...
  public static class SynchronousMode extends PragmaValue
  {
    ...
    public SynchronousMode(String v) { super(v); }
  }
  ...
  public static class TempStore extends PragmaValue
  {
    ...
    public TempStore(String v) { super(v); }
  }
  ...
  /**
   * Changes the value of the sqlite3_temp_directory global variable, which many
   * operating-system interface backends use to determine where to store
   * temporary tables and indices.
   * @param directoryName Directory name for storing temporary tables and
   *     indices.
   * @see <a
   ...
   */
  public void setUserVersion(int version) { set(Pragma.USER_VERSION, version); }

  public static class TransactionMode extends PragmaValue
  {
    public static final TransactionMode DEFFERED =
      new TransactionMode("DEFFERED");
    public static final TransactionMode IMMEDIATE =
      new TransactionMode("IMMEDIATE");
    public static final TransactionMode EXCLUSIVE =
      new TransactionMode("EXCLUSIVE");
    ...
    public TransactionMode(String v) { super(v); }
  }
  ...
  public static class DatePrecision extends PragmaValue
  {
    ...
    public static final DatePrecision MILLISECONDS =
      new DatePrecision(1, "MILLISECONDS");

    private DatePrecision(int v, String s) { super(v, s); }
  ...
  {
    setPragma(Pragma.DATE_PRECISION,
              DatePrecision.getPrecision(datePrecision).getValue());
  }
  ...
  public static class DateClass extends PragmaValue
  {
    ...
    private DateClass(String n) { super(n); }
