...
public class SQLiteConfig {
	...
	public SQLiteConfig(Hashtable prop) {
		...
		transactionMode = TransactionMode
						  .getMode((String) pragmaTable.get(Pragma.TRANSACTION_MODE.pragmaName,
								   TransactionMode.DEFFERED.name));

		dateClass = DateClass.getDateClass((String) pragmaTable.get(Pragma.DATE_CLASS.pragmaName,
										   DateClass.INTEGER.name));
		datePrecision = DatePrecision
						.getPrecision((String) pragmaTable.get(Pragma.DATE_PRECISION.pragmaName,
									  DatePrecision.MILLISECONDS.name));
		dateMultiplier = datePrecision == DatePrecision.MILLISECONDS ? 1L : 1000L;
		dateStringFormat = (String) pragmaTable.get(Pragma.DATE_STRING_FORMAT.pragmaName,
	...
	private boolean getBoolean(Pragma pragma, boolean defaultValue) {
		return pragmaTable.exists(pragma.pragmaName) ? "true".equalsIgnoreCase((String) pragmaTable.get(
					pragma.pragmaName))
			   : defaultValue;
	}
	...
	private static class Pragma extends Enum {
		...
		public static final Pragma OPEN_MODE = new Pragma("OPEN_MODE", "open_mode",
				"Database open-mode flag", null);
		...
		public static final Pragma CASE_SENSITIVE_LIKE = new Pragma("CASE_SENSITIVE_LIKE",
				"case_sensitive_like", OnOff);
		public static final Pragma COUNT_CHANGES = new Pragma("COUNT_CHANGES", "count_changes", OnOff);
		public static final Pragma DEFAULT_CACHE_SIZE = new Pragma("DEFAULT_CACHE_SIZE",
				"default_cache_size");
		public static final Pragma EMPTY_RESULT_CALLBACKS = new Pragma("EMPTY_RESULT_CALLBACKS",
		...
		public static final Pragma FULL_COLUMN_NAMES = new Pragma("FULL_COLUMN_NAMES", "full_column_names",
				OnOff);
		public static final Pragma FULL_SYNC = new Pragma("FULL_SYNC", "fullsync", OnOff);
		public static final Pragma INCREMENTAL_VACUUM = new Pragma("INCREMENTAL_VACUUM",
				"incremental_vacuum");
		...
		public static final Pragma JOURNAL_SIZE_LIMIT = new Pragma("JOURNAL_SIZE_LIMIT",
				"journal_size_limit");
		public static final Pragma LEGACY_FILE_FORMAT = new Pragma("LEGACY_FILE_FORMAT",
				"legacy_file_format", OnOff);
		...
		public static final Pragma READ_UNCOMMITED = new Pragma("READ_UNCOMMITED", "read_uncommited",
				OnOff);
		public static final Pragma RECURSIVE_TRIGGERS = new Pragma("RECURSIVE_TRIGGERS",
		...
		public static final Pragma SHORT_COLUMN_NAMES = new Pragma("SHORT_COLUMN_NAMES",
				"short_column_names", OnOff);
		...
		public static final Pragma TEMP_STORE_DIRECTORY = new Pragma("TEMP_STORE_DIRECTORY",
		...
		public static final Pragma DATE_STRING_FORMAT = new Pragma("DATE_STRING_FORMAT",
				"date_string_format",
