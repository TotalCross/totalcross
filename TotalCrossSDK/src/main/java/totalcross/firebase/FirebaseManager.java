...
public class FirebaseManager
{
  ...
  public void registerFirebaseInstanceIdService(
    FirebaseInstanceIdService service)
  {
    synchronized (runningLock)
    {
      if (firstTime) {
  ...
  public FirebaseMessagingService getMessagingService()
  {
  ...
  protected void onMessageReceived(String messageId,
                                   String messageType,
                                   String[] keys,
                                   String[] values,
                                   String collapsedKey,
                                   int ttl)
  {
    ...
    if (messagingService != null) {
      messagingService.onMessageReceived(new RemoteMessage.Builder()
