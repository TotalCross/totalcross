...
public class RemoteMessage
{
  ...
  public RemoteMessage() { data = new HashMap<String, String>(); }

  public static final class Builder
  {
    RemoteMessage rm;

    public Builder() { rm = new RemoteMessage(); }
    ...
    public RemoteMessage build() { return rm; }
  ...
  public String getCollapsedKey() { return collapsedKey; }
