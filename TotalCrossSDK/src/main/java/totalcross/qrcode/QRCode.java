...
public class QRCode
{
  ...
  private static final int[][] lowQualityParameters = {
    { 152, 41, 25, 17, 10 },           { 272, 77, 47, 32, 20 },
    { 440, 127, 77, 53, 32 },          { 640, 187, 114, 78, 48 },
    { 864, 255, 154, 106, 65 },        { 1088, 322, 195, 134, 82 },
    { 1248, 370, 224, 154, 95 },       { 1552, 461, 279, 192, 118 },
    { 1856, 552, 335, 230, 141 },      { 2192, 652, 395, 271, 167 },
    { 2592, 772, 468, 321, 198 },      { 2960, 883, 535, 367, 226 },
    { 3424, 1022, 619, 425, 262 },     { 3688, 1101, 667, 458, 282 },
    { 4184, 1250, 758, 520, 320 },     { 4712, 1408, 854, 586, 361 },
    { 5176, 1548, 938, 644, 397 },     { 5768, 1725, 1046, 718, 442 },
    { 6360, 1903, 1153, 792, 488 },    { 6888, 2061, 1249, 858, 528 },
    { 7456, 2232, 1352, 929, 572 },    { 8048, 2409, 1460, 1003, 618 },
    { 8752, 2620, 1588, 1091, 672 },   { 9392, 2812, 1704, 1171, 721 },
    { 10208, 3057, 1853, 1273, 784 },  { 10960, 3283, 1990, 1367, 842 },
    { 11744, 3517, 2132, 1465, 902 },  { 12248, 3669, 2223, 1528, 940 },
    { 13048, 3909, 2369, 1628, 1002 }, { 13880, 4158, 2520, 1732, 1066 },
    { 14744, 4417, 2677, 1840, 1132 }, { 15640, 4686, 2840, 1952, 1201 },
    { 16568, 4965, 3009, 2068, 1273 }, { 17528, 5253, 3183, 2188, 1347 },
    { 18448, 5529, 3351, 2303, 1417 }, { 19472, 5836, 3537, 2431, 1496 },
    { 20528, 6153, 3729, 2563, 1577 }, { 21616, 6479, 3927, 2699, 1661 },
    { 22496, 6743, 4087, 2809, 1729 }, { 23648, 7089, 4296, 2953, 1817 },
  ...
  private static final int[][] quartilyQualityParameters = {
    { 104, 27, 16, 11, 7 },           { 176, 48, 29, 20, 12 },
    { 272, 77, 47, 32, 20 },          { 384, 111, 67, 46, 28 },
    { 496, 144, 87, 60, 37 },         { 608, 178, 108, 74, 45 },
    { 704, 207, 125, 86, 53 },        { 880, 259, 157, 108, 66 },
    { 1056, 312, 189, 130, 80 },      { 1232, 364, 221, 151, 93 },
    { 1440, 427, 259, 177, 109 },     { 1648, 489, 296, 203, 125 },
    { 1952, 580, 352, 241, 149 },     { 2088, 621, 376, 258, 159 },
    { 2360, 703, 426, 292, 180 },     { 2600, 775, 470, 322, 198 },
    { 2936, 876, 531, 364, 224 },     { 3176, 948, 574, 394, 243 },
    { 3560, 1063, 644, 442, 272 },    { 3880, 1159, 702, 482, 297 },
    { 4096, 1224, 742, 509, 314 },    { 4544, 1358, 823, 565, 348 },
    { 4912, 1468, 890, 611, 376 },    { 5312, 1588, 963, 661, 407 },
    { 5744, 1718, 1041, 715, 440 },   { 6032, 1804, 1094, 751, 462 },
    { 6464, 1933, 1172, 805, 496 },   { 6968, 2085, 1263, 868, 534 },
    { 7288, 2181, 1322, 908, 559 },   { 7880, 2358, 1429, 982, 604 },
    { 8264, 2473, 1499, 1030, 634 },  { 8920, 2670, 1618, 1112, 684 },
    { 9368, 2805, 1700, 1168, 719 },  { 9848, 2949, 1787, 1228, 756 },
    { 10288, 3081, 1867, 1283, 790 }, { 10832, 3244, 1966, 1351, 832 },
    { 11408, 3417, 2071, 1423, 876 }, { 12016, 3599, 2181, 1499, 923 },
    { 12656, 3791, 2298, 1579, 972 }, { 13328, 3993, 2420, 1663, 1024 },
  ...
  /**
   * This method returns the byte matrix that contains the values of each point
   * of the QRCode. A QR code is composed of many little squares, called
   * modules, which represent encoded data, with additional error correction
   * (allowing partially damaged QR codes to still be read). Blank modules are
   * 0x00 and black modules are 0xFF.
   *
   * @param version         The version of a QR code is a number between 1 and
   *     40
   *                        (inclusive), which indicates the size of the QR
   * code. The width and height of a QR code are always equal (it is square) and
   * are equal to 4 * version + 17.
   * @param errorCorrection The level of error correction is a number between 0
   *                        and 3 (inclusive), or can be one of the symbolic
   * names ECC_LOW, ECC_MEDIUM, ECC_QUARTILE and ECC_HIGH. Higher levels of
   * error correction sacrifice data capacity, but allow a larger portion of the
   * QR code to be damaged or unreadable.
  ...
  private final byte[][] nativeGetBytes(String text,
                                        int errorCorrection,
                                        int version)
  {
   ...
   * modules, which represent encoded data, with additional error correction
   * (allowing partially damaged QR codes to still be read). Blank modules are
   * 0x00 and black modules are 0xFF. <p> This method do some calculus to find
   * the best version considering ecc and the given text
   *
   * @param errorCorrection The level of error correction is a number between 0
   *                        and 3 (inclusive), or can be one of the symbolic
   * names ECC_LOW, ECC_MEDIUM, ECC_QUARTILE and ECC_HIGH. Higher levels of
  ...
  {
    return getBytes(
      text, errorCorrection, getBestVersion(text, errorCorrection));
  }
   ...
   * (allowing partially damaged QR codes to still be read). Blank modules are
   * 0x00 and black modules are 0xFF. <p> This method do some calculus to find
   * the best version considering ecc and the given text. <p> By default this
   * method uses {@link #ECC_QUARTILE} as default ecc.
   *
   * @param text The text to encode.
   */

  public byte[][] getBytes(String text) { return getBytes(text, ECC_QUARTILE); }

  /**
   * This method returns an totalcross.ui.Image instance that contains the
   * values of each point of the QRCode. A QR code is composed of many little
   * squares, called modules, which represent encoded data, with additional
   * error correction (allowing partially damaged QR codes to still be read).
   * Blank modules are 0x00 and black modules are 0xFF.
   *
   * @param text The text to encode.
   ...
   * squares, called modules, which represent encoded data, with additional
   * error correction (allowing partially damaged QR codes to still be read).
   * Blank modules are 0x00 and black modules are 0xFF. <p> This method do some
   * calculus to find the best version considering ecc and the given text.
   *
   * @param text The text to encode.
   ...
   * error correction (allowing partially damaged QR codes to still be read).
   * Blank modules are 0x00 and black modules are 0xFF. <p> This method do some
   * calculus to find the best version considering ecc and the given text. <p>
