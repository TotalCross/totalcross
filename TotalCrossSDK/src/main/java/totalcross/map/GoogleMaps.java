...
public class GoogleMaps {
	...
	public static class Circle extends MapItem {
		...
		void serialize(StringBuffer sb) {
			sb.append("*C*,").append(toCoordI(lat)).append(",").append(toCoordI(lon)).append(",").append(
				rad).append(",")
	...
	public static class Place extends MapItem {
		...
		void serialize(StringBuffer sb) {
			...
			.append(detail.replace('"', '\'')).append("\",").append(toCoordI(lat)).append(",").append(toCoordI(
						lon))
	...
	@Deprecated
	@ReplacedByNativeOnDeploy
	public static boolean showRoute(String addressI, String addressF, String traversedPoints,
