...
public class Ruler extends Control
{
  ...
  public Ruler() { this(HORIZONTAL, true); }
  ...
  /**
   * For horizontal rulers, returns FILL. Otherwise, returns 2 if is 3d or 1 if
   * its not 3d.
   */
  ...
  /**
   * For vertical rulers, returns FILL. Otherwise, returns 2 if is 3d or 1 if
   * its not 3d.
   */
