...
public class TopMenu extends Window implements PathAnimation.AnimationFinished {
  ...
  public static class Item extends Container {
    ...
    public void initUI() {
      ...
      add(tit, (icon == null ? tit instanceof Label ? LEFT + itemH : AFTER + 0 : AFTER + 0), TOP,
          PARENTSIZE + perc - (tit instanceof Label ? 10 : 0), FILL, c);
    }
  ...
  public void initUI() {
    ...
    add(sc, LEFT + scInsets.left, TOP + scInsets.top, FILL - scInsets.right,
        isLR ? PARENTSIZE + 100 : Math.min(prefH, Settings.screenHeight - fmH * 2) - scInsets.bottom);
  ...
  public void unpop(AnimationListener alist) {
    ...
    if (animDir == CENTER) {
      ...
      PathAnimation.create(this, -animDir, this, totalTime).with(FadeAnimation.create(this, false, null, totalTime))
          .start();
    }
  }
  ...
  public void onPopup() {
    ...
    if (animDir == CENTER) {
      ...
      PathAnimation.create(this, animDir, null, totalTime).with(FadeAnimation.create(this, true, null, totalTime))
          .start();
    }
  }
