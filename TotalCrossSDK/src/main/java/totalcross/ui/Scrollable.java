...
/**
 * Scrollable is an extension that allows relative motion of the Containers
 * contents using flick animations. Used for scrollable containers that include
 * Flick capability. This interface exposes the methods used to support flick
 * animations.
 */
public interface Scrollable {
   ...
   * @param atPenDown Flag indicating if the animation ended due to a pendown
   *     event.
   */
   ...
   * @param direction The direction we want to flick given by one of the
   *     following constants:
   * @param target The target of the series of PEN events that triggered this
   *     flick attempt.
   *
