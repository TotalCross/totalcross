...
public class BorderContainer extends Container
{
  ...
  public BorderContainer(String title) { this.title = title; }

  @Override public void initUI()
  {
    setInsets(fmH / 2, fmH / 2, fmH + fmH / 4, fmH);
    add(l = new Label(title), LEFT, 0, PREFERRED, PREFERRED + 25);
    l.ignoreInsets = true;
    l.vAlign = TOP;
  ...
  @Override public int getPreferredHeight() { return WILL_RESIZE; }
