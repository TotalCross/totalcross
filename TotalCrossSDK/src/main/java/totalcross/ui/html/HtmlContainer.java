...
public class HtmlContainer extends Container
{
  ...
  {
    this.doc = doc;
    this.backColor = doc.getBackColor(); // flsobral@tc126_36: added support to
                                         // bgcolor attribute in body tag.
    removeAll();
  ...
  {
    for (Control control = c.getParent(); control != null;
   ...
   */
  public void resetWith(String url)
  { // guich@tc114_28
    if (doc != null) {
      doc.resetWith(url);
    }
