...
public class Style
{
  ...
  private static final int tagStyles[] = {
    /* 0  UNKNOWN   */ 0,
    /* 1  A         */ type(TYPE_INLINE) | CHG_STYLE | UNDERLINE |
      LINK, // miketogg@570_59: define fontcolor for A tags, remove
            // underline
    /* 2  ABBR      */ 0,
    /* 3  ACRONYM   */ 0,
    /* 4  ADDRESS   */ type(TYPE_BLOCK) | CHG_STYLE | ITALIC,
    /* 5  APPLET    */ 0,
    /* 6  AREA      */ 0,
    /* 7  B         */ type(TYPE_INLINE) | CHG_STYLE | BOLD,
    /* 8  BASE      */ 0,
    /* 9  BASEFONT  */ 0,
    /* 10 BGSOUND   */ 0,
    /* 11 BIG       */ type(TYPE_INLINE) | CHG_STYLE | fontSize(+2) | BOLD,
    /* 12 BLOCKQUOTE*/ type(TYPE_BLOCK) | CHG_STYLE | DISJOINT | P_AFTER |
      top(5) | indent(+2),
    /* 13 BODY      */ 0,
    /* 14 BR        */ type(TYPE_INLINE) | CHG_STYLE | DISJOINT | indent(-1),
    /* 15 BUTTON    */ 0,
    /* 16 CAPTION   */ 0,
    /* 17 CENTER    */ type(TYPE_BLOCK) | CHG_STYLE | DISJOINT |
      align(ALIGN_CENTER),
    /* 18 CITE      */ 0,
    /* 19 CODE      */ type(TYPE_INLINE) | CHG_STYLE | fontSize(-1),
    /* 20 COL       */ 0,
    /* 21 COLGROUP  */ 0,
    /* 22 COMMENT   */ 0,
    /* 23 DD        */ type(TYPE_BLOCK) | CHG_STYLE | DISJOINT | indent(2),
    /* 24 DEL       */ type(TYPE_INLINE) | CHG_STYLE | STRIKETHROUGH,
    /* 25 DFN       */ 0,
    /* 26 DIR       */ type(TYPE_DIV) | CHG_STYLE,
    /* 27 DIV       */ 0,
    /* 28 DL        */ type(TYPE_DIV) | CHG_STYLE | DISJOINT,
    /* 29 DT        */ type(TYPE_BLOCK) | CHG_STYLE | DISJOINT | BOLD |
      indent(-2),
    /* 30 EM        */ type(TYPE_INLINE) | CHG_STYLE | BOLD | ITALIC,
    /* 31 EMBED     */ 0,
    /* 32 FIELDSET  */ 0,
    /* 33 FONT      */ type(TYPE_INLINE) | CHG_STYLE,
    /* 34 FORM      */ type(TYPE_WIERD),
    /* 35 FRAME     */ 0,
    /* 36 FRAMESET  */ 0,
    /* 37 H1        */ type(TYPE_INLINE) | CHG_STYLE | DISJOINT | P_AFTER |
      align(ALIGN_NONE) | fontSize(+3) | BOLD,
    /* 38 H2        */ type(TYPE_INLINE) | CHG_STYLE | DISJOINT | P_AFTER |
      align(ALIGN_NONE) | fontSize(+2) | BOLD,
    /* 39 H3        */ type(TYPE_INLINE) | CHG_STYLE | DISJOINT | P_AFTER |
      align(ALIGN_NONE) | fontSize(+1) | BOLD,
    /* 40 H4        */ type(TYPE_INLINE) | CHG_STYLE | DISJOINT | P_AFTER |
      align(ALIGN_NONE) | fontSize(+0) | BOLD,
    /* 41 H5        */ type(TYPE_INLINE) | CHG_STYLE | DISJOINT | P_AFTER |
      align(ALIGN_NONE) | fontSize(-1) | BOLD,
    /* 42 H6        */ type(TYPE_INLINE) | CHG_STYLE | DISJOINT | P_AFTER |
      align(ALIGN_NONE) | fontSize(-2) | BOLD,
    /* 43 HEAD      */ 0,
    /* 44 HR        */ type(TYPE_WIERD),
    /* 45 HTML      */ 0,
    /* 46 I         */ type(TYPE_INLINE) | CHG_STYLE | ITALIC,
    /* 47 IFRAME    */ 0,
    /* 48 IMG       */ type(TYPE_INLINE),
    /* 49 INPUT     */ type(TYPE_INLINE),
    /* 50 INS       */ 0,
    /* 51 ISINDEX   */ 0,
    /* 52 KBD       */ 0,
    /* 53 LABEL     */ 0,
    /* 54 LEGEND    */ 0,
    /* 55 LI        */ type(TYPE_BLOCK) | CHG_STYLE | DISJOINT | HEADED |
      indent(+3),
    /* 56 LINK      */ 0,
    /* 57 LISTING   */
    /* 58 MAP       */ 0,
    ...
    /* 64 NOSCRIPT  */ 0,
    /* 65 OBJECT    */ 0,
    /* 66 OL        */ type(TYPE_DIV) | CHG_STYLE | DISJOINT | indent(+2),
    /* 67 OPTGROUP  */ 0,
    /* 68 OPTION    */ 0,
    /* 69 P         */ type(TYPE_BLOCK) | CHG_STYLE | DISJOINT | top(3),
    /* 70 PARAM     */ 0,
    /* 71 PLAINTEXT */ 0,
    ...
    /* 75 SAMP      */ type(TYPE_BLOCK) | CHG_STYLE | fontSize(-2),
    /* 76 SCRIPT    */ 0,
    /* 77 SELECT    */ 0,
    /* 78 SMALL     */ type(TYPE_INLINE) | CHG_STYLE | fontSize(-1),
    /* 79 SPAN      */ 0,
    /* 80 STRIKE    */ type(TYPE_INLINE) | CHG_STYLE | STRIKETHROUGH,
    /* 81 STRONG    */ type(TYPE_INLINE) | CHG_STYLE | BOLD,
    /* 82 STYLE     */ 0,
    /* 83 SUB       */ type(TYPE_INLINE) | CHG_STYLE | SUBSCRIPT | fontSize(-2),
    /* 84 SUP       */ type(TYPE_INLINE) | CHG_STYLE | SUPERSCRIPT |
      fontSize(-2),
    /* 85 TABLE     */ type(TYPE_SPECIAL) | CHG_STYLE,
    /* 86 TBODY     */ 0,
    /* 87 TD        */ type(TYPE_SPECIAL) | CHG_STYLE,
    /* 88 TEXTAREA  */ 0,
    /* 89 TFOOT     */ 0,
    /* 90 TH        */ type(TYPE_SPECIAL) | CHG_STYLE | BOLD,
    /* 91 THEAD     */ 0,
    /* 92 TITLE     */ 0,
    /* 93 TR        */ type(TYPE_SPECIAL) | CHG_STYLE,
    /* 94 TT        */ 0,
    /* 95 U         */ type(TYPE_INLINE) | CHG_STYLE | UNDERLINE,
    /* 96 UL        */ type(TYPE_DIV) | CHG_STYLE | DISJOINT | indent(+2),
    /* 97 VAR       */ 0,
    /* 98 WBR       */ 0,
    /* 99 XMP       */ type(TYPE_BLOCK) | CHG_STYLE | DISJOINT | top(3) |
      MONOSPACE
  };
  ...
  {
    return (val << TopMarginPos) &
      ((-1 >>> (32 - TopMarginLen)) << TopMarginPos);
  }
  ...
  private Style(int tagHashId, AttributeList atts, Style parent)
  {
    ...
    if (attval != null) {
      if (attval.equalsIgnoreCase("center")) {
        ...
        alignment =
          ALIGN_RIGHT; // guich@511_2: defaults to left instead of right.
      } else {
   ...
   * -- though HR could be seen as a true inline. HR is empty, cleaned up from
   * the list here. - FORM is also special. FORMS ends nothing. The dangling of
  ...
  static Style tagStartFound(Style current, int tagHashId, AttributeList atts)
  {
    ...
    if ((current.tagHashId == TagDereferencer.HR) ||
        (current.tagHashId == TagDereferencer.IMG) ||
        ...
        case TYPE_SPECIAL: // end themselves and INLINEs
          switch (tagHashId) {
            case TagDereferencer.TR: // A TR ends everything up to <TABLE>
              while ((current.tagHashId != 0) &&
                     (current.tagHashId != TagDereferencer.TABLE)) {
            ...
            case TagDereferencer.TD: // <TD> ends everything up to <TR>
              while ((current.tagHashId != 0) &&
                     (current.tagHashId != TagDereferencer.TR)) {
                current = current.parent;
              }
              break;
    ...
    if (isStyleChanged(tagHashId)) {
      switch (tagHashId) {
        ...
        default:
          ...
          } else if (tagHashId == TagDereferencer.BR &&
                     originalAlign != ALIGN_LEFT) {
            current.alignment = ALIGN_NONE;
          }
          break;
      }
  ...
  static int getStyle(int tagHashId) { return tagStyles[tagHashId]; }

  private int getFontBits() { return style & FontMask; }
  ...
  int getTopMargin()
  {
    return (style << (32 - (TopMarginPos + TopMarginLen))) >>>
      (32 - TopMarginLen);
  }
  ...
  private static abstract class HeaderMaker extends Style
  {
    ...
    private static class Unordered extends HeaderMaker
    {
      private class Bullet extends Header
      {
        ...
        @Override public int getPreferredWidth() { return fmH; }

        @Override public int getPreferredHeight() { return fmH; }
      }
      ...
      @Override Header getHeader() { return new Bullet(); }
    }
    ...
    private static class Ordered extends HeaderMaker
    {
      ...
      private class Number extends Header
      {
        ...
        @Override public void onPaint(Graphics g)
        {
          g.drawText(text,
                     0,
                     (height - fmH) / 2); // guich@tc114_21: vertical align
        }
      ...
      @Override Header getHeader() { return new Number(++order); }
    }
  }
  ...
  /**
   * Returns the Control alignment constant to be used by elements using this
   * style.
   *
   * @param isRelative
   *           true if the alignment constant returned should be relative to
   * another control instead of relative to the screen.
