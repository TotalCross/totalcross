...
public final class Font {
	...
	private static
	int returnUserSize() { // guich@tc130: allow user to set the font size throught the Launcher
	...
	private static Font getFont(String name, boolean boldStyle, int size,
								int skiaIndex) { // guich@580_10
	...
	public Font asBold() {
		return getFont(name, true, size,
					   skiaIndex); // guich@450_36: cache the bolded font - guich@580_10: cached now in the Hashtable.
	}
