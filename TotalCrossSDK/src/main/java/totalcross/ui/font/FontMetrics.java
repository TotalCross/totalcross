...
public final class FontMetrics
{
  ...
  /**
   * READ-ONLY member: indicates the average height of this font from the
   * baseline to up.
   */
  public int ascent;
  ...
  @ReplacedByNativeOnDeploy void fontMetricsCreate()
  {
   ...
   */
  @ReplacedByNativeOnDeploy public int charWidth(char c)
  {
    return Launcher.instance.getCharWidth(this.font, c);
  }

  /** Returns the width in pixels of the given text string. */
  @ReplacedByNativeOnDeploy public int stringWidth(String s)
  {
    int sum = 0;
   ...
   */
  @ReplacedByNativeOnDeploy public int sbWidth(StringBuffer s)
  {
  ...
  /**
   * Returns the width in pixels of the char located at the given index in the
   * StringBuffer.
   * @since TotalCross 1.0
   */
  @ReplacedByNativeOnDeploy public int charWidth(StringBuffer s, int i)
  {
