...
public class CircularProgressBar extends Control
{
  ...
  public CircularProgressBar(int thickness) { this(thickness, 100, 1, null); }
  ...
  @Override public void onPaint(Graphics g)
  {
    ...
    if (value != maxValue) {
      ...
      g.fillPie(width / 2,
                height / 2,
                outsideCircleRadius - 1,
                90 - (double)value / maxValue * 360,
                90);
    }
  ...
  @Override public <H extends EventHandler> void onEvent(Event<H> event)
  {
