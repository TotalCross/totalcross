...
/**
 * This class holds the tree structure that the Tree class used to render the
 * tree widget. Note: you should use this class to mofidy the tree after the
 * root node is setted to this model; otherwise, the tree will reflect the
 * change visually; a faster option for bulk inserts is to use the node's
 * add/insert methods and then do a reload.
 * @see #reload
 * @see Node#add
 * @see Node#insert
...
public class TreeModel
{
  ...
  /**
   * Constructor to create a tree model with the specified root node and with
   * the specified allowsChildren flag.
   */
   ...
   */
  public TreeModel(boolean allowsChildren) { this(null, allowsChildren); }

  /**
   * Method to set the tree (For internal use only) This method register the
   * tree to this model, so when the user add, delete, or modify a node, the
   * tree view will be notify and updated.
   *
   * @param tree
  ...
  /**
   * Method to set the root node of this tree model and notify the tree to
   * reload the tree.
   *
   * @param root
  ...
  /**
   * Method to insert a node to the parent node at the specified position. This
   * method will notify the associated tree to display the node, if the parent
   * node is expanded. If the index out of range, the new node will be inserted
   * at the end of the parent node children vector (consider, in this case,
   * using the addNode method, which is faster).
   *
   * @param parent
  ...
  /**
   * Method to add a node to the parent node at the specified position. This
   * method will notify the associated tree to display the node, if the parent
   * node is expanded. This is fastest than insertNode.
   *
   * @param parent
   *           the parent node of the node to insert.
   * @param newNode
  ...
  /**
   * Method to remove a node from the tree. This method will notify the tree to
   * collapse the tree.
   *
   * @param parent
