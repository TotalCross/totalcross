...
/**
 * This class holds the colors used in some user interface dialogs, such as
 * MessageBox, InputBox, CalculatorBox, KeyboardBox, CalendarBox, ToolTip,
 * KeyPad and others. You can customize it as needed. <p> To correctly change
 * the colors to your own, you must do it in the constructor of your
 * application.
 *
...
{ // guich@564_6
  ...
  /**
   * Make the edit area have the same color of the background setting this to
   * true
   */
  ...
  public static int[] highlightColors =
    (Settings.screenWidth > 200) // guich@573_23  - guich@580_
      ? new int[] { Color.GREEN, Color.GREEN, Color.CYAN,
                    Color.CYAN,  Color.WHITE, Color.WHITE }
      : new int[] { Color.GREEN, Color.CYAN, Color.WHITE };
  /**
   * The default step used on Vista buttons to make the fade. Decrease the step
   * to make the button lighter.
   */
  ...
  /**
   * Default value to be used in all textShadowColor(s) set in the constructor
   * of a control. Defaults to -1. Note that it does not affect the shadow when
   * you call setBackColor or setForeColor.
  ...
  /**
   * The color to fill the background of the PositionBar. Defaults to -1 (don't
   * fill).
   */
  public static int positionbarBackgroundColor = -1;

  /** Spinner foreground color. */
  @Deprecated public static int spinnerFore = controlsFore;

  /** Spinner background color. */
  @Deprecated public static int spinnerBack = -1;

  /**
   * The shaded factor (0 - 100) used to fill a background when the
   * backgroundStyle is BACKGROUND_SHADED
   */
  ...
  /**
   * The color that will be used to paint the disabled area when a screen shift
   * occurs.
  ...
  /**
   * Background color of the clipboard menu that is opened at Edit and
   * MultiEdit.
   */
  public static int clipboardBack = Color.YELLOW;
  /**
   * Foreground color of the clipboard menu that is opened at Edit and
   * MultiEdit.
   */
