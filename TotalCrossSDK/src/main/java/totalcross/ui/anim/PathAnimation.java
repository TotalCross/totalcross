...
public class PathAnimation extends ControlAnimation {
	 ...
	 */
	public static PathAnimation create(Control c, int toX, int toY, AnimationFinished animFinish,
									   int totalTime) {
	 ...
	 * @param totalTime The total time in millis that the animation will take, or -1 to use the default value (800ms).
	 */
	public static PathAnimation create(Control c, int fromX, int fromY, int toX, int toY,
	 ...
	 * @param totalTime The total time in millis that the animation will take, or -1 to use the default value (800ms).
	 */
	public static PathAnimation create(Control c, int direction, AnimationFinished animFinish,
									   int totalTime) {
