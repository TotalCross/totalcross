...
public class FadeAnimation extends ControlAnimation
{
  ...
  /**
   * Change this will affect all fade animations until you reset it to
   * DEFAULT_MAX_FADE.
   * @see totalcross.ui.Toast
   */
  public static int maxFade = 255;

  private FadeAnimation(Control c,
                        boolean fadeIn,
   ...
   * @param fadeIn True will make the control appear, false will make it
   *     disappear.
