...
public class Spacer extends Control
{
  ...
  /**
   * Constructs a new Spacer using the given String, whose width will be the
   * horizontal spacement. The vertical spacement will be the font's height.
   */
  ...
  @Override public int getPreferredHeight() { return s == null ? prefH : fmH; }
}
