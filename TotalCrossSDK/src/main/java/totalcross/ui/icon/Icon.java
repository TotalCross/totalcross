...
public class Icon extends Control
{
  ...
  public void setGlyph(IconType glyph) { this.glyph = glyph; }
  ...
  @Override public int getPreferredHeight() { return this.font.fm.height; }
  ...
  {
    premultipliedForeColor = Color.interpolateA(
      foreColor,
      backColor,
