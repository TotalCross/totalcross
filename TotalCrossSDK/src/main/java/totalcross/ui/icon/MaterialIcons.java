...
public enum MaterialIcons implements IconType {
  ...
  private MaterialIcons(int codepoint) { this.codepoint = codepoint; }

  @Override public String toString() { return String.valueOf((char)codepoint); }
  ...
  @Override public int codepoint() { return codepoint; }
}
