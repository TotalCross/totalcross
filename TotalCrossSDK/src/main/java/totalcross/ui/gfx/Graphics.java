...
public final class Graphics {
  ...
  private int lastXC, lastYC, lastRX, lastRY, lastSize, lastClipFactor, gxPoints[], gyPoints[], axPoints[][],
      ayPoints[][], anPoints[], aBase[], cyPoints[], cxPoints[], lastcRX, lastcRY, lastcSize;
  ...
  public Graphics(GfxSurface surface) {
    if (surface instanceof Image) // guich@200b4_37
    {
      ...
      if (mainWindowPixels == null
          || ((int[]) mainWindowPixels).length < Settings.screenWidth * Settings.screenHeight) {
  ...
  public void drawArc(int xc, int yc, int r, double startAngle, double endAngle) {
    arcPiePointDrawAndFill(xc, yc, r, r, startAngle, endAngle, foreColor | alpha, foreColor | alpha, false, false,
        false);
  }
  ...
  public void drawPie(int xc, int yc, int r, double startAngle, double endAngle) {
    arcPiePointDrawAndFill(xc, yc, r, r, startAngle, endAngle, foreColor | alpha, foreColor | alpha, false, true,
        false);
  }
  ...
  public void drawText(StringBuffer sb, int chrStart, int chrCount, int x, int y, int justifyWidth, boolean shadow,
      int shadowColor) {
    try {
  ...
  static final int[][][] windowBorderAlpha = {
      { // thickness 1
          { 190, 190, 152, 89, OUT, OUT, OUT }, { 255, 255, 255, 255, 220, OUT, OUT },
          { IN, IN, -32, -110, 255, 174, OUT }, { IN, IN, IN, -11, 255, 245, 62 }, { IN, IN, IN, IN, -110, 255, 81 },
          { IN, IN, IN, IN, -26, 255, 152 }, { IN, IN, IN, IN, IN, 255, 190 }, },
      { // thickness 2
