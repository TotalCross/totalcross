...
public class Rect
{
  ...
  /**
   * Translates this rect. The new positions will be this.x+deltaX,
   * this.y+deltaY.
   */
  ...
  /** Returns x+width-1 */
  public int x2() { return x + width - 1; }

  /** Returns y+height-1 */
  public int y2() { return y + height - 1; }
  ...
  /**
   * Modify this Rect by doing the intersection with the given rect. Returns
   * <code>this</code> rect.
   */
  ...
  /**
   * Modify this Rect by doing an union with the given rect. Returns
   * <code>this</code> rect.
   */
