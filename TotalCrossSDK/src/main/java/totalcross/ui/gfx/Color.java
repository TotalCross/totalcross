...
public final class Color {
	...
	public static int getCursorColor(int rgb) {
		...
		return getBrightness(rgb) >= 127
			   ...
			   : getRGBEnsureRange(((rgb >> 16) & 0xFF) + step, ((rgb >> 8) & 0xFF) + step,
								   (rgb & 0xFF) + step); // guich@220_45 - guich@340_51: in color devices, use normal step
	}
	...
	public static int brighter(int rgb, int step) {
		return getRGBEnsureRange(((rgb >> 16) & 0xFF) + step, ((rgb >> 8) & 0xFF) + step,
								 (rgb & 0xFF) + step);
	}
