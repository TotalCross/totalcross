 ...
 * </pre>
 * Note: there is no need (and you can't) add a RadioGroupController to a
 * container, since a RadioGroupController is a class that doesn't extend
 * Control. <p>
 */
...
public class RadioGroupController
{
  ...
  /**
   * Returns the currently selected index (in the order that the Radios were
   * added to the container), or -1 if none.
   ...
   */
  public Radio getRadio(int idx) { return (Radio)members.items[idx]; }
