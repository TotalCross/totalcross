...
public class DragEvent extends PenEvent
{
  ...
  /**
   * Constructs a new DragEvent from a PenEvent, setting a new timestamp and
   * setting consumed to false.
   */
  public DragEvent(PenEvent evt) { update(evt); }

  /**
   * Updates this DragEvent from a PenEvent, setting a new timestamp and setting
   * consumed to false.
   */
  ...
  {
    return EVENT_NAME[type - 200] + ", direction: " + DIRECTIONS[direction] +
      ", pos: " + x + "," + y + ", delta: " + xDelta + "," + yDelta +
      ", total: " + xTotal + "," + yTotal + ". " + super.toString();
  }
