...
/**
 * A class that represents an event Listener. Holds the type of the event and
 * the listener itself.
 * @since Totalcross 1.22
 */
public class Listener implements EventHandler
{ // guich@tc122_11: have to distinguish the type of
  // event of a listener, NOT only based on the
  // instanceof operator.
  ...
  {
    return o instanceof Listener && ((Listener)o).type == this.type &&
      ((Listener)o).listener == this.listener;
  }
}
