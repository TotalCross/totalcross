...
public class PenEvent extends Event<PenListener> implements Cloneable
{
  ...
  public static final int PEN_DRAG_START =
    EventType.PEN_DRAG_START; // kmeehl@tc100
  ...
  protected static final String[] EVENT_NAME = {
    "PEN_DOWN",   "PEN_UP",   "PEN_DRAG",  "PEN_DRAG_START", "PEN_DRAG_END",
  ...
  {
    return PEN_DOWN <= type && type <= PEN_DRAG_END ? EVENT_NAME[type - 200]
                                                    : "Not a PEN_EVENT";
  }

  @Override public String toString()
  {
    return EVENT_NAME[type - 200] + " pos: " + x + "," + y + " " +
      super.toString();
  }

  @Override public PenEvent clone()
  {
  ...
  @Override public void dispatch(PenListener listener)
  {
    switch (this.type) {
      case PEN_DOWN:
