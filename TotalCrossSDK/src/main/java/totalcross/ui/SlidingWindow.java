...
public class SlidingWindow extends Window implements PenListener, KeyListener
{
  ...
  public SlidingWindow(Presenter<Container> provider) { this(false, provider); }
  ...
  @Override public void onPopup()
  {
    ...
    screenResized(); // fix problem when the container is on portrait, then
                     // landscape, then closed,
  ...
  public int getSlackSpace() { return slackSpace; }

  /** Sets the slack space left by this window on pop-up */
  public void setSlackSpace(int slackSpace) { this.slackSpace = slackSpace; }
