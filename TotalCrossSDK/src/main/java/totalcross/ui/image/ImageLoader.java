...
public class ImageLoader
{
  ...
  public Image getImage(int desiredWidth, int desiredHeight)
    throws IOException, ImageException
  {
    ...
    try {
      ...
      // probably not a jpeg, we'll just ignore the exception and try again as a
      // regular image.
      i = new Image(path);
    }
  ...
  public Image getImage(RequestOptions options,
                        int desiredWidth,
                        int desiredHeight) throws IOException, ImageException
  {
    final String key = desiredWidth + "x" + desiredHeight;
    Image i = mipmap.get(key);
    if (i != null) {
  ...
  public class RequestManager
  {
    ...
    RequestManager(Container c) { this.c = c; }
    ...
    public class RequestBuilder implements Cloneable
    {
      ...
      public RequestBuilder into(ImageControl ic)
        throws IOException, ImageException
      {
            ...
            try {
              switch (scaleType) {
                case ScaleType.CENTER: {
                  ...
                  //                target.ic.lastX= (int) ((width -
                  //                i.getWidth())
                  //                * 0.4); target.ic.lastY = (int) ((height -
                  //                i.getHeight()) * 0.3);
                  ic.setImage(i, false);
                  break;
                }
                ...
                case ScaleType.CENTER_CROP: {
                  ...
                  if (i.getWidth() != width || i.getHeight() != height) {
                    ...
                    i = i.hwScaledFixedAspectRatio(p1 < p2 ? height : width,
                                                   p1 < p2);
                  }
                ...
                case ScaleType.CENTER_INSIDE: {
                  ...
                  if (i.getWidth() > width || i.getHeight() > height) {
                    double p1 = (double)width / i.getWidth();
                    double p2 = (double)height / i.getHeight();
                    i = i.hwScaledFixedAspectRatio(p1 > p2 ? width : height,
                                                   p1 > p2);
                  }
                  //                target.ic.centerImage = true;
                  ic.lastX = (width - i.getWidth()) / 2;
                ...
                case ScaleType.FOCUS_CROP: {
                  ...
                  if (i.getWidth() != width || i.getHeight() != height) {
                    double p1 = (double)width / i.getWidth();
                    double p2 = (double)height / i.getHeight();
                    i = i.smoothScaledFixedAspectRatio(p1 < p2 ? height : width,
                                                       p1 < p2);
                  }
                  //                target.ic.centerImage = true;
              ...
              //              options.keepAspectRatio = !ic.strechImage;
              //              target.ic.setImage(ImageLoader.this.getImage(options,
              //              width, height));
        ...
        if (ic.getWidth() > 0 || ic.getHeight() > 0) {
          //        	handler.onSizeChange(new SizeChangeEvent(ic,
