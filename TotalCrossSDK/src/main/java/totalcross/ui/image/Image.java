...
public class Image extends GfxSurface {
  ...
  static long jpegNativeDecodeCountForTest;
  static long jpegNativeDecodeNsForTest;
  static long jpegNativeDecodeFullCountForTest;
  static long jpegNativeDecodeFullNsForTest;
  static long jpegNativeDecodeHalfCountForTest;
  static long jpegNativeDecodeHalfNsForTest;
  static long jpegNativeDecodeQuarterCountForTest;
  static long jpegNativeDecodeQuarterNsForTest;
  static long jpegNativeDecodeEighthCountForTest;
  static long jpegNativeDecodeEighthNsForTest;
  static long jpegNativeDecodeOtherCountForTest;
  static long jpegNativeDecodeOtherNsForTest;
  static long jpegNativeDecodeRequestedFullCountForTest;
  static long jpegNativeDecodeRequestedTargetCountForTest;
  static long jpegNativeDecodeRequestedExplicitRatioCountForTest;
  static long jpegNativeDecodeRequestedBestFitCountForTest;
  static long jpegNativeDecodeFailureCountForTest;
  ...
  static void clearImageOperationAccountingCountersForTest() {
    ...
    jpegNativeDecodeCountForTest = 0;
    jpegNativeDecodeNsForTest = 0;
    jpegNativeDecodeFullCountForTest = 0;
    jpegNativeDecodeFullNsForTest = 0;
    jpegNativeDecodeHalfCountForTest = 0;
    jpegNativeDecodeHalfNsForTest = 0;
    jpegNativeDecodeQuarterCountForTest = 0;
    jpegNativeDecodeQuarterNsForTest = 0;
    jpegNativeDecodeEighthCountForTest = 0;
    jpegNativeDecodeEighthNsForTest = 0;
    jpegNativeDecodeOtherCountForTest = 0;
    jpegNativeDecodeOtherNsForTest = 0;
    jpegNativeDecodeRequestedFullCountForTest = 0;
    jpegNativeDecodeRequestedTargetCountForTest = 0;
    jpegNativeDecodeRequestedExplicitRatioCountForTest = 0;
    jpegNativeDecodeRequestedBestFitCountForTest = 0;
    jpegNativeDecodeFailureCountForTest = 0;
