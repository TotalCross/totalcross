 ...
 * You can set the spinner color and type before constructing the ProgressBox
 * (usually you do this in your application's constructor, and not for each
 * ProgressBar created).
 *
 * Here's a sample:
 *
...
public class ProgressBox extends MessageBox
{
  ...
  /**
   * Constructs a progress box with the text and one "Ok" button. The text may
