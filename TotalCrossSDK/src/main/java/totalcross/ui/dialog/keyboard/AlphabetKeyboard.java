...
public class AlphabetKeyboard extends Container
{
  ...
  public AlphabetKeyboard()
  {
    ...
    try {
      int size = fmH * 3 / 2;
      btDel = new Button(new Image("totalcross/res/del.png")
                           .getSmoothScaledInstance(size, size));
    } catch (Exception e) {
  ...
  private void addButtonLine(int WIDTH_BUTTON,
                             int aLeft,
                             int hGap,
                             int vGap,
                             int aHeight,
