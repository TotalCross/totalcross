...
public class Builder extends Control
{
  ...
  {
    public static final EnumTipoBotao
      BTN_SPOTLIGHT = new EnumTipoBotao("BTN_SPOTLIGHT"),
    ...
    private EnumTipoBotao(String name) { this.name = name; }
                                    ...
                                    EnumTipoBotao status)
  {
    ...
    button.addPressListener(new PressListener() {
      @Override public void controlPressed(ControlEvent event)
      {
  ...
  {
    return createButton(
      msg, img, RIGHT, (int)(Settings.screenWidth * 0.01), BTN_REGULAR);
  }
}
