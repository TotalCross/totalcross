...
public class StandardHttpClient {
	 ...
	 */
	public StandardHttpClient(String hostname, int port, String uri, int openTimeout, int readTimeout,
							  int writeTimeout)
	 ...
	 *            If the connection to the server could not be made
	 */
	public StandardHttpClient(String hostname, int port, String uri) throws UnknownHostException,
		XmlRpcException {
		this(hostname, port, uri, Socket.DEFAULT_OPEN_TIMEOUT, Socket.DEFAULT_READ_TIMEOUT,
