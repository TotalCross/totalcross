...
public class XmlRpcValue
{
  ...
  public XmlRpcValue() { this.type = STRING; }
  ...
  // This is a performance hack to get the type of a value without casting the
  // Object. It breaks the contract of method hashCode, but it doesn't matter
  // since Value objects are never used as keys in Hashtables.
  @Override public int hashCode() { return type; }
