...
/**
 * This class describes the attributes attached to a start-tag. Tags are
 * case-insensitive. <P> The <code>AttributeListIterator</code> class provides
 * an iterator over the components of each attribute in this
 * </code>AttributeList</code> instance: <UL> <LI>the attribute name <LI>the
 * unquoted value <LI>the quote, if one exists
 * </UL>
 */
public class AttributeList extends Hashtable
{
  ...
  { // guich@tc113_29
    return caseInsensitive ? k.toLowerCase()
                           : k; // guich@tc113_12: added toLowerCase
  }
   ...
   * @param dlm Delimiter that started the attribute value (<code>'</code> or
   *     <code>"</code>), or <code>'\0'</code> if none.
   */
  ...
  public final String getAttributeValue(String name)
  {
    AttributeValue value =
      (AttributeValue)get(getKey(name)); // guich@tc113_12: convert toLowerCase
    if (value != null) {
      return value.value;
    }
    return null;
   ...
   *
   * @param name The attribute name.
   * @param defaultValue The default value if there is no value for the
   *     attribute name.
   * @return The value, or the default value if it wasn't specified or there's a
   *     problem in the number conversion.
   */
  ...
  /**
   * Sets an <code>AttributeList.Filter</code> to filter the attribute entered
   * in this <code>AttributeList</code>.
   *
   * @param filter The <code>AttributeList.Filter</code> to set, or
   *     <code>null</code> if the current <code>AttributeList</code> filter must
   *     be
   * removed.
   * @return The previous <code>AttributeList.Filter</code> or <code>null</code>
   *     if none was set.
   */
  ...
  public interface Filter {
     ...
     * @param dlm Delimiter that started the attribute value (<code>'</code> or
     *     <code>"</code>), or <code>'\0'</code> if none.
     * @return <code>true</code> if the attribute can be entered;
  ...
  public class Iterator
  {
    ...
    /**
     * Constructs an <code>Iterator</code> over each attribute in the outer
     * <code>AttributeList</code>.
     */
    public Iterator() { this.keys = getKeys(); }

    /**
     * Makes current the next attribute in this <code>AttributeList</code>.
     *
     * @return <code>true</code> if the next attribute was activated, or
     *     <code>false</code> if there are no more attribute in this list.
     */
     ...
     *
     * @return The name of the current attribute, or <code>null</code> if no
     *     attribute is actually current.
     */
    public final String getAttributeName() { return currentName; }

    /**
     * Gets the unquoted value of the current attribute.
     *
     * @return The unquoted value of the current attribute, or <code>null</code>
     *     if no attribute is actually current.
     */
     ...
     *
     * @return <code>\'</code>, <code>\"</code>, or <code>\0</code> (the latter
     *     when no quote were surrounding the attribute value) or
    ...
    /**
     * Gets the attribute as a string, the value being surrounded by single or
     * double quotes if these were specified in the start-tag.
     *
