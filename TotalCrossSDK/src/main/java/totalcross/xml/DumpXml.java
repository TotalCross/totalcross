 ...
 * f.close();
 * </pre>
 * Then you'll learn how each of the methods of the XmlTokenizer interface are
...
public class DumpXml extends XmlTokenizer
{
  ...
  @Override public void foundStartOfInput(byte buffer[], int offset, int count)
  {
  ...
  @Override public void foundEndEmptyTag() { Vm.debug("EndEmptyTag"); }

  @Override public void foundCharacterData(byte buffer[], int offset, int count)
  {
  ...
  @Override public void foundAttributeName(byte buffer[], int offset, int count)
  {
  ...
  @Override public void foundEndOfInput(int count)
  {
