...
public abstract class ContentHandler
{
   ...
   *
   * <p>
   * The XMLReader will call this method to report each chunk of cdata found
   * during the parse. This XMLReader implementation returns all contiguous data
   * in a single chunk, except for the <CODE><B>&lt;![CDATA[</CODE></B> and
