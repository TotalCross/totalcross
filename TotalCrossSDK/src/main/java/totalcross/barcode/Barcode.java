...
public abstract class Barcode
{
  ...
  protected Font font;
  /**
   * The width of the quiet zone expressed in multiples of x(the minimun width
   *of the bar)
   **/
   ...
   * @param codeType String Codebar type(Barcode.TYPE_CODE128 or
   *     Barcode.TYPE_CODE93 or Barcode.INTERLEAVED2OF5)
   * @param codeValue String The code to represent
   * @param height the Image's height
   * @throws ImageException
   */
  public static synchronized Image createImage(String codeType,
                                               String codeValue,
                                               int height) throws ImageException
  {
   ...
   * @param alignment int Text alignment :use Barcode.ALIGN_CENTER,
   *     Barcode.ALIGN_LEFT, Barcode.ALIGN_RIGHT
                                               ...
                                               int n) throws Exception
  {
    ...
    Image image =
      new Image((int)barcode.getBarcodeWidth(), (int)barcode.getBarHeight());
    Graphics g = image.getGraphics();
    g.backColor = Color.WHITE;
   ...
   * @return int
   */
  public int getQuietZoneX() { return quietZoneX; }
   ...
   */
  public boolean isChecksumText() { return checksumText; }
   ...
   */
  public boolean isGuardBars() { return guardBars; }

  /**
   * Gets the property to show the quiet zone at start and end of the bars.
   * @return boolean
   */
  public boolean isQuietZone() { return quietZone; }
   ...
   */
  public boolean isStartStopText() { return startStopText; }
   ...
   * Example: Having the logical dimension 200, and the logical coordinate 20.5
   * we want to scale the coordinate to a 300 pixel physical dimension. The call
   * should be: int physicalCoordinate=scale(300,200,20.5); Fecha de creaci�n:
   * (26/02/2003 12:20:14)
   * @return int
   ...
   */
  public void setGuardBars(boolean guardBars) { this.guardBars = guardBars; }
   ...
   */
  public void setQuietZone(boolean newQuietZone) { quietZone = newQuietZone; }

  /**
   * Set the width of the quiet zone
   * @param newQuietZoneX int
   */
  public void setQuietZoneX(int newQuietZoneX) { quietZoneX = newQuietZoneX; }

  /**
   * Sets the property to show the text for barcode.
   * @param newShowText boolean
   */
  public void setShowText(boolean newShowText) { showText = newShowText; }
