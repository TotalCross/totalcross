...
public abstract class Barcode {
	 ...
	 * @throws Exception
	 */
	public static synchronized Image createImage(String codeType, String codeValue, int barHeight,
			String fontName,
			int fontSize, boolean transparent, int alignment, boolean fontBold, int newBarColor,
			int newTextColor, int x,
	 ...
	 * Fecha de creaci�n: (26/02/2003 12:20:14)
	 * @return int
