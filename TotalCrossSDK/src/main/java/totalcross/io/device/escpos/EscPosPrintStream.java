 ...
 *
 * <p>All characters printed by a <code>EscPosPrintStream</code> are converted
...
public class EscPosPrintStream extends FilterOutputStream
{
   ...
   *     <tt>this.out</tt> for later use, or <code>null</code> if this instance
   *     is to be created without an underlying stream.
   */
  public EscPosPrintStream(OutputStream out) { super(out); }

  /**
   * Initialize printer.
   *
   * <p>Clears the data in the print buffer and resets the printer modes to the
   ...
   *
   * <p>In page mode, prints all the data in the print buffer collectively and
   ...
   * Print and line feed.
   *
   * <p>Prints the data in the print buffer and feeds one line, based on the
   ...
   *
   * <p>Prints the data in the print buffer and feeds the paper n × (vertical or
   ...
   * @return This EscPosPrinter.
   * @throws IllegalArgumentException if the value of argument n is outside the
   *     range [0,255]
   * @throws IOException if an I/O error occurs.
   */
  public EscPosPrintStream feedPaper(int n) throws IOException
  {
    if (n < 0 || n > 255) {
      throw new IllegalArgumentException(
        "The value of argument 'n' is out of range");
    }
   ...
   * Select print mode(s).
   *
   * <p>The argument textPrintMode must be one of the
   * EscPosConstants.TEXTPRINTMODE constants defined, or any valid combination
   * of them ored together.
   *
   * <p>Other values in the range [0,255] may be supported by selected printers,
   * refer to your printer documentation for more details.
   *
   * @param textPrintMode one of the EscPosConstants.TEXTPRINTMODE constants, or
   *     any valid combination of them ored together.
   * @return This EscPosPrinter.
   * @throws IllegalArgumentException if the value of argument textPrintMode is
  ...
  public EscPosPrintStream textPrintMode(int textPrintMode) throws IOException
  {
    if (textPrintMode < 0 || textPrintMode > 255) {
      throw new IllegalArgumentException(
        "The value of argument 'textPrintMode' is out of range");
    }
   ...
   *
   * <p>The argument characterSize must be one of the
   * EscPosConstants.CHARACTERSIZE constants, or a combination of a width
   * constant with a height constant ored together.
   *
   * <p>Most printers support only single or double width/height (constants 1 or
   ...
   *
   * @see CharacterSize
   * @param characterSize one of the EscPosConstants.CHARACTERSIZE constants, or
   *     a combination of a width constant with a height constant ored together.
   * @return This EscPosPrinter.
   * @throws IOException if an I/O error occurs.
   ...
   *
   * @param enable sets the command to enable or disable white/black reverse
   *     print mode
   * @return This EscPosPrinter.
   * @throws IOException if an I/O error occurs.
   */
   ...
   *
   * @param enable sets the command to enable or disable 90° clockwise rotation
   *     mode
   * @return This EscPosPrinter.
   * @throws IOException if an I/O error occurs.
   */
   ...
   *
   * <p>Provided for printers that define other values for rotation mode besides
   * on/off, refer to your printer documentation for more information.
   *
   * @param value a valid value for the 'ESC V' command as defined by your
   ...
   *
   * <p>Moves the print position to n × (horizontal or vertical motion unit)
   * from the left edge of the print area.
   *
   * <p>A motion unit usually measures 1/203 inches or 0.125 mm.
   *
   * @param n the motion units value to set for the absolute print position from
   *     the left edge of the print area, which mus be in the range [0,65535]
   * @return This EscPosPrinter.
   * @throws IOException if an I/O error occurs.
   */
   ...
   *
   * <p>A maximum of 32 horizontal tab positions in ascending order can be set,
   * with each value in the range [0,255].
   *
   * <p>Executing this method with no arguments clears all the set tab
   * positions.
   *
   * <p>ATTENTION: The maximum amount of tab positions may be lower for some
   ...
   * <li>Leopardo A7: 8
   *
   * @param tabPositions A maximum of 32 tab positions in ascending orders, with
   *     each value in the range [0,255], or empty to clear all the set tab
   *     positions.
   * @return This EscPosPrinter.
   * @throws IllegalArgumentException if the maximum number of tab positions is
   *     greater than 32, OR if any given tab position is outside the range
   *     [0,255], OR if any given tab position is less than or equal the
   *     preceding value.
   * @throws IOException if an I/O error occurs.
   */
    ...
    throws IOException
  {
    if (tabPositions.length > 32) {
      throw new IllegalArgumentException(
        "A maximum of 32 tab positions may be specified");
    }
    int lastPosition = 0;
    ...
    for (int i = 0; i < length; i++) {
      ...
      if (tabPosition < 0 || tabPosition > 255) {
        throw new IllegalArgumentException(
          "The value of the " + (i + 1) +
          "º tabPosition is is outside the range [0,255]");
      }
   ...
   * <p>A motion unit usually measures 1/203 inches or 0.125 mm.
   *
   * @param n the size of the line spacing in motion units, which must be inside
   *     the range [0,255]
   * @return This EscPosPrinter.
   * @throws IllegalArgumentException if the value of argument n is outside the
   *     range [0,255]
   ...
   *
   * <p>Sets the right-side character spacing to n × (horizontal or vertical
   * motion unit).
   *
   * <p>A motion unit usually measures 1/203 inches or 0.125 mm.
   *
   ...
   * Select alignment.
   *
   * <p>Sets the printing alignment to either ALIGN_LEFT, ALIGN_CENTER or
   * ALIGN_RIGHT.
   *
   * @param alignment the printing alignment, which must be either ALIGN_LEFT,
   *     ALIGN_CENTER or ALIGN_RIGHT.
   * @return This EscPosPrinter.
   * @throws IllegalArgumentException if the value of argument alignment is not
  ...
  {
    if (alignment < EscPosConstants.ALIGN_LEFT ||
        alignment > EscPosConstants.ALIGN_RIGHT) {
      throw new IllegalArgumentException(
        "The value of argument 'alignment' is invalid");
    }
   ...
   * Set left margin.
   *
   * <p>In standard mode, sets the left margin to n × (horizontal motion unit)
   * from the left edge of the printable area.
   *
   * <p>A motion unit usually measures 1/203 inches or 0.125 mm.
   *
   * @param n the motion units value to set the left margin, must be inside the
   *     range [0,65535]
   * @return This EscPosPrinter.
   * @throws IllegalArgumentException if the value of argument n is outside the
   *     range [0,65535]
   ...
   * @return This EscPosPrinter.
   * @throws IllegalArgumentException if the value of argument cut is not either
   *     CUT_FULL or CUT_PART
   * @return This EscPosPrinter.
   * @throws IOException if an I/O error occurs.
   */
  public EscPosPrintStream cut(byte cut) throws IOException
  {
    if (cut < EscPosConstants.CUT_FULL || cut > EscPosConstants.CUT_PART) {
      throw new IllegalArgumentException(
        "The value of argument 'cut' is invalid");
    }
   ...
   *
   * <p>This command is not listed in the original ESC/POS Manual, refer to the
   ...
   */
  public EscPosPrintStream charset(Charset charset)
   ...
   * @throws UnsupportedEncodingException If no support for the named charset is
   *     available
   */
   ...
   *
   * <p>The value of argument mode must be either LOGO_NORMAL,
   * LOGO_DOUBLE_WIDTH, LOGO_DOUBLE_HEIGHT or LOGO_QUADRUPLE.
   *
   * @param mode the printing mode, which must be either LOGO_NORMAL,
   *     LOGO_DOUBLE_WIDTH, LOGO_DOUBLE_HEIGHT or LOGO_QUADRUPLE.
   * @return This EscPosPrinter.
   * @throws IllegalArgumentException if the value of argument mode is not
   *     LOGO_NORMAL, LOGO_DOUBLE_WIDTH, LOGO_DOUBLE_HEIGHT or LOGO_QUADRUPLE.
   * @throws IOException if an I/O error occurs.
  ...
  {
    if (mode < EscPosConstants.LOGO_NORMAL ||
        mode > EscPosConstants.LOGO_QUADRUPLE) {
      throw new IllegalArgumentException();
    }
   ...
   *
   * <p>All characters are converted into bytes using the platform's default
   * character encoding.
   *
   * @param text the data
   * @return This EscPosPrinter.
   ...
   * @throws IOException if an I/O error occurs.
   */
  public EscPosPrintStream print(EscPosPrintObject printStruct)
    throws IOException
  {
   ...
   * @throws IOException if an I/O error occurs.
   */
  public EscPosPrintStream print(EscPosPrintObject... commands)
    throws IOException
  {
