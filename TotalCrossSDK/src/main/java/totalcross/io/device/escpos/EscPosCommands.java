...
public interface EscPosCommands {
  ...
  public static final byte[] ESC_HORIZONTAL_TAB_POSITION =
    new byte[] { ESC, (byte)'D' };
  public static final byte[] ESC_DEFAULT_LINE_SPACING =
    new byte[] { ESC, (byte)'2' };
  public static final byte[] ESC_LINE_SPACING = new byte[] { ESC, (byte)'3' };
  public static final byte[] ESC_CHARACTER_SPACING =
    new byte[] { ESC, (byte)' ' };
  ...
  public static final byte[] ESC_SHORT_SELF_TEST =
    new byte[] { ESC, (byte)'T' };
  ...
  public static final byte[] GS_PRINT_DOWNLOADED_BIT_IMAGE =
    new byte[] { GS, (byte)'/' };
