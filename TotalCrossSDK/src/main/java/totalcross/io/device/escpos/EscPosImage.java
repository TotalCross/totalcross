...
public class EscPosImage implements EscPosPrintObject
{
  ...
  public EscPosImage(Image image) { this.image = image; }
  ...
  @Override public void write(OutputStream out) throws IOException
  {
    ...
    this.printImage(
      out, toPrint, width, toPrint.getHeight(), align, dither, false);
  }

  private void printImage(OutputStream out,
                          Image image,
                          int width,
                          int height,
                          byte align,
  ...
  private static void ditherImageByFloydSteinberg(int[] grayscale,
                                                  int width,
                                                  int height)
  {
    int stopXM1 = width - 1;
