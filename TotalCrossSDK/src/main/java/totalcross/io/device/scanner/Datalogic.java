...
public interface Datalogic {
  /**
   * To be used with Datalogic scanners, in the setParam method: scanning
   * timeout, expressed in terms of milliseconds
   */
  public final static int SCAN_PARAM_TIMEOUT = 0x4000001;
  /**
   * To be used with Datalogic scanners, in the setParam method: beeper
   * duration on barcode event, expressed in terms of milliseconds
   */
  public final static int SCAN_PARAM_BEEPER_DURATION = 0x4000002;
  /**
   * To be used with Datalogic scanners, in the setParam method: beeper
   * frequency on barcode event, expressed in terms of hertz
   */
  public final static int SCAN_PARAM_BEEPER_FREQUENCY = 0x4000003;
  /**
   * To be used with Datalogic scanners, in the setParam method: how many
   * pulses we blink the led on barcode event
   */
  public final static int SCAN_PARAM_LED_NUM_OF_PULSES = 0x4000004;
  /**
   * To be used with Datalogic scanners, in the setParam method: duration of
   * each pulse on barcode event, expressed in terms of milliseconds
   */
  public final static int SCAN_PARAM_LED_PULSE_DURATION = 0x4000005;
  /**
   * To be used with Datalogic scanners, in the setParam method: disable/enable
   * the scanning continous mode, the scanning doesn't stop on barcode event
   */
  public final static int SCAN_PARAM_CONTINUOUS_MODE = 0x4000006;
  /**
   * To be used with Datalogic scanners, in the setParam method: disable/enable
   * the keyborad emulation, all scanned data are translated to keyboard events
   */
  public final static int SCAN_PARAM_KEYBOARD_EMULATION = 0x4000007;
  /**
   * To be used with Datalogic scanners, in the setParam method: disable/enable
   * the soft trigger functions. if enabled, allows the scanner to read, even if
   * the scan button is not pressed
   */
  public final static int SCAN_PARAM_SOFT_TRIGGER = 0x4000008;
  /**
   * To be used with Datalogic scanners, in the setParam method: if enabled,
   * allows the scanner to read, even if the active() function has not been
   * called.
   */
  public final static int SCAN_PARAM_SCAN_ALWAYS_ENABLED = 0x4000009;
  /**
   * To be used with Datalogic scanners, in the setParam method: beeper type,
   * dual-tone (0), monotone (1)
   */
  ...
  /**
   To be used with Datalogic scanners, in the setParam method. Possible
   values: 0 - BCD_PARAM_NO_IDENTIFIER, 1 -
   BCD_PARAM_DATALOGIC_IDENTIFIER_AT_BEGINNING, 2 -
   BCD_PARAM_DATALOGIC_IDENTIFIER_AT_END, 3 -
   BCD_PARAM_AIM_IDENTIFIER_AT_BEGINNING, 4 - BCD_PARAM_AIM_IDENTIFIER_AT_END.
   */
  public final static int BCD_PARAM_BARCODE_SYMBOLOGY_IDENTIFIER = 2;

  /**
   To be used with Datalogic scanners, in the setParam method. Possible
   values: 0 - BCD_PARAM_MIN_SEVERITY, 1 - BCD_PARAM_LOW_SEVERITY, 2 -
   BCD_PARAM_MID_SEVERITY, 3 - BCD_PARAM_HIGH_SEVERITY, 4 -
   BCD_PARAM_MAX_SEVERITY.
   */
  public final static int BCD_PARAM_LINEAR_CODE_SEVERITY = 3;
  /**
   To be used with Datalogic scanners, in the setParam method. Possible
   values: 0 - BCD_PARAM_MIN_QUIET_ZONE, 1 - BCD_PARAM_STANDARD_QUIET_ZONE.
   */
  ...
  /**
   To be used with Datalogic scanners, in the setParam method. Possible
   values: 0 - BCD_PARAM_CODE_CHECK_C, 1 - BCD_PARAM_CODE_CHECK_K, 2 -
   BCD_PARAM_CODE_CHECK_C_AND_K, 3 - BCD_PARAM_CODE_CHECK_NONE.
   */
  ...
  /**
   ...
   BCD_PARAM_CODE_CHECK_C_AND_K, 3 - BCD_PARAM_CODE_CHECK_NONE.
   */
  public final static int BCD_PARAM_CODE_39_STANDARD_CHECK_DIGIT_TRANSMISSION =
    11;
  /** To be used with Datalogic scanners, in the setParam method. */
  ...
  public final static int
    BCD_PARAM_CODE_39_FULL_ASCII_CHECK_DIGIT_TRANSMISSION = 14;
  /** To be used with Datalogic scanners, in the setParam method. */
  ...
  /**
   ...
   BCD_PARAM_CODE_CHECK_C_AND_K, 3 - BCD_PARAM_CODE_CHECK_NONE.
   */
  public final static int BCD_PARAM_CODE_39_CODE_32_CHECK_DIGIT_TRANSMISSION =
    17;
  /** To be used with Datalogic scanners, in the setParam method. */
   ...
   */
  public final static int
    BCD_PARAM_CODE_25_INTERLEAVED_CHECK_DIGIT_TRANSMISSION = 24;
   ...
   */
  public final static int
    BCD_PARAM_CODE_25_INDUSTRIAL_CHECK_DIGIT_TRANSMISSION = 27;
  ...
  /**
   ...
   BCD_PARAM_CODE_CHECK_C_AND_K, 3 - BCD_PARAM_CODE_CHECK_NONE.
   */
  public final static int BCD_PARAM_CODE_25_MATRIX_CHECK_DIGIT_TRANSMISSION =
    30;
  ...
  /**
   ...
   BCD_PARAM_CODE_CHECK_C_AND_K, 3 - BCD_PARAM_CODE_CHECK_NONE.
   */
  public final static int BCD_PARAM_CODE_128_STANDARD_CHECK_DIGIT_TRANSMISSION =
    48;
