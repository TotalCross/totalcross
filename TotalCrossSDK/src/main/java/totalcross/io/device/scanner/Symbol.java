...
public interface Symbol {
  /**
   * To be used in the setBarcodeParam method with Symbol scanners; for
   * SocketCom ones, see the method for the avail codes.
   */
  ...
  /**
   * To be used in the setParam method for Windows CE only. Sets the time that
   * the scanner thread will wait for a beam. if value is <= 0, it waits
   * FOREVER. Otherwise, waits for the given number of milisseconds. <b>MUST BE
   * CALLED BEFORE SCANNER.ACTIVATE !!!</b>
   */
