...
public class Scanner {
	 ...
	 */
	@ReplacedByNativeOnDeploy
	public static boolean setBarcodeLength(int barcodeType, int lengthType, int min,
										   int max) { // guich@330_43
		return true;
	}
	...
	protected static void _onEvent(int type) {
		...
		int id = type % 1100 == 2 ? ScanEvent.BATTERY_ERROR : type % 1100 == 1 ? ScanEvent.SCANNED/* 0 */ :
				 ScanEvent.TRIGGERED;
