...
public class DiscoveryAgent4D
{
  ...
  DiscoveryAgent4D() { nativeDiscoveryAgent(); }
  ...
  native public int nativeSearchServices(int[] attrSet,
                                         UUID[] uuidSet,
                                         RemoteDevice btDev,
                                         DiscoveryListener discListener)
    throws IOException;

  native public String selectService(UUID uuid, int security, boolean master)
    throws IOException;

  native public boolean startInquiry(int accessCode, DiscoveryListener listener)
    throws IOException;
}
