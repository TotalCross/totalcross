...
public interface DiscoveryListener {
   ...
   * <code>inquiryCompleted()</code> method. <p> The value of
   * <code>INQUIRY_COMPLETED</code> is 0x00 (0).
   * </p>
   */
  public static final int INQUIRY_COMPLETED = 0x00;

  /**
   * Indicates that the inquiry request failed to complete normally, but was not
   * cancelled. <p> The value of <code>INQUIRY_ERROR</code> is 0x07 (7).
   * </p>
   */
  public static final int INQUIRY_ERROR = 0x07;

  /**
   * Indicates device discovery has been canceled by the application and did not
   * complete. Used with the <code>inquiryCompleted()</code> method. <p> The
   * value of <code>INQUIRY_TERMINATED</code> is 0x05 (5).
   * </p>
   */
   ...
   * <code>serviceSearchCompleted()</code> method. <p> The value of
   * <code>SERVICE_SEARCH_COMPLETED</code> is 0x01 (1).
   * </p>
   */
   ...
   * device provided to <code>DiscoveryAgent.searchServices()</code> could not
   * be reached.
   *
  ...
  /**
   * Indicates the service search has completed with no service records found on
   * the device.
   *
   * Used with the <code>serviceSearchCompleted()</code> method.
   * <p>
   ...
   * not complete. Used with the <code>serviceSearchCompleted()</code> method.
   * <p>
   ...
   * @param cod
   *           the service classes, major device class, and minor device class
  ...
  /**
   * Called when an inquiry is completed. <code>discType</code> will be
   ...
   * <code>DiscoveryAgent.cancelInquiry()</code>. The <code>discType</code> will
   * be <code>INQUIRY_ERROR</code> if an error occurred while processing the
   * inquiry causing the inquiry to end abnormally.
   *
   * @param discType
   ...
   * error. Legal status values in the <code>respCode</code> argument include
   ...
   * <code>SERVICE_SEARCH_DEVICE_NOT_REACHABLE</code>. The following table
   * describes when each <code>respCode</code> will be used: <table>
   *
   * <tbody>
   * <tr>
   ...
   * <code>DiscoveryAgent.cancelServiceSearch()</code></td>
   * </tr>
   *
   * <tr>
   ...
   * the local device could not establish a connection to the remote device</td>
   * </tr>
   *
   * </tbody>
   * </table>
