 ...
 * the Bluetooth Assigned Numbers document and contains information on the type
 ...
 * http://www.bluetooth.org/assigned-numbers/sdp.htm</a>) defines the service
 * class, major device class, and minor device class. The table below provides
 * some examples of possible return values and their meaning: <TABLE> <TR>
 * <TH>Method</TH>
 * <TH>Return Value</TH>
...
public class DeviceClass
{
   ...
   * provided. <code>record</code> must follow the format of the class of device
   * record in the Bluetooth specification.
   *
   * @param record
   ...
   * @since TotalCross 1.2
   */
  public int getMajorDeviceClass() { return record & MAJOR_DEVICE_CLASS_MASK; }
   ...
   * @since TotalCross 1.2
   */
  public int getMinorDeviceClass() { return record & MINOR_DEVICE_CLASS_MASK; }
   ...
   * @since TotalCross 1.2
   */
  public int getServiceClasses() { return record & SERVICE_CLASS_MASK; }
}
