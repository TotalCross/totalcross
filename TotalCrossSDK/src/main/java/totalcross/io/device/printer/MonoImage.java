...
/**
 * Image class that can be used to save 1-bpp images and print on monochromatic
 * printers. Only black pixels are printed, non-black are ignored.
 */
public class MonoImage extends Image
{
  /**
   * If set to true, the image's width is limited to 384 (double density) or
   * 192 (single density). If false, it will use the actual image's width.
   */
  ...
  public MonoImage(Stream s) throws ImageException, IOException { super(s); }
  ...
  /**
   * Prints a 1-bpp bitmap from this image. When writting, all non-white pixels
   * are written.
   */
