...
public interface FileStates {
   ...
   * createDir(), and isDir() methods to be called without requiring the file to
  ...
  /**
   * Used to create a file if one does not exist; if the file exists, it is not
   * erased, and the mode is changed to READ_WRITE.
   *
   * @see #File(String,int)
   * @see #File(String,int,int)
   */
  ...
  /**
   * Create an empty file; destroys the file if it exists, then the mode is
