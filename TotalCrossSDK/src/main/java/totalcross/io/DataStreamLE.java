...
public class DataStreamLE extends DataStream
{
   ...
   */
  public DataStreamLE(Stream stream) { super(stream); }

  @Override public int readInt() throws EOFException, totalcross.io.IOException
  {
    byte[] b = buffer;
  ...
  @Override public int writeInt(int i) throws totalcross.io.IOException
  {
    byte[] b = buffer;
    b[0] = (byte)i;
    i >>= 8; // guich@300_40
  ...
  @Override public int writeShort(int i) throws totalcross.io.IOException
  {
    byte[] b = buffer;
    b[0] = (byte)i;
    i >>= 8; // guich@300_40
  ...
  @Override public int writeLong(long l) throws totalcross.io.IOException
  {
  ...
  @Override public int writeChar(char c) throws totalcross.io.IOException
  { // guich@421_31
    byte[] b = buffer;
    b[0] = (byte)c;
    c >>= 8;
    ...
    throws EOFException, totalcross.io.IOException
  {
    ...
    while (len > 0) {
      ...
      for (int i = 0; i < avail; i += 2) {
        chars[start++] =
          (char)(((bytes[i + 1] & 0xFF) << 8) | (bytes[i] & 0xFF));
      }
      len -= avail / 2;
    }
  }
