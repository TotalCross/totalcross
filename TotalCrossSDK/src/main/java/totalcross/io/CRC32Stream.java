...
/*
 * CRC32.java - Computes CRC32 data checksum of a data stream Copyright (C)
 * 1999. 2000, 2001 Free Software Foundation, Inc. This file is part of GNU
 ...
 * USA. Linking this library statically or dynamically with other modules is
 ...
 * Java class libraries", 2nd edition (Addison-Wesley, 1998). The actual CRC32
 * algorithm is taken from RFC 1952. Status: Believed complete and correct.
 */

/**
 * Computes CRC32 data checksum of a stream. The actual CRC32 algorithm is
 * described in RFC 1952 (GZIP file format specification version 4.3). Can be
 * used to get the CRC32 over a stream if used with input/output streams.
 *
 * @author Per Bothner
 */
public class CRC32Stream extends Stream
{
  ...
  public CRC32Stream(Stream s) { this.stream = s; }

  /**
   * Returns the CRC32 data checksum computed so far.
   * You can safely cast it to <code>int</code>, but then the value may be
   * negative.
  ...
  /**
   * Computes the checksum for the given bytes, then write them to the attached
   * stream.
