...
public class Base64decoderStream extends InputStream {
	...
	public long skip(long n) throws IOException {
		throw new IOException(new
							  UnsupportedOperationException("totalcross.io.Base64Decoder.skip use is not supported"));
	...
	private void ensureFetch() throws IOException {
		...
		if (decodedReadPos == decodedSize) {
			...
			int readFromStream = base64encodedStream.read(bytesEncodedRead, oldOverflowSize,
								 BYTES_ENCODED_SIZE);
