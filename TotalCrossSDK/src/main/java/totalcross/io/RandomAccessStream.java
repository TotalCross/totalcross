...
public abstract class RandomAccessStream extends Stream
{
   ...
   */
  public int getPos() throws totalcross.io.IOException { return pos; }

  /**
   * Sets the file pointer for read and write operations to a new position
   ...
   *            if origin is not one of the values specified by the SEEK_*
   * constants.
   * @throws totalcross.io.IOException
   *            if the new position is negative or if an I/O error occurs.
   * @since TotalCross 1.2
   */
  public abstract void setPos(int offset, int origin)
    throws totalcross.io.IOException;
