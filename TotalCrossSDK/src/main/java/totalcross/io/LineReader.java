...
public class LineReader {
	protected Stream f;
	protected ByteArrayStream readBuf = new ByteArrayStream(!Settings.onJavaSE ? 4096 :
	 ...
	 */
	public LineReader(Stream f, byte[] buffer, int start,
					  int len) throws totalcross.io.IOException { // guich@tc125_16
		this.f = f;
