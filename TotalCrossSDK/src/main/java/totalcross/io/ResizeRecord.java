...
public class ResizeRecord extends Stream { // guich@580_19
	...
	private boolean isRecordClosed =
		true; // flsobral@tc113_30: flag to avoid the execution of endRecord twice for the same record.
	 ...
	 * @see #endRecord()
	 */
	public void startRecord(int pos) throws
		IOException { // flsobral@tc100b5_49: returning boolean is no longer necessary.
