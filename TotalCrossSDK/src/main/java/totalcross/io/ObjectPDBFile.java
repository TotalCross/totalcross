 ...
 * <pre>
 *   // save data
 *   ObjectPDBFile oc=new
 * ObjectPDBFile(&quot;Test.DATA&quot;,ObjectPDBFile.CREATE); for(int
 * i=0,size=objs.getCount();i++) oc.addObject((Storable)objs.get(i));
 *   oc.close();
 *
 *   // load data
 *   ObjectPDBFile oc=new ObjectPDBFile(&quot;Test.DATA&quot;);
...
public class ObjectPDBFile extends PDBFile
{
   ...
   * @throws totalcross.io.IllegalArgumentIOException
   */
  public ObjectPDBFile(String name)
   ...
   * @throws totalcross.io.IllegalArgumentIOException
   */
  public void addObject(Storable s)
    throws totalcross.io.IllegalArgumentIOException, totalcross.io.IOException
  {
    if (bs == null) {
   ...
   * @throws totalcross.io.IllegalArgumentIOException
   */
  public void deleteObjectAt(int i)
    throws totalcross.io.IllegalArgumentIOException, totalcross.io.IOException
  {
    setRecordPos(i);
    deleteRecord();
   ...
   * @throws totalcross.io.IOException
   */
  public boolean setObjectAttribute(int i, byte a)
    throws totalcross.io.IOException
  {
   ...
   */
  public void resetSearch() { setSearchIndex(0); }
   ...
   *           the index to start
   */
  public void setSearchIndex(int i) { cnt = i; }
