...
public class ObjectPDBFile extends PDBFile {
	 ...
	 * @throws totalcross.io.IllegalArgumentIOException
	 */
	public ObjectPDBFile(String name) throws totalcross.io.IllegalArgumentIOException,
		totalcross.io.IOException {
	 ...
	 * @throws totalcross.io.IllegalArgumentIOException
	 */
	public void addObject(Storable s) throws totalcross.io.IllegalArgumentIOException,
		totalcross.io.IOException {
		if (bs == null) {
	 ...
	 * @throws totalcross.io.IllegalArgumentIOException
	 */
	public Storable loadObjectAt(int i) throws totalcross.io.IllegalArgumentIOException,
		totalcross.io.IOException {
		Storable s = null;
	 ...
	 * @throws totalcross.io.IllegalArgumentIOException
	 */
	public void deleteObjectAt(int i) throws totalcross.io.IllegalArgumentIOException,
		totalcross.io.IOException {
		setRecordPos(i);
		deleteRecord();
	}
	 ...
	 * @throws totalcross.io.IllegalArgumentIOException
	 */
	public boolean nextObject(Storable s) throws totalcross.io.IllegalArgumentIOException,
		totalcross.io.IOException {
