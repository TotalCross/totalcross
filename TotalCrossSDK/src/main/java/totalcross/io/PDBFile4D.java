...
public class PDBFile4D extends Stream {
	...
	native public void rename(String newName) throws totalcross.io.IllegalArgumentIOException,
			   totalcross.io.IOException;

	native public void addRecord(int size) throws totalcross.io.IllegalArgumentIOException,
			   totalcross.io.IOException;

	native public void addRecord(int size, int pos)
	throws totalcross.io.IllegalArgumentIOException, totalcross.io.IOException;

	native public void resizeRecord(int size) throws totalcross.io.IllegalArgumentIOException,
			   totalcross.io.IOException;
	...
	native public void setRecordPos(int pos) throws totalcross.io.IllegalArgumentIOException,
			   totalcross.io.IOException;

	native int readWriteBytes(byte buf[], int start, int count,
	...
	native public int searchBytes(byte[] toSearch, int length,
								  int offsetInRec) throws totalcross.io.IOException;
