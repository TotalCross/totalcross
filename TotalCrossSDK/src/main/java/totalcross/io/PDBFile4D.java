...
public class PDBFile4D extends Stream
{
  ...
  native public void rename(String newName)
    throws totalcross.io.IllegalArgumentIOException, totalcross.io.IOException;

  native public void addRecord(int size)
    throws totalcross.io.IllegalArgumentIOException, totalcross.io.IOException;

  native public void addRecord(int size, int pos)
    throws totalcross.io.IllegalArgumentIOException, totalcross.io.IOException;

  native public void resizeRecord(int size)
    throws totalcross.io.IllegalArgumentIOException, totalcross.io.IOException;
  ...
  native public void setRecordPos(int pos)
    throws totalcross.io.IllegalArgumentIOException, totalcross.io.IOException;

  native int readWriteBytes(byte buf[], int start, int count, boolean isRead)
    throws totalcross.io.IOException;

  native public int inspectRecord(byte buf[], int recordPos, int offsetInRec)
    throws totalcross.io.IllegalArgumentIOException, totalcross.io.IOException;

  native public byte getRecordAttributes(int recordPos)
    throws totalcross.io.IOException;

  native public void setRecordAttributes(int recordPos, byte attr)
    throws totalcross.io.IOException;
  ...
  native public int searchBytes(byte[] toSearch, int length, int offsetInRec)
    throws totalcross.io.IOException;
