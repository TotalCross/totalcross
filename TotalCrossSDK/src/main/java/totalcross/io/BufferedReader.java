...
public class BufferedReader extends Reader
{
  ...
  public BufferedReader(Reader in) { this(in, 4096); }
  ...
  // reseta o offset para 0 e atualiza szRead para a quantidade de bytes de fato
  // lidos se a leitura dos bytes falhar, ou seja, in.read(buff) retornar -1,
  // coloca eof como true
  ...
  // XXX não tenta ler até acabar os caracteres, então não obedece totalmente ao
  // comportamento descrito no javadoc de java.io.BufferedReader.read(char[],
  // int, int)
