...
/**
 * Contains information about the anthena that this cell phone is receiving
 * signal. Used by the GPS class.
...
public class CellInfo
{
  ...
  private CellInfo() { loadResources(); }

  @ReplacedByNativeOnDeploy public static void update() {}

  @ReplacedByNativeOnDeploy private void loadResources() {}

  @ReplacedByNativeOnDeploy private void releaseResources() {}

  @Override protected void finalize() { releaseResources(); }
   ...
   * You need to manually update the values by calling the <code>update</code>
   * method.
   *
   * This method requires direct connection to the internet and uses the google
   * mmap service.
  ...
  public static double[] toCoordinates() throws Exception
  {
    ...
    totalcross.net.Socket sock =
      new totalcross.net.Socket("www.google.com", 80, 20000);
    ...
    if (line != null && line.indexOf(" 200 ") >= 0) {
      ...
      while ((line = lr.readLine()) !=
             null) { // skip all other header information
