...
public final class String4D implements Comparable<String4D>, CharSequence {
	 ...
	 */
	private String4D(char value[],
					 boolean dummy) { // dummy is just to distinguish from the original constructor
		this.chars = value;
	}
	...
	native static boolean copyChars(char[] srcArray, int srcStart, char[] dstArray, int dstStart,
									int length);
	 ...
	 * @throws NullPointerException if other is null
	 */
	public boolean regionMatches(boolean ignoreCase, int toffset, String4D other, int ooffset,
								 int len) {
	 ...
	 */
	public String replace(CharSequence targetcs,
						  CharSequence replacementcs) { // NOTE: the original version uses CharSequence
