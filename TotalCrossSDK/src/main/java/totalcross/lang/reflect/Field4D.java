...
public class Field4D
{
  ...
  public int getModifiers() { return mod; }
  ...
  @Override public boolean equals(Object obj)
  {
    ...
    return f.mod == mod && f.name.equals(name) &&
      f.type.getName().equals(type.getName()) &&
  ...
  @Override public String toString()
  {
    ...
    StringBuffer sb =
      new StringBuffer(64); // private static final int TCTestWin$TestField.x
    ...
    switch (primitiveType) {
      ...
      case /*public static final int DOUBLE  = */ 9:
        ...
        break;
      default: {
        t = type.getName(); // Class may think that its a primitive, but its an
                            // Object, so we convert it back
        if (t.equals("int")) {
          t = "java.lang.Integer";
  ...
  public native void setFloat(Object obj, double f)
    throws IllegalArgumentException, IllegalAccessException;
