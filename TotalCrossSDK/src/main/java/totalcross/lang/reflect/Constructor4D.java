...
public class Constructor4D implements Member4D {
	...
	public boolean equals(Object obj) {
		...
		if (m.mod != mod || !m.name.equals(name)
			...
			m.parameterTypes.length/* || exceptionTypes.length != m.exceptionTypes.length*/) {
			return false;
		}
	...
	public String toString() {
		...
		StringBuffer sb = new StringBuffer(
			128); // public static final void TCTestWin$TestMethod.printTest(int,short,java.lang.String,boolean,java.lang.Object,long,byte,char,double)
