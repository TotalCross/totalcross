...
public class Constructor4D implements Member4D
{
  ...
  @Override public int getModifiers() { return mod; }
  ...
  @Override public boolean equals(Object obj)
  {
    ...
    if (m.mod != mod || !m.name.equals(name) ||
        !m.declaringClass.getName().equals(declaringClass.getName()) ||
        parameterTypes.length !=
          m.parameterTypes
            .length /* || exceptionTypes.length != m.exceptionTypes.length*/) {
      return false;
    }
    ...
    // for (int i =0; i < exceptionTypes.length; i++) if
    // (!exceptionTypes[i].equals(m.exceptionTypes[i])) return false; - not
    // needed
    return true;
  }
  ...
  @Override public String toString()
  {
    ...
    StringBuffer sb = new StringBuffer(
      128); // public static final void
            // TCTestWin$TestMethod.printTest(int,short,java.lang.String,boolean,java.lang.Object,long,byte,char,double)
  ...
  public native Object newInstance(Object initargs[])
    throws InstantiationException, IllegalAccessException,
           IllegalArgumentException, InvocationTargetException4D;
}
