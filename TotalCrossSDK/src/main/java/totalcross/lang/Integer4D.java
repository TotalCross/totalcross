...
public class Integer4D extends Number4D implements Comparable<Integer4D>
{
  ...
  public Integer4D(int v) { this.v = v; }
  ...
  public static Integer4D valueOf(int i) { return new Integer4D(i); }
  ...
  public static String toHexString(int i) { return Convert.unsigned2hex(i, 4); }

  public static String toString(int v) { return String.valueOf(v); }

  @Override public long longValue() { return v; }

  @Override public double doubleValue() { return v; }

  @Override public int compareTo(Integer4D o) { return this.v - o.v; }
