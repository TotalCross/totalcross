...
public final class Float4D extends Number implements Comparable<Float4D>
{
   ...
   */
  public Float4D(float value) { this.value = value; }
   ...
   */
  public Float4D(double value) { this.value = (float)value; }
   ...
   * @since 1.2
   */
  public int compareTo(Float4D object) { return compare(value, object.value); }
   ...
   *         {@code false} if it is a (potentially infinite) float number.
   */
  public static boolean isNaN(float f) { return f != f; }
   ...
   */
  public static String toString(float f) { return Convert.toString(f); }
