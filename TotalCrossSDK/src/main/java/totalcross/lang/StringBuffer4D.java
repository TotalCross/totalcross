...
public final class StringBuffer4D
{
  ...
  public static final int STARTING_SIZE =
    16; // read by the StringBuffer test cases.

  /**
   * Constructs an empty String buffer.
   * Consider using the other constructor where you pass an initial size.
   */
  public StringBuffer4D() { charbuf = new char[STARTING_SIZE]; }

  /**
   * Constructs an empty String buffer with the specified initial length.
   * @param length the initial length
   */
  public StringBuffer4D(int length) { charbuf = new char[length]; }
   ...
   */
  public int capacity() { return charbuf.length; }
   ...
   */
  public StringBuffer4D append(Object obj)
  { // can't be native bc obj.toString is implemented in Java
   ...
   */
  @Override public String toString() { return new String(charbuf, 0, count); }
   ...
   * @throws NullPointerException if str is null
   */
  public int indexOf(String4D str) { return indexOf(str, 0); }
