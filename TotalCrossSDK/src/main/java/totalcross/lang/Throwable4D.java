...
public class Throwable4D
{
  ...
  public Throwable4D() { this(null, null); }

  /** Constructs an exception with the given message. */
  public Throwable4D(String msg) { this(msg, null); }
  ...
  public Throwable4D(String message,
                     Throwable4D cause,
  ...
  public Throwable4D getCause() { return (cause == this ? null : cause); }
    ...
    if (stackTrace == null) {
      ...
      for (int i = lines.length - 1; i >= 0; i--) {
        ...
        stackTrace[i] = new StackTraceElement(
          ...
          null,
          numberStart != -1
            ? Integer.valueOf(lines[i].substring(numberStart + 1))
            : -2);
      }
    }
