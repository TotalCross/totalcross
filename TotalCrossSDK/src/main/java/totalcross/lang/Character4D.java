...
public class Character4D {
	...
	public static boolean isJavaIdentifierStart(char ch) {
		...
		return ((1 << genTypes.get()[codePoint])
				& ((1 << UPPERCASE_LETTER) | (1 << LOWERCASE_LETTER) | (1 << TITLECASE_LETTER) |
				   (1 << MODIFIER_LETTER)
				   | (1 << OTHER_LETTER) | (1 << LETTER_NUMBER) | (1 << CURRENCY_SYMBOL) |
	...
	public static boolean isJavaIdentifierPart(char ch) {
		...
		return ((1 << category) & ((1 << UPPERCASE_LETTER) | (1 << LOWERCASE_LETTER) |
								   (1 << TITLECASE_LETTER)
								   | (1 << MODIFIER_LETTER) | (1 << OTHER_LETTER) | (1 << NON_SPACING_MARK) |
								   (1 << COMBINING_SPACING_MARK)
								   | (1 << DECIMAL_DIGIT_NUMBER) | (1 << LETTER_NUMBER) | (1 << CURRENCY_SYMBOL) |
	...
	public static boolean isLetterOrDigit(char codePoint) {
		return ((1 << getType(codePoint)) & ((1 << UPPERCASE_LETTER) | (1 << LOWERCASE_LETTER) |
											 (1 << TITLECASE_LETTER)
