...
public final class Class4D<T>
{
  ...
  /**
   * The TotalCross deployer can find classes that are instantiated using
   * Class.forName if, and only if, they are String constants. If you build the
   * className dynamically, then you must include the file passing it to the
   * tc.Deploy application (the deployer will warn you about that).
  ...
  /**
   * Creates a new instance of this class. The class must have a default and
   * public constructor (E.G.: <code>public MyClass()</code>)
   * @throws InstantiationException If you try to instantiate an interface,
   *     abstract class or array
