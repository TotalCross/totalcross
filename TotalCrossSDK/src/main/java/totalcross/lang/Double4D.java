...
public class Double4D extends Number4D implements Comparable<Double4D>
{
  ...
  public static final double MIN_NORMAL =
    0x1.0p-1022; // 2.2250738585072014E-308
  ...
  public Double4D(double v) { this.v = v; }
  ...
  { // same of java to keep compatibility
    long r = Convert.doubleToLongBits(v);
    if ((r & 0x7FF0000000000000L) == 0x7FF0000000000000L &&
        (r & 0x000FFFFFFFFFFFFFL) != 0L) {
  ...
  public static Double4D valueOf(double d) { return new Double4D(d); }
  ...
  {
    return v == Convert.DOUBLE_POSITIVE_INFINITY_VALUE ||
      v == Convert.DOUBLE_NEGATIVE_INFINITY_VALUE;
  }

  public static String toString(double d) { return Convert.toString(d); }
  ...
  public boolean isNaN() { return v == Convert.DOUBLE_NAN_VALUE; }
  ...
  @Override public int compareTo(Double4D o)
  {
