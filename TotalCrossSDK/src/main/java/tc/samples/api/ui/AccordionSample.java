...
public class AccordionSample extends BaseContainer {
  ...
  public void initUI() {
    ...
    ac.add(ac.new Caption(new Label("Type text 2"), setAwesome(new Button("\uf146", Button.BORDER_NONE), fmH),
        setAwesome(new Button("\uf0fe", Button.BORDER_NONE), fmH)), LEFT, AFTER, FILL, PREFERRED);
    ac.add(new MultiEdit(), LEFT + gap, AFTER + gap, FILL - gap, FONTSIZE + 700);
