...
public class ButtonSample extends BaseContainer {
  ...
  public void initUI() {
    try {
      ...
      c.addPressListener(new PressListener() {
        ...
        public void controlPressed(ControlEvent e) {
          if (--ccount == 0) {
            ...
            setInfo(ccount == 1 ? "1 more click will exit" : ccount + " more clicks to exit");
          }
        }
      });
      ...
      sc.add(c = new Button("This is an image Button", img, LEFT, gap), LEFT, AFTER + gap, PREFERRED + gap,
          PREFERRED + gap);
      ...
      if (Settings.screenWidth > 240) {
        addbtn(0x00FFFF, BEFORE - 4, SAME);
      }
