...
public class ComboListSample extends BaseContainer {
  ...
  public void initUI() {
    try {
      ...
      String[] items = { "One", "Two", "Three", "Four", "Five", "Six", "Seven", "Eight", "Nine", "Ten", "Um", "Dois",
      ...
      String[] items2 = { "cyan", "black", "blue", "bright", "green", "dark", "magenta", "orange", "pink", "red",
          "white", "yellow" };
        ...
        public void controlPressed(ControlEvent e) {
          try {
            String[] items = { "Always", "Never", "Only in Silent mode", "Only when not in Silent mode",
                "None the answers above", "All the answers above" };
