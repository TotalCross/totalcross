...
public class MenuScreen extends TranslucentBaseContainer
{
  ...
  public void initUI()
  {
    ...
    try
    {
      ...
      t.addPressListener(new PressListener() {@Override
        public void controlPressed(ControlEvent e) {EditScreen.getInstance().show();}});

      t = createTransButton("Search", "ui/images/bt_search.png"); 
      add(t, PARENTSIZE+75,PARENTSIZE+25,PARENTSIZE+40,PARENTSIZE+20);
      t.addPressListener(new PressListener() {@Override
        public void controlPressed(ControlEvent e) {SearchScreen.getInstance().show();}});

      t = createTransButton("List","ui/images/bt_list.png"); 
      add(t, PARENTSIZE+25,PARENTSIZE+50,PARENTSIZE+40,PARENTSIZE+20);
      t.addPressListener(new PressListener() {@Override
        public void controlPressed(ControlEvent e) {ListScreen.getInstance().show();}});

      t = createTransButton("View","ui/images/bt_view.png"); 
      add(t, PARENTSIZE+75,PARENTSIZE+50,PARENTSIZE+40,PARENTSIZE+20);        
      t.addPressListener(new PressListener() {@Override
        public void controlPressed(ControlEvent e) {ViewScreen.getInstance().show();}});

      Button t1 = createTransBarButton("ui/images/bt_info.png");
      t1.addPressListener(new PressListener() {@Override
        public void controlPressed(ControlEvent e) {MessageBox mb = new MessageBox(null,"Sample with translucent controls.",null); mb.popupNonBlocking(); Vm.sleep(3000); mb.unpop();}});
      Button t2 = createTransBarButton("ui/images/bt_home.png");
      t2.addPressListener(new PressListener() {@Override
