...
public class GridSample extends BaseContainer {
  ...
  private class Grid1 extends Container {
    ...
    public void initUI() {
      ...
      String[] gridCaptions = { " Caption 1 ", " Caption 2 ", " Caption 3 ", " Caption 4 ", "Caption 5", "Caption 6",
          "Caption 7" };
    ...
    public void onEvent(Event e) {
      ...
      case ControlEvent.PRESSED:
        if (e.target == btnAdd) {
          String newLine[] = { "column 1", "column 2", "column 3", "column 4", "column 5", "column 6", "column 7" };
          grid.add(newLine);
          ...
          String newLine[] = { "new line 1", "new line 2", "new line 3", "new line 4", "new line 5", "new line 6",
              "new line 7" };
  ...
  private class Grid2 extends Container {
    ...
    public void initUI() {
      ...
      String items[][] = { { "SuperWaba Ltda.", "Av. Padre Leonel Franca, 480, sala 27A", "2222-2222" },
  ...
  private class Grid4 extends Container {
    ...
    public void initUI() {
      ...
      int gridAligns[] = { LEFT, LEFT, LEFT };
      String items[][] = { { "Android", "320x480", "All in one" }, { "Palm OS", "160x160 320x320", "Easy to use" },
          { "Windows CE", "240x320", "Most stable" }, { "iPhone", "320x480", "TotalCross runs on it!" } };
  ...
  private class Grid5 extends Container {
    ...
    public void initUI() {
      try {
        ...
        String items[][] = { { "10", "3000.5", new Date(19700325).toString(), "Bárbara" },
  ...
  private class Grid6 extends Container {
    ...
    public void initUI() {
      ...
      String items[][] = { { "choose it", "check disabled" }, { "can't choose", "disabled combo" },
          { "choose it", "default values" }, { "choose it", "urca family" } };
    ...
    public void initUI() {
      try {
        try {
          ...
          String items[][] = { { "@car1", "Car number one", "good car" }, { "@car2", "Car number two", "great car" }, };
