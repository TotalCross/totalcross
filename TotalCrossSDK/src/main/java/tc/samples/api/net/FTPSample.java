...
import totalcross.net.FTP;
import totalcross.net.FTPConnectionClosedException;
...
public class FTPSample extends BaseContainer // TO BE FINISHED
{
  ...
  public void initUI() {
    super.initUI();
    MenuItem[] m0 = { new MenuItem("File"), new MenuItem("Help"), new MenuItem("About"), new MenuItem(),
        miTest = new MenuItem("Automatic Test"), new MenuItem(), new MenuItem("Clear log"), };
    miTest.isEnabled = false;
    MenuItem[] m1 = { new MenuItem("Parameters"), new MenuItem("URL"), new MenuItem("User"), new MenuItem("Password"),
        new MenuItem("Port"), new MenuItem(), miLogin = new MenuItem("Login"), miLogout = new MenuItem("Logout"),
        new MenuItem(), new MenuItem("Disconnect") };
