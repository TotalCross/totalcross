...
{
  Hashtable htImports;
  Vector vClassNamesSource, vClassNamesTarget, vFullClassNamesSource,
    vFullClassNamesTarget;

  String[] tofrom = {
    // target class                   , target package                      ,
    // source class                     , source package ,
    "Address",
    "totalcross.pim.palm.builtin",
    "Address",
    "superwaba.ext.palm.io.builtin",
    "AddressBook",
    "totalcross.pim.addressbook",
    "AddressBook",
    ...
    "waba.lang",
    "Packet",
    "totalcross.io.device.gps.garmin",
    "Packet",
    ...
    "waba.fx",
    "PalmAddressBook",
    "totalcross.pim.palm.builtin.pimal",
    "PalmAddressBook",
    ...
    "PocketPCAddressBook",
    "totalcross.pim.ce.builtin.pimal",
    "PocketPCAddressBook",
  ...
  private String delims =
    "abcdefghijklmnopqrtsuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ1234567890_$";
  ...
  private String processFile(String str)
  {
    ...
    for (int i = 0; i < n; i++) {
      ...
      while (true) {
        ...
        if (delims.indexOf(first) == -1 &&
            delims.indexOf(last) == -1) { // whole word?
  ...
  { // remove spaces/tabs before/after the package name
  ...
  private void setupHashtables()
  {
    ...
    htImports.put(
      ...
      "import totalcross.io.*;\r\nimport totalcross.net.*;\r\nimport totalcross.io.device.*;");
    htImports.put(
      "import superwaba.ext.xplat.webservice.*;",
    ...
    String[] sourceTarget = {
      ...
      "popupNonBlocking",
      "wasDateValid",
      "/* NO LONGER SUPPORTED wasDateValid - catch the InvalidDateException instead */",
      "getPanel",
      "getContainer",
      "setPanel",
      "setContainer",
      ...
      "createBmp",
      "createPng /* bas.count() has the # of bytes written */",
      "getChoices",
      "getControl", // CustomDialog
      "totalcross.JavaBridge.showMsgs",
      "totalcross.sys.Settings.showDesktopMessages",
      "JavaBridge.showMsgs",
      "Settings.showDesktopMessages",
      "onlyShowImage",
      "/* NO LONGER SUPPORTED: onlyShowImage - use ImageControl instead */",
      "getSelectedMenuItem",
      "getSelectedIndex",
      "saveBehind",
      "/* NO LONGER NEEDED: saveBehind*/",
      "dontSaveBehind",
      "/* NO LONGER NEEDED: dontSaveBehind*/",
      "createGraphics",
      "getGraphics",
      "setDoubleBuffer",
      "/* NO LONGER NEEDED: setDoubleBuffer*/",
      "getOffScreen",
      "/* NO LONGER SUPPORTED: getOffScreen*/",
      ".equ",
      "/*.equ*/", // c1.equ == c2.equ -> c1 == c2 (because color have only one
                  // instance per rgb)
      "Palette",
      "/* NO LONGER NEEDED: Palette - simply remove all palette manipulations */",
      "clearScreen()",
      "/* NO LONGER SUPPORTED: clearScreen - please change it to fillRect(0,0,width,height) */",
      "applyPalette",
      "/* NO LONGER SUPPORTED: applyPalette - there's a single system palette */",
      "collisionDetect",
      "/* NO LONGER SUPPORTED: collisionDetect - use a rectangle as a region instead */",
      "setDrawDots",
      "drawDots = ",
      "setCapitaliseMode",
      "capitalise = ",
      ...
      "getCharWidth",
      "charWidth",
      "totalcross.sys.Settings.setUIStyle",
      "setUIStyle",
      "Settings.setUIStyle",
      "setUIStyle",
      "Settings.useExceptions = true;",
      "//Settings. useExceptions = true;",
      "Settings.useExceptions = false;",
      "//Settings.useExceptions = false;",
      "listCatalogs",
      "listPDBs",
      "copyArray",
      ...
      "toByteArray",
      "drawCursor",
      "fillCursor", // 1. drawCursor -> fillCursor            please keep
      "drawCursorOutline",
      "drawCursor", // 2. drawCursorOutline -> drawCursor     this order!
      "PDBFile.READ_ONLY",
      "PDBFile.READ_WRITE",
      "PDBFile.WRITE_ONLY",
      "PDBFile.READ_WRITE",
      ...
      "nextFloat",
      "nextDouble",
      "Convert.toIntBitwise",
      "Convert.doubleToIntBits",
      "Convert.convertToFloat",
      "(float)Convert.convertToDouble",
      "Convert.toFloatBitwise",
      "(float)Convert.intBitsToDouble",
      "Convert.toFloat",
      ...
      "getRGB",
      "Vm.actionEqualsMenu",
      "Settings.actionInvokesMenu",
      "Vm.setTimeStamp",
      "Vm.setTime",
      "Vm.interceptSystemKeys",
      "Vm.interceptSpecialKeys /* read the javadocs */",
      "Vm.getSystemKeysPressed",
      "Vm.isKeyDown /* read the javadocs */",
      "ControlEvent.TIMER",
      "TimerEvent.TRIGGERED",
      "JOG_UP",
      "/* NO LONGER SUPPORTED: JOG_UP */",
      "JOG_DOWN",
      "/* NO LONGER SUPPORTED: JOG_DOWN */",
      "JOG_PUSH",
      "/* NO LONGER SUPPORTED: JOG_PUSH */",
      "JOG_RELEASE",
      "/* NO LONGER SUPPORTED: JOG_RELEASE */",
      "JOG_PUSHREPEAT",
      "/* NO LONGER SUPPORTED: JOG_PUSHREPEAT */",
      "JOG_PUSHUP",
      "/* NO LONGER SUPPORTED: JOG_PUSHUP */",
      "JOG_PUSHDOWN",
      "/* NO LONGER SUPPORTED: JOG_PUSHDOWN */",
      "JOG_BACK",
      "/* NO LONGER SUPPORTED: JOG_BACK */",
      ...
      "getMask()",
      "getClientRect()",
      "/* getClientRect(): replace by setRect(LEFT,TOP,FILL,FILL) */",
      "Socket.disconnect()",
      "ConnectionManager.close()",
      "Vm.TWEAK_PRINT_STACK",
      "/* NO LONGER NEEDED: Vm.TWEAK_PRINT_STACK */",
      "translateTo",
      "/* translateTo - replace by translate */",
      "uiPalm",
      "(Settings.uiStyle == Settings.PalmOS)",
      "uiCE",
      "(Settings.uiStyle == Settings.WinCE)",
      "uiVista",
      "(Settings.uiStyle == Settings.Vista)",
      "uiFlat",
      "(Settings.uiStyle == Settings.Flat)",
      "loadBehind(true)",
      "loadBehind() /*extra parameter has been removed!*/",
      "loadBehind(false)",
      "loadBehind() /*extra parameter has been removed!*/",
      "writeIntLE",
      "writeIntLE /*use DataStreamLE.writeInt instead*/",
      "writeShortLE",
      "writeShortLE /*- use DataStreamLE.writeShort instead*/",
      "readIntLE",
      "readIntLE /*- use DataStreamLE.readInt instead*/",
      "readShortLE",
      "readShortLE /*- use DataStreamLE.readShort instead*/",
      "onAdd",
      "onAddAgain",
      "onRemove",
      "onRemove",
      ...
      "getSelected",
      "getSelectedIndex",
      "ControlEvent.WINDOW_MOVED",
      "/* NO LONGER SUPPORTED: ControlEvent.WINDOW_MOVED */",
      "rand",
      "between",
      "onStart",
      "initUI",
      "Label.commonVGap",
      "/* NO LONGER NEEDED: Label.commonVGap */",
      "IntHashtable.INVALID",
      "/* NO LONGER SUPPORTED: IntHashtable.INVALID. Catch the ElementNotFoundException */",
      "enableHorizScroll",
      ...
      "getSelectedCaption",
      "getSelectedItem",
      "!totalcross.sys.Settings.onDevice",
      "totalcross.sys.Settings.onJavaSE",
      "totalcross.sys.Settings.onDevice",
      "!totalcross.sys.Settings.onJavaSE",
      "!Settings.onDevice",
      "Settings.onJavaSE",
      ...
      "setAutoOff(false)",
      "setDeviceAutoOff",
      "setAutoOff(true);// not needed",
      "isOpen",
      "/* NO LONGER SUPPORTED: isOpen - an exception is thrown if an error happens */",
      "transparentPixel",
      "transparentColor",
      "g.setForeColor",
      "g.foreColor = ",
      ...
      "fillVistaRect",
      "defaultFont",
      "/* defaultFont: use setDefaultFont or getDefaultFont */",
      "setNumberKeys",
      "setSymbolKeys",
      "Button.createArrowButton",
      "/* Button.createArrowButton - use ArrowButton class instead. */",
      "extraArrowSize",
      "/* extraArrowSize - no longer supported. size is now computed based on button's width/height */",
      "File.isAvailable()",
      "/* File.isAvailable() - no longer needed */",
      "getJulianDay",
      "getGregorianDay",
      "getRandom",
      "nextInt",
  ...
  public static void main(String args[]) { new SW2TC(args); }
}
