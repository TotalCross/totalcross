...
{
  public static Operand promoteOperand(Vector vcode,
                                       Operand opr,
                                       int toKind,
                                       int line)
  {
  ...
  public static final Instruction newInstruction(Vector vcode,
                                                 int prefix,
                                                 int line)
  {
    Instruction c = null;
                                                 ...
                                                 int line)
  {
    ...
    switch (opcode) {
      ...
      case RETURN_reg64: {
        c = new Reg(opcode, line);
        OperandReg r =
          OperandKind.isTypeL(opr.kind)
            ? (OperandReg)promoteOperand(vcode, opr, opr_regL, line)
  ...
  newInstruction(Vector vcode, int prefix, Operand opr1, Operand opr2, int line)
  {
    ...
    switch (opcode) {
      ...
      case CHECKCAST: {
        ...
        OperandRegO s1 =
          (OperandRegO)promoteOperand(vcode, opr1, opr_regO, line);
      ...
      case MOV_reg64_reg64: {
        c = new Reg_reg(opcode, line);
        OperandReg op =
          OperandKind.isTypeL(opr2.kind)
            ? (OperandReg)promoteOperand(vcode, opr2, opr_regL, line)
      ...
      case MOV_arc_reg16: {
        c = new Reg_ar(opcode, line);
        OperandReg s2 =
          (OperandReg)promoteOperand(vcode, opr2, opr_reg16, line);
      ...
      case MOV_arc_regIb: {
        c = new Reg_ar(opcode, line);
        OperandReg s2 =
          (OperandReg)promoteOperand(vcode, opr2, opr_regIb, line);
        GEN_REG_AR(c, s2, opr1);
        break;
      }
                                                 ...
                                                 int line)
  {
    ...
    switch (opcode) {
      case INSTANCEOF: {
        c = new Instanceof(opcode, line);
        OperandRegO s2 =
          (OperandRegO)promoteOperand(vcode, opr2, opr_regO, line);
      ...
      case ADD_regI_s12_regI: {
        ...
        if (s1.index == s2.index &&
            OperandKind.isConstantFitIn16Bits(opr3.kind)) {
      ...
      case JNE_regI_sym: {
        ...
        /*}
              else
              {
                 ...
                 OperandReg s1 = (OperandReg) promoteOperand(vcode, opr1,
           opr_regI, line); OperandSym s2 = (OperandSym) promoteOperand(vcode,
           opr2, opr_symI, line); GEN_REG_SYM_DESLOC(c, s1, s2, opr3);
              } */
        break;
      }
  ...
  public static final void newInstruction(Vector vcode,
                                          int defAddr,
                                          Operand k,
                                          BC171_lookupswitch ji,
                                          int line)
  {
  ...
  public static void GEN_REG_REG_REG(Instruction c,
                                     Operand opr1,
                                     Operand opr2,
                                     Operand opr3)
  {
  ...
  public static void GEN_REG_REG_S12(Instruction c,
                                     Operand opr1,
                                     Operand opr2,
                                     Operand opr3)
  {
  ...
  public static void GEN_REG_S6_DESLOC(Instruction c,
                                       Operand opr1,
                                       Operand opr2,
                                       Operand opr3)
  {
  ...
  public static void GEN_REG_SYM_DESLOC(Instruction c,
                                        Operand opr1,
                                        Operand opr2,
                                        Operand opr3)
  {
  ...
  public static void GEN_REG_ARL_S12(Instruction c,
                                     Operand opr1,
                                     Operand opr2,
                                     Operand opr3)
  {
  ...
  public static void GEN_REG_REG_SYM(Instruction c,
                                     Operand opr1,
                                     Operand opr2,
                                     Operand opr3)
  {
  ...
  public static void GEN_NEWARRAY(Instruction c,
                                  Operand opr1,
                                  Operand opr2,
                                  int lenOrRegIOrDims)
  {
  ...
  public static void GEN_CALL(Vector vcode,
                              Instruction c,
                              OperandSym sym,
                              OperandReg _this,
                              Operand retAndParams[],
  ...
  public static void GEN_INSTANCEOF(Instruction c,
                                    Operand opr1,
                                    Operand opr2,
                                    Operand opr3)
  {
  ...
  public static void GEN_SWITCH(Vector vcode,
                                Switch_reg sswitch,
                                int defAddr,
                                BC171_lookupswitch ji,
                                int line)
