...
public final class TCMethod implements TCConstants
{
  ...
  public void write(DataStreamLE ds) throws totalcross.io.IOException
  {
    ...
    if (tc.tools.converter.J2TC.dump)
    {
      ...
      if (iCount >= 64 || oCount >= 64 || v64Count >= 64){
        System.err.println("Warning: "+tcclass.className+"."+GlobalConstantPool.getMethodFieldName(cpName)+" has reached 64 registers. i="+iCount+",o="+oCount+",v64="+v64Count);
      }
