...
public final class TCClass
{
  ...
  // Object
  public int /*uint32*/ objOfs,
    v64Ofs; // there's no i32Ofs because int32's offset is always 0
  // The default instance field values. Used in object creation. The length is
  // the instance size, excluding TObjectProperties
  public byte[] /*Uint8Array*/ defaultInstanceValues;
  // A string representing this class.
  public String className;
  // A string representing the file name where this class was declared (.java,
  // not .class) - NOT STORED IN THE CONSTANT POOL!
  public String sourceFile;
  // The access flags of this class (e.g.: if this class is public, static, etc)
  public TCClassFlags flags = new TCClassFlags();
  // The fields that will be copied into each instance (an Object) of this
  // class.
  ...
  // The interfaces that this class implements  *** guich - for the compiler, it
  // is important to load and compile the class; but for the converter, its not
  // (unless method inline is implemented)
  public /*TCClass*/ String[] interfaces;
  // The superclass of this class. The only class that has a null superClass is
  // java.lang.Object
  public /*TCClass*/ String superClass; // *** idem
  // Number of active instances of this class - will be used later to create a
  // way to release memory in crucial situations
  ...
  public void write(DataStreamLE ds) throws totalcross.io.IOException
  {
    ...
    int i;
    int int32StaticFieldsCount =
      int32StaticFields != null ? int32StaticFields.length : 0;
    int objectStaticFieldsCount =
      objectStaticFields != null ? objectStaticFields.length : 0;
    int value64StaticFieldsCount =
      value64StaticFields != null ? value64StaticFields.length : 0;
    int int32InstanceFieldsCount =
      int32InstanceFields != null ? int32InstanceFields.length : 0;
    int objectInstanceFieldsCount =
      objectInstanceFields != null ? objectInstanceFields.length : 0;
    int value64InstanceFieldsCount =
      value64InstanceFields != null ? value64InstanceFields.length : 0;
    ...
    ds.writeShort(
      superClass != null ? GlobalConstantPool.getClassIndex(superClass) : 0);
