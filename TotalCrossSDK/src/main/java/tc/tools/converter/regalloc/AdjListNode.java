...
public class AdjListNode
{
  ...
  public void addInterf(int interf) { adjs.on(interf); }

  public void removeInterf(int interf) { adjs.off(interf); }

  public void addRemovedAdjs(int n) { removedAdjs.on(n); }
  ...
  public int nInts() { return adjs.count(); }
}
