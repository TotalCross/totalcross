...
public class Instruction implements TCConstants {
	...
	public void virtualRegs2PhysicalRegs(AdjListNode[] adjListI, AdjListNode[] adjListD,
		...
		switch (op) {
			...
			default: {
				throw new ConverterException("Instruction.virtualRegs2PhysicalRegs -> Opcode " + op +
