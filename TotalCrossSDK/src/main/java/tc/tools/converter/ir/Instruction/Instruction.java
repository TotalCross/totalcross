...
{
  public int len =
    1; // method, switch and newarray_multi parameters must have len=0
  ...
  public BitSet[] defsAndUses(BasicBlock bb, int iCount, int dCount, int oCount)
  {
    ...
    switch (op) {
      ...
      default: {
        throw new ConverterException("Instruction.defsAndUses -> Opcode " + op +
  ...
  public void virtualRegs2PhysicalRegs(AdjListNode[] adjListI,
    ...
    switch (op) {
      ...
      default: {
        throw new ConverterException(
          "Instruction.virtualRegs2PhysicalRegs -> Opcode " + op +
          " is not being handled.");
        // case ADD_regI_arc_s6:
        // case ADD_regI_aru_s6:
        // case ADD_aru_regI_s6:
