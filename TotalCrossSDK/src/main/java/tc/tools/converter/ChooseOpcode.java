...
/*
 * Implementation of functions for selection of opcodes for the virtual machine
 * instructions.
 *
 * If a function returns negative value, means that the caller needs to make an
 * swap between the operands. For example, if function chooseOpcodeMul is
 * called, and its parameters, src1 and src2, are a constant value of 12 bits
 * and an int register, respectively, then ( - MUL_regI_regI_s12) is returned.
 * In the multiplication, first the register, then the constant. The caller
 * knows that will be necessary swap src1 and src2, and then change the signal
 * of the returned value to get correct opcode.
 *
 * If a function returns positive value, this already is the opcode selected.
 *
 * The caller also cannot forget to make the adequacy of the operands of the
 * call to the selected operands (defined in opcode). For example:
 *
 * Example 1:
 * Operands of the call: MUL OPR_regI, OPR_regI, OPR_s24 // regI = regI * s24;
 * s24 is a signed constant of 24 bits. Opcode selected: MUL_regI_regI_regI The
 * caller must move s24 to regI.
 *
 * Example 2:
 * Operands of the call: MUL OPR_regI, OPR_regI, OPR_symI // regI = regI * symI;
 * symI is in the constant pool. Opcode selected: MUL_regI_regI_regI The caller
 * must move symI to regI.
 *
 * Example 3:
...
public class ChooseOpcode implements TCConstants
{
  ...
  /// MOV /////////////////////
  ///////////////////////////////////////////////////////////////////////////////////////////////////////
  //   Given operands target and src (source) of a MOV operation, choose and
  //   return the opcode. target and src are one of opr_XXX in TCConstants.java
  ...
  //////////////////////////////////////////////////////////////////////////////////////////////////
  /////
  //   Given operands target and src (source) of a CONV operation, choose and
  //   return the opcode.
  ...
  //////////////////////////////////////////////////////////////////////////////////////////////////
  /////
  //   Given operands target and sources (src1 and src2) of an ADD operation,
  //   choose and return the opcode.
  ...
  //////////////////////////////////////////////////////////////////////////////////////////////////
  /////
  //   Given operands target and sources (src1 and src2) of an SUB operation,
  //   choose and return the opcode.
    ...
    switch (target) {
      ...
      case opr_regI: {
        ...
        if (src1 == opr_s6I || src1 == opr_s12I) {
          ...
          // if (src2 == opr_s6 || src2 == opr_s12)  return _SUB_regI_regI_s12;
          // //special opcode
        }
  ...
  //   Given operands target and sources (src1 and src2) of an MUL operation,
  //   choose and return the opcode.
  ...
  ////////////////////////////////////////////////////////////////////////////////////////////////////
  ////////////////////////////////////////////////////////////////////////////////////////////////////
  ///////////// USHR USHR USHR USHR USHR USHR USHR USHR USHR USHR USHR USHR USHR
  /// USHR USHR ///////////
  ////////////////////////////////////////////////////////////////////////////////////////////////////
  ...
  private static int shift(int prefix, int target, int src1, int src2)
  {
    switch (target) {
      case opr_regI: {
        if (src2 == opr_s6I || src2 == opr_s12I) {
          return (prefix == pref_SHL ? SHL_regI_regI_s12
                                     : prefix == pref_SHR ? SHR_regI_regI_s12
                                                          : USHR_regI_regI_s12);
        }

        return (prefix == pref_SHL ? SHL_regI_regI_regI
                                   : prefix == pref_SHR ? SHR_regI_regI_regI
                                                        : USHR_regI_regI_regI);
      }
      case opr_regL: {
        return (prefix == pref_SHL ? SHL_regL_regL_regL
                                   : prefix == pref_SHR ? SHR_regL_regL_regL
                                                        : USHR_regL_regL_regL);
      }
      default:;
    }
  ...
  //////////////////////////////////////////////////////////////////////////////////////////////////
  /////
  //   Given operands target and sources (src1 and src2) of an AND operation,
  //   choose and return the opcode.
  ...
  private static int or_xor(int prefix, int target, int src1, int src2)
  {
    switch (target) {
      case opr_regI: {
        ...
        if (src1 == opr_s6I || src1 == opr_s12I) {
          return (prefix == pref_OR ? (-OR_regI_regI_s12)
                                    : (-XOR_regI_regI_s12));
        }
  ...
  //////////////////////////////////////////////////////////////////////////////////////////////////
  /////
  //////////////////    JLE JLE JLE JLE JLE JLE JLE JLE JLE JLE JLE JLE JLE JLE
  /// JLE /////////////////////
  //////////////////////////////////////////////////////////////////////////////////////////////////
  /////
  ...
  //////////////////////////////////////////////////////////////////////////////////////////////////
  /////
  //////////////////    JGE JGE JGE JGE JGE JGE JGE JGE JGE JGE JGE JGE JGE JGE
  /// JGE /////////////////////
  //////////////////////////////////////////////////////////////////////////////////////////////////
  /////
  ...
  ///////////////////////////////////////////////////////////////////////////////////////////////////////
  //////////////////    JEQ JEQ JEQ JEQ JEQ JEQ JEQ JEQ JEQ JEQ JEQ JEQ JEQ JEQ
  /// JEQ /////////////////////
  ///////////////////////////////////////////////////////////////////////////////////////////////////////
  ///////////////////////////////////////////////////////////////////////////////////////////////////////
  //////////////////    JNE JNE JNE JNE JNE JNE JNE JNE JNE JNE JNE JNE JNE JNE
  /// JNE /////////////////////
  ///////////////////////////////////////////////////////////////////////////////////////////////////////
  ...
  //////////////////////////////////////////////////////////////////////////////////////////////////
  /////
  //////////////////    JLT JLT JLT JLT JLT JLT JLT JLT JLT JLT JLT JLT JLT JLT
  /// JLT /////////////////////
  //////////////////////////////////////////////////////////////////////////////////////////////////
  /////
  //////////////////////////////////////////////////////////////////////////////////////////////////
  /////
  //////////////////    JGT JGT JGT JGT JGT JGT JGT JGT JGT JGT JGT JGT JGT JGT
  /// JGT /////////////////////
  //////////////////////////////////////////////////////////////////////////////////////////////////
  /////
  ...
  //   Given target and source operands of a RETURN operation, choose and return
  //   the opcode.
