...
public final class JavaMethod {
	...
	public boolean isPublic, isPrivate, isProtected, isStatic, isFinal, isVolatile, isTransient,
		   isNative, isAbstract,
	...
	public static String[] splitParams(String s, StringBuffer
									   ret) { // return the parameters array and the return type in the string buffer
		Vector v = vec;
		v.removeAllElements();
		ret.setLength(0);
		int n = s.length();
	...
	public JavaMethod(JavaClass jc, DataStream ds,
					  JavaConstantPool cp) throws totalcross.io.IOException {
	...
	public JavaMethod parse(JavaClass jc, DataStream ds,
							JavaConstantPool cp) throws totalcross.io.IOException {
