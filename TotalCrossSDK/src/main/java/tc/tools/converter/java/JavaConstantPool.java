  ...
  public JavaConstantPool(DataStream ds) throws totalcross.io.IOException
  {
    ...
    if (numConstants > 0) {
      ...
      for (int i = 1; i < numConstants; i++) {
        ...
        // guich@400_16: moved to here since now we compute other things; also,
        // ordered and inserted blank cases to let the compiler optimize it to a
        // jump table
        {
          ...
          case 12: // name and type
            constants[i] = new JavaConstantInfo(
              b, ds.readUnsignedShort(), ds.readUnsignedShort());
            break;
        }
      }
    }
