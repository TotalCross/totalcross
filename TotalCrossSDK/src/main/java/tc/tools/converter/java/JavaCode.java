...
public final class JavaCode implements JConstants {
	...
	public JavaCode(JavaMethod method, DataStream ds,
		...
		if (n > 0) {
			...
			ByteCode[] tempBcs = new
			ByteCode[n]; // we don't know how many bytecodes will exist, but surely not more than the number of bytes in this method
