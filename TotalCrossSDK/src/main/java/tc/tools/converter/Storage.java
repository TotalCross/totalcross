...
public final class Storage {
	...
	public static void readAndDecompress(Stream dsIn, ByteArrayStream bufOut,
	...
	public static int writeUnsignedShortArray(DataStreamLE ds,
			int[] out) throws totalcross.io.IOException {
