...
public class JavaClass implements JavaClassStructure
{
  ...
  @Override public String toString() { return getClassName(); }
  ...
  public JavaConstant getConstant(byte index1,
                                  byte index2,
                                  JavaClassStructure caller)
    throws IndexOutOfBoundsException
  {
    return getConstant((((int)index1 << 8) & 0xFF00) | ((int)index2 & 0xFF),
                       caller);
  }

  public JavaConstant getConstant(int index, JavaClassStructure caller)
    throws IndexOutOfBoundsException
  {
    if (index <= 0 || index > constantPool.size()) {
      throw new IndexOutOfBoundsException(
        "Invalid constant pool index: " + index + "; class: " + this +
        ", caller: " + caller);
    }
  ...
  public int getConstantIndex(JavaConstant constant, JavaClassStructure caller)
    throws IndexOutOfBoundsException
  {
