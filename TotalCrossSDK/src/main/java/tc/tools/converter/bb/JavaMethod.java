...
public class JavaMethod implements JavaClassStructure
{
  ...
  public String getName() { return ((UTF8)name.info).value; }

  public String getDescriptor() { return ((UTF8)descriptor.info).value; }
  ...
  public boolean isPublic() { return (accessFlags & ACC_PUBLIC) == ACC_PUBLIC; }
  ...
  public boolean isStatic() { return (accessFlags & ACC_STATIC) == ACC_STATIC; }

  public boolean isFinal() { return (accessFlags & ACC_FINAL) == ACC_FINAL; }
  ...
  public boolean isNative() { return (accessFlags & ACC_NATIVE) == ACC_NATIVE; }
  ...
  public boolean isStrict() { return (accessFlags & ACC_STRICT) == ACC_STRICT; }
