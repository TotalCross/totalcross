...
public class LocalVariableTable implements AttributeInfo
{
  ...
  @Override public int length() { return 2 + (variables.size() * 10); }
  ...
  public static class LocalVariable implements JavaClassStructure
  {
    ...
    public LocalVariable(LocalVariableTable table) { this.table = table; }

    @Override public int length() { return 10; }
