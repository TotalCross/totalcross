...
public class LineNumberTable implements AttributeInfo
{
  ...
  public LineNumberTable() { lineNumbers = new Vector(); }

  @Override public int length() { return 2 + (lineNumbers.size() * 4); }
  ...
  public static class LineNumber
  {
    ...
    public LineNumber(LineNumberTable table) { this.table = table; }
