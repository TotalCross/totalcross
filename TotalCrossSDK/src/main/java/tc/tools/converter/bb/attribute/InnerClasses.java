...
public class InnerClasses implements AttributeInfo
{
  ...
  @Override public int length() { return 2 + (classes.size() * 8); }
  ...
  public class Classes implements JavaClassStructure
  {
    ...
    {
      ds.writeShort(
        innerClass == null ? 0 : jclass.getConstantIndex(innerClass, this));
      ds.writeShort(
        outerClass == null ? 0 : jclass.getConstantIndex(outerClass, this));
      ds.writeShort(
        innerName == null
          ? 0
          : innerName == null ? 0 : jclass.getConstantIndex(innerName, this));
