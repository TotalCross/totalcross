...
public class JavaConstant implements JavaClassStructure
{
   ...
   * @param jclass
   */
  public JavaConstant(JavaClass jclass) { this.jclass = jclass; }

  @Override public java.lang.String toString() { return info.toString(); }

  @Override public int length() { return 1 + info.length(); }
  ...
  public static JavaConstant createConstant(JavaClass jclass,
                                            byte tag,
                                            Object value1,
                                            Object value2)
  {
  ...
  private static JavaConstant searchConstant(JavaClass jclass,
                                             byte tag,
                                             Object value1,
                                             Object value2)
  {
      ...
      if (constant.tag == tag) {
        ...
        switch (tag) {
          case CONSTANT_UTF8:
            ...
            break;
          case CONSTANT_INTEGER:
            result = ((Integer)constant.info).value ==
                     ((java.lang.Integer)value1).intValue();
            break;
          case CONSTANT_FLOAT:
            result = ((Float)constant.info).value ==
                     ((java.lang.Float)value1).floatValue();
            break;
          case CONSTANT_LONG:
            result = ((Long)constant.info).value ==
                     ((java.lang.Long)value1).longValue();
            break;
          case CONSTANT_DOUBLE:
            result = ((Double)constant.info).value ==
                     ((java.lang.Double)value1).doubleValue();
            break;
          case CONSTANT_CLASS:
          ...
          case CONSTANT_STRING:
            ...
            break;
          case CONSTANT_FIELD_REF:
            result = ((FieldRef)constant.info).value1.equals(value1) &&
                     ((FieldRef)constant.info).value2.equals(value2);
            break;
          case CONSTANT_METHOD_REF:
          ...
          case CONSTANT_INTERFACE_METHOD_REF:
            result =
              ((InterfaceMethodRef)constant.info).value1.equals(value1) &&
