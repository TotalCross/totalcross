...
{
  public BC093_dup2_x1() { super(2, true); }
  ...
  @Override public void exec()
  {
    /*
       ...
       value1 where value1, value2, and value3 are all values of a category 1
       computational type (§3.11.1). Form 2:
         ..., value2, value1  ..., value1, value2, value1
         where value1 is a value of a category 2 computational type and value2
