...
public class Deployer4LinuxArm {
	...
	public Deployer4LinuxArm() throws Exception {
		String linuxArguments =
			DeploySettings.commandLine; // the name of the tcz will be the same as the executable
		...
		if (DeploySettings.mainClassName != null) {
			...
			FileUtils.copyFileToDirectory(new java.io.File(DeploySettings.folderTotalCross3DistVM +
