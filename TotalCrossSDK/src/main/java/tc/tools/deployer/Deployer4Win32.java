...
public class Deployer4Win32 {
  ...
  public Deployer4Win32() throws Exception {
    ...
    if (DeploySettings.mainClassName != null) {
      ...
      FileUtils.copyFileToDirectory(new java.io.File(DeploySettings.folderTotalCross3DistVM + "TCBase.tcz"),
          new java.io.File(targetDir));
      FileUtils.copyFileToDirectory(new java.io.File(DeploySettings.folderTotalCross3DistVM + "TCFont.tcz"),
          new java.io.File(targetDir));
      FileUtils.copyFileToDirectory(new java.io.File(DeploySettings.folderTotalCross3DistVM + "TCUI.tcz"),
          new java.io.File(targetDir));
