...
public class ElephantMemoryWriter implements ElephantMemoryStream
{
  ...
  public ElephantMemoryWriter() { this(512); }

  public ElephantMemoryWriter(int size) { this(new byte[size]); }

  public ElephantMemoryWriter(byte[] data) { buffer = data; }
  ...
  public void write(byte value) { this.write(new byte[] { value }); }
  ...
  @Override public void moveBack() { this.pos = positions.pop(); }

  @Override public int getPos() { return pos; }

  @Override public void moveTo(int newPosition) { pos = newPosition; }

  public void moveTo(long newPosition) { pos = (int)newPosition; }

  @Override public void memorize() { positions.push(this.pos); }

  public int size() { return pos == 0 ? buffer.length : pos; }
