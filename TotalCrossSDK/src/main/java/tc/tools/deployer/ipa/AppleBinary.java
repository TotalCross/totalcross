...
public abstract class AppleBinary {
	...
	public static AppleBinary create(byte[] data) throws IOException, InstantiationException,
	...
	abstract public byte[] resign(KeyStore ks, X509Store certStore, String bundleIdentifier,
								  byte[] entitlementsBytes,
								  byte[] info, byte[] sourceData) throws IOException, CMSException, UnrecoverableKeyException,
		CertificateEncodingException, KeyStoreException, NoSuchAlgorithmException,
