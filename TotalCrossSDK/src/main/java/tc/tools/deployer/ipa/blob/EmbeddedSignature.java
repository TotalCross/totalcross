...
public class EmbeddedSignature extends SuperBlob
{
  ...
  public EmbeddedSignature() { super(CSMAGIC_EMBEDDED_SIGNATURE); }

  public EmbeddedSignature(CodeDirectory codeDirectory,
                           Entitlements entitlements,
                           Requirements requirements,
                           BlobWrapper blobWrapper)
  {
  ...
  @Override public void add(BlobIndex blobIndex)
  {
  ...
  public void sign() throws IOException, CMSException { blobWrapper.sign(); }
}
