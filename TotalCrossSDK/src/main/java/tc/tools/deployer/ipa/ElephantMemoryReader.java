...
public class ElephantMemoryReader
  extends ByteArrayInputStream implements ElephantMemoryStream
{
  Stack<Integer> positions = new Stack<Integer>();

  public ElephantMemoryReader(byte[] data) { super(data); }
  ...
  @Override public void moveTo(int newPosition)
  {
    reset();
    skip(newPosition);
  }
  ...
  @Override public int getPos() { return this.pos; }
}
