...
public class FatBinaryEntry {
	...
	public void resign(ElephantMemoryWriter writer, KeyStore ks, X509Store certStore,
	...
	throws UnrecoverableKeyException, CertificateEncodingException, KeyStoreException,
		...
		byte[] resignedFile = file.resign(ks, certStore, bundleIdentifier, entitlementsBytes, info,
										  sourceData);
