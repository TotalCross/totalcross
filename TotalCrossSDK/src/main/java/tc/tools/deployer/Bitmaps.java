...
public class Bitmaps
{
  static int palette256[] = {
    ...
    0xFF33FF, 0xFF00FF, 0xFFFFCC, 0xFFCCCC, // 0-7
    0xFF99CC, 0xFF66CC, 0xFF33CC, 0xFF00CC,
    0xFFFF99, 0xFFCC99, 0xFF9999, 0xFF6699, // 8-16
    0xFF3399, 0xFF0099, 0xCCFFFF, 0xCCCCFF,
    0xCC99FF, 0xCC66FF, 0xCC33FF, 0xCC00FF, // 16-23
    0xCCFFCC, 0xCCCCCC, 0xCC99CC, 0xCC66CC,
    0xCC33CC, 0xCC00CC, 0xCCFF99, 0xCCCC99, // 24-31
    0xCC9999, 0xCC6699, 0xCC3399, 0xCC0099,
    0x99FFFF, 0x99CCFF, 0x9999FF, 0x9966FF, // 32-39
    0x9933FF, 0x9900FF, 0x99FFCC, 0x99CCCC,
    0x9999CC, 0x9966CC, 0x9933CC, 0x9900CC, // 40-47
    0x99FF99, 0x99CC99, 0x999999, 0x996699,
    0x993399, 0x990099, 0x66FFFF, 0x66CCFF, // 48-55
    0x6699FF, 0x6666FF, 0x6633FF, 0x6600FF,
    0x66FFCC, 0x66CCCC, 0x6699CC, 0x6666CC, // 56-63
    0x6633CC, 0x6600CC, 0x66FF99, 0x66CC99,
    0x669999, 0x666699, 0x663399, 0x660099, // 64-71
    0x33FFFF, 0x33CCFF, 0x3399FF, 0x3366FF,
    0x3333FF, 0x3300FF, 0x33FFCC, 0x33CCCC, // 72-79
    0x3399CC, 0x3366CC, 0x3333CC, 0x3300CC,
    0x33FF99, 0x33CC99, 0x339999, 0x336699, // 80-87
    0x333399, 0x330099, 0x00FFFF, 0x00CCFF,
    0x0099FF, 0x0066FF, 0x0033FF, 0x0000FF, // 88-95
    0x00FFCC, 0x00CCCC, 0x0099CC, 0x0066CC,
    0x0033CC, 0x0000CC, 0x00FF99, 0x00CC99, // 96-103
    0x009999, 0x006699, 0x003399, 0x000099,
    0xFFFF66, 0xFFCC66, 0xFF9966, 0xFF6666, // 104-111
    0xFF3366, 0xFF0066, 0xFFFF33, 0xFFCC33,
    0xFF9933, 0xFF6633, 0xFF3333, 0xFF0033, // 112-119
    0xFFFF00, 0xFFCC00, 0xFF9900, 0xFF6600,
    0xFF3300, 0xFF0000, 0xCCFF66, 0xCCCC66, // 120-127
    0xCC9966, 0xCC6666, 0xCC3366, 0xCC0066,
    0xCCFF33, 0xCCCC33, 0xCC9933, 0xCC6633, // 128-135
    0xCC3333, 0xCC0033, 0xCCFF00, 0xCCCC00,
    0xCC9900, 0xCC6600, 0xCC3300, 0xCC0000, // 136-143
    0x99FF66, 0x99CC66, 0x999966, 0x996666,
    0x993366, 0x990066, 0x99FF33, 0x99CC33, // 144-151
    0x999933, 0x996633, 0x993333, 0x990033,
    0x99FF00, 0x99CC00, 0x999900, 0x996600, // 152-159
    0x993300, 0x990000, 0x66FF66, 0x66CC66,
    0x669966, 0x666666, 0x663366, 0x660066, // 160-167
    0x66FF33, 0x66CC33, 0x669933, 0x666633,
    0x663333, 0x660033, 0x66FF00, 0x66CC00, // 168-175
    0x669900, 0x666600, 0x663300, 0x660000,
    0x33FF66, 0x33CC66, 0x339966, 0x336666, // 176-183
    0x333366, 0x330066, 0x33FF33, 0x33CC33,
    0x339933, 0x336633, 0x333333, 0x330033, // 184-191
    0x33FF00, 0x33CC00, 0x339900, 0x336600,
    0x333300, 0x330000, 0x00FF66, 0x00CC66, // 192-199
    0x009966, 0x006666, 0x003366, 0x000066,
    0x00FF33, 0x00CC33, 0x009933, 0x006633, // 200-207
    0x003333, 0x000033, 0x00FF00, 0x00CC00,
    0x009900, 0x006600, 0x003300, 0x111111, // 208-215
    0x222222, 0x444444, 0x555555, 0x777777,
    0x888888, 0xAAAAAA, 0xBBBBBB, 0xDDDDDD, // 216-223
    0xEEEEEE, 0xC0C0C0, 0x800000, 0x800080,
    0x008000, 0x008080, 0x000000, 0x000000, // 224-231
    0x000000, 0x000000, 0x000000, 0x000000,
    0x000000, 0x000000, 0x000000, 0x000000, // 232-239
    0x000000, 0x000000, 0x000000, 0x000000,
    0x000000, 0x000000, 0x000000, 0x000000, // 240-247
    0x000000, 0x000000, 0x000000, 0x000000,
    0x000000, 0x000000, 0x000000, 0x060003 // 248-255
  };

  String prefix;

  public Bitmaps(String prefix) throws Exception
  { // guich@330_48: added a prefix
    this.prefix = prefix;
  ...
  public class Bmp
  {
    ...
    public Bmp(int w, int h) throws ImageException, IOException
    {
      ...
      // the sized image is 24bpp. create the palette, reading all pixels in the
      // image;
      ...
      for (int y = 0; y < h; y++) {
        for (int x = 0; x < w; x++) {
          pixels[(invertY ? (h - y - 1) : y) * realW + x] =
            (byte)findExact(palette256, pix[x][y]);
        }
      }
    }
    ...
    public Bmp(byte[] bytes)
    {
      ...
      /* guich@340 notes:
            An icon differs from a bmp in another way: the icon has a mask at
         the end of the file. Also, the height is doubled (for a 32x32 icon, the
      ...
      offset += 2;
      if (bitsPerPixel > 8) {
        throw new IllegalArgumentException("Bitmaps " + width + "x" +
                                           (height / 2) + " cannot be 24bpp!");
      }
      compression = readInt(offset);
      offset += 4;
      if (compression != 0) {
        new Exception(
          "The bitmap used to create icons can't be compressed (RLE)!");
      }
      imageSize = readInt(offset);
      offset += 4;
      if (imageSize == 0) { // fdiebolt@341_12: if image size is not defined,
      ...
      if (palette[0] == 0xFFFFFF && width != 22 && width != 15 && width != 30 &&
          width != 44 && width != 20) {
        System.out.println(
          "This image won't appear correct in WinCE. Palette index 0 must be black (it is white): " +
          width + "x" + (height >> 1) + "x" + bitsPerPixel +
          ". Please read the instructions.");
      }

      // Utils.println(""+width+'x'+height+'x'+bitsPerPixel+"
      // ("+totalcross.sys.Convert.unsigned2hex(imageSize,4)+")");
    }

    private int readInt(int offset)
    {
      return (((wholeImage[offset + 3] & 0xFF) << 24) |
              ((wholeImage[offset + 2] & 0xFF) << 16) |
              ((wholeImage[offset + 1] & 0xFF) << 8) |
              (wholeImage[offset + 0] & 0xFF));
    }

    private short readShort(int offset)
    {
      return (short)(((wholeImage[offset + 1] & 0xFF) << 8) |
                     (wholeImage[offset] & 0xFF));
    }
  }
  ...
  /**
   * Returns the exact index for the matching color in the given palette, or -1
   * if not found
   */
   ...
   *  If maskOffset != -1, the mask is created and stored in that location (the
   * most bright pixel is used as background - usually, white)
   */
  private void copyBits(byte[] src,
                        int[] paletteFrom,
                        int[] paletteTo,
                        int srcWidthInBytes,
                        byte[] dest,
                        int destOffset,
                        int destWidthInBytes,
                        int rows,
                        int bpp,
                        int maskOffset,
                        boolean inverseMask,
                        boolean shouldInvertY)
  { // TODO use the maskOffset in
    ...
    if (maskOffset != -1) {
      conv = inverseMask ? new int[] { 1, 2, 4, 8, 16, 32, 64, 128 }
                         : new int[] {
                             128, 64, 32, 16, 8, 4, 2, 1
                           }; // epoc uses the inverse mask
  ...
  public void saveWinCEIcons(byte[] bytes,
                             int bitmap16x16x8_Offset,
                             int bitmap32x32x8_Offset,
                             int bitmap48x48x8_Offset)
    throws ImageException, IOException
  {
    ...
    if (bmp16x16x8 != null && bitmap16x16x8_Offset != -1) {
      copyBits(bmp16x16x8.pixels,
               bmp16x16x8.palette,
               loadPalette(bytes, bitmap16x16x8_Offset + 40, 256),
               16,
               bytes,
               bitmap16x16x8_Offset + 40 + 1024,
               16,
               -16,
               8,
               bitmap16x16x8_Offset + 16 * 16 + 40 + 1024,
               false,
               bmp16x16x8.shouldInvertY);
    }
    if (bmp32x32x8 != null && bitmap32x32x8_Offset != -1) {
      copyBits(bmp32x32x8.pixels,
               bmp32x32x8.palette,
               loadPalette(bytes, bitmap32x32x8_Offset + 40, 256),
               32,
               bytes,
               bitmap32x32x8_Offset + 40 + 1024,
               32,
               -32,
               8,
               bitmap32x32x8_Offset + 32 * 32 + 40 + 1024,
               false,
               bmp32x32x8.shouldInvertY);
    }
    if (bmp48x48x8 != null && bitmap48x48x8_Offset != -1) {
      copyBits(bmp48x48x8.pixels,
               bmp48x48x8.palette,
               loadPalette(bytes, bitmap48x48x8_Offset + 40, 256),
               48,
               bytes,
               bitmap48x48x8_Offset + 40 + 1024,
               48,
               -48,
               8,
               bitmap48x48x8_Offset + 48 * 48 + 40 + 1024,
               false,
    ...
    throws ImageException, IOException
  {
    ...
    if (bmp32x32x8 != null && iconOffset != -1) {
      copyBits(bmp32x32x8.pixels,
               bmp32x32x8.palette,
               loadPalette(bytes, iconOffset + 40, 256),
               32,
               bytes,
               iconOffset + 40 + 1024,
               32,
               -32,
               8,
               iconOffset + 32 * 32 + 40 + 1024,
               false,
               bmp32x32x8.shouldInvertY);
    }
  }

  public void saveAndroidIcon(OutputStream zos, int res) throws Exception
  { // icon.png
  ...
  static class Image4iOS
  {
    ...
    public byte[] getImage()
    {
      byte[] b = null;
      try {
        Image img = width == height ? IconStore.getSquareIcon(width)
                                    : IconStore.getSplashImage(width, height);
...
class IconStore extends Hashtable
{
  ...
  private IconStore() throws IOException
  {
    ...
    if (DeploySettings.classPath != null &&
        DeploySettings.classPath.length > 0) {
  ...
  public static Bmp getBmp(int width, int height, int bpp)
    throws IOException, ImageException
  {
    byte[] b =
      (byte[])getInstance().get(width + "x" + Math.abs(height) + "x" + bpp);
    return b != null ? DeploySettings.bitmaps.new Bmp(b)
                     : DeploySettings.bitmaps.new Bmp(width, height);
  }

  public static Image getSplashImage(int width, int height)
    throws ImageException, IOException
  {
    Image img;
    ...
    if (img.getHeight() != height || img.getWidth() != width) {
      throw new ImageException("splash" + img.getHeight() + "x" +
                               img.getWidth() + " must be " + width + "x" +
                               height);
    }
    return img;
  }
  ...
  public static Image getSquareIcon(int size) throws ImageException, IOException
  {
    ...
    if (img.getHeight() != size || img.getWidth() != size) {
      throw new ImageException("icon" + img.getHeight() + "x" + img.getWidth() +
                               " must be " + size + "x" + size);
    }
    return img;
  }

  public static Image getIcon(int width, int height)
    throws ImageException, IOException
  {
    Image img;
    IconStore store = getInstance();
      ...
      if (files != null) {
        for (int i = files.length - 1; i >= 0; i--) {
          ...
          if (file.endsWith("appicon.gif")) {
            System.out.println(
              "*** Warning: appicon.gif is deprecated. Convert it to a 256x256 png with transparency");
            name = "appicon";
