...
public class LinuxBuildNatives {
	...
	public static void main(String args[]) throws Exception {
		...
		createLinuxPackage(name, category, description, location, url, version, maintainer, binFile,
						   targetDir, vFiles);
	...
	public static void createLinuxPackage(String name, String category, String description,
										  String location, String url,
										  String version, String maintainer, String binFile, String targetDir,
