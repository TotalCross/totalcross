...
public class Help extends MainWindow {
  ...
  class DepContainer extends ScrollContainer {
    ...
    public void initUI() {
      ...
      b2.add(wp8 = new Check("Win Phone 8"), LEFT + 50, AFTER + 25);
      wp8.appId = 2;
      tip(wp8, "Deploys for Windows Phone 8", "Faz o deploy para Windows Phone 8");
      ...
      add(inst = new Check(x("Install on device (android or wp8)", "Instalar no equipamento (android ou wp8)")), LEFT,
          AFTER + 50);
      tip(inst, "Install the package if device is connected. You must only select android or wp8",
          "Instala o pacote se o equipamento estiver conectado. Voc� dever� selecionar somente android ou wp8");
