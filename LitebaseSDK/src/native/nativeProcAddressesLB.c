...
void fillNativeProcAddressesLB() {
	...
	htPutPtr(&htNativeProcAddresses, hashCode("lLC_privateGetDefaultLogger"),
			 &lLC_privateGetDefaultLogger);
	htPutPtr(&htNativeProcAddresses, hashCode("lLC_privateDeleteLogFiles"), &lLC_privateDeleteLogFiles);
	htPutPtr(&htNativeProcAddresses, hashCode("lLC_privateProcessLogs_Ssb"),
	...
	htPutPtr(&htNativeProcAddresses, hashCode("lLC_isTableProperlyClosed_s"),
	...
	htPutPtr(&htNativeProcAddresses, hashCode("lRSMD_getColumnDisplaySize_i"),
	...
	htPutPtr(&htNativeProcAddresses, hashCode("lRSMD_getColumnTableName_i"),
			 &lRSMD_getColumnTableName_i);
	htPutPtr(&htNativeProcAddresses, hashCode("lRSMD_getColumnTableName_s"),
	...
	htPutPtr(&htNativeProcAddresses, hashCode("lRSMD_getPKColumnIndices_s"),
