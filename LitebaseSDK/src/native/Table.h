 ...
 * @return <code>true</code> if the table already exists or the table name is
 * too big; <code>false</code>, othewise.
 * @throws AlreadyCreatedException If the table is already created.
 ...
 */
void
test_rowUpdated(TestSuite* testSuite, Context currentContext);
