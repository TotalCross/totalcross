...
{  
   ...
   ASSERT2_EQUALS(Sz, errorMsgs_en[33], "Invalid connection parameter: %s.");
   ...
   ASSERT2_EQUALS(Sz, errorMsgs_en[37], "It is not possible to open a table within a connection with a different cryptography format.");
 ...
 "%s was not listed in the SELECT clause. All fields present in a HAVING clause must be listed in the SELECT clause as aliased aggregation funtions."
   ...
   ASSERT2_EQUALS(Sz, errorMsgs_pt[33], "Parâmetro de conexão inválido: %s.");
