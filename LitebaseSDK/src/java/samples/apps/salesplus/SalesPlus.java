...
public class SalesPlus extends MainWindow
{
  ...
  // Constants for swapping between screens. Each one assigns a window to be
  // swapped to.
  /**
   ...
   */
  public static final String[] years = { "2008", "2009", "2010", "2011", "2012",
                                         "2013", "2014", "2015", "2016" };
  ...
  public SalesPlus()
  {
    ...
    info = new MessageBox(
      "About",
      "TotalCross Sales Plus | Example program for the|TotalCross SDK. | Created by Celso Marcelo da Silva "
   ...
   */
  public void initUI() { ((BaseMenu)screens[MAIN_MENU]).show(); }
}
