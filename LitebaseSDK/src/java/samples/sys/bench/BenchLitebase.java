...
public class BenchLitebase extends MainWindow
{
  ...
  private int insertWithPS()
  {
    ...
    log("Creation time (PrepStat): " + (time = Vm.getTimeStamp() - time) +
        "ms");
    return time;
  }
  ...
  private int insertNormal()
  {
    ...
    int refresh = REFRESH_MOD, i = NRECS_DIV2, time = Vm.getTimeStamp();
  ...
  private int selectBeforeLast()
  {
    ...
    ResultSet resultSet = driver.executeQuery(
      "select * from person where name = 'a" + (NRECS - 1) + "'");
  ...
  private int selectLikeA9()
  {
    ...
    ResultSet resultSet =
      driver.executeQuery("select * from person where name like 'a9%'");
  ...
  private int selectCountStar()
  {
    ...
    ResultSet resultSet =
      driver.executeQuery("select count(*) as number from person");
  ...
  private int selectMax()
  {
    ...
    int time = Vm.getTimeStamp();
    ResultSet resultSet = driver.executeQuery(
      "select max(name) as mname from person where name >= 'a0'");
  ...
  private int selectOrderBy()
  {
    ...
    int time = Vm.getTimeStamp();
    ResultSet resultSet =
      driver.executeQuery("select * from person order by name");
  ...
  public void initUI()
  {
    ...
    log("total: " + (time1 + time2 + time3 + time4 + time5 + time6 + time7 +
