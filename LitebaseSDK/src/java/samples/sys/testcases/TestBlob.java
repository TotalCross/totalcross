...
public class TestBlob extends TestCase
{
  ...
  public void testRun()
  {
    ...
    driver.execute(
      "create table blob2 (name varchar(10), picture blob(100 K))");
    driver.execute(
      "create table blob3 (name varchar(10), id int, video blob(1 M))");

    // Checks that the tables exist.
    assertTrue(driver.exists("blob1") && driver.exists("blob2") &&
               driver.exists("blob3"));
    ...
    try { // A blob can't be in a primary key.
      driver.execute(
        "create table blob0 (value blob(100), primary key(value))");
      fail("4");
    } catch (SQLParseException exception) {
    }
    assertFalse(driver.exists("blob0"));
    ...
    try { // There can't be a default value for blobs.
      driver.execute(
        "create table blob0 (value blob(100) default null, age int)");
      fail("7");
    } catch (SQLParseException exception) {
    }
    assertFalse(driver.exists("blob0"));
    ...
    PreparedStatement preparedStmt1 =
      driver.prepareStatement("Insert into blob1 values (?)");
    PreparedStatement preparedStmt2 = driver.prepareStatement(
      "insert into blob2 (picture, name) values (?, ?)");
    PreparedStatement preparedStmt3 = driver.prepareStatement(
      "insert into blob3 (id, video, name) values (?, ?, ?)");
    ...
    preparedStmt3 =
      driver.prepareStatement("update blob3 set video = ? where rowid = ?");
    i = -1;
    while (++i < 10) {
    ...
    assertEquals(
      10, (rs3 = driver.executeQuery("select * from blob3")).getRowCount());
    i = 10;
    while (--i >= 0) {
      rs3.next();
      assertEquals(bytes[i], rs3.getBlob("video"));
    ...
    preparedStmt1 =
      driver.prepareStatement("update blob1 set value = ? where rowid = ?");
    preparedStmt2 =
      driver.prepareStatement("update blob2 set picture = ? where rowid = ?");
    ...
    // Queries the tables.
    assertEquals(
      10, (rs1 = driver.executeQuery("select value from blob1")).getRowCount());
    assertEquals(
      10,
      (rs2 = driver.executeQuery("select picture from blob2")).getRowCount());
    assertEquals(
      10, (rs3 = driver.executeQuery("select video from blob3")).getRowCount());
    ...
    (preparedStmt2 = driver.prepareStatement(
       "insert into blob2 (picture, name) values (?, ?)"))
      .setBlob(0, null);
    ...
    assertEquals(
      1,
      (rs2 = driver.executeQuery("select * from blob2 where rowid = 11"))
        .getRowCount());
    rs2.next();
    ...
    (preparedStmt2 =
       driver.prepareStatement("update blob2 set picture = ? where rowid = 11"))
      .setBlob(0, bytes[0]);
    assertEquals(1, preparedStmt2.executeUpdate());
    assertEquals(
      1,
    ...
    assertEquals(
      1,
      (rs2 = driver.executeQuery("select * from blob2 where rowid = 12"))
        .getRowCount());
    rs2.next();
    assertNull(rs2.getBlob(2));
    rs2.close();
    ...
    assertEquals(1,
                 driver.executeUpdate(
                   "insert into blob2 (picture, name) values (null, 0)"));
    assertEquals(
      1,
      (rs2 = driver.executeQuery("select * from blob2 where rowid = 13"))
        .getRowCount());
    rs2.next();
    assertNull(rs2.getBlob(2));
    rs2.close();
    ...
    assertEquals(
      1,
      (rs3 = driver.executeQuery("select * from blob3 where rowid = 10"))
        .getRowCount());
    rs3.next();
    ...
    assertEquals(
      1,
      driver.executeUpdate("update blob3 set video = null where rowid = 10"));
    assertEquals(
      1,
      (rs3 = driver.executeQuery("select * from blob3 where rowid = 10"))
        .getRowCount());
    ...
    (preparedStmt3 =
       driver.prepareStatement("update blob3 set video = ? where rowid = 10"))
      .setBlob(0, bytes[9]);
    assertEquals(1, preparedStmt3.executeUpdate());
    assertEquals(
      1,
    ...
    (preparedStmt2 = driver.prepareStatement(
       "insert into blob2 (picture, name) values (?, ?)"))
      .setBlob(0, new byte[0]);
    preparedStmt2.setString(1, "");
    assertEquals(1, preparedStmt2.executeUpdate());
    assertEquals(
      1,
      (rs2 = driver.executeQuery("select * from blob2 where rowid = 14"))
        .getRowCount());
    rs2.next();
    ...
    (preparedStmt2 = driver.prepareStatement(
       "update blob2 set picture = ?, name = '' where rowid = 1"))
      .setBlob(0, new byte[0]);
    assertEquals(1, preparedStmt2.executeUpdate());
    assertEquals(
      2,
      (rs2 = driver.executeQuery("select * from blob2 where name = ''"))
        .getRowCount());
    rs2.next();
    assertEquals(0, rs2.getChars("name").length);
    assertEquals(0, rs2.getBlob("picture").length);
    ...
    assertEquals(
      10,
      (rs3 = driver.executeQuery("select * from blob3 order by id desc"))
        .getRowCount());
    i = 9;
    ch = 'i';
    rs3.next();
    ...
    assertEquals(
      1,
      (rs2 = driver.executeQuery("select * from blob2 where rowid = 1"))
        .getRowCount());
    rs2.next();
    assertEquals(0, rs2.getChars("name").length);
