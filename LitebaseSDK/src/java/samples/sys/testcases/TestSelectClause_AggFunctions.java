...
public class TestSelectClause_AggFunctions extends TestCase {
	...
	public void testRun() {
		...
		assertTrue((resultSet =
						driver.executeQuery("select max(FIRST_NAME) as max_name, min(FIRST_NAME) as min_name, MAX(city) as max_city, "
		...
		assertTrue((resultSet =
						driver.executeQuery("select max(FIRST_NAME) as max_name, count(*) as total, state from PERSON group by state "
											+
		...
		assertTrue((resultSet =
						driver.executeQuery("select min(FIRST_NAME) as min_name, count(*) as total, state from PERSON group by state "
											+
		...
		assertTrue((resultSet =
						driver.executeQuery("select COUNT(*) as total_records from PERSON where state = 'sp'")).next());
		...
		assertTrue((resultSet =
						driver.executeQuery("select COUNT(*) as total, min(age) as min_age, max(age) as max_age, sum(salary) as sum_salary, "
		...
		assertTrue((resultSet =
						driver.executeQuery("select CITY, state, COUNT(*) as total, min(age) as min_age, avg(age) as avg_age, "
											+
		...
		assertTrue((resultSet =
						driver.executeQuery("select first_name as name, CITY from PERSON order by age, first_name desc")).next());
		...
		assertTrue((resultSet =
						driver.executeQuery("select first_name as name, CITY from PERSON where state = 'sp' or state = 'rs' "
		...
		assertTrue((resultSet =
						driver.executeQuery("select COUNT(*) as total, CITY from PERSON where age > 26 and salary > 3000F group by CITY"))
				   .next());
		...
		assertTrue((resultSet =
						driver.executeQuery("select COUNT(*) as total, CITY from PERSON where state = 'sp' or state = 'rj' "
											+
		...
		assertTrue((resultSet =
						driver.executeQuery("select CITY from PERSON where state = 'sp' or state = 'rj' group by CITY")).next());
		...
		assertTrue((resultSet =
						driver.executeQuery("select CITY, COUNT(*) as total from PERSON where state = 'sp' or state = 'rj' group by CITY "
											+
		...
		assertFalse((resultSet =
						 driver.prepareStatement(" SELECT max(clienteId) as id FROM cliente ").executeQuery()).first());
		resultSet.close();
		driver.closeAll();
