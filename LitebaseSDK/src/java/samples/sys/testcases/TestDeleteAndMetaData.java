...
public class TestDeleteAndMetaData extends TestCase {
	...
	private void testMetaData() {
		...
		assertEquals(2, (meta = (rs =
									 driver.executeQuery("select name, time as Tempo from tabsync")).getResultSetMetaData()).getColumnCount());
		...
		assertEquals(2, (meta = (rs =
									 driver.executeQuery("select * from tabsync")).getResultSetMetaData()).getColumnCount());
		assertEquals(5, meta.getColumnDisplaySize(2));
		...
		assertEquals(3, (meta = (rs =
									 driver.executeQuery("select rowid, time, name from tabsync")).getResultSetMetaData()).getColumnCount());
		...
		// Join
		assertEquals(4, (meta = (rs =
									 driver.executeQuery("select * from tabsync, tabsync2")).getResultSetMetaData()).getColumnCount());
		assertEquals(5, meta.getColumnDisplaySize(2));
		...
		assertEquals(4, (meta = (rs =
									 driver.executeQuery("select count(*) as c, upper(tabsync.name) as n1, lower(tabsync2.name) as n2, "
