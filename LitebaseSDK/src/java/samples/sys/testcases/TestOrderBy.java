...
public class TestOrderBy extends TestCase {
	...
	public void testRun() {
		...
		assertEquals((rs =
						  driver.executeQuery("select * from person order by name asc, district desc, age")).getRowCount(),
					 20);
		assertTrue(rs.next());
		assertEquals("Bruno", rs.getString(1));
		assertEquals("23", rs.getString(2));
		...
		assertEquals((rs =
						  driver.executeQuery("select * from person order by age, name asc, district desc")).getRowCount(),
					 20);
		assertTrue(rs.next());
		assertEquals("Bruno", rs.getString(1));
		assertEquals("23", rs.getString(2));
		...
		assertEquals((rs =
						  driver.executeQuery("select * from person order by age asc, district, name desc")).getRowCount(),
					 20);
		...
		assertEquals((rs =
						  driver.executeQuery("select * from person order by district desc, name asc, age")).getRowCount(),
					 20);
		...
		assertEquals((rs =
						  driver.executeQuery("select * from person order by district asc, age, name desc")).getRowCount(),
					 20);
