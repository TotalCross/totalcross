...
// $Id: TestOrderBy.java,v 1.1.2.2.4.13 2011-03-21 21:28:51 juliana Exp $
...
public class TestOrderBy extends TestCase
{
   ...
   public void testRun()
   {
      ...
      // Populates the table.
      driver.executeUpdate("insert into person values ('Juliana', 28, 'Maracanã')");
      driver.executeUpdate("insert into person values ('Roberta', 26, 'Maracanã')");
      ...
      driver.executeUpdate("insert into person values ('Célia', 57, 'Maracanã')");
      driver.executeUpdate("insert into person values ('Renato', 35, 'Flamengo')");
      driver.executeUpdate("insert into person values ('Ronaldo', 61, 'Maracanã')");
      driver.executeUpdate("insert into person values ('Fábio', 23, 'Jacaré')");
      driver.executeUpdate("insert into person values ('Vinícius', 28, 'Ipanema')");
      driver.executeUpdate("insert into person values ('Renato', 23, 'Caculé')");
      ...
      assertTrue(rs.next());
      assertEquals("Vinícius", rs.getString(1));
      ...
      assertEquals("Maracanã", rs.getString(3));
      assertTrue(rs.next());
      assertEquals("Ronaldo", rs.getString(1));
      assertEquals("61", rs.getString(2));
      assertEquals("Maracanã", rs.getString(3));
      ...
      assertEquals("Caculé", rs.getString(3));
      assertTrue(rs.next());
      assertEquals("Renato", rs.getString(1));
      assertEquals("23", rs.getString(2));
      assertEquals("Caculé", rs.getString(3));
      ...
      assertTrue(rs.next());
      assertEquals("Fábio", rs.getString(1));
      assertEquals("23", rs.getString(2));
      assertEquals("Jacaré", rs.getString(3));
      assertTrue(rs.next());
      assertEquals("Fábio", rs.getString(1));
      assertEquals("23", rs.getString(2));
      assertEquals("Jacaré", rs.getString(3));
      ...
      assertTrue(rs.next());
      assertEquals("Célia", rs.getString(1));
