...
public class TestNullAndDefaultValues extends TestCase
{
   ...
   private void testUpdatingWithBool() 
   {
      ...
      driver.executeUpdate("update person set name = 'TIãoZÃo' where age is not null");
   ...
   private void testPreparedStatements() 
   {
      ...
      // Populates the table.
      (ps = driver.prepareStatement("insert into person( age1, age3, age2, name) values (?,?,?,?)")).setString(3,"João Pedro");
      ps.setString(0, "21");
      ps.setString(1, "156");
      ps.executeUpdate();
      ps.clearParameters();
      ...
      assertEquals("João Pedro", rs.getString("name"));
