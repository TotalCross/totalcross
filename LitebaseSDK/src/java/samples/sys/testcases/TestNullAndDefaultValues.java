...
public class TestNullAndDefaultValues extends TestCase
{
  ...
  public void testRun()
  {
    ...
    testUpdatingWithBool();     // Tests updating with AND and OR boolean
                                // connectors.
  ...
  private void testSimpleInserts()
  {
    ...
    // Invalid default empty date and empty datetime, and invalid date and
    // datetime.
    try {
      driver.execute(
        "create table person(name char(20) primary key default 'rnovais' not null, age int default 10, birth Date default '', "
    ...
    try {
      driver.execute(
        "create table person(name char(20) primary key default 'rnovais' not null, age int default 10, "
    ...
    try {
      driver.execute(
        "create table person(name char(20) primary key default 'rnovais' not null, age int default 10, birth Date default '2010/02/29', "
        + "years DateTime not null)");
      fail("5");
    } catch (SQLParseException exception) {
    }
    ...
    try {
      driver.execute(
        "create table person(name char(6) primary key default 'rnovais' not null, age int default 10, "
    ...
    try {
      driver.execute(
        "create table person(name char(20) primary key default 'rnovais' not null, age short default 32768, "
        + "birth Date default '1981/06/06', years DateTime not null)");
      fail("8");
    } catch (SQLParseException exception) {
    }
    try {
      driver.execute(
        "create table person(name char(20) primary key default 'rnovais' not null, age short default -32769, "
        + "birth Date default '1981/06/06', years DateTime not null)");
      fail("9");
    } catch (SQLParseException exception) {
    }
    ...
    try {
      driver.execute(
        "create table person(name char(20) primary key default 'rnovais' not null, age int default 2147483648, "
        + "birth Date default '1981/06/06', years DateTime not null)");
      fail("10");
    } catch (SQLParseException exception) {
    }
    try {
      driver.execute(
        "create table person(name char(20) primary key default 'rnovais' not null, age int default -2147483649, "
        + "birth Date default '1981/06/06', years DateTime not null)");
      fail("11");
    } catch (SQLParseException exception) {
    }
    ...
    try {
      driver.execute(
        "create table person(name char(20) primary key default 'rnovais' not null, age long default 9223372036854775808, "
        + "birth Date default '1981/06/06', years DateTime not null)");
      fail("12");
    } catch (SQLParseException exception) {
    }
    try {
      driver.execute(
        "create table person(name char(20) primary key default 'rnovais' not null, age long default -9223372036854775809, "
        + "birth Date default '1981/06/06', years DateTime not null)");
      fail("13");
    } catch (SQLParseException exception) {
    }
    ...
    try {
      driver.execute(
        "create table person(name char(20) primary key default 'rnovais' not null, age int default 'rnovais', "
        + "birth Date default '1981/06/06', years DateTime not null)");
      fail("14");
    } catch (SQLParseException exception) {
    }
    try {
      driver.execute(
        "create table person(name char(20) primary key default 'rnovais' not null, age float default 'rnovais', "
        + "birth Date default '1981/06/06', years DateTime not null)");
      fail("15");
    } catch (SQLParseException exception) {
    }
    ...
    driver.execute(
      "create table person(name char(7) primary key default 'rnovais' not null, age int default 10, "
      + "birth Date default '1981/06/06', years DateTime not null)");
    driver.executeUpdate("drop table person");

    // Tests short values in the limit of the range.
    driver.execute(
      "create table person(name char(20) primary key default 'rnovais' not null, age short default +32767, "
      + "birth Date default '1981/06/06', years DateTime not null)");
    driver.executeUpdate("drop table person");
    driver.execute(
      "create table person(name char(20) primary key default 'rnovais' not null, age short default -32768, "
    ...
    driver.execute(
      "create table person(name char(20) primary key default 'rnovais' not null, age int default +2147483647, "
      + "birth Date default '1981/06/06', years DateTime not null)");
    driver.executeUpdate("drop table person");
    driver.execute(
      "create table person(name char(20) primary key default 'rnovais' not null, age int default -2147483648, "
    ...
    driver.execute(
      "create table person(name char(20) primary key default 'rnovais' not null, age long default +9223372036854775807, "
      + "birth Date default '1981/06/06', years DateTime not null)");
    driver.executeUpdate("drop table person");
    driver.execute(
      "create table person(name char(20) primary key default 'rnovais' not null, age long default -9223372036854775808, "
    ...
    driver.executeUpdate(
      "insert into person(name, birth, years) values ('renato novais', '1985/02/28',' 2006/08-21    12:08:01:234 ')");
    driver.executeUpdate(
      "insert into person(birth, years) values ( '1985/02/28',' 2006/08-21    12:08:01:234 ')"); // Not null with default.
    driver.executeUpdate(
      "insert into person(name,age, years) values ('indira gomes', 14,' 2006/08-21    12:08:01:234 ')");
    driver.executeUpdate(
      "insert into person(name, years) values ('caio novais', ' 2006/08-21    12:08:01:234 ')");

    try { // It is not possible not to insert a value in a column with a
          // non-null restriction and no default value.
    ...
    assertEquals(expectedDate =
                   Date.formatDate(06, 06, 1981, Settings.DATE_DMY),
                 rs.getDate(3).toString(Settings.DATE_DMY));
    assertEquals(expectedTime, rs.getDateTime(4).toString());
    ...
    // juliana@202_12: The default values must have been correctly saved on the
    // table.
    driver.closeAll();
    driver = AllTests.getInstance("Test");
    assertEquals(
      4, (rs = driver.executeQuery("Select * from person")).getRowCount());
    rs.close();
  }
  ...
  private void testGettingNulls()
  {
    ...
    // Creates and populates the table.
    driver.execute(
      "create table person(field0 char(20),field1 short, field2 int, field3 long, field4 float, field5 double, field6 date, "
      + "field7 DateTime)");
    driver.executeUpdate(
      "insert into person values (null,null,null,null,null,null,null,null)");
    driver.executeUpdate(
      "insert into person values (null,null,null,null,null,null,null,null)");
    ...
    assertEquals(
      ...
      (rs = driver.executeQuery(
         "Select * from person where field0 is null and field1 is null and field2 is null and field3 is null "
         + "and field4 is null and field5 is null and field6 is null"))
        .getRowCount());
    assertTrue(rs.next());
    assertNull(rs.getString("field0"));
    assertEquals(0, rs.getShort("field1"));
  ...
  private void testUpdatingNulls()
  {
    ...
    // Creates and populates the table.
    driver.execute(
      "create table person(name char(20) default '', age int default 10)");
    driver.execute("create index idx on person(name)");
    driver.executeUpdate(
      "insert into person( name, age) values ('InDiRa GoMeS', null)");

    // Closes and reopens Litebase to test that the default values data will be
    // saved correctly.
    driver.closeAll();
    driver = AllTests.getInstance("Test");

    ResultSet rs = driver.executeQuery(
      "Select age, name from person where name = 'InDiRa GoMeS'");
    assertEquals(1, rs.getRowCount());
    assertTrue(rs.next());
    assertEquals("InDiRa GoMeS", rs.getString("name"));
    ...
    assertEquals(
      1,
      (rs = driver.executeQuery("Select age, name from person")).getRowCount());
    assertTrue(rs.next());
    ...
    driver.executeUpdate(
      "update person set name = 'juliana', age = 32 where name is null");
    rs = driver.executeQuery("Select age, name from person");
    assertEquals(
      1,
      (rs = driver.executeQuery("Select age, name from person")).getRowCount());
    ...
    assertEquals(
      2,
      (rs = driver.executeQuery(
         "Select age, name from person where name = 'juliana' or name = ''"))
        .getRowCount());
    assertTrue(rs.next());
  ...
  private void testUpdatingWithBool()
  {
    ...
    driver.execute(
      "create table person(name char(20) default 'ZeneS', age int)");
    driver.execute("create index idx on person (name, age)");
    driver.executeUpdate(
      "insert into person( age, name) values (21, 'renato')");
    driver.executeUpdate(
      "insert into person( age, name) values (null, 'maria')");

    // Updates the table.
    driver.executeUpdate(
      "update person set age = 12, name = null where age is not null and name is null");
    driver.executeUpdate(
      "update person set age = 12, name = null where age is not null and name is not null");
    driver.executeUpdate(
      "update person set age = 12, name = null where name = 'joao' or age is not null");
    driver.executeUpdate(
      "update person set age = null, name = 'zENEs' where name is null and age = 12");
    ...
    assertEquals(
      0,
      (rs = driver.executeQuery(
         "Select name, age from person where name = 'zENEs' and age = 0"))
        .getRowCount());
    rs.close();
    assertEquals(
      0,
      (rs = driver.executeQuery(
         "Select name, age from person where name = 'maria' and age = 0"))
        .getRowCount());
    rs.close();
    ...
    driver.executeUpdate(
      "insert into person( age, name) values (21, 'renato')");
    driver.executeUpdate(
      "insert into person( age, name) values (null, 'jener')");

    // Updates the table.
    driver.executeUpdate(
      "update person set age = null, name = 'indira' where age is null");
    driver.executeUpdate(
      "update person set name = 'TI�oZ�o' where age is not null");

    assertEquals(
      2,
      (rs = driver.executeQuery("Select name, age from person")).getRowCount());
    assertTrue(rs.next());
    ...
    assertEquals(
      1,
      (rs = driver.executeQuery(
         "Select name, age from person where name = 'TI�oZ�o' and age = 21"))
        .getRowCount());
    assertTrue(rs.next());
    assertEquals("TI�oZ�o", rs.getString("name"));
    assertEquals(21, rs.getInt("age"));
    ...
    assertEquals(
      0,
      (rs = driver.executeQuery(
         "Select name, age from person where name = 'indira' and age = 0"))
        .getRowCount());
    rs.close();
  }
  ...
  private void testSelects()
  {
    ...
    // Creates and populates the table.
    driver.execute(
      "create table person(name char(20) primary key default 'rnovais' not null, age int, birth DATE default '1994/05/06')");
    ...
    driver.executeUpdate(
      "insert into person( name, age) values ('VUlcao',5000)");
    driver.executeUpdate("insert into person( name) values ('Plinio')");

    try { // Primary key violation.

      driver.executeUpdate(
        "insert into person( age, birth) values (17,'2005/03/12')");
      fail("17");
    ...
    // More inserts.
    driver.executeUpdate(
      "insert into person( name, age, birth) values ('Maria Beatriz',1,null)");
    driver.executeUpdate(
      "insert into person( name, age, birth) values ('Caio', null, null)");
    driver.executeUpdate(
      "insert into person( name, age, birth) values ('Lucas', null, '2020/11/30')");
    driver.executeUpdate(
      "insert into person( birth, name) values ('1998/12/23', 'celia')");
    driver.executeUpdate(
      "insert into person values ('Marlene',10,'2000/02/04')");

    ResultSet rs =
      driver.executeQuery("Select * from person where name is null");
    assertEquals(0, rs.getRowCount());
    rs.close();

    assertEquals(
      10,
      (rs = driver.executeQuery("Select * from person where name is not null"))
        .getRowCount());
    rs.close();

    assertEquals(
      5,
      (rs = driver.executeQuery("Select * from person where age is not null"))
        .getRowCount());
    assertTrue(rs.next());
    ...
    assertEquals(
      3,
      (rs = driver.executeQuery("Select * from person where birth is null"))
        .getRowCount());
    assertTrue(rs.next());
    assertEquals("rnovais", rs.getString("name"));
    assertTrue(rs.next());
    ...
    assertEquals(
      3,
      (rs = driver.executeQuery(
         "Select * from person where name is not null and age is not null and birth is not null"))
        .getRowCount());
    assertTrue(rs.next());
    assertEquals("maria", rs.getString("name"));
    assertTrue(rs.next());
  ...
  private void testDefaultNull()
  {
    ...
    driver.executeUpdate("drop table person");
    driver.execute(
      "create table PERSON (name char(20) default null not null, age int default 21)");
  ...
  private void testPrimaryKeyNull()
  {
    ...
    driver.executeUpdate("drop table person");
    driver.execute(
      "create table PERSON (name char(20) primary key , age int default 21)");
  ...
  private void testOrderBy()
  {
    ...
    driver.executeUpdate(
      "insert into person(name, age1, age2) values ('Joao Pedro',10, 20)");
    driver.executeUpdate(
      "insert into person(name, age1, age2) values ('Caio',null, 30)");
    driver.executeUpdate(
      "insert into person(name, age1, age2) values ('Lucas',8, null)");
    driver.executeUpdate(
      "insert into person(name, age1, age2) values ('Maria',null, null)");
    driver.executeUpdate(
      "insert into person(name, age1, age2) values (null,null, 12)");
    driver.executeUpdate(
      "insert into person(name, age1, age2) values ('carol',23, null)");
    driver.executeUpdate(
      "insert into person(name, age1, age2) values ('null',null, 12)");
    driver.executeUpdate(
      "insert into person(name, age1, age2) values ('danilo',null, 27)");
    driver.executeUpdate(
      "insert into person(name, age1, age2) values ('felipe',null, 12)");
    driver.executeUpdate(
      "insert into person(name, age1, age2) values (null,23, null)");
    driver.executeUpdate(
      "insert into person(name, age1, age2) values ('renato',null, 12)");
    driver.executeUpdate(
      "insert into person(name, age1, age2) values ('indira',null, 29)");
    driver.executeUpdate(
      "insert into person(name, age1, age2) values ('felipe',null, 12)");
    driver.executeUpdate(
      "insert into person(name, age1, age2) values (null,23, null)");
    driver.executeUpdate(
      "insert into person(name, age1, age2) values ('renato',null, 12)");
    driver.executeUpdate(
      "insert into person(name, age1, age2) values ('caio',null, 25)");

    ResultSet rs =
      driver.executeQuery("Select name, age1, age2 from person order by name");
    assertTrue(rs.next());
    assertEquals("Caio", rs.getString("name"));
    ...
    assertTrue(
      (rs = driver.executeQuery(
         "Select name, age1, age2 from person order by name desc, age1, age2"))
        .next());
    assertNull(rs.getString("name"));
    assertEquals("23", rs.getString("age1"));
    assertNull(rs.getString("age2"));
  ...
  private void testAggregationFunctions()
  {
    ...
    driver.execute("create table PERSON (name char(20) , age1 int, age2 int)");
    driver.executeUpdate(
      "insert into person(name, age1, age2) values ('maria',10, 20)");
    driver.executeUpdate(
      "insert into person(name, age1, age2) values ('maria',null, 30)");

    ResultSet rs = driver.executeQuery(
      "Select name, avg(age1) as a1, avg(age2) as a2 from person group by name");
    assertTrue(rs.next());
    ...
    driver.executeUpdate(
      "insert into person(name, age1, age2) values ('maria',8, null)");
    driver.executeUpdate(
      "insert into person(name, age1, age2) values ('maria',null, null)");
    ...
    driver.executeUpdate(
      "insert into person(name, age1, age2) values ('maria',null, 12)");
    driver.executeUpdate(
      "insert into person(name, age1, age2) values ('maria',23, null)");
    driver.executeUpdate(
      "insert into person(name, age1, age2) values ('renato',null, 12)");
    driver.executeUpdate(
      "insert into person(name, age1, age2) values ('renato',null, 24)");

    assertTrue(
      (rs = driver.executeQuery(
         "Select name, avg(age1) as a1, avg(age2) as a2 from person group by name order by name"))
        .next());
    ...
    assertTrue(
      (rs = driver.executeQuery("Select count(*) as av from person")).next());
    ...
    assertTrue(
      (rs = driver.executeQuery((
         "Select name, count(*) as a,  max(age1) as a1, min(age2) as a2 from person group by name")))
        .next());
    assertEquals("maria", rs.getString("name"));
    ...
    driver.executeUpdate("drop table person");
    driver.execute(
      "create table PERSON (name char(20) , age1 char(20), age2 int)");
    driver.executeUpdate(
      "insert into person(name, age1, age2) values ('Joao Pedro',null, 20)");
    driver.executeUpdate(
      "insert into person(name, age1, age2) values (null,null, 12)");
    driver.executeUpdate(
      "insert into person(name, age1, age2) values (null,'23', null)");
    driver.executeUpdate(
      "insert into person(name, age1, age2) values ('Joao Pedro',null, 30)");
    driver.executeUpdate(
      "insert into person(name, age1, age2) values (null,'23', null)");
    driver.executeUpdate(
      "insert into person(name, age1, age2) values ('Joao Pedro',null, 50)");
    driver.executeUpdate(
      "insert into person(name, age1, age2) values (null,'23', null)");
    driver.executeUpdate(
      "insert into person(name, age1, age2) values (null,'23', null)");
    ...
    assertTrue(
      (rs = driver.executeQuery(
         "Select name, age1, count(*) as cnt  from person group by name, age1"))
        .next());
    assertEquals("Joao Pedro", rs.getString("name"));
    assertNull(rs.getString("age1"));
    ...
    driver.executeUpdate(
      "delete from person where name is null or name is not null"); // Deletes
                                                                    // all
    ...
    driver.executeUpdate(
      "insert into person(name, age1, age2) values ('null',null, 12)");
    driver.executeUpdate(
      "insert into person(name, age1, age2) values ('danilo',null, 28)");
    driver.executeUpdate(
      "insert into person(name, age1, age2) values ('felipe',null, 16)");
    driver.executeUpdate(
      "insert into person(name, age1, age2) values (null,'23', null)");
    driver.executeUpdate(
      "insert into person(name, age1, age2) values ('renato','85', 12)");
    driver.executeUpdate(
      "insert into person(name, age1, age2) values ('renato',null, 84)");
    driver.executeUpdate(
      "insert into person(name, age1, age2) values ('indira',null, 05)");
    driver.executeUpdate(
      "insert into person(name, age1, age2) values ('felipe',null, 12)");
    driver.executeUpdate(
      "insert into person(name, age1, age2) values ('null',null, 10)");
    driver.executeUpdate(
      "insert into person(name, age1, age2) values (null,'23', null)");
    driver.executeUpdate(
      "insert into person(name, age1, age2) values ('renato',null, 12)");
    driver.executeUpdate(
      "insert into person(name, age1, age2) values ('caio',null, 24)");
    ...
    assertTrue(
      (rs = driver.executeQuery(
         "Select name, age1, avg(age2) as cnt  from person group by name, age1 having cnt is not null"))
        .next());
    assertEquals("Joao Pedro", rs.getString("name"));
    assertNull(rs.getString("age1"));
    ...
    assertTrue(
      (rs = driver.executeQuery(
         "Select name, age1, avg(age2) as cnt  from person group by name, age1 having cnt is null"))
        .next());
    assertEquals("Lucas", rs.getString("name"));
    assertEquals("8", rs.getString("age1"));
  ...
  {
    LitebaseConnection driver =
      AllTests.getInstance("Test"); // Gets another connection.
    ...
    // Populates the table.
    PreparedStatement ps = driver.prepareStatement(
      "insert into person(age1, age2, name) values (?,?,?)");
    ps.setNull(0);
    ps.setString(1, null);
    ...
    driver.executeUpdate("drop table person");
    driver.execute(
      "create table PERSON (name char(20) , age1 int , age2 int default 50, age3 int not null)");

    // Populates the table.
    (ps = driver.prepareStatement(
       "insert into person( age1, age3, age2, name) values (?,?,?,?)"))
      .setString(3, "Jo�o Pedro");
    ps.setString(0, "21");
    ps.setString(1, "156");
    ps.executeUpdate();
    ps.clearParameters();
    ...
    assertTrue(
      (rs = driver.executeQuery("Select name, age1, age2, age3 from person"))
        .next());
    ...
    (ps = driver.prepareStatement(
       "update person set age1 = ?, name = ?, age2=?  where name = ? "))
      .clearParameters();
    ps.setString(1, "Caio");
    ps.setString(0, "26");
    ps.setString(2, null);
    ...
    (ps = driver.prepareStatement(
       "update person set name = ?, age1 = ? where name = ? "))
      .clearParameters();
    ...
    (ps = driver.prepareStatement(
       "update person set age1 = ?, age3 = ?, name = ?, age2 = ? where name = ? "))
      .clearParameters();
    ps.setString(0, "21");
    ps.setString(1, "23");
    ps.setNull(2);
    ...
    (ps =
       driver.prepareStatement("update person set name = ? where name is null"))
      .setString(0, "Danilo");
    ps.executeUpdate();
  ...
  private void testLikeWithNull()
  {
    ...
    PreparedStatement ps =
      driver.prepareStatement("INSERT INTO PERSON (birth) VALUES (?)");
    ...
    ResultSet rs = driver.executeQuery(
      "select * from person where birth like '1981/06/06 %'");
    assertEquals(1, rs.getRowCount());
    rs.close();

    assertEquals(1,
                 (rs = driver.executeQuery(
                    "select * from person where birth like '1980/06/06 %'"))
                   .getRowCount());
    rs.close();
    ...
    assertEquals(
      2,
      (rs = driver.executeQuery("select * from person where birth is not null"))
        .getRowCount());
    rs.close();
