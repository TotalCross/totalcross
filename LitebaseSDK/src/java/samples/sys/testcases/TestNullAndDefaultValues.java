...
public class TestNullAndDefaultValues extends TestCase {
	...
	private void testSimpleInserts() {
		...
		assertEquals(expectedDate = Date.formatDate(06, 06, 1981, Settings.DATE_DMY),
	...
	private void testGettingNulls() {
		...
		assertEquals(1, (rs =
							 driver.executeQuery("Select * from person where field0 is null and field1 is null and field2 is null and field3 is null "
	...
	private void testUpdatingWithBool() {
		...
		assertEquals(0, (rs =
							 driver.executeQuery("Select name, age from person where name = 'zENEs' and age = 0")).getRowCount());
		rs.close();
		assertEquals(0, (rs =
							 driver.executeQuery("Select name, age from person where name = 'maria' and age = 0")).getRowCount());
		rs.close();
		...
		assertEquals(1, (rs =
							 driver.executeQuery("Select name, age from person where name = 'TI�oZ�o' and age = 21")).getRowCount());
		assertTrue(rs.next());
		assertEquals("TI�oZ�o", rs.getString("name"));
		assertEquals(21, rs.getInt("age"));
		rs.close();
		assertEquals(0, (rs =
							 driver.executeQuery("Select name, age from person where name = 'indira' and age = 0")).getRowCount());
		rs.close();
	}
	...
	private void testSelects() {
		...
		assertEquals(10, (rs =
							  driver.executeQuery("Select * from person where name is not null")).getRowCount());
		rs.close();

		assertEquals(5, (rs =
							 driver.executeQuery("Select * from person where age is not null")).getRowCount());
		assertTrue(rs.next());
		...
		assertEquals(3, (rs =
							 driver.executeQuery("Select * from person where birth is null")).getRowCount());
		assertTrue(rs.next());
		assertEquals("rnovais", rs.getString("name"));
		assertTrue(rs.next());
		...
		assertEquals(3, (rs =
							 driver.executeQuery("Select * from person where name is not null and age is not null and birth is not null")).getRowCount());
		assertTrue(rs.next());
		assertEquals("maria", rs.getString("name"));
		assertTrue(rs.next());
	...
	private void testOrderBy() {
		...
		assertTrue((rs =
						driver.executeQuery("Select name, age1, age2 from person order by name desc, age1, age2")).next());
		assertNull(rs.getString("name"));
		assertEquals("23", rs.getString("age1"));
		assertNull(rs.getString("age2"));
		assertTrue(rs.isNull(1));
	...
	private void testAggregationFunctions() {
		...
		ResultSet rs =
			driver.executeQuery("Select name, avg(age1) as a1, avg(age2) as a2 from person group by name");
		assertTrue(rs.next());
		...
		assertTrue((rs =
						driver.executeQuery("Select name, avg(age1) as a1, avg(age2) as a2 from person group by name")).next());
		...
		assertTrue((rs =
						driver.executeQuery("Select name, avg(age1) as a1, avg(age2) as a2 from person group by name order by name")).next());
		...
		assertTrue((rs =
						driver.executeQuery(("Select name, count(*) as a,  max(age1) as a1, min(age2) as a2 from person group by name"))).next());
		assertEquals("maria", rs.getString("name"));
		...
		assertTrue((rs =
						driver.executeQuery("Select name, age1, count(*) as cnt  from person group by name, age1")).next());
		assertEquals("Joao Pedro", rs.getString("name"));
		assertNull(rs.getString("age1"));
		...
		// having
		assertTrue((rs =
						driver.executeQuery("Select name, age1, avg(age2) as cnt  from person group by name, age1 having cnt is not null")).next());
		assertEquals("Joao Pedro", rs.getString("name"));
		assertNull(rs.getString("age1"));
		...
		assertTrue((rs =
						driver.executeQuery("Select name, age1, avg(age2) as cnt  from person group by name, age1 having cnt is null")).next());
		assertEquals("Lucas", rs.getString("name"));
		assertEquals("8", rs.getString("age1"));
	...
	private void testFunctionsAndNulls() {
		...
		ResultSet rs =
			driver.executeQuery("Select name, age1, count(*) as cnt  from person group by name, age1");
		assertTrue(rs.next());
		assertEquals("Joao Pedro", rs.getString("name"));
		assertNull(rs.getString("age1"));
		assertEquals(1, rs.getInt("cnt"));
	...
	private void testPreparedStatements() {
		...
		PreparedStatement ps =
			driver.prepareStatement("insert into person(age1, age2, name) values (?,?,?)");
		ps.setNull(0);
		ps.setString(1, null);
		...
		// Populates the table.
		(ps = driver.prepareStatement("insert into person( age1, age3, age2, name) values (?,?,?,?)")).setString(
			3, "Jo�o Pedro");
		ps.setString(0, "21");
		ps.setString(1, "156");
		ps.executeUpdate();
		...
		(ps = driver.prepareStatement("update person set name = ? where name is null")).setString(0,
				"Danilo");
		ps.executeUpdate();
	...
	private void testLikeWithNull() {
		...
		assertEquals(1, (rs =
							 driver.executeQuery("select * from person where birth like '1980/06/06 %'")).getRowCount());
		rs.close();
