...
public class TestDuplicateEntry extends TestCase
{
  ...
  public void testRun()
  {
    ...
    String insert =
      "INSERT INTO ACT_PRODUTO (ACTCODPRODUTO, ACTCODFABRICANTE, ACTDESCRICAO, ACTQTDEMBALAGEM, ACTCODUNIPRIMARIA, "
      +
    ...
    driver.execute(
      "CREATE TABLE act_produto (actcodproduto char(30), actcodfabricante char(30), actdescricao char(70), actqtdembalagem long, "
      +
    ...
    try {
      assertNotNull(
        resultSet = driver.executeQuery(
          "select * from act_produto where ACTGRUPOTRIBUTACAOID = 20050411095951L"));
      resultSet.close();
  ...
  private void testRepetedNameOnSelect()
  {
    ...
    try {
      ResultSet rs =
        driver.executeQuery("Select name, name as t, age from person");
      assertTrue(rs.next());
