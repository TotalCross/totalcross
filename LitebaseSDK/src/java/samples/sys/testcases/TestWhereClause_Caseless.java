...
public class TestWhereClause_Caseless extends TestCase
{
  ...
  public void testRun()
  {
    ...
    // Creates table.
    driver.execute(
      "create table PERSON (FIRST_NAME CHAR(30) NOCASE, LAST_NAME CHAR(40) NOCASE, CITY CHAR(30) NOCASE, SALARY_CUR DOUBLE, "
    ...
    driver.executeUpdate("drop table person");
    driver.execute(
      "create table PERSON (FIRST_NAME CHAR(30), LAST_NAME CHAR(40), CITY CHAR(30), SALARY_CUR DOUBLE, SALARY_PREV DOUBLE, "
  ...
  private void testQueriesCaseless(LitebaseConnection driver)
  {
    ...
    assertEquals(
      5,
      executeQuery(driver, "select * from PERSON where FIRST_NAME = 'maria'"));
    assertEquals(
      15,
      executeQuery(driver, "select * from PERSON where FIRST_NAME != 'maria'"));
    ...
    // Group by.
    assertEquals(8,
                 executeQuery(driver, "select city from PERSON group by city"));
  }
