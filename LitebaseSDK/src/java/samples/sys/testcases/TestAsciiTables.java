...
public class TestAsciiTables extends TestCase {
	...
	public void testRun() {
		...
		LitebaseConnection conn = LitebaseConnection.getInstance("Test",
								  "chars_type = ascii; path = " + tempPath);
		...
		(conn = LitebaseConnection.getInstance("Test",
											   "chars_type = unicode; path = " + tempPath)).execute("create table person (name char(10))");
		conn.closeAll();
		...
		LitebaseConnection connAux = LitebaseConnection.getInstance("Test",
									 "path = " + tempPath + " ; chars_type = ascii");
		assertNotEquals(conn = LitebaseConnection.getInstance("Test",
							   "path = " + tempPath + ";chars_type = unicode"), connAux);
