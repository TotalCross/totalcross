...
public class TestBigJoins extends TestCase
{
  ...
  public void testRun()
  {
    ...
    // Lists all the table names and tests if all tables of this test are in the
    // list.
  ...
  private void test2Tables()
  {
    ...
    // Creates the tables.
    connection.execute(
      "CREATE TABLE ANIMAL (ID INT, APELIDO CHAR(50) NOT NULL, CODIGO_PROPRIEDADE INT NOT NULL, CODIGO_CLIENTE INT NOT NULL)");
    connection.execute(
      "CREATE TABLE ORDENHA (NUMERO INT NOT NULL, ID_ANIMAL INT NOT NULL, LEITE DOUBLE, DATA_HORA DATETIME)");

    // Prepared statements.
    PreparedStatement psInsertAnimal = connection.prepareStatement(
                        "INSERT INTO ANIMAL VALUES (?, ?, ?, ?)"),
                      psInsertOrdenha = connection.prepareStatement(
                        "INSERT INTO ORDENHA VALUES (?, ?, ?, ?)");
    ...
    connection.executeUpdate(
      "alter table ordenha add primary key (numero, id_animal)");
    ...
    ResultSet resultSet = connection.executeQuery(
      "SELECT SUM(ORDENHA.LEITE) AS TOTAL FROM ORDENHA, ANIMAL WHERE ORDENHA.LEITE > 0 "
      +
  ...
  private void test3Tables()
  {
    ...
    // Creates the tables.
    connection.execute(
      "create table precos (CODPROD char(14), CODCONDPAG char(14), PRCVENDALONG long, codlista char(3))");
    connection.execute(
      "create table produtos (CODPROD char(14), CODGRP char(14), SITUACAO char(14), DESCRPROD char(40), UNIDADE char(14))");
    connection.execute(
      "create table estoque (CODPROD char(14), num int, cod_un_neg char(14))");

    // Prepared statements.
    PreparedStatement psPrecos = connection.prepareStatement(
                        "insert into precos values(?, ?, ?, ?)"),
                      psProdutos = connection.prepareStatement(
                        "insert into produtos values(?, ?, ?, ?, ?)"),
                      psEstoque = connection.prepareStatement(
    ...
    ResultSet resultSet = connection.executeQuery(
      "select * from precos, produtos, estoque where estoque.CODPROD = produtos.CODPROD and produtos.CODPROD = precos.CODPROD and codlista = 'l1'");
    String column2;
    ...
    try { // Checks the results.
      while (resultSet.next()) {
        ...
        assertEquals(Convert.toLong(column2.substring(4)),
                     resultSet.getLong(3) - 1);
  ...
  private void test4Tables()
  {
    ...
    connection.execute(
      "create table ComponentDefinition (id long, name char(20))");
    connection.execute("create table Panel (id long, name char(20))");
    connection.execute(
      "create table Component (id long, typeid long, componentdefinitionid long, panelid long, name char(20))");

    // Inserts data into ComponentType.
    int j = 0;
    PreparedStatement ps =
      connection.prepareStatement("insert into ComponentType values (?, ?)");
    ...
    ps = connection.prepareStatement(
      "insert into ComponentDefinition values (?, ?)");
    ...
    connection.executeUpdate(
      "alter table ComponentDefinition add primary key (id)");
    ...
    connection.execute(
      "create index compdefid on component(componentdefinitionid)");
    connection.execute("create index panelid on component(panelid)");

    String
      baseSQL =
        "select Component.name, ComponentType.name, ComponentDefinition.name, Panel.name from Component, Panel, ComponentDefinition, "
        + "ComponentType where ",
      d = "Component.componentdefinitionid = ComponentDefinition.id",
      i = "Component.id = 1", p = "Component.panelid = Panel.id",
    ...
    baseSQL =
      "select Component.name, ComponentType.name, ComponentDefinition.name, Panel.name from Component, Panel, ComponentType, "
    ...
    baseSQL =
      "select Component.name, ComponentType.name, ComponentDefinition.name, Panel.name from Component, ComponentDefinition, Panel, "
      + "ComponentType where ";
    executeTestQuery(baseSQL + d + " and " + i + " and " + p + " and " + t);
    executeTestQuery(baseSQL + d + " and " + i + " and " + t + " and " + p);
    executeTestQuery(baseSQL + d + " and " + p + " and " + i + " and " + t);
    ...
    baseSQL =
      "select Component.name, ComponentType.name, ComponentDefinition.name, Panel.name from Component, ComponentDefinition, ComponentType, "
      + "Panel where ";
    executeTestQuery(baseSQL + d + " and " + i + " and " + p + " and " + t);
    executeTestQuery(baseSQL + d + " and " + i + " and " + t + " and " + p);
    executeTestQuery(baseSQL + d + " and " + p + " and " + i + " and " + t);
    ...
    baseSQL =
      "select Component.name, ComponentType.name, ComponentDefinition.name, Panel.name from Component, ComponentType, Panel, "
      + "ComponentDefinition where ";
    executeTestQuery(baseSQL + d + " and " + i + " and " + p + " and " + t);
    executeTestQuery(baseSQL + d + " and " + i + " and " + t + " and " + p);
    executeTestQuery(baseSQL + d + " and " + p + " and " + i + " and " + t);
    ...
    baseSQL =
      "select Component.name, ComponentType.name, ComponentDefinition.name, Panel.name from Component, ComponentType, ComponentDefinition, "
      + "Panel where ";
    executeTestQuery(baseSQL + d + " and " + i + " and " + p + " and " + t);
    executeTestQuery(baseSQL + d + " and " + i + " and " + t + " and " + p);
    executeTestQuery(baseSQL + d + " and " + p + " and " + i + " and " + t);
    ...
    baseSQL =
      "select Component.name, ComponentType.name, ComponentDefinition.name, Panel.name from Panel, Component, ComponentDefinition, "
      + "ComponentType where ";
    executeTestQuery(baseSQL + d + " and " + i + " and " + p + " and " + t);
    executeTestQuery(baseSQL + d + " and " + i + " and " + t + " and " + p);
    executeTestQuery(baseSQL + d + " and " + p + " and " + i + " and " + t);
    ...
    baseSQL =
      "select Component.name, ComponentType.name, ComponentDefinition.name, Panel.name from Panel, Component, ComponentType, "
      + "ComponentDefinition where ";
    executeTestQuery(baseSQL + d + " and " + i + " and " + p + " and " + t);
    executeTestQuery(baseSQL + d + " and " + i + " and " + t + " and " + p);
    executeTestQuery(baseSQL + d + " and " + p + " and " + i + " and " + t);
    ...
    baseSQL =
      "select Component.name, ComponentType.name, ComponentDefinition.name, Panel.name from Panel, ComponentDefinition, Component, "
      + "ComponentType where ";
    executeTestQuery(baseSQL + d + " and " + i + " and " + p + " and " + t);
    executeTestQuery(baseSQL + d + " and " + i + " and " + t + " and " + p);
    executeTestQuery(baseSQL + d + " and " + p + " and " + i + " and " + t);
    ...
    baseSQL =
      "select Component.name, ComponentType.name, ComponentDefinition.name, Panel.name from Panel, ComponentDefinition, ComponentType, "
      + "Component where ";
    executeTestQuery(baseSQL + d + " and " + i + " and " + p + " and " + t);
    executeTestQuery(baseSQL + d + " and " + i + " and " + t + " and " + p);
    executeTestQuery(baseSQL + d + " and " + p + " and " + i + " and " + t);
    ...
    baseSQL =
      "select Component.name, ComponentType.name, ComponentDefinition.name, Panel.name from Panel, ComponentType, Component, "
      + "ComponentDefinition where ";
    executeTestQuery(baseSQL + d + " and " + i + " and " + p + " and " + t);
    executeTestQuery(baseSQL + d + " and " + i + " and " + t + " and " + p);
    executeTestQuery(baseSQL + d + " and " + p + " and " + i + " and " + t);
    ...
    baseSQL =
      "select Component.name, ComponentType.name, ComponentDefinition.name, Panel.name from Panel, ComponentType, ComponentDefinition, "
      + "Component where ";
    executeTestQuery(baseSQL + d + " and " + i + " and " + p + " and " + t);
    executeTestQuery(baseSQL + d + " and " + i + " and " + t + " and " + p);
    executeTestQuery(baseSQL + d + " and " + p + " and " + i + " and " + t);
    ...
    baseSQL =
      "select Component.name, ComponentType.name, ComponentDefinition.name, Panel.name from ComponentDefinition, Component, Panel, "
      + "ComponentType where ";
    executeTestQuery(baseSQL + d + " and " + i + " and " + p + " and " + t);
    executeTestQuery(baseSQL + d + " and " + i + " and " + t + " and " + p);
    executeTestQuery(baseSQL + d + " and " + p + " and " + i + " and " + t);
    ...
    baseSQL =
      "select Component.name, ComponentType.name, ComponentDefinition.name, Panel.name from ComponentDefinition, Component, ComponentType,"
      + " Panel where ";
    executeTestQuery(baseSQL + d + " and " + i + " and " + p + " and " + t);
    executeTestQuery(baseSQL + d + " and " + i + " and " + t + " and " + p);
    executeTestQuery(baseSQL + d + " and " + p + " and " + i + " and " + t);
    ...
    baseSQL =
      "select Component.name, ComponentType.name, ComponentDefinition.name, Panel.name from ComponentDefinition, Panel, Component, "
      + "ComponentType where ";
    executeTestQuery(baseSQL + d + " and " + i + " and " + p + " and " + t);
    executeTestQuery(baseSQL + d + " and " + i + " and " + t + " and " + p);
    executeTestQuery(baseSQL + d + " and " + p + " and " + i + " and " + t);
    ...
    baseSQL =
      "select Component.name, ComponentType.name, ComponentDefinition.name, Panel.name from ComponentDefinition, Panel, ComponentType, "
      + "Component where ";
    executeTestQuery(baseSQL + d + " and " + i + " and " + p + " and " + t);
    executeTestQuery(baseSQL + d + " and " + i + " and " + t + " and " + p);
    executeTestQuery(baseSQL + d + " and " + p + " and " + i + " and " + t);
    ...
    baseSQL =
      "select Component.name, ComponentType.name, ComponentDefinition.name, Panel.name from ComponentDefinition, ComponentType, Component,"
      + " Panel where ";
    executeTestQuery(baseSQL + d + " and " + i + " and " + p + " and " + t);
    executeTestQuery(baseSQL + d + " and " + i + " and " + t + " and " + p);
    executeTestQuery(baseSQL + d + " and " + p + " and " + i + " and " + t);
    ...
    baseSQL =
      "select Component.name, ComponentType.name, ComponentDefinition.name, Panel.name from ComponentDefinition, ComponentType, Panel, "
      + "Component where ";
    executeTestQuery(baseSQL + d + " and " + i + " and " + p + " and " + t);
    executeTestQuery(baseSQL + d + " and " + i + " and " + t + " and " + p);
    executeTestQuery(baseSQL + d + " and " + p + " and " + i + " and " + t);
    ...
    baseSQL =
      "select Component.name, ComponentType.name, ComponentDefinition.name, Panel.name from ComponentType, Component, Panel, "
      + "ComponentDefinition where ";
    executeTestQuery(baseSQL + d + " and " + i + " and " + p + " and " + t);
    executeTestQuery(baseSQL + d + " and " + i + " and " + t + " and " + p);
    executeTestQuery(baseSQL + d + " and " + p + " and " + i + " and " + t);
    ...
    baseSQL =
      "select Component.name, ComponentType.name, ComponentDefinition.name, Panel.name from ComponentType, Component, ComponentDefinition,"
      + " Panel  where ";
    executeTestQuery(baseSQL + d + " and " + i + " and " + p + " and " + t);
    executeTestQuery(baseSQL + d + " and " + i + " and " + t + " and " + p);
    executeTestQuery(baseSQL + d + " and " + p + " and " + i + " and " + t);
    ...
    baseSQL =
      "select Component.name, ComponentType.name, ComponentDefinition.name, Panel.name from ComponentType, Panel, Component, "
      + "ComponentDefinition where ";
    executeTestQuery(baseSQL + d + " and " + i + " and " + p + " and " + t);
    executeTestQuery(baseSQL + d + " and " + i + " and " + t + " and " + p);
    executeTestQuery(baseSQL + d + " and " + p + " and " + i + " and " + t);
    ...
    baseSQL =
      "select Component.name, ComponentType.name, ComponentDefinition.name, Panel.name from ComponentType, Panel, ComponentDefinition, Component where ";
    executeTestQuery(baseSQL + d + " and " + i + " and " + p + " and " + t);
    executeTestQuery(baseSQL + d + " and " + i + " and " + t + " and " + p);
    executeTestQuery(baseSQL + d + " and " + p + " and " + i + " and " + t);
    executeTestQuery(baseSQL + d + " and " + p + " and " + t + " and " + i);
    ...
    baseSQL =
      "select Component.name, ComponentType.name, ComponentDefinition.name, Panel.name from ComponentType, ComponentDefinition, Component,"
      + " Panel where ";
    executeTestQuery(baseSQL + d + " and " + i + " and " + p + " and " + t);
    executeTestQuery(baseSQL + d + " and " + i + " and " + t + " and " + p);
    executeTestQuery(baseSQL + d + " and " + p + " and " + i + " and " + t);
    ...
    baseSQL =
      "select Component.name, ComponentType.name, ComponentDefinition.name, Panel.name from ComponentType, ComponentDefinition, Panel, "
      + "Component where ";
    executeTestQuery(baseSQL + d + " and " + i + " and " + p + " and " + t);
    executeTestQuery(baseSQL + d + " and " + i + " and " + t + " and " + p);
    executeTestQuery(baseSQL + d + " and " + p + " and " + i + " and " + t);
