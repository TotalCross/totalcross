...
public class TestJoin extends TestCase {
	...
	private void testSimpleJoins() {
		...
		ResultSet rs =
			driver.executeQuery("select name, name2, age, age2 from person, person2 where 'RLN' = person.name order by name2");
		assertNotNull(rs);
		...
		assertNotNull(rs =
						  driver.executeQuery("select name, name2, age, age2 from person, person2  where age2 = 40 and name = 'RLN'"));
		...
		assertNotNull(rs =
						  driver.executeQuery("select name, name2, age, age2 from person, person2  where name = 'RLN' and person2.age2 = 40 "));
		assertEquals(1, rs.getRowCount());
		assertTrue(rs.next());
		assertEquals("RLN", rs.getString("name"));
		assertEquals("IAPU", rs.getString("name2"));
		...
		assertNotNull(rs =
						  driver.executeQuery("select name, name2, age, age2 from person, person2  where person.name = 'RLN' or person2.age2 = 40 "));
		...
		assertNotNull(rs =
						  driver.executeQuery("select name, name2, age, age2 from person, person2  where age2 = 40 or person.name = 'RLN'"));
		assertEquals(3, rs.getRowCount());
		assertTrue(rs.next());
		assertEquals("RLN", rs.getString("name"));
		assertEquals("RLN", rs.getString("name2"));
		...
		assertNotNull(rs =
						  driver.executeQuery("select name, name2 from person, person2 where person.name = person2.name2 and (person.name = 'RLN' or person2.name2 = 'RLN')"));
		assertEquals(1, rs.getRowCount());
		assertTrue(rs.next());
		assertEquals("RLN", rs.getString("name"));
		assertEquals("RLN", rs.getString("name2"));
		...
		assertNotNull(rs =
						  driver.executeQuery("select name, name2, age, age2 from person, person2  where not age2 <> 40 or not person.name <> 'RLN'"));
		assertEquals(3, rs.getRowCount());
		assertTrue(rs.next());
		assertEquals("RLN", rs.getString("name"));
		assertEquals("RLN", rs.getString("name2"));
		...
		// Tests the boolean operator NOT.
		assertNotNull(rs =
						  driver.executeQuery("select name, name2, age, age2 from  person,person2 where not years = 1 or not age2 = 30 "
											  + "order by age2"));
		assertEquals(3, rs.getRowCount());
		assertTrue(rs.next());
		assertEquals("IOG", rs.getString("name"));
		...
		assertNotNull(rs =
						  driver.executeQuery("select name, name2, age, age2 from person2,person where name = person2.name2"));
		assertEquals(1, rs.getRowCount());
		assertTrue(rs.next());
		assertEquals("RLN", rs.getString("name"));
		assertEquals("RLN", rs.getString("name2"));
	...
	private void testComparisons() {
		...
		ResultSet rs  =
			driver.executeQuery("select name, name2, age, age2 from person2, person where lower(person.name) = person2.name2");
		assertNotNull(rs);
		assertEquals(1, rs.getRowCount());
		assertTrue(rs.next());
		assertEquals("RLN", rs.getString("name"));
		...
		assertNotNull(rs =
						  driver.executeQuery("select name, name2, age, age2 from person2, person where person.age = person2.age2"));
		assertEquals(1, rs.getRowCount());
		assertTrue(rs.next());
		assertEquals("IOG", rs.getString("name"));
		assertEquals("RLN", rs.getString("name2"));
		...
		assertNotNull(rs =
						  driver.executeQuery("select name, name2, age, age2 from person2, person where person.age = person2.age2 or name = name2"));
		assertEquals(3, rs.getRowCount());
		assertTrue(rs.next());
		assertEquals("RLN", rs.getString("name"));
		assertEquals("RLN", rs.getString("name2"));
		...
		assertNotNull(rs =
						  driver.executeQuery("select name, name2, age, age2 from person2, person where person.age = person2.age2 and name = name2"));
		...
		assertNotNull(rs =
						  driver.executeQuery("select * from person2, person where age is null and years is null and age2 is null"));
		assertEquals(1, rs.getRowCount());
		assertTrue(rs.next());
		...
		assertNotNull(rs =
						  driver.executeQuery("select count(*) as tt from person, person2 where name = 'IND'"));
		assertTrue(rs.next());
		assertEquals(9, rs.getInt("tt"));
		rs.close();

		assertNotNull(rs =
						  driver.executeQuery("select name, count(*) as tt from person, person2 group by name"));
		assertEquals(3, rs.getRowCount());
		assertTrue(rs.next());
		assertEquals("IND", rs.getString("name"));
		assertEquals(9, rs.getInt("tt"));
		...
		assertNotNull(rs =
						  driver.executeQuery("select name, count(*) as tt from person, person2 group by name having tt > 3"));
		assertEquals(2, rs.getRowCount());
		assertTrue(rs.next());
		assertEquals("IND", rs.getString("name"));
		assertEquals(9, rs.getInt("tt"));
		...
		assertNotNull(rs =
						  driver.executeQuery("select age2, lower(name) as tt, age, upper(name2) as rr from person, person2 where name = name2 "
											  + "order by age"));
		assertEquals(2, rs.getRowCount());
		assertTrue(rs.next());
	...
	private void test3TablesJoin() {
		...
		assertNotNull(rs =
						  driver.executeQuery("select * from person, person2, person3 where name = name2"));
		assertEquals(32, rs.getRowCount());
		rs.close();

		assertNotNull(rs =
						  driver.executeQuery("select * from person, person2, person3 where name = name2 and person3.age3 is null"));
		assertEquals(12, rs.getRowCount());
		rs.close();

		assertNotNull(rs =
						  driver.executeQuery("select * from person, person2, person3 where name = name2 and person3.age3 is null and name3 = 'IOG' "
											  + "and age = 10"));
		assertEquals(1, rs.getRowCount());
		assertTrue(rs.next());
		assertEquals("RLN", rs.getString("name"));
	...
	private void testRSColName() {
		...
		assertEquals(4, (rs =
							 driver.executeQuery("select person.name as tt, age, years as bb, person2.name, person2.age2 from person, person2"))
					 .getRowCount());
		assertTrue(rs.next());
		assertEquals("RLN", rs.getString(1));
		assertEquals("20", rs.getString(2));
		...
		assertEquals((rs =
						  driver.executeQuery("select person.name, person2.name from person, person2")).getRowCount(), 4);
		assertTrue(rs.next());
		assertEquals("RLN", rs.getString(1));
	...
	private void testIndexOnAge() {
		...
		assertNotNull(rs =
						  driver.executeQuery("select * from person,person2 where name = 'RLN' and age = 40"));
		assertEquals(3, rs.getRowCount());
		assertTrue(rs.next());
		assertEquals("RLN", rs.getString("name"));
		assertEquals("RLN", rs.getString("name2"));
		...
		assertNotNull(rs =
						  driver.executeQuery("select * from person,person2 where name = 'RLN' or age = 40"));
		...
		assertNotNull(rs =
						  driver.executeQuery("select * from person,person2 where name = 'RLN2' and age = 40"));
		assertEquals(3, rs.getRowCount());
		assertTrue(rs.next());
		assertEquals("RLN2", rs.getString("name"));
		assertEquals("RLN", rs.getString("name2"));
	...
	private void testIndexOnName2() {
		ResultSet rs =
			driver.executeQuery("select * from person, person2 where name = 'RLN' and name2 = 'rln'");
		assertNotNull(rs);
		assertEquals(1, rs.getRowCount());
		assertTrue(rs.next());
		assertEquals("RLN", rs.getString("name"));
		...
		assertNotNull(rs =
						  driver.executeQuery("select * from person, person2 where name2 = 'rln' and name = 'RLN'"));
		...
		assertNotNull(rs =
						  driver.executeQuery("select * from person, person2 where name = 'RLN' or name2 = 'rln'"));
		...
		assertNotNull(rs =
						  driver.executeQuery("select * from person, person2 where name2 = 'rln' or name = 'RLN'"));
		assertEquals(5, rs.getRowCount());
		assertTrue(rs.next());
		assertEquals("RLN", rs.getString("name"));
		assertEquals("RLN", rs.getString("name2"));
		...
		assertNotNull(rs =
						  driver.executeQuery("select * from person, person2 where (name = 'RLN' or name2 = 'rln') or name = 'RLN2'"));
		...
		assertNotNull(rs =
						  driver.executeQuery("select * from person, person2 where (name = 'RLN' or name2 = 'rln') and name = 'RLN2'"));
		assertEquals(1, rs.getRowCount());
		assertTrue(rs.next());
		assertEquals("RLN2", rs.getString("name"));
		assertEquals("rln", rs.getString("name2"));
		...
		assertNotNull(rs =
						  driver.executeQuery("select * from person, person2 where name = 'RLN2' and (name = 'RLN' or name2 = 'rln')"));
		assertEquals(1, rs.getRowCount());
		assertTrue(rs.next());
		assertEquals("RLN2", rs.getString("name"));
		assertEquals("rln", rs.getString("name2"));
	...
	private void testComparisonsWithIndices() {
		...
		assertNotNull(rs =
						  driver.executeQuery("select * from person, person2 where name = name2 and name = 'IOG'"));
		assertEquals(1, rs.getRowCount());
		assertTrue(rs.next());
		assertEquals("IOG", rs.getString("name"));
		assertEquals("IOG", rs.getString("name2"));
		...
		assertNotNull(rs =
						  driver.executeQuery("select * from person, person2 where name = name2 and age = age2"));
		assertEquals(1, rs.getRowCount());
		assertTrue(rs.next());
		assertEquals("RLN", rs.getString("name"));
		assertEquals("RLN", rs.getString("name2"));
		...
		assertNotNull(rs =
						  driver.executeQuery("select * from person, person2 where age = age2 and name = name2"));
		assertEquals(1, rs.getRowCount());
		assertTrue(rs.next());
		assertEquals("RLN", rs.getString("name"));
		assertEquals("RLN", rs.getString("name2"));
	...
	private void testPrimaryKeyAndOrdering() {
		...
		// Populates the tables
		PreparedStatement ptInsert =
			driver.prepareStatement("insert into person (id,lastname,firstname) values (?,?,?)");
		PreparedStatement acctInsert =
			driver.prepareStatement("insert into course (id,personid,cname) values (?,?,?)");
		int i = 101;
		while (--i > 0) {
		...
		assertEquals(1, (rs =
							 driver.executeQuery("select course.id from course where course.personid = 50")).getRowCount());
		rs.close();

		assertEquals(1, (rs =
							 driver.executeQuery("select person.id, course.id from person,course where person.id = course.personid and person.id = 50")).getRowCount());
		rs.next();
		...
		assertEquals(1, (rs =
							 driver.executeQuery("select person.id, course.id from course, person where person.id = course.personid and person.id = 50")).getRowCount());
		rs.next();
		assertEquals(50, rs.getLong(1));
		assertEquals(150, rs.getLong(2));
		rs.close();
		...
		assertEquals(1, (rs =
							 driver.executeQuery("select person.id, course.id from person,course where course.personid = person.id and person.id = 50")).getRowCount());
		rs.next();
		assertEquals(50, rs.getLong(1));
		assertEquals(150, rs.getLong(2));
		rs.close();
		...
		assertEquals(1, (rs =
							 driver.executeQuery("select person.id, course.id from course, person where course.personid = person.id and person.id = 50")).getRowCount());
		rs.next();
		assertEquals(50, rs.getLong(1));
		assertEquals(150, rs.getLong(2));
		rs.close();
		...
		assertEquals(1, (rs =
							 driver.executeQuery("select person.id, course.id from person,course where person.id = 50 and course.personid = person.id")).getRowCount());
		rs.next();
		assertEquals(50, rs.getLong(1));
		assertEquals(150, rs.getLong(2));
		rs.close();
		...
		assertEquals(1, (rs =
							 driver.executeQuery("select person.id, course.id from course, person where person.id = 50 and course.personid = person.id")).getRowCount());
		rs.next();
		assertEquals(50, rs.getLong(1));
		assertEquals(150, rs.getLong(2));
		rs.close();
	...
	void testComparisonInTheSameTable() {
		...
		ResultSet resultSet =
			driver.executeQuery("select * from M_META_GRUPO_MATERIAL MGM where MGM.QTD_CONSUMIDA = MGM.QTD_META");
		...
		assertEquals(2, (resultSet =
							 driverAux.executeQuery("select * from M_MATERIAL MM, M_META_GRUPO_MATERIAL MGM where MM.GMF_CODIGO=MGM.GMF_CODIGO and MM.CODIGO_MATERIAL=1")).getRowCount());
		resultSet.close();

		assertEquals(1, (resultSet =
							 driverAux.executeQuery("select * from M_MATERIAL MM, M_META_GRUPO_MATERIAL MGM where MM.GMF_CODIGO=MGM.GMF_CODIGO and MM.CODIGO_MATERIAL=1 and MGM.QTD_CONSUMIDA = MGM.QTD_META")).getRowCount());
		resultSet.close();

		assertEquals(1, (resultSet =
							 driverAux.executeQuery("select * from M_MATERIAL MM, M_META_GRUPO_MATERIAL MGM where MM.GMF_CODIGO=MGM.GMF_CODIGO and MM.CODIGO_MATERIAL=1 and MGM.QTD_CONSUMIDA = 350.5")).getRowCount());
		resultSet.close();
	}
	...
	private void testOrWithFalseConstantComparison() {
		...
		assertEquals(2, (resultSet =
							 driverAux.executeQuery("select * from tbpedido ped, tbcliente cli where cli.cdcliente = ped.cdcliente and "
		...
		assertEquals(2, (resultSet =
							 driverAux.executeQuery("select * from tbpedido ped, tbcliente cli where (ped.cdcliente = 1 or '1' = '0') and "
									 + "cli.cdcliente = ped.cdcliente")).getRowCount());
		resultSet.close();

		assertEquals(2, (resultSet =
							 driverAux.executeQuery("select * from tbpedido ped, tbcliente cli where ('1' = '0' or ped.cdcliente = 1) and "
									 + "cli.cdcliente = ped.cdcliente")).getRowCount());
		resultSet.close();
	}
	...
	void testOrderGroupBy() {
		...
		// The joins.
		ResultSet resultSet =
			driverAux.executeQuery("select ASS.IDASSGRUPOPERGUNTA, P.IDPERGUNTA, P.DESCRICAO, P.FOTO from PERGUNTA P, "
