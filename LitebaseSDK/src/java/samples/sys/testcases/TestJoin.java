...
// $Id: TestJoin.java,v 1.1.2.6.2.4.4.20 2011-01-03 20:20:35 juliana Exp $
...
public class TestJoin extends TestCase
{
   ...
   private void testJoinSintax()
   {
      ...
      // Create tables.
      driver.execute("create table person(person_id int primary key, name char(20) default 'Está sem nome: ç^~' not null, age int default 10, " 
