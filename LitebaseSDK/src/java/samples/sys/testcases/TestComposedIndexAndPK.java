...
public class TestComposedIndexAndPK extends TestCase
{
   ...
   public void testRun()
   {
      try
      {
         ...
         driver.executeUpdate("INSERT INTO person VALUES (2, 'Indira', 'Jequié', 562)");
         driver.executeUpdate("INSERT INTO person VALUES (3, 'Zenes e Jener', 'Caculé', 120)");
         driver.executeUpdate("INSERT INTO person VALUES (4, 'Jener e Zenes', 'Caculé', 500)");
         ...
         driver.executeUpdate("INSERT INTO person VALUES (7, 'Joao Pedro', 'Caculé', 620)");
         ...
         driver.executeUpdate("INSERT INTO person VALUES (10, 'Zé de Jener', 'Caculé', 1234)");
         driver.executeUpdate("INSERT INTO person VALUES (11, 'Marlene', 'Caculé', 156)");
         ...
         try // Repeated key.
         {
            driver.executeUpdate("Insert into person values (3, 'RLN', 'Caculé', 25, 10)");
            fail("7");
         }
         catch (PrimaryKeyViolationException exception) {}
         
         driver.executeUpdate("Insert into person values (1, 'Indira', 'Jequié', 21, 14)");
         ...
         try // Null in a key.
         {
            driver.executeUpdate("Insert into person values (1, null, 'jacaré', 26, 16)");
            fail("9");
         }
         catch (DriverException exception) {}
         try // Null in a key.
         {
            driver.executeUpdate("Insert into person values (null, 'Maria', 'jacaré', 26, 16)");
            fail("10");
         }
         catch (DriverException exception) {}
         
         driver.executeUpdate("Insert into person values (3, 'RLN1', 'da u pé', 81,166)");
