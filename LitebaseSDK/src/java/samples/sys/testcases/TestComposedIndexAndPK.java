	...
	public void testRun() {
		try {
			...
			assertTrue(new File(path + "Test-person&1.idk",
								File.DONT_OPEN).exists()); // The composed index files must exist.
			...
			driver.closeAll();
			assertTrue(new File(path + "Test-person$1.idk",
								File.DONT_OPEN).exists()); // The simple index files must exist.
			...
			rs.close();
			assertEquals(5, (rs =
								 driver.executeQuery("select * from person where not ('a' != 'a')")).getRowCount());
			rs.close();
			assertEquals(0, (rs =
								 driver.executeQuery("select * from person where ('2010/11/23' != '2010/11/23')")).getRowCount());
			rs.close();
			assertEquals(0, (rs =
								 driver.executeQuery("select * from person where not ('2010/11/23 17:28:11' = '2010/11/23 17:28:11')")).getRowCount());
			rs.close();
			assertEquals(0, (rs =
								 driver.executeQuery("select * from person where (0.1d = 0.2d)")).getRowCount());
			rs.close();
			assertEquals(5, (rs = driver.executeQuery("select * from person where not (0 = 1)")).getRowCount());
			rs.close();
			assertEquals(5, (rs =
								 driver.executeQuery("select * from person where ('2010/11/24' != '2010/11/23')")).getRowCount());
			rs.close();
			assertEquals(5, (rs =
								 driver.executeQuery("select * from person where not ('2010/11/23 17:28:11' = '2010/11/23 17:28:12')")).getRowCount());
			rs.close();

			// Tests queries that uses the composed primary key.
			assertEquals(1, (rs =
								 driver.executeQuery("select * from person where (1 = 1 and id = 3 and name = 'RLN')")).getRowCount());
			rs.next();
			...
			assertEquals(1, (rs =
								 driver.executeQuery("select * from person where (name = 'RLN' and id = 3 and 1 = 1)")).getRowCount());
			rs.next();
			assertEquals(3, rs.getInt("id"));
			assertEquals("RLN", rs.getString("name"));
			assertEquals(44, rs.getInt("age"));
			...
			assertEquals(1, (rs =
								 driver.executeQuery("select * from person where (1 = 1 and id = 3 and address = 'Salvador')")).getRowCount());
			rs.next();
			assertEquals(3, rs.getInt("id"));
			assertEquals("RLN", rs.getString("name"));
			assertEquals(44, rs.getInt("age"));
			...
			assertEquals(1, (rs =
								 driver.executeQuery("select * from person where (address = 'Salvador' and id = 3 and 1 = 1)")).getRowCount());
			rs.next();
			assertEquals(3, rs.getInt("id"));
			assertEquals("RLN", rs.getString("name"));
			assertEquals(44, rs.getInt("age"));
			...
			assertEquals(3, (rs =
								 driver.executeQuery("select * from person where (1 = 1 and id = 3)")).getRowCount());
			rs.next();
			assertEquals(3, rs.getInt("id"));
			assertEquals("RLN", rs.getString("name"));
			assertEquals(44, rs.getInt("age"));
			...
			assertEquals(3, (rs =
								 driver.executeQuery("select * from person where (id = 3 and 1 = 1)")).getRowCount());
			rs.next();
			assertEquals(3, rs.getInt("id"));
			assertEquals("RLN", rs.getString("name"));
			assertEquals(44, rs.getInt("age"));
			...
			assertEquals(1, (rs =
								 driver.executeQuery("select * from person where (1 = 1 and name = 'RLN')")).getRowCount());
			rs.next();
			assertEquals(3, rs.getInt("id"));
			assertEquals("RLN", rs.getString("name"));
			assertEquals(44, rs.getInt("age"));
			...
			assertEquals(1, (rs =
								 driver.executeQuery("select * from person where (name = 'RLN' and 1 = 1)")).getRowCount());
			rs.next();
			assertEquals(3, rs.getInt("id"));
			assertEquals("RLN", rs.getString("name"));
			assertEquals(44, rs.getInt("age"));
			...
			assertEquals(1, (rs =
								 driver.executeQuery("select * from person where (address = 'Salvador' and age = 44)")).getRowCount());
			rs.next();
			assertEquals(3, rs.getInt("id"));
			assertEquals("RLN", rs.getString("name"));
			assertEquals(44, rs.getInt("age"));
			...
			assertEquals(1, (rs =
								 driver.executeQuery("select * from person where age < 45 and age > 43")).getRowCount());
			rs.next();
			assertEquals(3, rs.getInt("id"));
			assertEquals("RLN", rs.getString("name"));
			assertEquals(44, rs.getInt("age"));
			...
			assertEquals(1, (rs =
								 driver.executeQuery("select * from person where years >= 3 and years <= 3")).getRowCount());
			rs.next();
			assertEquals(3, rs.getInt("id"));
			assertEquals("RLN", rs.getString("name"));
			assertEquals(44, rs.getInt("age"));
			...
			// Tests update.
			assertEquals(1,
						 driver.executeUpdate("update person set name = 'juliana' where id = 3 and name = 'RLN'"));
			assertEquals(0, (rs =
								 driver.executeQuery("select * from person where id = 3 and name = 'RLN'")).getRowCount());
			rs.close();
			assertEquals(1, (rs =
								 driver.executeQuery("select * from person where id = 3 and name = 'juliana'")).getRowCount());
			rs.close();
			...
			assertEquals(1, (rs =
								 driver.executeQuery("select * from person where id = 3 and name = 'maria'")).getRowCount());
			rs.close();
			...
			driver.executeUpdate("insert into CDAIT values (7667, 'EHYYSSSSS�', 'Y', '2011/12/22', 'YYYY:::', 1, 'HX�YH', 1, 'YB�_HE', null)");
			assertEquals(2, (rs =
								 driver.executeQuery("SELECT * from CDAIT WHERE CDAITORGAO = 7667 AND CDAITAGENTE = 'YB�_HE' AND CDAITCOD IS NOT NULL")).getRowCount());
			rs.close();
			driver.closeAll();
