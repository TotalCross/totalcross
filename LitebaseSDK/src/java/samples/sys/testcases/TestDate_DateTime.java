...
// $Id: TestDate_DateTime.java,v 1.9.4.2.2.1.4.30 2011-03-21 21:28:51 juliana Exp $
...
public class TestDate_DateTime extends TestCase
{
   ...
   private void testPreparedStatement2() // rnovais@570_108
   {
      ...
      ps.setString(3, " 2006/08-21    12:08:01:0 ");
      ps.executeUpdate();
      driver.prepareStatement("insert into person2 values ('joão pedro',13, '2006/7/8 ', '2006/08-21 0:08')").executeUpdate();
