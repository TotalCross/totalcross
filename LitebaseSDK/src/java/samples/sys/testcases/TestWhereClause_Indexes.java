...
public class TestWhereClause_Indexes extends TestCase
{
  ...
  public void testRun()
  {
    ...
    // Creates the table.
    driver.execute(
      "create table PERSON (FIRST_NAME CHAR(30), CITY CHAR(30), SALARY_CUR DOUBLE, SALARY_PREV DOUBLE, YEARS_EXP_JAVA INT, "
      + "YEARS_EXP_C INT )");
    ...
    driver.execute(
      "create table parecer(numero_registro int primary key, nome_obra char(08), fase_obra char(04), Codigo_Etapa short, "
      +
    ...
    driver.executeUpdate(
      "Insert into parecer(numero_registro, nome_obra, fase_obra, Codigo_Etapa, numero_ord_serv , codigo_atividade , "
      +
    ...
    ResultSet resultSet = driver.executeQuery(
      "Select codigo_Empreiteiro, Codigo_Atividade, Numero_Ord_Serv, Data_Prevista_Ini, Data_Prevista_Fim,"
      +
    ...
    driver.execute(
      "create table visitaDetalhe ( codigoVendedor char( 6 ), dataRoteiro char( 8 ), codigoCliente char( 8 ), status char( 2 ), "
      +
    ...
    driver.execute(
      "create index idx_dataRoteiro on visitaDetalhe(dataRoteiro)");
    assertEquals(0,
                 driver.executeUpdate(
                   "delete visitaDetalhe  where dataRoteiro <> '20110211'"));
    driver.executeUpdate(
      "insert into visitaDetalhe values ( '700001','20101001','00000301','00','00000000','000',0,'','','','','','','','','','',"
      + "'','',0,'---','S','','' )");
    driver.executeUpdate(
      "insert into visitaDetalhe values ( '700001','20101001','00000401','03','00000000','000',0,'','','','','','','','','','',"
      + "'','',0,'---','S','','' )");
    driver.executeUpdate(
      "insert into visitaDetalhe values ( '700001','20101001','00000401','03','00000000','000',0,'','','','','','','','','','',"
      + "'','',0,'---','S','','' )");
    driver.executeUpdate(
      "insert into visitaDetalhe values ( '700001','20101001','00001501','03','00000000','000',0,'','','','','','','','','','',"
      + "'','',0,'---','S','','' )");
    driver.executeUpdate(
      "insert into visitaDetalhe values ( '700001','20101001','00001501','03','00000000','000',0,'','','','','','','','','','',"
      + "'','',0,'---','S','','' )");
    driver.executeUpdate(
      "insert into visitaDetalhe values ( '700001','20101001','00001701','00','00000000','000',0,'','','','','','','','','','',"
      + "'','',0,'---','S','','' )");
    driver.executeUpdate(
      "insert into visitaDetalhe values ( '700001','20101001','00002501','00','00000000','000',0,'','','','','','','','','','',"
      + "'','',0,'---','S','','' )");
    driver.executeUpdate(
      "insert into visitaDetalhe values ( '700001','20101001','00002501','03','00000000','000',0,'','','','','','','','','','',"
      + "'','',0,'---','S','','' )");
    driver.executeUpdate(
      "insert into visitaDetalhe values ( '700001','20101001','00002501','03','00000000','000',0,'','','','','','','','','','',"
      + "'','',0,'---','S','','' )");
    driver.executeUpdate(
      "insert into visitaDetalhe values ( '700001','20101001','00003001','00','00000000','000',0,'','','','','','','','','','',"
      + "'','',0,'---','S','','' )");
    ...
    assertEquals(
      1, driver.executeUpdate("delete from person p where p.rowid = 1"));
    ...
    assertEquals(
      1, driver.executeUpdate("delete from person p where p.id is not null"));
    assertEquals(2, driver.getRowCountDeleted("person"));
    assertEquals(1, driver.getRowCount("person"));
    assertEquals(
      1, driver.executeUpdate("delete from person p where p.id is null"));
    ...
    driver.execute(
      "create table cliente (CODCLI char( 10 ), CODIGO char( 10 ), NOMEFANTASIA char( 50 ), RAZAOSOCIAL char( 65 ), "
      +
    ...
    driver
      .executeQuery(
        "select rowid,NOMEFANTASIA,RAZAOSOCIAL,CODIGO,BLOQUEIAVENDA,CNPJCPF,CODCLI from cliente "
        +
    ...
    driver.execute(
      "create table CADCLIENTES (id int, CODCLIPRE char(5), RAZAO char(60), ENDERECO char(40), REFENDER char(25), BAIRRO char(20), "
      +
    ...
    driver.executeUpdate(
      "insert into CADCLIENTES values (-1, null, 'TESTE', 'ASD', null, 'ASD', 'ASD', 'AL', '22222222', null, '10101142714', "
      +
      "null, null, 'ASD', 'ASD', '123', '', 'ASD', null, '029', null, '', '001', 'F', 'N', 'N', 'TESTE', '')");
    driver.executeUpdate(
      "update CADCLIENTES set id = 37, CODCLIPRE = 'YTPEE', ENV = 'S' where id = -1");
  ...
  private void testQueries(LitebaseConnection driver)
  {
    ...
    assertEquals(
      2,
      executeQuery(driver,
                   "select * from PERSON where FIRST_NAME = 'guilherme'"));
    assertEquals(
      19,
      executeQuery(
        driver,
        "select * from PERSON where FIRST_NAME != 'guilherme' and FIRST_NAME is not null"));
    ...
    assertEquals(
      ...
      executeQuery(
        driver,
        "select * from PERSON where FIRST_NAME = 'guilherme' or FIRST_NAME = 'roberto'"));
    assertEquals(
      7,
      executeQuery(
        driver,
        "select * from PERSON where FIRST_NAME = 'roberto' or city = 'Porto Seguro'"));
    ...
    assertEquals(
      ...
      executeQuery(
        driver,
        "select * from PERSON where FIRST_NAME = 'maria' and city = 'Paraty'"));
    assertEquals(
      3,
      executeQuery(
        driver,
        "select * from PERSON where FIRST_NAME = 'maria' and YEARS_EXP_C = 6"));

    // Exact query with function.
    assertEquals(
      2,
      executeQuery(
        driver, "select * from PERSON where upper(FIRST_NAME) = 'GUILHERME'"));
    assertEquals(
      19,
      executeQuery(
        driver, "select * from PERSON where upper(FIRST_NAME) != 'GUILHERME'"));
    ...
    assertEquals(
      ...
      executeQuery(
        driver,
        "select * from PERSON where salary_prev < 3000 or years_exp_C = 10 or years_exp_java > 20"));
    assertEquals(
      6,
      executeQuery(
        driver,
        "select * from PERSON where city = 'Ouro Preto' or SALARY_CUR > 10000 or years_exp_C = 12"));
    assertEquals(
      9,
      executeQuery(
        driver,
        "select * from PERSON where city = 'Paraty' or years_exp_Java > 10 or years_exp_C > 18"));
    assertEquals(
      19,
      executeQuery(
        driver,
        "select * from PERSON where (years_exp_C > 10 or years_exp_C < 10) and years_exp_C is not null"));
    ...
    assertEquals(
      ...
      executeQuery(
        driver,
        "select * from PERSON where salary_prev < 3000 and years_exp_C = 10 and years_exp_java > 3"));
    assertEquals(
      1,
      executeQuery(
        driver,
        "select * from PERSON where FIRST_NAME = 'maria' and SALARY_CUR > 3000 and years_exp_C = 6"));
    assertEquals(
      2,
      executeQuery(
        driver,
        "select * from PERSON where city = 'Rio de Janeiro' and years_exp_Java > 10 and years_exp_C > 3"));
    assertEquals(
      2,
      executeQuery(
        driver,
        "select * from PERSON where city = 'Rio de Janeiro' and years_exp_C < 10 and years_exp_C > 3"));
    ...
    assertEquals(
      ...
      executeQuery(
        driver,
        "select * from PERSON where (salary_prev < 3000 and years_exp_C = 10) or city = 'Natal'"));
    assertEquals(
      8,
      executeQuery(
        driver,
        "select * from PERSON where FIRST_NAME = 'maria' or (SALARY_CUR > 3000 and years_exp_C = 6) "
          + "or city = 'Fortaleza'"));
    assertEquals(
      5,
      executeQuery(
        driver,
        "select * from PERSON where city = 'Rio de Janeiro' and (years_exp_Java > 10 or years_exp_C > 3)"));
    assertEquals(
      2,
      executeQuery(
        driver,
        "select * from PERSON where (salary_prev < 3000 or years_exp_C = 10) and city = 'Porto Seguro' "
          + "and years_exp_C > 2"));
    ...
    assertEquals(
      ...
      executeQuery(
        driver,
        "select * from PERSON where FIRST_NAME != 'null' and FIRST_NAME is not null"));
    assertEquals(
      1,
      executeQuery(driver, "select * from PERSON where FIRST_NAME = 'null'"));
    assertEquals(
      21,
      executeQuery(driver,
                   "select * from PERSON where FIRST_NAME is not null"));
    assertEquals(
      1, executeQuery(driver, "select * from PERSON where FIRST_NAME is null"));
  }
}
