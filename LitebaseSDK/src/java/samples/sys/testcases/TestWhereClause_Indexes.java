...
public class TestWhereClause_Indexes extends TestCase {
	...
	public void testRun() {
		...
		ResultSet resultSet =
			driver.executeQuery("Select codigo_Empreiteiro, Codigo_Atividade, Numero_Ord_Serv, Data_Prevista_Ini, Data_Prevista_Fim,"
	...
	private void testQueries(LitebaseConnection driver) {
		...
		assertEquals(19, executeQuery(driver,
									  "select * from PERSON where upper(FIRST_NAME) != 'GUILHERME'"));

		// Non-exact search with OR.
		assertEquals(13, executeQuery(driver,
		...
		// Null queries.
		assertEquals(20, executeQuery(driver,
