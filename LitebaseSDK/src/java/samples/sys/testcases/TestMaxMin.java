...
public class TestMaxMin extends TestCase
{
  ...
  public void testRun()
  {
    ...
    connection.execute(
      "create table person (name char(10), cpf char(10), birth datetime, id long)");
  ...
  private void testEmptyMaxMin(LitebaseConnection connection)
  {
    ResultSet resultSet = connection.executeQuery(
      "select max(name) as maxn, min(name) as minn, max(cpf) as maxc, min(cpf) as minc from person");
    ...
    assertEquals(
      ...
      (resultSet = connection.executeQuery(
         "select max(name) as maxn, min(name) as minn, max(cpf) as maxc, min(cpf) as minc "
         + "from person where name > 'name0' and cpf > 'cpf0'"))
        .getRowCount());
    assertFalse(resultSet.next());
    resultSet.close();
    ...
    assertEquals(
      ...
      (resultSet = connection.executeQuery(
         "select max(name) as maxn, min(name) as minn, max(cpf) as maxc, min(cpf) as minc "
         + "from person where name > 'name0' and cpf < 'cpf999'"))
        .getRowCount());
    assertFalse(resultSet.next());
    resultSet.close();
    ...
    assertEquals(
      ...
      (resultSet = connection.executeQuery(
         "select max(name) as maxn, min(name) as minn, max(cpf) as maxc, min(cpf) as minc "
         + "from person where name < 'name999' and cpf > 'cpf0'"))
        .getRowCount());
    assertFalse(resultSet.next());
    resultSet.close();
    ...
    assertEquals(
      ...
      (resultSet = connection.executeQuery(
         "select max(name) as maxn, min(name) as minn, max(cpf) as maxc, min(cpf) as minc "
         + "from person where name = 'name0' and cpf = 'cpf1999'"))
        .getRowCount());
    assertFalse(resultSet.next());
    resultSet.close();
    ...
    assertEquals(
      ...
      (resultSet = connection.executeQuery(
         "select max(name) as maxn, min(name) as minn, max(cpf) as maxc, min(cpf) as minc "
         + "from person where name = 'name1999' and cpf = 'cpf0'"))
        .getRowCount());
    assertFalse(resultSet.next());
    resultSet.close();
    ...
    assertEquals(
      0,
      (resultSet = connection.executeQuery(
         "select count(*) as c, avg(rowid) as a, max(name) as maxn, min(name) as minn, "
         + "max(cpf) as maxc, min(cpf) as minc from person"))
        .getRowCount());
    assertFalse(resultSet.next());
    resultSet.close();
    ...
    assertEquals(
      0,
      (resultSet = connection.executeQuery(
         "select max(birth) as maxb, min(birth) as mimb from person"))
        .getRowCount());
    assertFalse(resultSet.next());
    resultSet.close();
    ...
    assertEquals(
      0,
      (resultSet = connection.executeQuery(
         "select max(birth) as maxb, min(birth) as mimb from person where birth is null"))
        .getRowCount());
    assertFalse(resultSet.next());
    resultSet.close();
    ...
    assertEquals(
      0,
      (resultSet = connection.executeQuery(
         "select max(birth) as maxb, min(birth) as mimb from person where birth is not null"))
        .getRowCount());
    assertFalse(resultSet.next());
    resultSet.close();
    ...
    assertEquals(
      0,
      (resultSet = connection.executeQuery(
         "select max(birth) as maxb, min(birth) as mimb from person where birth > '2011/07/19'"))
        .getRowCount());
    assertFalse(resultSet.next());
    resultSet.close();
    ...
    assertEquals(
      0,
      (resultSet = connection.executeQuery(
         "select max(birth) as maxb, min(birth) as mimb from person where birth < '2011/07/20'"))
        .getRowCount());
    assertFalse(resultSet.next());
    resultSet.close();
    ...
    assertEquals(
      0,
      (resultSet = connection.executeQuery(
         "select max(birth) as maxb, min(birth) as mimb from person where birth like '2011/07/19%'"))
        .getRowCount());
    assertFalse(resultSet.next());
    resultSet.close();
    ...
    assertEquals(
      0,
      (resultSet = connection.executeQuery(
         "select max(birth) as maxb, min(birth) as mimb from person where birth like '2011/07/18%'"))
        .getRowCount());
    assertFalse(resultSet.next());
    resultSet.close();
    ...
    assertEquals(0,
                 (resultSet = connection.executeQuery(
                    "select max(id) as maxi, min(id) as mini from person"))
                   .getRowCount());
    assertFalse(resultSet.next());
    resultSet.close();
  }
  ...
  private void testMaxMinWithDelete(LitebaseConnection connection)
  {
    ...
    assertEquals(
      ...
      (resultSet = connection.executeQuery(
         "select max(name) as maxn, min(name) as minn, max(cpf) as maxc, min(cpf) as minc "
         + "from person where name = 'name1' and cpf = 'cpf1998'"))
        .getRowCount());
    assertTrue(resultSet.next());
    ...
    assertEquals(
      ...
      (resultSet = connection.executeQuery(
         "select max(name) as maxn, min(name) as minn, max(cpf) as maxc, min(cpf) as minc "
         + "from person where name = 'name1998' and cpf = 'cpf1'"))
        .getRowCount());
    assertTrue(resultSet.next());
    ...
    assertEquals(
      ...
      (resultSet = connection.executeQuery(
         "select max(name) as maxn, min(name) as minn, max(cpf) as maxc, min(cpf) as minc "
         + "from person where name = 'name999' or cpf = 'cpf0'"))
        .getRowCount());
    assertFalse(resultSet.next());
    resultSet.close();
