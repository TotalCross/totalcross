...
public class TestMultipleConnection extends TestCase {
	...
	private void TestConnections(String tempPath) {
		...
		LitebaseConnection driver1 = AllTests.getInstance("Test",
		...
		LitebaseConnection driver2 = AllTests.getInstance("Test",
		...
		assertEquals(1, driver2.executeUpdate("insert into person values('" + rs1.getString("id") + "','" +
