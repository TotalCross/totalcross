...
class SQLColumnListClause {
	...
	public void checkEquality(SQLColumnListClause columnListClause) throws SQLParseException {
		...
		if (len !=
			columnListClause.fieldsCount) // If the length of the column lists are different, the lists are different.
	 ...
	 * clause.
	 */
	void bindColumnsSQLColumnListClause(IntHashtable names2Index, byte[] columnTypes,
