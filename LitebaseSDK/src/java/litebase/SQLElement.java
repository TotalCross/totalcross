...
/**
 * Internal use only. Represents a SQL element, like data types, operands, and
 * functions. It also has useful methods.
 */
class SQLElement
{
  ...
  /**
   * Represents the SQL command <code>ALTER TABLE ADD... (new column definition)
   * </code>.
   */
  static final int CMD_ALTER_ADD_COLUMN =
    9; // juliana@253_22: added command ALTER TABLE ADD column.
  ...
  /**
   * <code>AVG</code> aggregation function. It calculates the average of the
   * values.
   */
  ...
  /**
   * <code>YEAR</code> function. It returns the year of a date or a datetime
   * data type.
   */
  static final int FUNCTION_DT_YEAR = 0;

  /**
   * <code>MONTH</code> function. It returns the month of a date or a datetime
   * data type.
   */
  static final int FUNCTION_DT_MONTH = 1;

  /**
   * <code>DAY</code> function. It returns the day of a date or a datetime data
   * type.
   */
  ...
  /**
   * <code>MINUTE</code> function. It returns the minutes of a datetime data
   * type.
   */
  static final int FUNCTION_DT_MINUTE = 4;

  /**
   * <code>SECOND</code> function. It returns the seconds of a datetime data
   * type.
   */
  static final int FUNCTION_DT_SECOND = 5;

  /**
   * <code>MILLIS</code> function. It returns the milli secconds of a datetime
   * data type.
   */
  static final int FUNCTION_DT_MILLIS = 6;

  /**
   * <code>ABS</code> function. It returns the absolute value of a number data
   * type.
   */
  static final int FUNCTION_DT_ABS = 7; // rnovais@570_1

  /**
   * <code>UPPER</code> function. It converts the characters of a string to
   * upper case.
   */
  static final int FUNCTION_DT_UPPER = 8; // rnovais@570_1

  /**
   * <code>LOWER</code> function. It converts the characters of a string to
   * lower case.
   */
  static final int FUNCTION_DT_LOWER = 9; // rnovais@570_1

  // juliana@250_8: now the maximum number of columns, fields, tables, etc is
  // 254 instead of 128 except on palm. Maximum constants.
  /**
   ...
   */
  static final String[] aggregateFunctionsNames = { "count",
                                                    "max",
                                                    "min",
                                                    "avg",
                                                    "sum" };
   ...
   */
  static final byte[] aggregateFunctionsTypes = { INT,
                                                  UNDEFINED,
                                                  UNDEFINED,
                                                  DOUBLE,
                                                  DOUBLE };
   ...
   */
  static final String[] dataTypeFunctionsNames = { "year",   "month",  "day",
                                                   "hour",   "minute", "second",
                                                   "millis", "abs",    "upper",
                                                   "lower" };
   ...
   */
  static final byte[] dataTypeFunctionsTypes = { SHORT, SHORT, SHORT, SHORT,
                                                 SHORT, SHORT, SHORT, UNDEFINED,
                                                 CHARS, CHARS };

  // rnovais@_568_10
  /**
   * Functions X data type. Each row corresponds to one data type:
   * <code>CHARS</code>, <code>SHORT</code>, <code>INT</code>,
   * <code>LONG</code>, <code>FLOAT</code>, <code>DOUBLE</code>,
   * <code>CHARS_NOCASE</code>, <code>BOOLEAN</code>, <code>DATE</code>, and
   * <code>DATETIME</code>. The order can't be changed and it contains the
