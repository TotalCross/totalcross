							...
							switch (colType) { // Checks the type of the column
								...
								case SQLElement.DATETIME: // rnovais@567_2
									if (groupCountCols[j] == 1) {
										aggValue.asInt = value.asInt;
										aggValue.asShort = value.asShort;
									} else if ((aggValue.asInt <= value.asInt) && ((aggValue.asInt < value.asInt) || (aggValue.asShort < value.asShort) )) {
										aggValue.asInt = value.asInt;
										aggValue.asShort = value.asShort;
									}
							}
							...
							switch (colType) { // Checks the type of the column
								...
								case SQLElement.DATETIME: // rnovais@567_2
									if (groupCountCols[j] == 1) {
										aggValue.asInt = value.asInt;
										aggValue.asShort = value.asShort;
									} else if ((aggValue.asInt >= value.asInt) && ((aggValue.asInt > value.asInt) || (aggValue.asShort > value.asShort) )) { // the date is greater, or the time is greater
										aggValue.asInt = value.asInt;
										aggValue.asShort = value.asShort;
									}
							}
