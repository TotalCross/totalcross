...
public class LitebaseConnection4D {
	 ...
	 */
	private static native LitebaseConnection4D privateGetInstance(String appCrid) throws
	...
	private static native LitebaseConnection4D privateGetInstance(String appCrid,
			String params) throws DriverException, NullPointerException;
	 ...
	 */
	private static native LitebaseConnection4D privateProcessLogs(String[] sql, String params,
	...
	*/
	 ...
	 */
	public native static void dropDatabase(String crid, String sourcePath,
										   int slot) throws DriverException, NullPointerException;
	 ...
	 */
	public native boolean isTableProperlyClosed(String tableName) throws DriverException,
	 ...
	 * @throws OutOfMemoryError If a memory allocation fails.
	 */
	public native String[] listAllTables() throws DriverException, IllegalStateException,
			   OutOfMemoryError;
