...
public class ResultSetMetaData4D {
	 ...
	 */
	public native String getColumnTableName(String columnName) throws DriverException,
	 ...
	 * @throws NullPointerException if the column name is null.
	 */
	public native boolean hasDefaultValue(String columnName) throws DriverException,
			   NullPointerException;
	 ...
	 * @throws NullPointerException if the column name is null.
	 */
	public native String getDefaultValue(String columnName) throws DriverException,
			   NullPointerException;
}
