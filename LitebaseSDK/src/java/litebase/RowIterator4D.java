...
/**
 * Native class used to iterate through the rows of a database. It can access
 * some attributes from the row that eases the control of which row was changed,
 * deleted or is newer since a synchronization.
 */
public class RowIterator4D
{
   ...
   *     synced. Otherwise, it will return <code>false</code>.
   */
