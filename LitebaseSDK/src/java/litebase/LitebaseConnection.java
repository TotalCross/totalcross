...
{ 
    ...
    */
   public static String versionStr = "2.64beta";
      ...
      try
      {
         ...
         while (++i < rows) // Checks all table records.
         {
            ...
            else
            {
               ...
               int leu = dataStream.readInt();
               if (table.name.contains("laudo"))
                  System.out.println("crc antigo: "+leu+", novo: "+crc32);
               if (crc32 != leu) // Deletes and invalidates corrupted records.
               {
                  bas.reset();
