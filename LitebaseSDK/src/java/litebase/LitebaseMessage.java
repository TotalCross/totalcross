...
/**
 * Contains error messages with multi-language support. By now, only English and
 * Portuguese are implemented.
 */
class LitebaseMessage
{
   ...
   */
  static final int ERR_NOT_NULL_DEFAULT =
    22; // juliana@253_22: added command ALTER TABLE ADD column.

  // Driver errors.
  /**
   * "This driver instance was closed and can't be used anymore. Please get a
   * new instance of it."
   */
  ...
  /**
   * "Cant't find native methods implementation for LitebaseConnection. Please
   * install Litebase.dll/prc file."
   */
  ...
  // juliana@253_11: now a DriverException will be throw if an incorrect
  // parameter is passed in LitebaseConnection.getInstance().
  /**
   ...
   * string format."
   */
  static final int ERR_WRONG_STRING_FORMAT =
    34; // juliana@210_2: now Litebase supports tables with ascii strings.

  /**
   * "It is not possible to open a table within a connection with a different
   * cryptography format."
   */
  static final int ERR_WRONG_CRYPTO_FORMAT =
    35; // juliana@crypto_1: now Litebase supports weak cryptography.
  ...
  // Function errors.
  /**
   * "All non-aggregation function columns in the SELECT clause must also be in
   * the GROUP BY clause."
   */
  static final int ERR_AGGREG_FUNCTION_ISNOT_ON_SELECT = 50;

  /**
   * " is not an aggregation function. All fields present in a HAVING clause
   * must be listed in the SELECT clause as aliased aggregation functions."
   */
  ...
  /**
   * " was not listed in the SELECT clause. All fields present in a HAVING
  ...
  /**
   * "SUM and AVG aggregation functions are not used with DATE and DATETIME type
   * fields."
   */
  ...
  /**
   * "The table format is incompatible with Litebase version. Please update your
   * tables."
   */
  ...
  static
  {
    ...
    errorMsgs_en[ERR_FIELDS_OVERFLOW] =
      "The maximum number of fields in a SELECT clause was exceeded.";
    errorMsgs_en[ERR_COLUMNS_OVERFLOW] =
      "The maximum number of columns was exceeded.";
    ...
    errorMsgs_en[ERR_RESULTSETMETADATA_CLOSED] =
      "ResultSetMetaData can't be used after the ResultSet is closed.";
    errorMsgs_en[ERR_LITEBASEPRCDLL_NOT_FOUND] =
      "Can't find native methods implementation for LitebaseConnection. Please install Litebase.dll/prc "
      + "file.";
    errorMsgs_en[ERR_INVALID_CRID] =
      "The application id must be 4 characters long.";
    errorMsgs_en[ERR_INVALID_INC] =
      "The increment must be greater than 0 or -1.";
    errorMsgs_en[ERR_INVALID_PARAMETER] = "Invalid connection parameter: ";
    errorMsgs_en[ERR_PREPARED_CLOSED] =
      "The prepared statement is already closed.";
    ...
    errorMsgs_en[ERR_AGGREG_FUNCTION_ISNOT_ON_SELECT] =
      "All non-aggregation function columns in the SELECT clause must also be in the GROUP BY "
      + "clause.";
    errorMsgs_en[ERR_IS_NOT_AGGREG_FUNCTION] =
      " is not an aggregation function. All fields present in a HAVING "
      +
      "clause must be listed in the SELECT clause as aliased aggregation funtions.";
    errorMsgs_en[ERR_CANNOT_MIX_AGGREG_FUNCTION] =
      "Can't mix aggregation functions with real columns in the SELECT clause without a GROUP BY "
      + "clause.";
    ...
    errorMsgs_en[ERR_TABLE_CLOSED] =
      "A properly closed table can't be used in recoverTable(): "; // juliana@222_2
    ...
    errorMsgs_en[ERR_WRONG_PREV_VERSION] =
      "The table format is not the previous one: ";         // juliana@220_11
    ...
    errorMsgs_en[ERR_BLOB_TOO_BIG] =
      "The total size of a blob can't be greater then 10 Mb.";
    errorMsgs_en[ERR_INVALID_MULTIPLIER] =
      "This is not a valid size multiplier.";
    ...
    errorMsgs_pt[ERR_COLUMNS_OVERFLOW] =
      "O n�mero m�ximo de colunas foi excedido.";
    ...
    errorMsgs_pt[ERR_COLUMN_DOESNOT_HAVE_AN_INDEX] =
      "A(s) coluna(s) a seguir n�o tem (t�m) um ind�ce associado ";
    ...
    errorMsgs_pt[ERR_PRIMARY_KEY_ALREADY_DEFINED] =
      "Uma chave primaria j� foi definida para esta tabela.";
    ...
    errorMsgs_pt[ERR_STATEMENT_CREATE_DUPLICATED_PK] =
      "Comando cria uma chave prim�ria duplicada em ";
    ...
    errorMsgs_pt[ERR_CHAR_TOO_BIG] =
      "O tamanho m�ximo de um CHAR ou VARCHAR � 65535.";
    ...
    errorMsgs_pt[ERR_NUMBER_VALUES_DIFF_TABLE_DEFINITION] =
      "O n�mero de valores dado n�o coincide com a defini��o da tabela.";
    ...
    errorMsgs_pt[ERR_DRIVER_CLOSED] =
      "Esta inst�ncia do driver est� fechada e n�o pode ser mais utilizada. Por favor, obtenha uma nova "
      + "inst�ncia.";
    ...
    errorMsgs_pt[ERR_LITEBASEPRCDLL_NOT_FOUND] =
      "N�o � poss�vel encontrar a implementa��o dos m�todos nativos "
      +
    ...
    errorMsgs_pt[ERR_WAS_NOT_LISTED_ON_AGGREG_FUNCTION] =
      " n�o foi listado no SELECT. Todas "
      +
    ...
    errorMsgs_pt[ERR_VALUE_ISNOT_DATETIME] =
      "Valor n�o � um tipo DATETIME v�lido: ";
    ...
    errorMsgs_pt[ERR_RS_INV_POS] =
      "ResultSet em uma posi��o de registro inv�lida.";
    ...
    errorMsgs_pt[ERR_CANT_LOAD_NODE] =
      "N�o � poss�vel carregar o n�: �ndice corrompido.";
    errorMsgs_pt[ERR_TABLE_CORRUPTED] = "Tabela est� corrompida: ";
    errorMsgs_pt[ERR_TABLE_NOT_CLOSED] =
      "Tabela n�o foi fechada corretamente: ";
    errorMsgs_pt[ERR_TABLE_CLOSED] =
      "Uma tabela fechada corretamente n�o pode ser usada no recoverTable(): "; // juliana@222_2
    ...
    errorMsgs_pt[ERR_WRONG_VERSION] =
      "O formato de tabela n�o � compat�vel com a vers�o do Litebase. Por favor, atualize suas tabelas.";
    errorMsgs_pt[ERR_WRONG_PREV_VERSION] =
      "O formato de tabela n�o � o anterior: ";            // juliana@220_11
