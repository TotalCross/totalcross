...
/**
 * This class returns useful information for the <code>ResultSet</code> columns.
 * Note that the information can be retrieved even if the <code>ResultSet</code>
 * returns no data. <P>Important: it is not possible to retrieve these
 * information if the <code>ResultSet</code> is closed!
 */
public class ResultSetMetaData
{
  /**
   * Used by the <code>getColumnType</code> method to indicate that the column
   * is of type <code>CHAR</code>.
   */
  public static final int CHAR_TYPE = 0;

  /**
   * Used by the <code>getColumnType</code> method to indicate that the column
   * is of type <code>SHORT</code>.
   */
  ...
  /**
   * Used by the <code>getColumnType</code> method to indicate that the column
   * is of type <code>LONG</code>.
   */
  public static final int LONG_TYPE = 3;

  /**
   * Used by the <code>getColumnType</code> method to indicate that the column
   * is of type <code>FLOAT</code>.
   */
  public static final int FLOAT_TYPE = 4;

  /**
   * Used by the <code>getColumnType</code> method to indicate that the column
   * is of type <code>DOUBLE</code>.
   */
  public static final int DOUBLE_TYPE = 5;

  /**
   * Used by the <code>getColumnType</code> method to indicate that the column
   * is of type <code>CHARS_NOCASE</code>.
   */
  ...
  /**
   * Used by the <code>getColumnType</code> method to indicate that the column
   * is of type <code>DATE_TYPE</code>.
   */
  public static final int DATE_TYPE = 8;

  /**
   * Used by the <code>getColumnType</code> method to indicate that the column
   * is of type <code>DATETIME_TYPE</code>.
   */
  public static final int DATETIME_TYPE = 9;

  /**
   * Used by the <code>getColumnType</code> method to indicate that the column
   * is of type <code>BLOB_TYPE</code>.
   */
  ...
  /**
   * Constructs a new <code>ResultSetMetaData</code> for a given
   * <code>ResultSet</code>.
   *
   * @param aRs The ResultSet.
   */
  ResultSetMetaData(ResultSet aRs) { rs = aRs; }
  ...
  public int getColumnCount()
  {
    ...
    // join, group by, order by, and aggregation. juliana@114_10: skips the
    // rowid.
    return rs.fields.length;
  }

  /**
   * Given the column index (starting at 1), returns the display size. For
   * chars, it will return the number of chars defined; for primitive types, it
   * will return the number of decimal places it needs to be displayed
   * correctly. Returns 0 if an error occurs.
   *
  ...
  /**
   * Given the column index (starting at 1), returns the column name. Note that
   * if an alias is used to the column, the alias will be returned instead. If
   * an error occurs, an empty string is returned. Note that
   * LitebaseConnection 2.x tables must be recreated to be able to return this
   * label information.
   *
   * @param column The column index (starting at 1).
   * @return The name or alias of the column, which can be an empty string if an
   *     error occurs.
   */
   ...
   *
   * @param column The column index (starting at 1).
   * @return The column type, which can be: <code><b>SHORT_TYPE</b></code>,
   *     <code><b>INT_TYPE</b></code>, <code><b>LONG_TYPE</b></code>,
   * <code><b>FLOAT_TYPE</b></code>, <code><b>DOUBLE_TYPE</b></code>,
   * <code><b>CHAR_TYPE</b></code>, <code><b>CHAR_NOCASE_TYPE</b></code>,
   * <code><b>DATE_TYPE</b></code>, <code><b>DATETIME_TYPE</b></code>, or
   * <code><b>BLOB_TYPE</b></code>.
   */
  public int getColumnType(int column)
  {
    ...
    if (resultSet.allRowsBitmap != null || resultSet.isSimpleSelect) {
      ...
      return resultSet.table
        .columnTypes[field.parameter == null ? field.tableColIndex
  ...
  /**
   * Given the column index (starting at 1), returns the name of the column
   * type.
   *
   * @param column The column index (starting at 1).
   * @return The name of the column type, which can be:
   *     <code><b>chars</b></code>, <code><b>short</b></code>,
   *     <code><b>int</b></code>,
   * <code><b>long</b></code>, <code><b>float</b></code>,
   * <code><b>double</b></code>, <code><b>date</b></code>,
   * <code><b>datetime</b></code>, <code><b>blob</b></code>, or null if an error
   * occurs.
   */
  public String getColumnTypeName(int column)
  {
    switch (
      getColumnType(column)) { // Gets the string representation of the type.
      case CHAR_TYPE:
  ...
  /**
   * Given the column index, (starting at 1) returns the name of the table it
   * came from.
   *
   ...
   * @return The name of the table it came from or <code>null</code> if the
  ...
  public String getColumnTableName(String columnName) throws DriverException
  {
    ...
    int i = -1, len = fields.length;

    while (
      ++i <
      len) // Gets the name of the table or its alias given the column name.
      if (columnName.equalsIgnoreCase(fields[i].tableColName) ||
          columnName.equalsIgnoreCase(fields[i].alias)) {
   ...
   * @throws DriverException If an <code>IOException</code> occurs or the column
   *     index does not have an underlining table.
   */
  public boolean hasDefaultValue(int columnIndex) throws DriverException
  {
    try { // Gets the table column info.
      String name = getColumnTableName(
        columnIndex); // It already tests if the result set is valid.
      SQLResultSetField field = rs.fields[columnIndex - 1];

      if (name != null)
        return ((rs.driver.getTable(name))
                  .columnAttrs[field.tableColIndex >= 0
                                 ? field.tableColIndex
                                 : field.parameter.tableColIndex] &
   ...
   * @return <code>true</code> if the column has a default value;
   *     <code>false</code>, otherwise.
   * @throws DriverException If the column was not found, does not have an
   *     underlining table, or an <code>IOException</code> occurs.
   */
  public boolean hasDefaultValue(String columnName) throws DriverException
  {
    ...
    while (++i < len) { // Gets the name of the table or its alias given the
                        // column name and gets the table column info.
      if (columnName.equalsIgnoreCase((field = fields[i]).tableColName) ||
          columnName.equalsIgnoreCase(fields[i].alias))
        try {
          if (field.tableName != null)
            return ((resultSet.driver.getTable(field.tableName)
                       .columnAttrs[field.tableColIndex >= 0
                                      ? field.tableColIndex
                                      : field.parameter.tableColIndex]) &
                    Utils.ATTR_COLUMN_HAS_DEFAULT) != 0;
      ...
      if (name != null)
        return ((rs.driver.getTable(name))
                  .columnAttrs[field.tableColIndex >= 0
                                 ? field.tableColIndex
                                 : field.parameter.tableColIndex] &
                Utils.ATTR_COLUMN_IS_NOT_NULL) != 0;
      throw new DriverException(
        LitebaseMessage.getMessage(LitebaseMessage.ERR_INVALID_COLUMN_NUMBER) +
        columnIndex);
    } catch (IOException exception) {
   ...
   * @return <code>null</code> if the given table does not have primary key or
   *     an array with the column indices of the primary key.
   */
  public byte[] getPKColumnIndices(String tableName)
  {
    ...
    Table table =
      getTable(tableName); // Gets the table given its name in the result set.
    ...
    if (table.composedPK != Utils.NO_PRIMARY_KEY) { // Composed primary key.
      ...
      Vm.arrayCopy(
        table.composedPrimaryKeyCols, 0, composedPK, 0, composedPK.length);
      return composedPK;
    }
   ...
   * @param tableName The table name.
   * @return <code>null</code> if the given table does not have primary key or
   *     an array with the column names of the primary key.
   */
  ...
  {
    String name = getColumnTableName(
      columnIndex); // Already checks if the result set is valid.
    ResultSet resultSet = rs;
    ...
    return getDefault(name,
                      field.tableColIndex >= 0 ? field.tableColIndex
                                               : field.parameter.tableColIndex);
  }
  ...
  public String getDefaultValue(String columnName) throws DriverException
  {
    ...
    while (++i < len) { // Gets the name of the table or its alias given the
      ...
      if (columnName.equalsIgnoreCase((field = fields[i]).tableColName) ||
          columnName.equalsIgnoreCase(fields[i].alias)) {
        if (field.tableName != null)
          return getDefault(field.tableName,
                            field.tableColIndex >= 0
                              ? field.tableColIndex
                              : field.parameter.tableColIndex);
  ...
  /**
   * Checks if the driver or the result set is closed, and if the column index
   * is invalid.
   *
  ...
  private void verifyRSMDState(int column) throws IllegalArgumentException
  {
    ...
    // juliana@230_36: corrected ResultSetMetaData returning extra columns in
    // queries with order by where there are ordered fields that are not in the
    // select clause. juliana@213_5: Now a DriverException is thrown instead of
  ...
  private Table getTable(String tableName) throws DriverException
  {
    ...
    while (--i >= 0 && (fields[i].tableName == null ||
                        !fields[i].tableName.equals(tableName)))
      ;
    if (i == -1)
      throw new DriverException(
   ...
   *     there is no default value.
   * @throws DriverException If an <code>IOException</code> occurs or the column
   *     index is of a column of type <code>BLOB</code>.
   */
    ...
    try {
      ...
      switch (type) {
        ...
        case SQLElement.BLOB: // Blob can't be used with default.
          throw new DriverException(
            LitebaseMessage.getMessage(LitebaseMessage.ERR_BLOB_STRING));
      }
    } catch (IOException exception) {
      throw new DriverException(exception);
    } catch (InvalidDateException exception) {
