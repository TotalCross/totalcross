...
public class DBListBox extends ListBox
{
   ...
   */
  public Object[] getItems() { return sitems; }

  protected Object[] getItemsArray() { return sitems; }
  ...
  public void setSelectedIndex(int i)
  {
    if (0 <= i && i < itemCount &&
      ...
      if (offset + vi >
          ma) // astein@200b4_195: fix list items from being lost when the
              // comboBox.setSelectedIndex() method is used
  ...
  { // guich@220_34
    ...
    while (true) {
      while (high >= low && mid.compareTo(sitems[low][dataCol]) >
                              0) { // guich@_566_25: added "high > low" here
                                   // and below - guich@_568_5: changed to >=
        low++;
      }
