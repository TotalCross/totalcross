...
// $Id: NormalFile.java,v 1.1.2.43 2011-03-21 20:40:16 juliana Exp $
...
class NormalFile extends XFile
{
   ...
   NormalFile(String name, boolean isCreation, int cacheSize) throws IOException
   {
      ...
      {
         protected synchronized void finalize() // flsobral@lb201_1: Overriding finalize method prevents files from being finalized before the LitebaseConnection.
         {
