...
/**
 * This is a memory file, ie, a file that is allocated in memory and never
 * dumped to disk. Used for result sets.
 */
class MemoryFile extends XFile
{
  ...
  void shrinkTo(int newSize)
  {
    ...
    Vm.arrayCopy(fbuf,
                 ...
                 temp,
                 0,
                 size = newSize); // Copies the the old buffer.
    fbuf = temp;
  }
