...
function(tcvm_auto_fetch_sqlite3)
  ...
  if(NOT DEFINED SQLITE3_VARIANT AND DEFINED ENV{SQLITE3_VARIANT} AND NOT "$ENV{SQLITE3_VARIANT}" STREQUAL "")
    set(SQLITE3_VARIANT "$ENV{SQLITE3_VARIANT}")
  elseif(NOT DEFINED SQLITE3_VARIANT)
    set(SQLITE3_VARIANT "plain")
  endif()

  if(NOT DEFINED SQLITE3_RELEASE_TAG AND DEFINED ENV{SQLITE3_RELEASE_TAG} AND NOT "$ENV{SQLITE3_RELEASE_TAG}" STREQUAL "")
  ...
  if(NOT DEFINED SQLITE3_GITHUB_REPO AND DEFINED ENV{SQLITE3_GITHUB_REPO} AND NOT "$ENV{SQLITE3_GITHUB_REPO}" STREQUAL "")
  ...
  if(NOT DEFINED SQLITE3_GITHUB_TOKEN_ENV AND DEFINED ENV{SQLITE3_GITHUB_TOKEN_ENV} AND NOT "$ENV{SQLITE3_GITHUB_TOKEN_ENV}" STREQUAL "")
