...
public:
   ...
   * using a disc light. The shadow may be cached, depending on the path type
   * and canvas matrix. If the matrix is perspective or the path is volatile, it
   * will not be cached.
   *
   ...
   * offset of the occluder from the canvas based on local x and y values (the
   * current matrix is not applied).
   * @param lightPos  The 3D position of the light relative to the canvas plane.
   * This is independent of the canvas's current matrix.
   ...
   */
  static void ComputeTonalColors(SkColor inAmbientColor,
                                 SkColor inSpotColor,
