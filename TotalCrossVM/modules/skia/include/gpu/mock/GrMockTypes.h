...
/**
 * A pointer to this type is used as the GrBackendContext when creating a Mock
 * GrContext. It can be used to specify capability options for the mock context.
 * If nullptr is used a default constructed GrMockOptions is used.
 */
struct GrMockOptions
{
  GrMockOptions()
  {
    ...
    // By default RGBA_8888 is textureable and renderable and A8 and RGB565 are
    // texturable.
    fConfigOptions[kRGBA_8888_GrPixelConfig].fRenderability =
      Renderability::kNonMSAA;
