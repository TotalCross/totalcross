 ...
 *
 * GR_GL_USE_NEW_SHADER_SOURCE_SIGNATURE is for compatibility with the new
 * version of the OpenGLES2.0 headers from Khronos.  glShaderSource now takes a
 * const char * const *, instead of a const char
 */
