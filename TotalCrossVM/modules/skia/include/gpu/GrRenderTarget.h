...
private:
  // Allows the backends to perform any additional work that is required for
  // attaching a GrStencilAttachment. When this is called, the
  // GrStencilAttachment has already been put onto the GrRenderTarget. This
  // function must return false if any failures occur when completing the
  // stencil attachment.
