...
namespace skstd {
	...
	template <bool B, typename T, typename F> using conditional_t = typename
...
namespace sknonstd {
	...
	template <typename D, typename S> using same_volatile =
		copy_volatile<skstd::remove_volatile_t<D>, S>;
