...
/**
 * Tracks all the CCPR paths in a given opList that will be drawn when it
 * flushes.
 */
// DDL TODO: given the usage pattern in DDL mode, this could probably be
// non-atomic refcounting.
struct GrCCPerOpListPaths : public SkRefCnt
{
  SkTInternalLList<GrCCDrawPathsOp>
    fDrawOps; // This class does not own these ops.
