...
SkFloatToMScalar(float x)
{
  return static_cast<double>(x);
}
static inline float
SkMScalarToFloat(double x)
{
  return static_cast<float>(x);
}
static inline double
SkDoubleToMScalar(double x)
{
  return x;
}
static inline double
SkMScalarToDouble(double x)
{
  return x;
}
static inline double
SkMScalarAbs(double x)
{
  return fabs(x);
}
...
static inline double
SkMScalarToDouble(float x)
{
  return static_cast<double>(x);
}
static inline float
SkMScalarAbs(float x)
{
...
/** \class SkMatrix44
    ...
    SkMatrix44 is not thread safe unless you've first called
   SkMatrix44::getType().
*/
...
public:
  ...
  void setRotateDegreesAbout(SkMScalar x,
                             SkMScalar y,
                             SkMScalar z,
                             SkMScalar degrees)
  {
   ...
   */
  void setRotateAboutUnit(SkMScalar x,
                          SkMScalar y,
                          SkMScalar z,
                          SkMScalar radians);
