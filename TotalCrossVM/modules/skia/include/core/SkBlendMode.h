...
/* Generated by tools/bookmaker from include/core/SkBlendMode.h and
   docs/SkBlendMode_Reference.bmh on 2018-07-13 08:15:10. Additional
   ...
   require editing both files. After editing docs/SkBlendMode_Reference.bmh,
   run: bookmaker -b docs -i include/core/SkBlendMode.h -p to create an updated
...
enum class SkBlendMode
{
  ...
  kScreen,   //!< multiply inverse of pixels, inverting result; brightens
             //!< destination
...
*/
SK_API const char*
SkBlendMode_Name(SkBlendMode blendMode);
