...
/* Generated by tools/bookmaker from include/core/SkRect.h and
   docs/SkRect_Reference.bmh on 2018-09-13 13:59:55. Additional documentation
   and examples can be found at: https://skia.org/user/api/SkRect_Reference

   You may edit either file directly. Structural changes to public interfaces
   require editing both files. After editing docs/SkRect_Reference.bmh, run:
...
struct SK_API SkIRect
{
  ...
  /** Returns constructed SkIRect set to (0, 0, 0, 0).
     ...
     right, or if top is equal to or greater than bottom. Setting all members to
     zero is a convenience, but does not designate a special empty rectangle.
  ...
  */
  ...
  /** Returns constructed SkIRect set to (0, 0, w, h). Does not validate input;
  ...
  */
  ...
  /** Returns constructed SkIRect set to (l, t, r, b). Does not sort input;
     SkIRect may result in fLeft greater than fRight, or fTop greater than
     fBottom.
  ...
  */
  static constexpr SkIRect SK_WARN_UNUSED_RESULT MakeLTRB(int32_t l,
                                                          int32_t t,
                                                          int32_t r,
                                                          int32_t b)
  {
  ...
  */
  static constexpr SkIRect SK_WARN_UNUSED_RESULT MakeXYWH(int32_t x,
                                                          int32_t y,
                                                          int32_t w,
                                                          int32_t h)
  {
  ...
  */
  ...
  /** Returns top edge of SkIRect, if sorted. Call isEmpty() to see if SkIRect
     may be invalid, and sort() to reverse fTop and fBottom if needed.
  ...
  */
  ...
  /** Returns bottom edge of SkIRect, if sorted. Call isEmpty() to see if
     SkIRect may be invalid, and sort() to reverse fTop and fBottom if needed.

      @return  fBottom
  */
  int32_t bottom() const { return fBottom; }

  /** Returns left edge of SkIRect, if sorted. Call isEmpty() to see if SkIRect
     may be invalid, and sort() to reverse fLeft and fRight if needed.
  ...
  */
  ...
  /** Returns span on the x-axis. This does not check if SkIRect is sorted, or
     if result fits in 32-bit signed integer; result may be negative.

      @return  fRight minus fLeft
  */
  int32_t width() const { return Sk32_can_overflow_sub(fRight, fLeft); }

  /** Returns span on the y-axis. This does not check if SkIRect is sorted, or
     if result fits in 32-bit signed integer; result may be negative.
  ...
  */
  ...
  /** Returns spans on the x-axis and y-axis. This does not check if SkIRect is
     sorted, or if result fits in 32-bit signed integer; result may be negative.

      @return  SkISize (width, height)
  */
  SkISize size() const { return SkISize::Make(this->width(), this->height()); }

  /** Returns span on the x-axis. This does not check if SkIRect is sorted, so
     the result may be negative. This is safer than calling width() since
     width() might overflow in its calculation.

      @return  fRight minus fLeft cast to int64_t
  */
  int64_t width64() const { return (int64_t)fRight - (int64_t)fLeft; }

  /** Returns span on the y-axis. This does not check if SkIRect is sorted, so
     the result may be negative. This is safer than calling height() since
  ...
  */
  ...
  /** Returns true if fLeft is equal to or greater than fRight, or if fTop is
     equal to or greater than fBottom. Call sort() to reverse rectangles with
     negative width64() or height64().
  ...
  */
  ...
  /** Offsets SkIRect by adding dx to fLeft, fRight; and by adding dy to fTop,
     fBottom.
  ...
  */
  ...
  /** Offsets SkIRect so that fLeft equals newX, and fTop equals newY. width and
  ...
  */
  ...
  /** Adjusts SkIRect by adding dL to fLeft, dT to fTop, dR to fRight, and dB to
     fBottom.

      If dL is positive, narrows SkIRect on the left. If negative, widens it on
     the left. If dT is positive, shrinks SkIRect on the top. If negative,
     lengthens it on the top. If dR is positive, narrows SkIRect on the right.
     If negative, widens it on the right. If dB is positive, shrinks SkIRect on
     the bottom. If negative, lengthens it on the bottom.

      The resulting SkIRect is not checked for validity. Thus, if the resulting
     SkIRect left is greater than right, the SkIRect will be considered empty.
     Call sort() after this call if that is not the desired behavior.
  ...
  */
  ...
  /** Constructs SkIRect to intersect from (left, top, right, bottom). Does not
     sort construction.
  ...
  */
  bool contains(int32_t left, int32_t top, int32_t right, int32_t bottom) const
  {
    return left < right && top < bottom &&
           !this->isEmpty() && // check for empties
  ...
  */
  ...
  /** Constructs SkIRect from (left, top, right, bottom). Does not sort
      ...
      Returns true if SkIRect contains construction.
      Asserts if SkIRect is empty or construction is empty, and if SK_DEBUG is
     defined.
      ...
      @return        true if all sides of SkIRect are outside construction
  */
  bool containsNoEmptyCheck(int32_t left,
                            int32_t top,
                            int32_t right,
  ...
  */
  ...
  /** Returns true if SkIRect intersects r, and sets SkIRect to intersection.
      Returns false if SkIRect does not intersect r, and leaves SkIRect
     unchanged.
  ...
  */
                                                   ...
                                                   const SkIRect& b)
  {
    ...
    SkIRect r = { SkMax32(a.fLeft, b.fLeft),
  ...
  */
  ...
  /** Constructs SkIRect to intersect from (left, top, right, bottom). Does not
     sort construction.
      ...
      Returns true if SkIRect intersects construction, and sets SkIRect to
     intersection. Returns false if SkIRect does not intersect construction, and
     leaves SkIRect unchanged.

      Returns false if either construction or SkIRect is empty, leaving SkIRect
     unchanged.
  ...
  */
  ...
  /** Constructs SkIRect to intersect from (left, top, right, bottom). Does not
     sort construction.
      ...
      Has no effect if construction is empty. Otherwise, if SkIRect is empty,
     sets SkIRect to construction.
  ...
  */
  ...
  /** Sets SkIRect to the union of itself and r.
      ...
      Has no effect if r is empty. Otherwise, if SkIRect is empty, sets SkIRect
     to r.
  ...
  */
  ...
  /** Returns SkIRect with fLeft and fRight swapped if fLeft is greater than
     fRight; and with fTop and fBottom swapped if fTop is greater than fBottom.
  ...
  */
  ...
  {
    return MakeLTRB(SkMin32(fLeft, fRight),
                    SkMin32(fTop, fBottom),
                    SkMax32(fLeft, fRight),
...
struct SK_API SkRect
{
  ...
  */
  ...
  /** Returns constructed SkRect set to SkScalar values (0, 0, w, h). Does not
      ...
      represent 32-bit integers exactly. Use SkIRect for an exact integer
     rectangle.
  ...
  */
  ...
  /** Returns constructed SkRect set to integer values (0, 0, w, h). Does not
     validate input; w or h may be negative.
  ...
  */
  ...
  /** Returns constructed SkRect set to (l, t, r, b). Does not sort input;
     SkRect may result in fLeft greater than fRight, or fTop greater than
     fBottom.
      ...
      @return   bounds (l, t, r, b)
  */
  static constexpr SkRect SK_WARN_UNUSED_RESULT MakeLTRB(SkScalar l,
                                                         SkScalar t,
                                                         SkScalar r,
                                                         SkScalar b)
  {
  ...
  /** Returns constructed SkRect set to (x, y, x + w, y + h).
      ...
      @return   bounds at (x, y) with width w and height h
  */
  static constexpr SkRect SK_WARN_UNUSED_RESULT MakeXYWH(SkScalar x,
                                                         SkScalar y,
                                                         SkScalar w,
                                                         SkScalar h)
  {
  ...
  */
  bool isEmpty() const
  {
    // We write it as the NOT of a non-empty rect, so we will return true if any
    // values are NaN.
  ...
  */
  ...
  /** Returns left edge of SkRect, if sorted. Call isSorted() to see if SkRect
     is valid. Call sort() to reverse fLeft and fRight if needed.

      @return  fLeft
  */
  SkScalar x() const { return fLeft; }

  /** Returns top edge of SkRect, if sorted. Call isEmpty() to see if SkRect may
     be invalid, and sort() to reverse fTop and fBottom if needed.
  ...
  */
  ...
  /** Returns right edge of SkRect, if sorted. Call isSorted() to see if SkRect
     is valid. Call sort() to reverse fLeft and fRight if needed.
  ...
  */
  ...
  /** Returns bottom edge of SkRect, if sorted. Call isEmpty() to see if SkRect
     may be invalid, and sort() to reverse fTop and fBottom if needed.
  ...
  */
  ...
  /** Returns average of left edge and right edge. Result does not change if
     SkRect is sorted. Result may overflow to infinity if SkRect is far from the
     origin.
  ...
  */
  ...
  {
    // don't use SkScalarHalf(fLeft + fBottom) as that might overflow before the
    // 0.5
    return SkScalarHalf(fLeft) + SkScalarHalf(fRight);
  }

  /** Returns average of top edge and bottom edge. Result does not change if
     SkRect is sorted.
  ...
  */
  ...
  {
    // don't use SkScalarHalf(fTop + fBottom) as that might overflow before the
    // 0.5
  ...
  */
  ...
  /** Returns four points in quad that enclose SkRect ordered as: top-left,
     top-right, bottom-right, bottom-left. Consider adding param to control
     whether quad is clockwise or counterclockwise.
  ...
  */
  ...
  /** Sets SkRect to (0, 0, width, height).
      width and height may be zero or negative. width and height are promoted
     from integer to SkScalar, large values may lose precision.
  ...
  */
  ...
  /** Sets to bounds of SkPoint array with count entries. If count is zero or
     smaller, or if SkPoint array contains an infinity or NaN, sets SkRect to
     (0, 0, 0, 0).
  ...
  */
  ...
  /** Sets to bounds of SkPoint array with count entries. If count is zero or
     smaller, or if SkPoint array contains an infinity or NaN, sets to (0, 0, 0,
     0).
  ...
  */
  ...
  /** Sets to bounds of SkPoint array with count entries. Returns false if count
     is zero or smaller, or if SkPoint array contains an infinity or NaN; in
     these cases sets SkRect to (0, 0, 0, 0).
  ...
  */
  ...
  /** Sets to bounds of SkPoint pts array with count entries. If any SkPoint in
     pts contains infinity or NaN, all SkRect dimensions are set to NaN.
  ...
  */
  ...
  /** Sets bounds to the smallest SkRect enclosing SkPoint p0 and p1. The result
     is sorted and may be empty. Does not check to see if values are finite.
  ...
  */
  ...
  /** Offsets SkRect by adding dx to fLeft, fRight; and by adding dy to fTop,
     fBottom.
  ...
  */
  ...
  /** Offsets SkRect by adding delta.fX to fLeft, fRight; and by adding delta.fY
     to fTop, fBottom.
  ...
  */
  ...
  /** Offsets SkRect so that fLeft equals newX, and fTop equals newY. width and
     height are unchanged.
  ...
  */
  ...
  /** Constructs SkRect to intersect from (left, top, right, bottom). Does not
     sort construction.

      Returns true if SkRect intersects construction, and sets SkRect to
     intersection. Returns false if SkRect does not intersect construction, and
     leaves SkRect unchanged.

      Returns false if either construction or SkRect is empty, leaving SkRect
     unchanged.
...
public:
  /** Constructs SkRect to intersect from (left, top, right, bottom). Does not
     sort construction.
      ...
      Returns false if either construction or SkRect is empty, or do not
     intersect.
  ...
  */
  ...
  {
    return Intersects(
      fLeft, fTop, fRight, fBottom, r.fLeft, r.fTop, r.fRight, r.fBottom);
  }
  ...
  */
  ...
  /** Constructs SkRect to intersect from (left, top, right, bottom). Does not
     sort construction.
      ...
      Has no effect if construction is empty. Otherwise, if SkRect is empty,
     sets SkRect to construction.
  ...
  */
  bool contains(const SkRect& r) const
  {
    ...
    return !r.isEmpty() && !this->isEmpty() && fLeft <= r.fLeft &&
           fTop <= r.fTop && fRight >= r.fRight && fBottom >= r.fBottom;
  }
  ...
  */
  ...
  {
    SkASSERT(dst);
    dst->set(SkScalarRoundToInt(fLeft),
  ...
  /** Sets SkIRect by discarding the fractional portion of fLeft and fTop; and
     rounding up fRight and fBottom, using (SkScalarFloorToInt(fLeft),
  ...
  */
  ...
  {
    SkASSERT(dst);
    dst->set(SkScalarFloorToInt(fLeft),
  ...
  */
  ...
  /** Sets SkRect by rounding up fLeft and fTop; and discarding the fractional
     portion of fRight and fBottom, using (SkScalarCeilToInt(fLeft),
     SkScalarCeilToInt(fTop), SkScalarFloorToInt(fRight),
  ...
  */
  ...
  {
    SkASSERT(dst);
    dst->set(SkScalarCeilToInt(fLeft),
  ...
  /** Returns SkIRect by adding 0.5 and discarding the fractional portion of
     SkRect members, using (SkScalarRoundToInt(fLeft), SkScalarRoundToInt(fTop),
                      SkScalarRoundToInt(fRight), SkScalarRoundToInt(fBottom)).
  ...
  */
  ...
  /** Returns SkRect with fLeft and fRight swapped if fLeft is greater than
     fRight; and with fTop and fBottom swapped if fTop is greater than fBottom.
     Result may be empty; and width() and height() will be zero or positive.
  ...
  */
  ...
  {
    return MakeLTRB(SkMinScalar(fLeft, fRight),
                    SkMinScalar(fTop, fBottom),
                    SkMaxScalar(fLeft, fRight),
                    SkMaxScalar(fTop, fBottom));
  }

  /** Returns pointer to first scalar in SkRect, to treat it as an array with
     four entries.
  ...
  */
  ...
  /** Writes text representation of SkRect to standard output. Set asHex to true
  ...
  */
  ...
  /** Writes text representation of SkRect to standard output. The
     representation may be directly compiled as C++ code. Floating point values
     are written with limited precision; it may not be possible to reconstruct
     original SkRect from output.
  */
  ...
  /** Writes text representation of SkRect to standard output. The
     ...
     reconstructs the original SkRect.
...
inline bool
SkIRect::contains(const SkRect& r) const
{
  return !r.isEmpty() && !this->isEmpty() && // check for empties
