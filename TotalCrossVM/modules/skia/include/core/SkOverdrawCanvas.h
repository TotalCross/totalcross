...
/**
 *  Captures all drawing commands.  Rather than draw the actual content, this
 * device increments the alpha channel of each pixel every time it would have
 * been touched by a draw call.  This is useful for detecting overdraw.
 */
...
public:
  ...
  void onDrawAnnotation(const SkRect&,
                        const char key[],
                        SkData* value) override;
  void onDrawShadowRec(const SkPath&, const SkDrawShadowRec&) override;

private:
  void drawPosTextCommon(const void*,
                         size_t,
                         const SkScalar[],
                         int,
                         const SkPoint&,
