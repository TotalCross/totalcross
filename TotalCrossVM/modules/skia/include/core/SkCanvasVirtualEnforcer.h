...
// If you would ordinarily want to inherit from Base (eg SkCanvas,
// SkNWayCanvas), instead inherit from SkCanvasVirtualEnforcer<Base>, which will
// make the build fail if you forget to override one of SkCanvas' key virtual
// hooks.
