...
/* Generated by tools/bookmaker from include/core/SkPoint.h and
   docs/SkPoint_Reference.bmh on 2018-09-13 13:59:55. Additional documentation
   and examples can be found at: https://skia.org/user/api/SkPoint_Reference

   You may edit either file directly. Structural changes to public interfaces
   require editing both files. After editing docs/SkPoint_Reference.bmh, run:
...
struct SkIPoint
{
  ...
  */
  ...
  /** Subtracts ivector v from SkIPoint. Sets SkIPoint to: (fX - v.fX, fY -
     v.fY).
  ...
  */
  ...
  /** Returns true if SkIPoint is equivalent to SkIPoint constructed from (x,
     y).
  ...
  */
  ...
  /** Returns SkIPoint resulting from SkIPoint a offset by ivector b, computed
     as: (a.fX + b.fX, a.fY + b.fY).
...
struct SK_API SkPoint
{
  ...
  */
  ...
  /** Sets fX to p.fX and fY to p.fY, promoting integers to SkScalar values.
      ...
      Assigning an SkIPoint containing a large integer value directly to fX or
     fY may cause a compiler error, triggered by narrowing conversion of int to
     SkScalar. This safely casts p.fX and p.fY to avoid the error.
  ...
  */
  ...
  /** Scales (fX, fY) so that length() returns one, while preserving ratio of fX
     to fY, if possible. If prior length is nearly zero, sets vector to (0, 0)
  ...
  */
  ...
  /** Scales vector so that distanceToOrigin() returns length, if possible. If
     former length is nearly zero, sets vector to (0, 0) and return false;
  ...
  */
  ...
  /** Sets vector to (x, y) scaled to length, if possible. If former
      length is nearly zero, sets vector to (0, 0) and return false; otherwise
     returns true.
  ...
  */
  ...
  /** Sets dst to SkPoint times scale. dst may be SkPoint to modify SkPoint in
     place.
  ...
  */
  ...
  /** Scales (vec->fX, vec->fY) so that length() returns one, while preserving
     ratio of vec->fX to vec->fY, if possible. If original length is nearly
     zero, sets vec to (0, 0) and returns zero; otherwise, returns length of vec
     before vec is scaled.
