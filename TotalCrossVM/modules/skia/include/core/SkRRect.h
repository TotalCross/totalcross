...
/* Generated by tools/bookmaker from include/core/SkRRect.h and
   docs/SkRRect_Reference.bmh on 2018-08-10 12:59:44. Additional documentation
   and examples can be found at: https://skia.org/user/api/SkRRect_Reference

   You may edit either file directly. Structural changes to public interfaces
   require editing both files. After editing docs/SkRRect_Reference.bmh, run:
...
/** \class SkRRect
   ...
   each corner. The bounds and radii can be set so that SkRRect describes: a
   ...
   radii. If either axis radii is zero or less: radii are stored as zero; corner
   is square. If corner curves overlap, radii are proportionally reduced to fit
   within bounds.
*/
...
public:
  ...
  */
  ...
  /** Returns span on the x-axis. This does not check if result fits in 32-bit
     float; result may be infinity.

      @return  bounds().fRight minus bounds().fLeft
  */
  SkScalar width() const { return fRect.width(); }

  /** Returns span on the y-axis. This does not check if result fits in 32-bit
     float; result may be infinity.
  ...
  */
  ...
  /** Returns top-left corner radii. If type() returns kEmpty_Type, kRect_Type,
      kOval_Type, or kSimple_Type, returns a value representative of all corner
     radii. If type() returns kNinePatch_Type or kComplex_Type, at least one of
     the remaining three corners has a different value.
  ...
  */
  ...
  /** Sets bounds to rect. Sets radii to (leftRad, topRad), (rightRad, topRad),
      ...
      Otherwise, if leftRad and rightRad are equal and at least half
     rect.width(), and topRad and bottomRad are equal at least half
     rect.height(), sets to kOval_Type. Otherwise, if leftRad and rightRad are
     equal, and topRad and bottomRad are equal, sets to kSimple_Type. Otherwise,
  ...
  */
  void setNinePatch(const SkRect& rect,
                    SkScalar leftRad,
                    SkScalar topRad,
                    SkScalar rightRad,
                    SkScalar bottomRad);

  /** Sets bounds to rect. Sets radii array for individual control of all for
     corners.
     ...
     and all y-axis radii are equal at least half rect.height(), sets to
     kOval_Type. Otherwise, if all x-axis radii are equal, and all y-axis radii
  ...
  */
  ...
  /** Returns bounds. Bounds may have zero width or zero height. Bounds right is
      greater than or equal to left; bounds bottom is greater than or equal to
     top. Result is identical to getBounds().
  ...
  */
  ...
  /** Returns scalar pair for radius of curve on x-axis and y-axis for one
     corner. Both radii may be zero. If not zero, both are positive and finite.
  ...
  */
  ...
  /** Returns bounds. Bounds may have zero width or zero height. Bounds right is
      greater than or equal to left; bounds bottom is greater than or equal to
     top. Result is identical to rect().
  ...
  */
  ...
  /** Returns true if bounds and radii in a are not equal to bounds and radii in
     b.
  ...
  */
  ...
  /** Copies SkRRect to dst, then insets dst bounds by dx and dy, and adjusts
     dst radii by dx and dy. dx and dy may be positive, negative, or zero. dst
     may be SkRRect.

      If either corner radius is zero, the corner has no curvature and is
     unchanged. Otherwise, if adjusted radius becomes negative, pins radius to
     zero. If dx exceeds half dst bounds width, dst bounds left and right are
     set to bounds x-axis center. If dy exceeds half dst bounds height, dst
     bounds top and bottom are set to bounds y-axis center.
  ...
  */
  ...
  /** Insets bounds by dx and dy, and adjusts radii by dx and dy. dx and dy may
     be positive, negative, or zero.
      ...
      If either corner radius is zero, the corner has no curvature and is
     unchanged. Otherwise, if adjusted radius becomes negative, pins radius to
     zero. If dx exceeds half bounds width, bounds left and right are set to
  ...
  */
  ...
  /** Outsets dst bounds by dx and dy, and adjusts radii by dx and dy. dx and dy
  ...
  */
  ...
  /** Returns true if bounds and radii values are finite and describe a SkRRect
     ...
     types, even if the input values are not valid. Invalid SkRRect data can
     only be generated by corrupting memory.
  ...
  */
  ...
  /** Transforms by SkRRect by matrix, storing result in dst.
      ...
      Returns false if matrix contains transformations other than scale and
     translate.
  ...
  */
  ...
  /** Writes text representation of SkRRect to standard output. The
     representation may be directly compiled as C++ code. Floating point values
     are written with limited precision; it may not be possible to reconstruct
     original SkRRect from output.
  */
  ...
  /** Writes text representation of SkRRect to standard output. The
     ...
     reconstructs the original SkRRect.
  */
...
private:
  ...
  /**
   * Initializes fRect. If the passed in rect is not finite or empty the rrect
   * will be fully initialized and false is returned. Otherwise, just fRect is
  ...
  // use an explicitly sized type so we're sure the class is dense (no
  // uninitialized bytes)
