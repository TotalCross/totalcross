...
#define SK_BUILD_FOR_ANDROID
  ...
  defined(__DragonFly__) || defined(__Fuchsia__) || defined(__GLIBC__) ||      \
  defined(__GNU__) || defined(__unix__)
...
#define SK_CPU_LENDIAN
  ...
  defined(__powerpc__) || defined(__ppc__) || defined(__hppa) ||               \
  defined(__PPC__) || defined(__PPC64__) || defined(_MIPSEB) ||                \
...
#if !defined(SK_ARM_HAS_NEON) && !defined(SK_BUILD_NO_OPTS) &&                 \
  defined(__ARM_NEON)
#define SK_ARM_HAS_NEON
#endif

// Really this __APPLE__ check shouldn't be necessary, but it seems that Apple's
// Clang defines
// __ARM_FEATURE_CRC32 for -arch arm64, even though their chips don't support
// those instructions!
