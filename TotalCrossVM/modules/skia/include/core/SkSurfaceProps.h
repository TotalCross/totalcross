...
/**
 *  Description of how the LCD strips are arranged for each pixel. If this is
 * unknown, or the pixels are meant to be "portable" and/or transformed before
 * showing (e.g. rotated, scaled) then use kUnknown_SkPixelGeometry.
 */
...
static inline bool
SkPixelGeometryIsRGB(SkPixelGeometry geo)
{
...
static inline bool
SkPixelGeometryIsBGR(SkPixelGeometry geo)
{
...
static inline bool
SkPixelGeometryIsH(SkPixelGeometry geo)
{
...
static inline bool
SkPixelGeometryIsV(SkPixelGeometry geo)
{
...
public:
  ...
  static const Flags kUseDistanceFieldFonts_Flag =
