...
/**
 *  Describes geometric operations (ala SkRegion::Op) that can be applied to
 * coverage bytes. These can be thought of as variants of porter-duff
 * (SkBlendMode) modes, but only applied to the alpha channel.
 *
