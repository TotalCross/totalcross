...
public:
   ...
   */
  SkTypeface* matchFamilyStyle(const char familyName[],
   ...
   */
  SkTypeface* matchFamilyStyleCharacter(const char familyName[],
                                        const SkFontStyle&,
                                        const char* bcp47[],
                                        int bcp47Count,
...
protected:
  ...
  virtual sk_sp<SkTypeface> onMakeFromData(sk_sp<SkData>,
  ...
  virtual sk_sp<SkTypeface> onMakeFromStreamArgs(std::unique_ptr<SkStreamAsset>,
                                                 const SkFontArguments&) const;
  virtual sk_sp<SkTypeface> onMakeFromFontData(
    std::unique_ptr<SkFontData>) const;
