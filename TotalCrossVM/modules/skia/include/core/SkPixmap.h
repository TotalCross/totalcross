...
/* Generated by tools/bookmaker from include/core/SkPixmap.h and
   docs/SkPixmap_Reference.bmh on 2018-06-08 11:48:28. Additional documentation
   and examples can be found at: https://skia.org/user/api/SkPixmap_Reference

   You may edit either file directly. Structural changes to public interfaces
   require editing both files. After editing docs/SkPixmap_Reference.bmh, run:
...
public:
  ...
  */
  ...
  /** Creates SkPixmap from info width, height, SkAlphaType, and SkColorType.
      ...
      SkPixmap may be later modified by reset() to change its size, pixel type,
     or storage.
      ...
      @param rowBytes  size of one row of addr; width times pixel size, or
     larger
  ...
  */
  ...
  /** Sets width, height, SkAlphaType, and SkColorType from info.
      ...
      Does not check addr. Asserts if built with SK_DEBUG defined and if
  ...
  */
  ...
  /** Changes SkColorSpace in SkImageInfo; preserves width, height, SkAlphaType,
     and SkColorType in SkImage, and leaves pixel address and row bytes
     unchanged. SkColorSpace reference count is incremented.
  ...
  */
  ...
  /** Sets subset width, height, pixel address to intersection of SkPixmap with
     area, if intersection is not empty; and return true. Otherwise, leave
     subset unchanged and return false.
  ...
  */
  bool SK_WARN_UNUSED_RESULT extractSubset(SkPixmap* subset,
                                           const SkIRect& area) const;
  ...
  */
  ...
  /** Returns row bytes, the interval from one pixel row to the next. Row bytes
      ...
      It is up to the SkBitmap creator to ensure that row bytes is a useful
     value.
  ...
  */
  ...
  /** Returns pixel address, the base address corresponding to the pixel origin.
      ...
      It is up to the SkPixmap creator to ensure that pixel address is a useful
     value.
  ...
  */
  ...
  /** Returns readable pixel address at (x, y). Returns nullptr if SkPixelRef is
     nullptr.

      Input is not validated: out of bounds values of x or y trigger an assert()
     if built with SK_DEBUG defined. Returns nullptr if SkColorType is
  ...
  */
  ...
  /** Returns readable base pixel address. Result is addressable as unsigned
     8-bit bytes. Will trigger an assert() if SkColorType is not
     kAlpha_8_SkColorType or kGray_8_SkColorType, and is built with SK_DEBUG
     defined.
  ...
  */
  ...
  /** Returns readable base pixel address. Result is addressable as unsigned
     ...
     kRGB_565_SkColorType or kARGB_4444_SkColorType, and is built with SK_DEBUG
     defined.
  ...
  */
  ...
  /** Returns readable base pixel address. Result is addressable as unsigned
     ...
     kRGBA_8888_SkColorType or kBGRA_8888_SkColorType, and is built with
     SK_DEBUG defined.
  ...
  */
  ...
  /** Returns readable pixel address at (x, y).
      ...
      Input is not validated: out of bounds values of x or y trigger an assert()
     if built with SK_DEBUG defined.
  ...
  */
  const uint8_t* addr8(int x, int y) const
  {
    ...
    return (const uint8_t*)((const char*)this->addr8() + y * fRowBytes +
                            (x << 0));
  }
  ...
  */
  const uint16_t* addr16(int x, int y) const
  {
    SkASSERT((unsigned)x < (unsigned)fInfo.width());
    SkASSERT((unsigned)y < (unsigned)fInfo.height());
    return (const uint16_t*)((const char*)this->addr16() + y * fRowBytes +
                             (x << 1));
  }
  ...
  */
  const uint32_t* addr32(int x, int y) const
  {
    SkASSERT((unsigned)x < (unsigned)fInfo.width());
    SkASSERT((unsigned)y < (unsigned)fInfo.height());
    return (const uint32_t*)((const char*)this->addr32() + y * fRowBytes +
                             (x << 2));
  }
  ...
  /** Returns readable pixel address at (x, y).
     ...
     if built with SK_DEBUG defined.
      ...
      Will trigger an assert() if SkColorType is not kRGBA_F16_SkColorType and
     is built with SK_DEBUG defined.
  ...
  */
  const uint64_t* addr64(int x, int y) const
  {
    SkASSERT((unsigned)x < (unsigned)fInfo.width());
    SkASSERT((unsigned)y < (unsigned)fInfo.height());
    return (const uint64_t*)((const char*)this->addr64() + y * fRowBytes +
                             (x << 3));
  }
  ...
  /** Returns readable pixel address at (x, y).
     ...
     is built with SK_DEBUG defined.
      ...
      Each unsigned 16-bit word represents one color component encoded as a half
     float. Four words correspond to one pixel.
  ...
  */
  ...
  /** Returns writable pixel address at (x, y).
      ...
      Input is not validated: out of bounds values of x or y trigger an assert()
     if built with SK_DEBUG defined. Returns zero if SkColorType is
     kUnknown_SkColorType.
  ...
  */
  ...
  /** Returns writable pixel address at (x, y). Result is addressable as
     unsigned 8-bit bytes. Will trigger an assert() if SkColorType is not
     kAlpha_8_SkColorType or kGray_8_SkColorType, and is built with SK_DEBUG
     defined.
  ...
  */
  ...
  /** Returns writable_addr pixel address at (x, y). Result is addressable as
     unsigned 16-bit words. Will trigger an assert() if SkColorType is not
     kRGB_565_SkColorType or kARGB_4444_SkColorType, and is built with SK_DEBUG
     defined.
  ...
  */
  ...
  /** Returns writable pixel address at (x, y). Result is addressable as
     unsigned 32-bit words. Will trigger an assert() if SkColorType is not
      kRGBA_8888_SkColorType or kBGRA_8888_SkColorType, and is built with
     SK_DEBUG defined.
  ...
  */
  ...
  /** Returns writable pixel address at (x, y). Result is addressable as
     unsigned 64-bit words. Will trigger an assert() if SkColorType is not
      kRGBA_F16_SkColorType and is built with SK_DEBUG defined.
  ...
  */
  ...
  /** Copies a SkRect of pixels to dstPixels. Copy starts at (0, 0), and does
     not exceed SkPixmap (width(), height()).
     ...
     false if dstInfo.addr() equals nullptr, or dstRowBytes is less than
     dstInfo.minRowBytes().

      Pixels are copied only if pixel conversion is possible. If SkPixmap
     colorType() is kGray_8_SkColorType, or kAlpha_8_SkColorType;
     dstInfo.colorType() must match. If SkPixmap colorType() is
     kGray_8_SkColorType, dstInfo.colorSpace() must match. If SkPixmap
     alphaType() is kOpaque_SkAlphaType, dstInfo.alphaType() must match. If
     SkPixmap colorSpace() is nullptr, dstInfo.colorSpace() must match. Returns
  ...
  */
  ...
  /** Copies a SkRect of pixels to dstPixels. Copy starts at (srcX, srcY), and
     does not exceed SkPixmap (width(), height()).
     ...
     SkPixmap colorSpace() is nullptr, dstInfo.colorSpace() must match. Returns
      ...
      false if SkPixmap width() or height() is zero or negative. Returns false
     if: abs(srcX) >= Pixmap width(), or if abs(srcY) >= Pixmap height().
  ...
  */
  ...
  /** Copies a SkRect of pixels to dst. Copy starts at (srcX, srcY), and does
     not exceed SkPixmap (width(), height()). dst specifies width, height,
     SkColorType, SkAlphaType, and SkColorSpace of destination.  Returns true if
     pixels are copied. Returns false if dst.addr() equals nullptr, or
     dst.rowBytes() is less than dst SkImageInfo::minRowBytes.

      Pixels are copied only if pixel conversion is possible. If SkPixmap
     colorType() is kGray_8_SkColorType, or kAlpha_8_SkColorType;
     dst.info().colorType must match. If SkPixmap colorType() is
     kGray_8_SkColorType, dst.info().colorSpace must match. If SkPixmap
     alphaType() is kOpaque_SkAlphaType, dst.info().alphaType must match. If
     SkPixmap colorSpace() is nullptr, dst.info().colorSpace must match. Returns
      false if pixel conversion is not possible.
  ...
  */
  bool readPixels(const SkPixmap& dst, int srcX, int srcY) const
  {
    return this->readPixels(
      dst.info(), dst.writable_addr(), dst.rowBytes(), srcX, srcY);
  }

  /** Copies pixels inside bounds() to dst. dst specifies width, height,
     SkColorType, SkAlphaType, and SkColorSpace of destination.  Returns true if
     pixels are copied. Returns false if dst.addr() equals nullptr, or
     dst.rowBytes() is less than dst SkImageInfo::minRowBytes.
     ...
     SkColorType must match. If SkPixmap colorType() is kGray_8_SkColorType, dst
     SkColorSpace must match. If SkPixmap alphaType() is kOpaque_SkAlphaType,
     dst SkAlphaType must match. If SkPixmap colorSpace() is nullptr, dst
  ...
  */
  ...
  {
    return this->readPixels(
      dst.info(), dst.writable_addr(), dst.rowBytes(), 0, 0);
  }

  /** Copies SkBitmap to dst, scaling pixels to fit dst.width() and
     dst.height(), and converting pixels to match dst.colorType() and
     dst.alphaType(). Returns true if pixels are copied. Returns false if
     dst.addr() is nullptr, or dst.rowBytes() is less than dst
  ...
  */
  ...
  /** Writes color to pixels bounded by subset; returns true on success.
      if subset is nullptr, writes colors pixels inside bounds(). Returns false
     if colorType() is kUnknown_SkColorType, if subset is not nullptr and does
