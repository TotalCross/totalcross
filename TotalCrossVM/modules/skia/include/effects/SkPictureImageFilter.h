...
public:
  ...
  /**
   *  Refs the passed-in picture. cropRect can be used to crop or expand the
   * destination rect when the picture is drawn. (No scaling is implied by the
...
private:
  ...
  // Should never be set by a public constructor.  This is only used when
  // onMakeColorSpace() forces a deferred color space xform.
