...
public:
   ...
   * interval, they will be pinned to the nearest legal value. If either is NaN,
   ...
   * return 2 logical segments: 0...stopT and startT...1
   */
  static sk_sp<SkPathEffect> Make(SkScalar startT,
                                  SkScalar stopT,
                                  Mode = Mode::kNormal);
};
