...
struct SK_API SkFontIdentity
{
  ...
  // On Linux/FontConfig there is also the ability to specify preferences for
  // rendering antialias, embedded bitmaps, autohint, hinting, hintstyle, lcd
  // rendering may all be set or set to no-preference (No-preference is resolved
  // against globals set by the platform) Since they may be selected against,
  // these are really 'extensions' to SkFontStyle. SkFontStyle should pick these
  // up.
