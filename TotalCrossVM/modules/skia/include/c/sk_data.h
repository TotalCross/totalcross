...
*/
SK_API sk_data_t*
sk_data_new_from_malloc(const void* memory, size_t length);
/**
...
*/
SK_API sk_data_t*
sk_data_new_subset(const sk_data_t* src, size_t offset, size_t length);
...
*/
SK_API void
sk_data_unref(const sk_data_t*);

/**
    Returns the number of bytes stored.
*/
SK_API size_t
sk_data_get_size(const sk_data_t*);
/**
    Returns the pointer to the data.
 */
SK_API const void*
sk_data_get_data(const sk_data_t*);
