...
sk_picture_recorder_new(void);
/**
    Release the memory and other resources used by this
    sk_picture_recorder_t.
*/
void
sk_picture_recorder_delete(sk_picture_recorder_t*);
...
*/
sk_canvas_t*
sk_picture_recorder_begin_recording(sk_picture_recorder_t*, const sk_rect_t*);
/**
...
*/
void
sk_picture_unref(sk_picture_t*);

/**
    Returns a non-zero value unique among all pictures.
 */
uint32_t
sk_picture_get_unique_id(sk_picture_t*);

/**
    Return the cull rect specified when this picture was recorded.
*/
sk_rect_t
sk_picture_get_bounds(sk_picture_t*);
