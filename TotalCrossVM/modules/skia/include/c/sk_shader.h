...
void
sk_shader_ref(sk_shader_t*);
void
sk_shader_unref(sk_shader_t*);
...
*/
sk_shader_t*
sk_shader_new_linear_gradient(const sk_point_t points[2],
...
*/
sk_shader_t*
sk_shader_new_radial_gradient(const sk_point_t* center,
                              float radius,
                              const sk_color_t colors[],
                              const float colorPos[],
                              int colorCount,
...
*/
sk_shader_t*
sk_shader_new_sweep_gradient(const sk_point_t* center,
                             const sk_color_t colors[],
                             const float colorPos[],
                             int colorCount,
                             const sk_matrix_t* localMatrix);
