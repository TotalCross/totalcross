...
*/
SK_API sk_surface_t*
sk_surface_new_raster(const sk_imageinfo_t*, const sk_surfaceprops_t*);
...
*/
SK_API sk_surface_t*
sk_surface_new_raster_direct(const sk_imageinfo_t*,
                             void* pixels,
                             size_t rowBytes,
...
*/
SK_API void
sk_surface_unref(sk_surface_t*);

/**
 *  Return the canvas associated with this surface. Note: the canvas is owned by
 * the surface, so the returned object is only valid while the owning surface is
 * valid.
 */
SK_API sk_canvas_t*
 ...
 */
SK_API sk_image_t*
sk_surface_new_image_snapshot(sk_surface_t*);
