...
*/
SK_API void
sk_canvas_save_layer(sk_canvas_t*, const sk_rect_t*, const sk_paint_t*);
/**
...
*/
SK_API void
sk_canvas_translate(sk_canvas_t*, float dx, float dy);
/**
    Preconcat the current coordinate transformation matrix with the
    specified scale.
*/
SK_API void
sk_canvas_scale(sk_canvas_t*, float sx, float sy);
/**
    Preconcat the current coordinate transformation matrix with the
    specified rotation in degrees.
*/
SK_API void
sk_canvas_rotate_degrees(sk_canvas_t*, float degrees);
/**
    Preconcat the current coordinate transformation matrix with the
    specified rotation in radians.
*/
SK_API void
sk_canvas_rotate_radians(sk_canvas_t*, float radians);
/**
    Preconcat the current coordinate transformation matrix with the
    specified skew.
*/
SK_API void
sk_canvas_skew(sk_canvas_t*, float sx, float sy);
/**
    Preconcat the current coordinate transformation matrix with the
    specified matrix.
*/
SK_API void
sk_canvas_concat(sk_canvas_t*, const sk_matrix_t*);
...
*/
SK_API void
sk_canvas_clip_rect(sk_canvas_t*, const sk_rect_t*);
/**
...
*/
SK_API void
sk_canvas_clip_path(sk_canvas_t*, const sk_path_t*);
...
*/
SK_API void
sk_canvas_draw_paint(sk_canvas_t*, const sk_paint_t*);
/**
...
*/
SK_API void
sk_canvas_draw_rect(sk_canvas_t*, const sk_rect_t*, const sk_paint_t*);
/**
 *  Draw the circle centered at (cx, cy) with radius rad using the specified
 * paint. The circle will be filled or framed based on the style in the paint
 */
SK_API void
sk_canvas_draw_circle(sk_canvas_t*,
                      float cx,
                      float cy,
                      float rad,
                      const sk_paint_t*);
...
*/
SK_API void
sk_canvas_draw_oval(sk_canvas_t*, const sk_rect_t*, const sk_paint_t*);
/**
    Draw the specified path using the specified paint. The path will be
    filled or framed based on the style in the paint
*/
SK_API void
sk_canvas_draw_path(sk_canvas_t*, const sk_path_t*, const sk_paint_t*);
/**
...
*/
SK_API void
sk_canvas_draw_image(sk_canvas_t*,
                     const sk_image_t*,
                     float x,
                     float y,
                     const sk_paint_t*);
...
*/
SK_API void
sk_canvas_draw_picture(sk_canvas_t*,
                       const sk_picture_t*,
                       const sk_matrix_t*,
                       const sk_paint_t*);
