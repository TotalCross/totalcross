...
// juliana@114_9: the absence of primary key can't be zero because the rowid may
// be a primary key or it can have an index.
#define NO_PRIMARY_KEY                                                         \
  -1 // nowosad@200 - Indicates if table does not have primary key.
#define NO_COLUMN_NAMES                                                        \
  0 // nowosad@200 - Indicates if table has column names info.
...
#define DEFAULT_ROW_INC                                                        \
  10 // The default record increment when growing the table file.
#define CACHE_SIZE 20  // The index cache size.
#define RECGROWSIZE 64 // The record increment for indices.
#define SECTOR_SIZE                                                            \
  512 // The record size used to calculate the number of keys per b-tree node.
#define MAX_IDX                                                                \
  65534 // The maximum number of nodes of an index. // juliana@noidr_2
#define DBNAME_SIZE                                                            \
  41 // Space for the name of the table plus the identification of the index, if
     // needed.
#define COMP_IDX_PK_SIZE                                                       \
  64 // The space for composed indices in the header of .db.
...
// juliana@250_8: now the maximum number of columns, fields, tables, etc is 254
// instead of 128 except on palm. guich@561_1: maximums for the parsing process.
...
#define CMD_ALTER_ADD_COLUMN                                                   \
  9 // ALTER TABLE ADD... (new column definition) // juliana@add_1
...
#define NO_VALUE                                                               \
  0xFFFFFFFF        // Represents a key that has no values attached to it.
...
#define TSMD_ONLY_DELETEDROWSCOUNT                                             \
  1 // Saves only the deleted rows count and header information.
#define TSMD_ONLY_AUXROWID 2 // rnovais@570_61: Also save the auxiliary row id.
#define TSMD_ONLY_PRIMARYKEYCOL                                                \
  3                            // Also save the primary key column information.
...
// Limit errors.
#define ERR_MAX_NUM_FIELDS_REACHED                                             \
  3 // "Maximum number of different fields was reached."
#define ERR_MAX_NUM_PARAMS_REACHED                                             \
  4 // "Maximum number of paramList in the 'WHERE/HAVING' clause was reached."
#define ERR_MAX_COMP_INDICES                                                   \
  5 // "Maximum number of composed indices 32 was reached."
#define ERR_MAX_TABLE_NAME_LENGTH 6 // "Table name too big: must be <= 23."
#define ERR_FIELDS_OVERFLOW                                                    \
  7 // "The maximum number of fields in a SELECT clause was exceeded."
#define ERR_FIELD_OVERFLOW_GROUPBY_ORDERBY                                     \
  8 // "Maximum number of columns exceeded in the 'ORDER BY/GROUP BY' clause."
...
#define ERR_COLUMN_DOESNOT_HAVE_AN_INDEX                                       \
  12 // "The following column(s) does (do) not have an associated index "
#define ERR_AMBIGUOUS_COLUMN_NAME                                              \
  13                            // "Column name in field list is ambiguous: "
#define ERR_COLUMN_NOT_FOUND 14 // "Column not found: "
#define ERR_DUPLICATED_COLUMN_NAME 15 // "Duplicated column name: "

// Primary key errors.
#define ERR_PRIMARY_KEY_ALREADY_DEFINED                                        \
  16 // "A primary key was already defined for this table."
#define ERR_TABLE_DOESNOT_HAVE_PRIMARY_KEY                                     \
  17 // "Table does not have a primary key."
#define ERR_STATEMENT_CREATE_DUPLICATED_PK                                     \
  18 // "Statement creates a duplicated primary key in "

// Type errors.
#define ERR_INCOMPATIBLE_TYPES 19 // "Incompatible types."
#define ERR_FIELD_SIZE_IS_NOT_INT                                              \
  20 // "Field size must be a positive interger value."
#define ERR_INVALID_NUMBER                                                     \
  21 // "Value is not a valid number for the desired type: "
#define ERR_DATA_TYPE_FUNCTION                                                 \
  22 // "Incompatible data type for the function call: "

// Number of fields errors.
#define ERR_NUMBER_FIELDS_AND_VALUES_DOES_NOT_MATCH                            \
  23 // "The number of fields does not match the number of values "
#define ERR_NUMBER_VALUES_DIFF_TABLE_DEFINITION                                \
  24 // "The given number of values does not match the table definition."

// Default value errors.
#define ERR_LENGTH_DEFAULT_VALUE_IS_BIGGER                                     \
  25 // "Length of default value is bigger than column size."
#define ERR_NOT_NULL_DEFAULT                                                   \
  26 // "An added column declared as NOT NULL must have a not null default
     // value."

// Driver errors.
#define ERR_DRIVER_CLOSED                                                      \
  27 // "This driver instance was closed and can't be used anymore. Please get a
     // new instance of it."
#define ERR_RESULTSET_CLOSED 28 // "ResultSet already closed!"
#define ERR_RESULTSETMETADATA_CLOSED                                           \
  29 // "ResultSetMetaData can't be used after the ResultSet is closed. "
#define ERR_INVALID_CRID                                                       \
  30                       // "The application id must be four characters long."
...
#define ERR_PREPARED_STMT_CLOSED                                               \
  33 // "Prepared statement closed. Please prepare it again."
#define ERR_INVALID_PARAMETER                                                  \
  34 // "Invalid connection parameter: %s". // juliana@253_11

// Table errors.
#define ERR_TABLE_NAME_NOT_FOUND 35  // "Table name not found: "
#define ERR_TABLE_ALREADY_CREATED 36 // "Table already created: "
#define ERR_WRONG_STRING_FORMAT                                                \
  37 // "It is not possible to open a table within a connection with a different
     // string format."
#define ERR_WRONG_CRYPTO_FORMAT                                                \
  38 // "It is not possible to open a table within a connection with a different
     // cryptography format."
...
#define ERR_QUERY_DOESNOT_RETURN_RESULTSET                                     \
  40 // "SQL statement does not return result set."
#define ERR_QUERY_DOESNOT_PERFORM_UPDATE                                       \
  41 // "SQL statement does not perform updates in the database."
#define ERR_NOT_ALL_PARAMETERS_DEFINED                                         \
  42 // "Not all parameters of the query had their values defined."
#define ERR_PARAMETER_NOT_DEFINED                                              \
  43 // "A value was not defined for the parameter "
#define ERR_INVALID_PARAMETER_INDEX 44 // "Invalid parameter index."

// Rename errors.
#define ERR_TABLE_ALREADY_EXIST                                                \
  45 // "Can't rename table. This table already exists: "
#define ERR_COLUMN_ALREADY_EXIST 46 // "Column already exists: "

// Alias errors.
#define ERR_NOT_UNIQUE_ALIAS_TABLE 47 // "Not unique table/alias: "
#define ERR_DUPLICATE_ALIAS                                                    \
  48 // "This alias is already being used in this expression: "
#define ERR_REQUIRED_ALIAS                                                     \
  49 // "An alias is required for the aggregate function column."

// Litebase.execute() error.
#define ERR_ONLY_CREATE_TABLE_INDEX_IS_ALLOWED                                 \
  50 // "Only CREATE TABLE and CREATE INDEX can be used in Litebase.execute()."

// Order by and group by errors.
#define ERR_ORDER_GROUPBY_MUST_MATCH                                           \
  51 // "ORDER BY and GROUP BY clauses must match."
#define ERR_VIRTUAL_COLUMN_ON_GROUPBY                                          \
  52 // "No support for virtual columns in SQL queries with GROUP BY clause."

// Function errors.
#define ERR_AGGREG_FUNCTION_ISNOT_ON_SELECT                                    \
  53 // "All non-aggregation function columns in the SELECT clause must also be
     // in the GROUP BY clause."

// " is not an aggregation function. All fields present in a HAVING clause must
// be listed in the SELECT clause as aliased aggregation functions."
...
#define ERR_CANNOT_HAVE_AGGREG_AND_NO_GROUPBY                                  \
  56 // "Can't have aggregation functions with ORDER BY clause and no GROUP BY
     // clause."

// " was not listed in the SELECT clause. All fields present in a HAVING clause
// must be listed in the SELECT clause as aliased aggregation funtions."
#define ERR_WAS_NOT_LISTED_ON_AGGREG_FUNCTION 57

#define ERR_SUM_AVG_WITH_DATE_DATETIME                                         \
  58 // "SUM and AVG aggregation functions are not used with DATE and DATETIME
     // type fields."
...
#define ERR_DROP_PRIMARY_KEY                                                   \
  62 // "Can't drop a primary key index with drop index."
#define ERR_INDEX_LARGE                                                        \
  63 // "Index too large. It can't have more than 32767 nodes."
...
#define ERR_RS_DEC_PLACES_START                                                \
  68 // "Invalid value for decimal places: . It must range from -1 to 40."
...
#define ERR_TABLE_NOT_CLOSED                                                   \
  72 // "Table not closed properly: " // juliana@220_2
#define ERR_TABLE_CLOSED                                                       \
  73 // "A properly closed table can't be used in recoverTable(): " //
     // juliana@222_2
#define ERR_IDX_RECORD_DEL 74 // "Can't find index record position on delete."
#define ERR_WRONG_VERSION                                                      \
  75 // "The table format is incompatible with Litebase version. Please update
     // your tables."
#define ERR_WRONG_PREV_VERSION                                                 \
  76                        // "The table format is not the previous one: "
...
#define ERR_TABLE_OPENED                                                       \
  80 // "An opened table can't be recovered or converted: " // juliana@230_12

// BLOB errors.
#define ERR_BLOB_TOO_BIG                                                       \
  81 // "The total size of a blob can't be greater then 10 Mb."
...
#define ERR_BLOB_ORDER_GROUP                                                   \
  87 // "Blobs types can't be in ORDER BY or GROUP BY clauses.
#define ERR_COMP_BLOBS 88 // "It is not possible to compare BLOBs."
#define ERR_BLOBS_PREPARED                                                     \
  89 // "It is only possible to insert or update a BLOB through prepared
     // statements."

#define TOTAL_ERRORS 90 // Total Litebase possible errors.

#define MAX_NUM_INDEXES_APPLIED                                                \
  32 // The maximum number of indexes to be applied.
...
#define INDEX_SORT_MAX_TIME                                                    \
  40 // The maximum time (in seconds) that will be taken to sort a table before
     // creating the index.
...
#define VALIDATION_RECORD_INCOMPLETE_OK                                        \
  4 // Used internally on booleanTreeEvaluateJoin(). The current branch was
    // validated as true.
...
#define IS_ASCII                                                               \
  2 // Indicates that the table strings are to be saved in the ascii format.
...
#ifdef POSIX // juliana@226_18: minimum float and double values for POSIX are
             // different from IEEE values.
...
#endif
#define MAX_FLOAT_VALUE                                                        \
  3.4028235e+38 // The maximum float value: 3.4028235e+38f.
