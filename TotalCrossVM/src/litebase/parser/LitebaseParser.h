...
setOperandType(int32 operandType, LitebaseParser* parse);
 ...
 */
void
test_lbError(TestSuite* testSuite, Context currentContext);
 ...
 */
void
test_lbErrorWithMessage(TestSuite* testSuite, Context currentContext);
 ...
 */
void
test_initLitebaseParser(TestSuite* testSuite, Context currentContext);
