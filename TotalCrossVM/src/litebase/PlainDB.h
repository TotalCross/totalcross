...
/**
 * This has the function declarations for a database in a plain binary file. The
 ...
 *
 * This also has function declarations for a temporary database for
