...
void PNGFAPI png_set_cHRM_XYZ_fixed(png_const_structrp png_ptr, png_inforp info_ptr,
...
void PNGAPI png_set_cHRM_XYZ(png_const_structrp png_ptr, png_inforp info_ptr, double red_X,
...
void PNGAPI png_set_sRGB_gAMA_and_cHRM(png_const_structrp png_ptr, png_inforp info_ptr,
									   int srgb_intent) {
...
int /* PRIVATE */ png_set_text_2(png_const_structrp png_ptr, png_inforp info_ptr,
								 png_const_textp text_ptr, int num_text) {
	int i;
...
void PNGAPI png_set_sPLT(png_const_structrp png_ptr,
...
void PNGAPI png_set_read_user_chunk_fn(png_structrp png_ptr, png_voidp user_chunk_ptr,
...
void PNGAPI png_set_user_limits(png_structrp png_ptr, png_uint_32 user_width_max,
 ...
 */
png_uint_32 /* PRIVATE */ png_check_keyword(png_structrp png_ptr, png_const_charp key,
		png_bytep new_key) {
