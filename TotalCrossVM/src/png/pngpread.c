...
void /* PRIVATE */ png_push_restore_buffer(png_structrp png_ptr, png_bytep buffer,
...
void /* PRIVATE */ png_process_IDAT_data(png_structrp png_ptr, png_bytep buffer,
		png_size_t buffer_length) {
...
void /* PRIVATE */ png_read_push_finish_row(png_structrp png_ptr) {
#ifdef PNG_READ_INTERLACING_SUPPORTED
...
void /* PRIVATE */ png_push_have_row(png_structrp png_ptr, png_bytep row) {
