...
void fillNativeProcAddressesTC()
{
   ...
   htPutPtr(&htNativeProcAddresses, hashCode("jlC_getSigners"), &jlC_getSigners);
   ...
   htPutPtr(&htNativeProcAddresses, hashCode("jlrM_getDeclaringClass"), &jlrM_getDeclaringClass);
   htPutPtr(&htNativeProcAddresses, hashCode("jlrM_getName"), &jlrM_getName);
   htPutPtr(&htNativeProcAddresses, hashCode("jlrM_getModifiers"), &jlrM_getModifiers);
   htPutPtr(&htNativeProcAddresses, hashCode("jlrM_getReturnType"), &jlrM_getReturnType);
   htPutPtr(&htNativeProcAddresses, hashCode("jlrM_getParameterTypes"), &jlrM_getParameterTypes);
   htPutPtr(&htNativeProcAddresses, hashCode("jlrM_getExceptionTypes"), &jlrM_getExceptionTypes);
   htPutPtr(&htNativeProcAddresses, hashCode("jlrM_equals_o"), &jlrM_equals_o);
   htPutPtr(&htNativeProcAddresses, hashCode("jlrM_hashCode"), &jlrM_hashCode);
   htPutPtr(&htNativeProcAddresses, hashCode("jlrM_toString"), &jlrM_toString);
   htPutPtr(&htNativeProcAddresses, hashCode("jlrM_invoke_oO"), &jlrM_invoke_oO);
   htPutPtr(&htNativeProcAddresses, hashCode("jlrC_getDeclaringClass"), &jlrC_getDeclaringClass);
   htPutPtr(&htNativeProcAddresses, hashCode("jlrC_getName"), &jlrC_getName);
   htPutPtr(&htNativeProcAddresses, hashCode("jlrC_getModifiers"), &jlrC_getModifiers);
   htPutPtr(&htNativeProcAddresses, hashCode("jlrC_getParameterTypes"), &jlrC_getParameterTypes);
   htPutPtr(&htNativeProcAddresses, hashCode("jlrC_getExceptionTypes"), &jlrC_getExceptionTypes);
   htPutPtr(&htNativeProcAddresses, hashCode("jlrC_equals_o"), &jlrC_equals_o);
   htPutPtr(&htNativeProcAddresses, hashCode("jlrC_hashCode"), &jlrC_hashCode);
   htPutPtr(&htNativeProcAddresses, hashCode("jlrC_toString"), &jlrC_toString);
   htPutPtr(&htNativeProcAddresses, hashCode("jlrC_newInstance_O"), &jlrC_newInstance_O);
   htPutPtr(&htNativeProcAddresses, hashCode("jlrF_getDeclaringClass"), &jlrF_getDeclaringClass);
   htPutPtr(&htNativeProcAddresses, hashCode("jlrF_getName"), &jlrF_getName);
   htPutPtr(&htNativeProcAddresses, hashCode("jlrF_getModifiers"), &jlrF_getModifiers);
   htPutPtr(&htNativeProcAddresses, hashCode("jlrF_getType"), &jlrF_getType);
   htPutPtr(&htNativeProcAddresses, hashCode("jlrF_equals_o"), &jlrF_equals_o);
   htPutPtr(&htNativeProcAddresses, hashCode("jlrF_hashCode"), &jlrF_hashCode);
   htPutPtr(&htNativeProcAddresses, hashCode("jlrF_toString"), &jlrF_toString);
   ...
   htPutPtr(&htNativeProcAddresses, hashCode("jlrF_setFloat_of"), &jlrF_setFloat_of);
