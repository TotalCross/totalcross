...
void fillNativeProcAddressesTC()
{
   ...
   htPutPtr(&htNativeProcAddresses, hashCode("tuiI_applyChangesNative"), &tuiI_applyChangesNative);
   ...
   htPutPtr(&htNativeProcAddresses, hashCode("tuiI_decodeEncodedSourceCandidat"), &tuiI_decodeEncodedSourceCandidat);
   ...
   htPutPtr(&htNativeProcAddresses, hashCode("tuiNIB_createEmptyForTestNative"), &tuiNIB_createEmptyForTestNative_iii);
   ...
   htPutPtr(&htNativeProcAddresses, hashCode("tuiNIB_formatBytesTest_i"), &tuiNIB_formatBytesTest_i);
   htPutPtr(&htNativeProcAddresses, hashCode("tuiNIB_compactDecodeCountTest"), &tuiNIB_compactDecodeCountTest);
   htPutPtr(&htNativeProcAddresses, hashCode("tuiNIB_compactDecodeBytesTest"), &tuiNIB_compactDecodeBytesTest);
   htPutPtr(&htNativeProcAddresses, hashCode("tuiNIB_temporaryRgbaBytesTest"), &tuiNIB_temporaryRgbaBytesTest);
   htPutPtr(&htNativeProcAddresses, hashCode("tuiNIB_compactReadbacksTest"), &tuiNIB_compactReadbacksTest);
   htPutPtr(&htNativeProcAddresses, hashCode("tuiNIB_compactScratchPeakTest"), &tuiNIB_compactScratchPeakTest);
   htPutPtr(&htNativeProcAddresses, hashCode("tuiNIB_promotionAttemptsTest"), &tuiNIB_promotionAttemptsTest);
   htPutPtr(&htNativeProcAddresses, hashCode("tuiNIB_promotionSuccessesTest"), &tuiNIB_promotionSuccessesTest);
   htPutPtr(&htNativeProcAddresses, hashCode("tuiNIB_promotionFailuresTest"), &tuiNIB_promotionFailuresTest);
   htPutPtr(&htNativeProcAddresses, hashCode("tuiNIB_promotionBytesTest"), &tuiNIB_promotionBytesTest);
   ...
   htPutPtr(&htNativeProcAddresses, hashCode("tuiNIB_failNextPromotionNative"), &tuiNIB_failNextPromotionNative);
   htPutPtr(&htNativeProcAddresses, hashCode("tuiNIB_failNextAdoptionNative"), &tuiNIB_failNextAdoptionNative);
   ...
   htPutPtr(&htNativeProcAddresses, hashCode("tuiNIB_currentFormatNative"), &tuiNIB_currentFormatNative);
   ...
   htPutPtr(&htNativeProcAddresses, hashCode("tuiNIB_generationNative"), &tuiNIB_generationNative);
   ...
   htPutPtr(&htNativeProcAddresses, hashCode("tuiNIB_writePixelsRejectInvalidTargetOrSourceTest"), &tuiNIB_writePixelsRejectInvalidTargetOrSourceTest);
   htPutPtr(&htNativeProcAddresses, hashCode("tuiNIB_writePixelsRejectAlphaMaskTest"), &tuiNIB_writePixelsRejectAlphaMaskTest);
   htPutPtr(&htNativeProcAddresses, hashCode("tuiNIB_writePixelsRejectMatrixTest"), &tuiNIB_writePixelsRejectMatrixTest);
   htPutPtr(&htNativeProcAddresses, hashCode("tuiNIB_writePixelsRejectSaveCountTest"), &tuiNIB_writePixelsRejectSaveCountTest);
   htPutPtr(&htNativeProcAddresses, hashCode("tuiNIB_writePixelsRejectSourceRectTest"), &tuiNIB_writePixelsRejectSourceRectTest);
   htPutPtr(&htNativeProcAddresses, hashCode("tuiNIB_writePixelsRejectSizeMismatchTest"), &tuiNIB_writePixelsRejectSizeMismatchTest);
   htPutPtr(&htNativeProcAddresses, hashCode("tuiNIB_writePixelsRejectFractionalDestinationTest"), &tuiNIB_writePixelsRejectFractionalDestinationTest);
   htPutPtr(&htNativeProcAddresses, hashCode("tuiNIB_writePixelsRejectDestinationBoundsTest"), &tuiNIB_writePixelsRejectDestinationBoundsTest);
   htPutPtr(&htNativeProcAddresses, hashCode("tuiNIB_writePixelsRejectOpacityTest"), &tuiNIB_writePixelsRejectOpacityTest);
   htPutPtr(&htNativeProcAddresses, hashCode("tuiNIB_writePixelsRejectSourcePixelsTest"), &tuiNIB_writePixelsRejectSourcePixelsTest);
   htPutPtr(&htNativeProcAddresses, hashCode("tuiNIB_writePixelsRejectWriteFailureTest"), &tuiNIB_writePixelsRejectWriteFailureTest);
   htPutPtr(&htNativeProcAddresses, hashCode("tuiNIB_writePixelsDeviceOneToOneCandidatesTest"), &tuiNIB_writePixelsDeviceOneToOneCandidatesTest);
   htPutPtr(&htNativeProcAddresses, hashCode("tuiNIB_writePixelsDeviceOneToOneKnownOpaqueCandidatesTest"), &tuiNIB_writePixelsDeviceOneToOneKnownOpaqueCandidatesTest);
   ...
   htPutPtr(&htNativeProcAddresses, hashCode("tugG_copyGeometryNative_oiiiiiib"), &tugG_copyGeometryNative_oiiiiiib);
   ...
   htPutPtr(&htNativeProcAddresses, hashCode("tugG_drawImageNative_iii"), &tugG_drawImageNative_iii);
   ...
   htPutPtr(&htNativeProcAddresses, hashCode("tufFM_descentAtSizeD_d"), &tufFM_descentAtSizeD_d);
   htPutPtr(&htNativeProcAddresses, hashCode("tufFM_ascentAtSizeD_d"), &tufFM_ascentAtSizeD_d);
   ...
   htPutPtr(&htNativeProcAddresses, hashCode("tuW_getSafeAreaInsets"), &tuW_getSafeAreaInsets);
