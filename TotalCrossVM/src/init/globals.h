...
extern int64 nextTimerDeadlineNs;
extern int64 lastFiredTimerDeadlineNs;
extern int32 absoluteTimerIntervalMs;
...
#ifdef ANDROID
extern jmethodID jshowCamera,jgetNativeResolutions,jgetNativeVideoResolutions,jgetDefaultToString,jzxing;
