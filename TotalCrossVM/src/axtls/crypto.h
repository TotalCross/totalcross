...
typedef struct
{
    uint32_t Intermediate_Hash[SHA256_SIZE/4]; /* Message Digest */
    uint32_t Length_Low;                /* Message length in bits */
    uint32_t Length_High;               /* Message length in bits */
    uint16_t Message_Block_Index;		/* Index into message block array   */
    uint8_t Message_Block[64];			/* 512-bit message blocks */
...
void SHA256Update(SHA256_CTX *, const uint8_t *msg, int len);
void SHA256Final(SHA256_CTX *, uint8_t *digest);
...
EXP_FUNC int STDCALL MD2Init(MD2_CTX *);
...
/* see http://www.obj-sys.com/asn1tutorial/node128.html */
#define ASN1_INTEGER            0x02
#define ASN1_BIT_STRING         0x03
#define ASN1_OCTET_STRING       0x04
#define ASN1_NULL               0x05
#define ASN1_OID                0x06
#define ASN1_UTF8_STR           0x0c
...
#if defined(CONFIG_SSL_FULL_MODE) || defined(WIN32) || defined(__SYMBIAN32__) || defined(CONFIG_DEBUG)
