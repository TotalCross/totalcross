...
#define abort() tcabort(__FILE__,__LINE__); // TOTALCROSS

#if defined(__SYMBIAN32__) && !defined(EKA2)
// add some missing int64 operations generated by gcc
#include <e32std.h>
#if !defined(linux) && !defined(__arm__) && (defined(WINCE) || defined(__SYMBIAN32__) || (_MSC_VER <= 1200))  // 1200 = VC6 and earlier
#define I64_CONST(x) x##L
#else
#define I64_CONST(x) x##LL
#endif
extern "C" int64_t __udivdi3(int64_t a, int64_t b)
{
	TInt64 _acc((TInt)(a >> 32), (TInt)(a & I64_CONST(0xFFFFFFFF)));
	TInt64 _div((TInt)(b >> 32), (TInt)(b & I64_CONST(0xFFFFFFFF)));
	_acc /= _div;
	int64_t r = _acc.High();
	r <<= 32;
	r |= _acc.Low();
...
extern "C" int64_t __umoddi3(int64_t a, int64_t b)
{
	TInt64 _acc((TInt)(a >> 32), (TInt)(a & I64_CONST(0xFFFFFFFF)));
	TInt64 _div((TInt)(b >> 32), (TInt)(b & I64_CONST(0xFFFFFFFF)));
	_acc %= _div;
