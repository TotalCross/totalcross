...
//////////////////////////////////////////////////////////////////////////
TC_API void tpSMS_send_ss(NMParams
						  p) { // totalcross/phone/SMS native public static void send(String destination, String message) throws totalcross.io.IOException;
	...
	if (destination == null) {
		...
		if (!szMessage || !szDestination) {
			throwException(p->currentContext, OutOfMemoryError,
						   !szMessage ? "When allocating 'message'" : "'When allocating 'destination'");
		} else {
...
//////////////////////////////////////////////////////////////////////////
TC_API void tpSMS_receive(NMParams
						  p) { // totalcross/phone/SMS native public static String[] receive() throws totalcross.io.IOException;
#if defined (WINCE)
