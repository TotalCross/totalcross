 ...
 */
TCHAR buf[128];
TCObject createFile(Context currentContext, const TCHARP dir, const TCHARP fileName,
					TCObject* outPath) {
	TCObject obj;
 ...
 */
TCObject createTime(Context currentContext, int32 year, int32 month, int32 day, int32 hour,
