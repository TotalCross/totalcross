...
static Err nativeStartGPS(TCObject gpsObject) {
	...
	jmethodID method = (*env)->GetStaticMethodID(env, applicationClass, "requestLocationPermission",
					   "()I");
	...
	jgpsData = (*env)->CallStaticObjectMethod(env, applicationClass, jgpsFunc, GPSFUNC_START,
