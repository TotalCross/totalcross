...
//////////////////////////////////////////////////////////////////////////
TC_API void tidgGPS_startGPS(NMParams
							 p) { // totalcross/io/device/gps/GPS native private boolean startGPS() throws totalcross.io.IOException;
...
//////////////////////////////////////////////////////////////////////////
TC_API void tidgGPS_updateLocation(NMParams
								   p) { // totalcross/io/device/gps/GPS native private int updateLocation();
	int32 flags = 0;
#if defined(WINCE) || defined(ANDROID) || defined(darwin)
	Err err;
...
//////////////////////////////////////////////////////////////////////////
TC_API void tidgGPS_stopGPS(NMParams
							p) { // totalcross/io/device/gps/GPS native private void stopGPS();
#if defined(WINCE) || defined(ANDROID) || defined(darwin)
	nativeStopGPS();
#elif defined (WP8)
	nativeStopGPSCPP();
