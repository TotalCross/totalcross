...
//////////////////////////////////////////////////////////////////////////
TC_API void
tidgGPS_startGPS(NMParams p)
{ // totalcross/io/device/gps/GPS native private boolean
  // startGPS() throws totalcross.io.IOException;
...
#endif
  {
    if (err == 2) {
      throwException(
        p->currentContext, GPSDisabledException, "GPS is disabled");
    }
#ifdef ANDROID
    else if (err == 1) {
...
//////////////////////////////////////////////////////////////////////////
TC_API void
tidgGPS_updateLocation(NMParams p)
{ // totalcross/io/device/gps/GPS native
...
//////////////////////////////////////////////////////////////////////////
TC_API void
tidgGPS_stopGPS(NMParams p)
{ // totalcross/io/device/gps/GPS native private void stopGPS();
#if defined(WINCE) || defined(ANDROID) || defined(darwin)
  nativeStopGPS();
#elif defined(WP8)
  nativeStopGPSCPP();
