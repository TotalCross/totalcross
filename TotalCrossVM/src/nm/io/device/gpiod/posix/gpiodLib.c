...
bool initGpiod() {
	...
	if (gpiodLib != null) {
		_gpiod_chip_open_by_number = (_gpiod_chip_open_by_numberProc) dlsym(gpiodLib,
									 TEXT("gpiod_chip_open_by_number"));
		_gpiod_chip_get_line = (_gpiod_chip_get_lineProc) dlsym(gpiodLib, TEXT("gpiod_chip_get_line"));
		_gpiod_line_request_output = (_gpiod_line_request_outputProc) dlsym(gpiodLib,
									 TEXT("gpiod_line_request_output"));
		_gpiod_line_set_value = (_gpiod_line_set_valueProc) dlsym(gpiodLib, TEXT("gpiod_line_set_value"));
		_gpiod_line_request_input = (_gpiod_line_request_inputProc) dlsym(gpiodLib,
									TEXT("gpiod_line_request_input"));
