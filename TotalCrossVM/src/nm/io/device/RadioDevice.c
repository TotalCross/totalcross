...
//////////////////////////////////////////////////////////////////////////
TC_API void
tidRD_isSupported_i(NMParams p)
{ // totalcross/io/device/RadioDevice native
...
//////////////////////////////////////////////////////////////////////////
TC_API void
tidRD_getState_i(NMParams p)
{ // totalcross/io/device/RadioDevice native public static int
  // getState(int type) throws IllegalArgumentException;
  int32 type = p->i32[0];
...
//////////////////////////////////////////////////////////////////////////
TC_API void
tidRD_setState_ii(NMParams p)
{ // totalcross/io/device/RadioDevice native
  // public static void setState(int type, int
