...
//////////////////////////////////////////////////////////////////////////
TC_API void tidbSPS_createSerialPortServer_s(NMParams
		p) { // totalcross/io/device/bluetooth/SerialPortServer native private void createSerialPortServer(String uuid, String []params) throws totalcross.io.IOException;
...
//////////////////////////////////////////////////////////////////////////
TC_API void tidbSPS_accept(NMParams
						   p) { // totalcross/io/device/bluetooth/SerialPortServer native public totalcross.io.Stream accept() throws totalcross.io.IOException;
#if !defined WP8 && (defined (WIN32) || defined (WINCE) || defined (ANDROID))
	TCObject serialPortServerObj = p->obj[0];
	...
	if ((serialPortClientObj = createObject(p->currentContext,
...
//////////////////////////////////////////////////////////////////////////
TC_API void tidbSPS_close(NMParams
						  p) { // totalcross/io/device/bluetooth/SerialPortServer native public void close() throws throws totalcross.io.IOException;
#if !defined WP8 && (defined (WIN32) || defined (WINCE) || defined (ANDROID))
	TCObject serialPortServerObj = p->obj[0];
	TCObject nativeHandleObj = SerialPortServer_nativeHandle(serialPortServerObj);
	NATIVE_HANDLE* nativeHandle;
