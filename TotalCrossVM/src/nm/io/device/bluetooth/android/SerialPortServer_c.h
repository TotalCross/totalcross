...
static void
loadFunctions(JNIEnv* env)
{
  jserverAccept = (*env)->GetStaticMethodID(
    env, jBluetooth4A, "serverAccept", "(Ljava/lang/String;)I");
  jserverClose =
    (*env)->GetStaticMethodID(env, jBluetooth4A, "serverClose", "()V");
}

static void
guid2handle(NATIVE_HANDLE* nativeHandle, GUID guid)
{
