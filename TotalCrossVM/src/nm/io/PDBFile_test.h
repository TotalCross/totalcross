...
TESTCASE(tiPDBF_create_sssi)
{ // totalcross/io/PDBFile native private void
  // create(String name, String creator, String
  // type, int mode) throws
  ...
  // Empty parameters. Test must pass because the constructor already checks
  // them.
  p.obj[0] =
  ...
  ASSERT1_EQUALS(NotNull, p.obj[0]);
  p.obj[1] =
    createStringObjectFromCharP(currentContext, "tiPDBF_create_sssi", -1);
  ...
  // Mode CREATE_EMPTY with a PDB file that not exist does not throw an
  // exception.
  p.obj[0] = createObject(currentContext, "totalcross.io.PDBFile");
  ASSERT1_EQUALS(NotNull, p.obj[0]);
  p.obj[1] =
  ...
  ASSERT1_EQUALS(NotNull, p.obj[0]);
  p.obj[1] =
    createStringObjectFromCharP(currentContext, "tiPDBF_create_sssixxx", -1);
  p.obj[2] = createStringObjectFromCharP(currentContext, "TEST", -1);
  p.obj[3] = createStringObjectFromCharP(currentContext, "TEST", -1);
  ASSERT1_EQUALS(NotNull, p.obj[1]);
  p.i32[0] = CREATE_EMPTY;
...
TESTCASE(tiPDBF_rename_s)
{ // totalcross/io/PDBFile native public void
  // rename(String newName) throws
  ...
  p.obj[1] =
    createStringObjectFromCharP(currentContext, "tiPDBF_rename_s_ren", -1);
  p.obj[2] = createStringObjectFromCharP(currentContext, "TEST", -1);
  p.obj[3] = createStringObjectFromCharP(currentContext, "TEST", -1);
  ASSERT1_EQUALS(NotNull, p.obj[1]);
  p.i32[0] = CREATE_EMPTY;
  ...
  if (PDBFile_openRef(p.obj[0]) !=
      null) { // tiPDBF_rename_s_ren.TEST.TEST already exists
    tiPDBF_delete(&p);
    ASSERT1_EQUALS(Null, currentContext->thrownException);
    tiPDBF_nativeClose(&p);
    ASSERT1_EQUALS(
      NotNull,
      currentContext
        ->thrownException); // It's not possible to close a deleted PDBFile.
    currentContext->thrownException = null;
  }
  ...
  p.obj[1] = createStringObjectFromCharP(
    currentContext, "tiPDBF_rename_s_ren.TEST.TEST", -1);
  ASSERT1_EQUALS(NotNull, p.obj[1]);
  tiPDBF_rename_s(&p);
  ASSERT1_EQUALS(Null, currentContext->thrownException);
  tiPDBF_nativeClose(&p);
...
TESTCASE(tiPDBF_addRecord_i)
{ // totalcross/io/PDBFile native public int
  // addRecord(int size) throws
  // totalcross.io.IllegalArgumentIOException,
  // totalcross.io.IOException;
  int32 i32Array[1];
  TNMParams p;
  ...
  p.obj[1] =
    createStringObjectFromCharP(currentContext, "tiPDBF_addRecord_i", -1);
  p.obj[2] = createStringObjectFromCharP(currentContext, "TEST", -1);
  p.obj[3] = createStringObjectFromCharP(currentContext, "TEST", -1);
  ASSERT1_EQUALS(NotNull, p.obj[1]);
  p.i32[0] = CREATE_EMPTY;
...
TESTCASE(tiPDBF_addRecord_ii)
{ // totalcross/io/PDBFile native public int
  // addRecord(int size, int pos) throws
  // totalcross.io.IllegalArgumentIOException,
  // totalcross.io.IOException;
  int32 i32Array[2];
  TNMParams p;
  ...
  p.obj[1] =
    createStringObjectFromCharP(currentContext, "tiPDBF_addRecord_ii", -1);
  p.obj[2] = createStringObjectFromCharP(currentContext, "TEST", -1);
  p.obj[3] = createStringObjectFromCharP(currentContext, "TEST", -1);
  ASSERT1_EQUALS(NotNull, p.obj[1]);
  p.i32[0] = CREATE_EMPTY;
...
TESTCASE(tiPDBF_resizeRecord_i)
{ // totalcross/io/PDBFile native public void
  // resizeRecord(int size) throws
  // totalcross.io.IllegalArgumentIOException,
  // totalcross.io.IOException;
  int32 i32Array[1];
  ...
  p.obj[1] =
    createStringObjectFromCharP(currentContext, "tiPDBF_resizeRecord_i", -1);
  p.obj[2] = createStringObjectFromCharP(currentContext, "TEST", -1);
  p.obj[3] = createStringObjectFromCharP(currentContext, "TEST", -1);
  ASSERT1_EQUALS(NotNull, p.obj[1]);
  p.i32[0] = CREATE_EMPTY;
...
TESTCASE(tiPDBF_nativeClose)
{ // totalcross/io/PDBFile native private void
  // nativeClose() throws totalcross.io.IOException;
  int32 i32Array[1];
  TNMParams p;
  TCObject objs[4];
  p.obj = objs;
  ...
  ASSERT1_EQUALS(NotNull, p.obj[0]);
  p.obj[1] =
    createStringObjectFromCharP(currentContext, "tiPDBF_nativeClose_", -1);
  p.obj[2] = createStringObjectFromCharP(currentContext, "TEST", -1);
  p.obj[3] = createStringObjectFromCharP(currentContext, "TEST", -1);
  ASSERT1_EQUALS(NotNull, p.obj[1]);
  p.i32[0] = CREATE_EMPTY;
...
TESTCASE(tiPDBF_delete)
{ // totalcross/io/PDBFile native public boolean
  // delete() throws totalcross.io.IOException;
  int32 i32Array[1];
  TNMParams p;
  TCObject objs[4];
  ...
  ASSERT1_EQUALS(NotNull, p.obj[0]);
  p.obj[1] =
    createStringObjectFromCharP(currentContext, "tiPDBF_delete_i_", -1);
  p.obj[2] = createStringObjectFromCharP(currentContext, "TEST", -1);
  p.obj[3] = createStringObjectFromCharP(currentContext, "TEST", -1);
  ASSERT1_EQUALS(NotNull, p.obj[1]);
  p.i32[0] = CREATE_EMPTY;
...
{ // totalcross/io/PDBFile native public static
  ...
  p.obj[1] =
    createStringObjectFromCharP(currentContext, "tiPDBF_listPDBs_ii", -1);
  p.obj[2] = createStringObjectFromCharP(currentContext, "TEST", -1);
  p.obj[3] = createStringObjectFromCharP(currentContext, "TEST", -1);
  ASSERT1_EQUALS(NotNull, p.obj[1]);
  p.i32[0] = CREATE_EMPTY;
...
TESTCASE(tiPDBF_deleteRecord)
{ // totalcross/io/PDBFile native public void
  // deleteRecord() throws totalcross.io.IOException;
  int32 i32Array[1];
  TNMParams p;
  TCObject objs[4];
  ...
  p.obj[1] = createStringObjectFromCharP(
    currentContext, "tiPDBF_deleteRecord.TEST.TEST", -1);
  p.obj[2] = createStringObjectFromCharP(currentContext, "TEST", -1);
  p.obj[3] = createStringObjectFromCharP(currentContext, "TEST", -1);
  ASSERT1_EQUALS(NotNull, p.obj[1]);
  p.i32[0] = CREATE_EMPTY;
...
TESTCASE(tiPDBF_getRecordCount)
{ // totalcross/io/PDBFile native public int
  // getRecordCount() throws
  // totalcross.io.IOException;
  int32 i32Array[1];
  TNMParams p;
  TCObject objs[4];
  ...
  p.obj[1] =
    createStringObjectFromCharP(currentContext, "tiPDBF_getRecordCount_", -1);
  p.obj[2] = createStringObjectFromCharP(currentContext, "TEST", -1);
  p.obj[3] = createStringObjectFromCharP(currentContext, "TEST", -1);
  ASSERT1_EQUALS(NotNull, p.obj[1]);
  p.i32[0] = CREATE_EMPTY;
...
TESTCASE(tiPDBF_setRecordPos_i)
{ // totalcross/io/PDBFile native public boolean
  // setRecordPos(int pos) throws
  // totalcross.io.IllegalArgumentIOException,
  // totalcross.io.IOException;
  int32 i32Array[1];
  TNMParams p;
  ...
  p.obj[1] =
    createStringObjectFromCharP(currentContext, "tiPDBF_setRecordPos_i", -1);
  p.obj[2] = createStringObjectFromCharP(currentContext, "TEST", -1);
  p.obj[3] = createStringObjectFromCharP(currentContext, "TEST", -1);
  ASSERT1_EQUALS(NotNull, p.obj[1]);
  p.i32[0] = CREATE_EMPTY;
...
TESTCASE(tiPDBF_readBytes_Bii)
{ // totalcross/io/PDBFile native int
  // readWriteBytes(byte buf[], int start, int count,
  // boolean isRead) throws totalcross.io.IOException;
  CharP buf;
  int32 i, recSize = 128;
  int32 i32Array[3];
  TNMParams p;
  ...
  p.obj[1] = createStringObjectFromCharP(
    currentContext, "tiPDBF_readBytes_Bii.TEST.TEST", -1);
  p.obj[2] = createStringObjectFromCharP(currentContext, "TEST", -1);
  p.obj[3] = createStringObjectFromCharP(currentContext, "TEST", -1);
  ASSERT1_EQUALS(NotNull, p.obj[1]);
  p.i32[0] = CREATE_EMPTY;
...
TESTCASE(tiPDBF_writeBytes_Bii)
{ // totalcross/io/PDBFile native int
  // readWriteBytes(byte buf[], int start, int
  // count, boolean isRead) throws
  // totalcross.io.IOException;
  CharP buf;
  int32 i, recSize = 128;
  int32 i32Array[3];
  ...
  p.obj[1] =
    createStringObjectFromCharP(currentContext, "tiPDBF_writeBytes_Bii", -1);
  p.obj[2] = createStringObjectFromCharP(currentContext, "TEST", -1);
  p.obj[3] = createStringObjectFromCharP(currentContext, "TEST", -1);
  ASSERT1_EQUALS(NotNull, p.obj[1]);
  p.i32[0] = CREATE_EMPTY;
...
TESTCASE(tiPDBF_inspectRecord_Bii)
{ // totalcross/io/PDBFile native public int
  // inspectRecord(byte buf[], int recordPos,
  // int offsetInRec) throws
  // totalcross.io.IllegalArgumentIOException,
  // totalcross.io.IOException;
  CharP buf;
  int32 i, recSize = 128;
  ...
  p.obj[1] =
    createStringObjectFromCharP(currentContext, "tiPDBF_inspectRecord_Bii", -1);
  p.obj[2] = createStringObjectFromCharP(currentContext, "TEST", -1);
  p.obj[3] = createStringObjectFromCharP(currentContext, "TEST", -1);
  ASSERT1_EQUALS(NotNull, p.obj[1]);
  p.i32[0] = CREATE_EMPTY;
...
TESTCASE(tiPDBF_setRecordAttributes_ib)
{ // totalcross/io/PDBFile native public void
  // setRecordAttributes(int recordPos, byte
  ...
  p.obj[1] = createStringObjectFromCharP(
    currentContext, "tiPDBF_setRecAttributes_ib", -1);
  p.obj[2] = createStringObjectFromCharP(currentContext, "TEST", -1);
  p.obj[3] = createStringObjectFromCharP(currentContext, "TEST", -1);
  ASSERT1_EQUALS(NotNull, p.obj[1]);
  p.i32[0] = CREATE_EMPTY;
...
TESTCASE(tiPDBF_setAttributes_i)
{ // totalcross/io/PDBFile native public void
  // setAttributes(int i);
  int32 i32Array[3];
  TNMParams p;
  ...
  p.obj[1] =
    createStringObjectFromCharP(currentContext, "tiPDBF_setAttributes_i", -1);
  p.obj[2] = createStringObjectFromCharP(currentContext, "TEST", -1);
  p.obj[3] = createStringObjectFromCharP(currentContext, "TEST", -1);
  ASSERT1_EQUALS(NotNull, p.obj[1]);
  p.i32[0] = CREATE_EMPTY;
...
TESTCASE(tiPDBF_searchBytes_Bii)
{ // totalcross/io/PDBFile native public int
  // searchBytes(byte []toSearch, int length, int
  // offsetInRec) throws totalcross.io.IOException;
  TNMParams p;
  TCObject objs[4];
  int32 i32Array[3];
  CharP buf = null;
  ...
  p.obj[1] =
    createStringObjectFromCharP(currentContext, "tiPDBF_searchBytes_Bii", -1);
  p.obj[2] = createStringObjectFromCharP(currentContext, "TEST", -1);
  p.obj[3] = createStringObjectFromCharP(currentContext, "TEST", -1);
  ASSERT1_EQUALS(NotNull, p.obj[1]);
  p.i32[0] = CREATE_EMPTY;
