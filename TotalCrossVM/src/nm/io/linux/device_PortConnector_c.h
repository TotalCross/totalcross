...
#define CASE(x)                                                                \
  ...
  switch (baudRate) {
    ...
    CASE(75)
    CASE(110)
    CASE(134) CASE(150) CASE(200) CASE(300) CASE(600) CASE(1200) CASE(1800)
      CASE(2400) CASE(4800) CASE(9600) CASE(19200) CASE(38400) CASE(57600)
        CASE(115200) default : baudRate = B0; /* hang up */
  }
  ...
  /* Set character size.  csize variable is an integer holding the desired
   * character size. */
