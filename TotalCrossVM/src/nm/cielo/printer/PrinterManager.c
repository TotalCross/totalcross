...
//////////////////////////////////////////////////////////////////////////
TC_API void tcspPM_internalPrintText_ssp(NMParams
		p) { // totalcross/cielo/sdk/printer/PrinterManager private native void internalPrintText(String textToPrint, String printerAttributes, totalcross.cielo.printer.PrinterManager.PrinterListenerInternal printerListener);
