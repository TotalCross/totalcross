...
TC_API void jlrA_get_oi(NMParams p) { // totalcross/lang/reflect/Array public static native Object get(Object array, int index) throws IllegalArgumentException, ArrayIndexOutOfBoundsException;
	...
	switch (checkPrimitiveArray(p, Type_Null, true)) {
		case Type_Byte:    o = createObjectWithoutCallingDefaultConstructor(p->currentContext, "java.lang.Byte");      if (o) {
				Byte_v     (o) = ((int8  *) ARRAYOBJ_START(array))[index];
		}
			break;
		case Type_Boolean: o = createObjectWithoutCallingDefaultConstructor(p->currentContext, "java.lang.Boolean");   if (o) {
				Boolean_v  (o) = ((int8  *) ARRAYOBJ_START(array))[index];
		}
			break;
		case Type_Short:   o = createObjectWithoutCallingDefaultConstructor(p->currentContext, "java.lang.Short");     if (o) {
				Short_v    (o) = ((int16 *) ARRAYOBJ_START(array))[index];
		}
			break;
		case Type_Char:    o = createObjectWithoutCallingDefaultConstructor(p->currentContext, "java.lang.Character"); if (o) {
				Character_v(o) = ((int16 *) ARRAYOBJ_START(array))[index];
		}
			break;
		case Type_Int:     o = createObjectWithoutCallingDefaultConstructor(p->currentContext, "java.lang.Integer");   if (o) {
				Integer_v  (o) = ((int32 *) ARRAYOBJ_START(array))[index];
		}
			break;
		case Type_Long:    o = createObjectWithoutCallingDefaultConstructor(p->currentContext, "java.lang.Long");      if (o) {
				Long_v     (o) = ((int64 *) ARRAYOBJ_START(array))[index];
		}
			break;
		case Type_Float:   o = createObjectWithoutCallingDefaultConstructor(p->currentContext, "java.lang.Float");     if (o) {
				Float_v    (o) = ((double*) ARRAYOBJ_START(array))[index];
		}
			break;
		case Type_Double:  o = createObjectWithoutCallingDefaultConstructor(p->currentContext, "java.lang.Double");    if (o) {
...
static void invoke(NMParams p, TCObject m, TCObject obj, TCObject args) {
	...
	if (!target->flags.isStatic && (obj == null) ) {
		throwException(p->currentContext, NullPointerException, "Object is null");
	} else if (!target->flags.isStatic && (areClassesCompatible(p->currentContext, OBJ_CLASS(obj), target->class_->name) != COMPATIBLE) ) {
