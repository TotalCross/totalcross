...
//////////////////////////////////////////////////////////////////////////
TC_API void jlO_toStringNative(NMParams
							   p) { // java/lang/Object native private String toStringNative();
	TCClass c;
	TCObject obj;
	int32 len;
...
//////////////////////////////////////////////////////////////////////////
TC_API void jlO_clone(NMParams
					  p) { // java/lang/Object native protected Object clone() throws CloneNotSupportedException;
	TCObject thisObj = p->obj[0];
	...
	if (!isSuperClass(thisClass, cloneable)) {
		...
		// Array.clone().
		if (!(p->retO = cloneObj = createArrayObject(p->currentContext, thisClass->name,
...
TC_API void jlO_nativeHashCode(NMParams
							   p) { // java/lang/Object native private int nativeHashCode();
