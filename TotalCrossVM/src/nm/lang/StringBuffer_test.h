...
TESTCASE(jlSB_append_i) { // java/lang/StringBuffer native public StringBuffer append(int i);
	...
	v.asInt32 = 0xFFFFFFF;
	ASSERT2_EQUALS(Sz, sbAppend(currentContext, buf, sb, v, RegI), "01234-5321268435455");
...
TESTCASE(jlSB_append_l) { // java/lang/StringBuffer native public StringBuffer append(long l)
	...
	v.asInt64 = 0xFFFFFFF;
	ASSERT2_EQUALS(Sz, sbAppend(currentContext, buf, sb, v, RegL), "01234-5321268435455");
	v.asInt64 = I64_CONST(0xFFFFFFFFFFFF);
	ASSERT2_EQUALS(Sz, sbAppend(currentContext, buf, sb, v, RegL),
...
TESTCASE(jlSB_append_d) { // java/lang/StringBuffer native public StringBuffer append(double d);
	...
	ASSERT2_EQUALS(Sz, JCharP2CharPBuf(StringBuffer_charsStart(sb), StringBuffer_count(sb), buf),
				   "0.0");
