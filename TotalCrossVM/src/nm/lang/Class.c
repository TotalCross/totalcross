...
void createClassObject(Context currentContext, CharP className, Type type, TCObject* ret, bool* isNew) {
	...
	if ((*ret == null) && strEqn(className, "java.lang.", 10)) {
		...
		if (strEq(p, "Boolean")   && (booleanTYPE != null)) {
			*ret = *booleanTYPE; return;
		}
		if (strEq(p, "Short")     && (shortTYPE   != null)) {
			*ret = *shortTYPE;   return;
		}
		...
		if (strEq(p, "Float")     && (floatTYPE   != null)) {
			*ret = *floatTYPE;   return;
		}
		if (strEq(p, "Double")    && (doubleTYPE  != null)) {
			*ret = *doubleTYPE;  return;
		}
	}
	if (*ret == null) {
...
static void getFieldByName(NMParams p, bool onlyPublic) {
	...
	if (nameObj == NULL) {
		...
		o = getTargetClass(me);
		for (ff = o->i32InstanceFields, i = ARRAYLENV(ff), ff += i-1; --i >= 0; --ff) if (((onlyPublic && ff->flags.isPublic) || (!onlyPublic && !ff->flags.isInherited)) && strEq(ff->name,name)) {
				found = ff; goto cont;
			}
		for (ff = o->objInstanceFields, i = ARRAYLENV(ff), ff += i-1; --i >= 0; --ff) if (((onlyPublic && ff->flags.isPublic) || (!onlyPublic && !ff->flags.isInherited)) && strEq(ff->name,name)) {
				found = ff; goto cont;
			}
		for (ff = o->v64InstanceFields, i = ARRAYLENV(ff), ff += i-1; --i >= 0; --ff) if (((onlyPublic && ff->flags.isPublic) || (!onlyPublic && !ff->flags.isInherited)) && strEq(ff->name,name)) {
				found = ff; goto cont;
			}
		for (ff = o->i32StaticFields, i = ARRAYLENV(ff), ff += i-1; --i >= 0; --ff) if (((onlyPublic && ff->flags.isPublic) || (!onlyPublic && !ff->flags.isInherited)) && strEq(ff->name,name)) {
				found = ff; goto cont;
			}
		for (ff = o->objStaticFields, i = ARRAYLENV(ff), ff += i-1; --i >= 0; --ff) if (((onlyPublic && ff->flags.isPublic) || (!onlyPublic && !ff->flags.isInherited)) && strEq(ff->name,name)) {
				found = ff; goto cont;
			}
		for (ff = o->v64StaticFields, i = ARRAYLENV(ff), ff += i-1; --i >= 0; --ff) if (((onlyPublic && ff->flags.isPublic) || (!onlyPublic && !ff->flags.isInherited)) && strEq(ff->name,name)) {
				found = ff; goto cont;
			}
cont:
		if (found) {
...
static void getFields(NMParams p, bool onlyPublic) {
	...
	if (o->flags.isInterface) {
		...
		for (ff = o->i32InstanceFields, i = ARRAYLENV(ff), ff += i-1; --i >= 0; --ff) if ((onlyPublic && ff->flags.isPublic) || (!onlyPublic && !ff->flags.isInherited)) {
				count++;
			}
		for (ff = o->objInstanceFields, i = ARRAYLENV(ff), ff += i-1; --i >= 0; --ff) if ((onlyPublic && ff->flags.isPublic) || (!onlyPublic && !ff->flags.isInherited)) {
				count++;
			}
		for (ff = o->v64InstanceFields, i = ARRAYLENV(ff), ff += i-1; --i >= 0; --ff) if ((onlyPublic && ff->flags.isPublic) || (!onlyPublic && !ff->flags.isInherited)) {
				count++;
			}
		for (ff = o->i32StaticFields, i = ARRAYLENV(ff), ff += i-1; --i >= 0; --ff) if ((onlyPublic && ff->flags.isPublic) || (!onlyPublic && !ff->flags.isInherited)) {
				count++;
			}
		for (ff = o->objStaticFields, i = ARRAYLENV(ff), ff += i-1; --i >= 0; --ff) if ((onlyPublic && ff->flags.isPublic) || (!onlyPublic && !ff->flags.isInherited)) {
				count++;
			}
		for (ff = o->v64StaticFields, i = ARRAYLENV(ff), ff += i-1; --i >= 0; --ff) if ((onlyPublic && ff->flags.isPublic) || (!onlyPublic && !ff->flags.isInherited)) {
				count++;
			}
		ret = createArrayObject(p->currentContext, "[java.lang.reflect.Field", count);
		if (ret) {
