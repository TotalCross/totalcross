...
TESTCASE(jlC_forName_s)
{ // java/lang/Class native public static Class
  // forName(String className) throws
  // java.lang.ClassNotFoundException;
  TNMParams p;
  TCObject obj, jls;
  TCClass c1, c2, c3;

  // Test if the Class of "java.lang.String" is the class of the created
  // instance
  tzero(p);
...
TESTCASE(jlC_newInstance)
{ // java/lang/Class native public Object newInstance()
  // throws java.lang.InstantiationException,
  // java.lang.IllegalAccessException;
  // #DEPENDS(jlC_forName_s)
  TNMParams p;
  TCObject obj;
  TCClass c;

  // create an instance of the String class using the default constructor
  // {"chars = new char[0]"}
  tzero(p);
  p.currentContext = currentContext;
...
TESTCASE(jlC_isInstance_o)
{ // java/lang/Class native public boolean
  // isInstance(Object obj); #DEPENDS(jlC_newInstance)
  TCObject obj[2];
  TNMParams p;
  ...
  p.retI = 0;
  obj[0] = jlC_JavaLangClassOfJavaLangString;
  obj[1] = createObjectWithoutCallingDefaultConstructor(currentContext,
                                                        "java.lang.Array");
  setObjectLock(obj[1], UNLOCKED);
  ASSERT1_EQUALS(NotNull, obj[1]);
  jlC_isInstance_o(&p);
