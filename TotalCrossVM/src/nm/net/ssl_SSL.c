...
//////////////////////////////////////////////////////////////////////////
TC_API void tnsSSL_handshakeStatus(NMParams
								   p) { // totalcross/net/ssl/SSL native public int handshakeStatus();
#ifdef HAVE_IMPLEMENTATION
	TCObject sslObj = p->obj[0];
	SSL* ssl = (SSL*) SSL_sslRef(sslObj);
...
//////////////////////////////////////////////////////////////////////////
TC_API void tnsSSL_getCipherId(NMParams
							   p) { // totalcross/net/ssl/SSL native public byte getCipherId();
#ifdef HAVE_IMPLEMENTATION
	TCObject sslObj = p->obj[0];
	SSL* ssl = (SSL*) SSL_sslRef(sslObj);
...
//////////////////////////////////////////////////////////////////////////
TC_API void tnsSSL_getSessionId(NMParams
								p) { // totalcross/net/ssl/SSL native public byte[] getSessionId();
#ifdef HAVE_IMPLEMENTATION
	TCObject sslObj = p->obj[0];
	SSL* ssl = (SSL*) SSL_sslRef(sslObj);
...
//////////////////////////////////////////////////////////////////////////
TC_API void tnsSSL_getCertificateDN_i(NMParams
									  p) { // totalcross/net/ssl/SSL native public String getCertificateDN(int component);
#ifdef HAVE_IMPLEMENTATION
	TCObject sslObj = p->obj[0];
...
//////////////////////////////////////////////////////////////////////////
TC_API void tnsSSL_read_s(NMParams
						  p) { // totalcross/net/ssl/SSL native public int read(totalcross.net.ssl.SSLReadHolder rh);
#ifdef HAVE_IMPLEMENTATION
	TCObject sslObj = p->obj[0];
...
//////////////////////////////////////////////////////////////////////////
TC_API void tnsSSL_write_Bi(NMParams
							p) { // totalcross/net/ssl/SSL native public int write(byte []out_data, int len);
#ifdef HAVE_IMPLEMENTATION
	TCObject sslObj = p->obj[0];
...
//////////////////////////////////////////////////////////////////////////
TC_API void tnsSSL_verifyCertificate(NMParams
									 p) { // totalcross/net/ssl/SSL native public int verifyCertificate();
#ifdef HAVE_IMPLEMENTATION
	TCObject sslObj = p->obj[0];
	SSL* ssl = (SSL*) SSL_sslRef(sslObj);
...
//////////////////////////////////////////////////////////////////////////
TC_API void tnsSSL_renegotiate(NMParams
							   p) { // totalcross/net/ssl/SSL native public int renegotiate();
#ifdef HAVE_IMPLEMENTATION
	TCObject sslObj = p->obj[0];
	SSL* ssl = (SSL*) SSL_sslRef(sslObj);
...
//////////////////////////////////////////////////////////////////////////
TC_API void tnsSSLCTX_create_ii(NMParams
								p) { // totalcross/net/ssl/SSLCTX native public void create(int options, int num_sessions);
#ifdef HAVE_IMPLEMENTATION
...
//////////////////////////////////////////////////////////////////////////
TC_API void tnsSSLCTX_dispose(NMParams
							  p) { // totalcross/net/ssl/SSLCTX native public void dispose();
#ifdef HAVE_IMPLEMENTATION
	TCObject sslCtxObj = p->obj[0];
...
//////////////////////////////////////////////////////////////////////////
TC_API void tnsSSLCTX_find_s(NMParams
							 p) { // totalcross/net/ssl/SSLCTX native public totalcross.net.ssl.SSL find(totalcross.net.Socket s);
#ifdef HAVE_IMPLEMENTATION
	TCObject sslCtxObj = p->obj[0];
	...
	p->retO = (TCObject)ssl_find(ssl_ctx,
								 (uint32) * socketHandle); // flsobral@tc110_106: ssl_find expects a handle, not an object.
...
//////////////////////////////////////////////////////////////////////////
TC_API void tnsSSLCTX_objLoad_iss(NMParams
								  p) { // totalcross/net/ssl/SSLCTX native public int objLoad(int obj_type, totalcross.io.Stream material, String password);
#ifdef HAVE_IMPLEMENTATION
...
#define BUFSIZE 0x400
	...
	} else if ((readMethod = getMethod(OBJ_CLASS(streamObj), true, "readBytes", 3, BYTE_ARRAY, J_INT,
									   J_INT)) == null) {
...
//////////////////////////////////////////////////////////////////////////
TC_API void tnsSSLCTX_objLoad_iBis(NMParams
								   p) { // totalcross/net/ssl/SSLCTX native public int objLoad(int obj_type, byte []data, int len, String password);
#ifdef HAVE_IMPLEMENTATION
	TCObject sslCtxObj = p->obj[0];
	int32 obj_type = p->i32[0];
...
//////////////////////////////////////////////////////////////////////////
TC_API void tnsSSLCTX_newClient_sB(NMParams
								   p) { // totalcross/net/ssl/SSLCTX native public totalcross.net.ssl.SSL newClient(totalcross.net.Socket s, byte []session_id);
#ifdef HAVE_IMPLEMENTATION
	...
	SSL_sslRef(ssl) = (int64)ssl_client_new(ssl_ctx, (int32) * socketHandle,
											id ? ARRAYOBJ_START(id) : NULL, id ? ARRAYOBJ_LEN(id) : 0);
	p->retO = ssl;
...
//////////////////////////////////////////////////////////////////////////
TC_API void tnsSSLCTX_newServer_s(NMParams
								  p) { // totalcross/net/ssl/SSLCTX native public totalcross.net.ssl.SSL newServer(totalcross.net.Socket s);
#ifdef HAVE_IMPLEMENTATION
	SSL_CTX* ssl_ctx = (SSL_CTX*)SSLCTX_ctxRef(p->obj[0]);
	TCObject socketObj = p->obj[1];
	volatile TCObject ssl = null;
...
//////////////////////////////////////////////////////////////////////////
TC_API void tnsSSLU_getConfig_i(NMParams
								p) { // totalcross/net/ssl/SSLUtil native public static int getConfig(int which);
#ifdef HAVE_IMPLEMENTATION
...
//////////////////////////////////////////////////////////////////////////
TC_API void tnsSSLU_displayError_i(NMParams
								   p) { // totalcross/net/ssl/SSLUtil native public static void displayError(int error_code);
#ifdef HAVE_IMPLEMENTATION
...
//////////////////////////////////////////////////////////////////////////
TC_API void tnsSSLU_version(NMParams
							p) { // totalcross/net/ssl/SSLUtil native public static String version();
#ifdef HAVE_IMPLEMENTATION
