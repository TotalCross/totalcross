...
//////////////////////////////////////////////////////////////////////////
TC_API void tnSS_serversocketCreate_iiis(NMParams
		p) { // totalcross/net/ServerSocket native void serversocketCreate(int port, int backlog, String host) throws totalcross.io.IOException;
...
//////////////////////////////////////////////////////////////////////////
TC_API void tnSS_nativeAccept(NMParams
							  p) { // totalcross/net/ServerSocket native public void nativeAccept() throws totalcross.io.IOException;
	TCObject serverSocket = p->obj[0];
...
//////////////////////////////////////////////////////////////////////////
TC_API void tnSS_nativeClose(NMParams
							 p) { // totalcross/net/ServerSocket native private void nativeClose() throws totalcross.io.IOException;
	TCObject serverSocket = p->obj[0];
	TCObject serverSocketRef = ServerSocket_serverRef(serverSocket);
	SERVER_SOCKET* serverSocketHandle;
	Err err;
