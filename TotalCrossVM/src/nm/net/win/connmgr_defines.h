...
const GUID IID_DestNetCorp = { 0xa1182988, 0x0d73, 0x439e, { 0x87, 0xad, 0x2a, 0x5b, 0x36, 0x9f, 0x80, 0x8b } };
...
const GUID IID_DestNetSecureWAP = { 0xf28d1f74, 0x72be, 0x4394, { 0xa4, 0xa7, 0x4e, 0x29, 0x62, 0x19, 0x39, 0x0c } };
