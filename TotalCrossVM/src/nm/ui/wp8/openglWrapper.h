...
typedef GLchar TCGchar;
  ...
  void glDrawPixelColors(Context currentContext,
                         int32* x,
                         int32* y,
                         PixelConv* colors,
                         int32 n);
  ...
  bool glLoadTexture(Context currentContext,
                     TCObject img,
                     int32* textureId,
                     Pixel* pixels,
                     int32 width,
                     int32 height,
                     bool onlyAlpha);
  void glDrawLines(Context currentContext,
                   TCObject g,
                   int32* x,
                   int32* y,
                   int32 n,
  ...
  void glDrawTexture(int32* textureId,
                     int32 x,
                     int32 y,
                     int32 w,
                     int32 h,
  ...
  void flushAll();
  void glGetPixels(Pixel* dstPixels,
                   int32 srcX,
                   int32 srcY,
                   int32 width,
                   int32 height,
  ...
  void glFillShadedRect(TCObject g,
                        int32 x,
                        int32 y,
                        int32 w,
                        int32 h,
