...
bool
checkGLfloatBuffer(Context c, int32 n)
{
  if (n > flen) {
    xfree(glXYA);
    flen = n * 3 / 2;
    ...
    if (!glXYA) {
      throwException(
        c, OutOfMemoryError, "Cannot allocate buffer for drawPixels");
      flen = 0;
      return false;
    }
  }
...
void
glDrawThickLine(int32 x1, int32 y1, int32 x2, int32 y2, int32 rgb, int32 a)
{}

int32
glGetPixel(int32 x, int32 y)
{
...
void
glDrawPixelColors(Context currentContext,
                  int32* x,
                  int32* y,
                  PixelConv* colors,
                  int32 n)
...
void
glDrawPixels(int32 n, int32 rgb)
{
...
void
glDrawPixel(int32 x, int32 y, int32 rgb, int32 a)
{
...
void
glDrawLines(Context currentContext,
            TCObject g,
            int32* x,
            int32* y,
            int32 n,
...
void
glDrawLine(int32 x1, int32 y1, int32 x2, int32 y2, int32 rgb, int32 a)
{
  Pixel colour = getGlColor(rgb, a);
...
extern "C"
{
  extern int32 *shiftYfield, *lastShiftYfield, *shiftHfield;
}
void
setTimerInterval(int32 t);
void
...
void
glFillRect(int32 x, int32 y, int32 w, int32 h, int32 rgb, int32 a)
{
  dxFillRect(x, y, x + w, y + h, getGlColor(rgb, a));
}

void
glSetLineWidth(int32 w)
{}
