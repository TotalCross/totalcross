...
extern "C"
{
  ...
  void dxGetPixels(Pixel* dstPixels,
                   int32 srcX,
                   int32 srcY,
                   int32 width,
                   int32 height,
                   int32 pitch);
  void dxUpdateScreen();
  void dxDrawLines(Context currentContext,
                   TCObject g,
                   int32* x,
                   int32* y,
                   int32 n,
  ...
  bool dxLoadTexture(Context currentContext,
                     TCObject img,
                     int32* textureId,
                     Pixel* pixels,
                     int32 width,
  ...
  void dxDrawTexture(int32* textureId,
                     int32 x,
                     int32 y,
                     int32 w,
                     int32 h,
                     ...
                     PixelConv* color,
                     int32 alphaMask);
  void dxFillShadedRect(TCObject g,
                        int32 x,
                        int32 y,
                        int32 w,
                        int32 h,
