...
extern "C"
{
  ...
  int32 skia_stringWidth(const void* text,
                         int32 charCount,
                         int32 typefaceIndex,
                         int32 fontSize);
  ...
  void skia_drawSurface(int32 skiaSurface,
                        int32 id,
                        int32 srcX,
                        int32 srcY,
                        int32 srcW,
                        ...
                        int32 alphaMask,
                        int32 doClip);
  void skia_drawDottedLine(int32 skiaSurface,
                           int32 x1,
                           int32 y1,
                           int32 x2,
                           int32 y2,
  ...
  void skia_drawLine(int32 skiaSurface,
                     int32 x1,
                     int32 y1,
                     int32 x2,
                     int32 y2,
                     Pixel pixel);
  void skia_drawRect(int32 skiaSurface,
                     int32 x,
                     int32 y,
                     int32 w,
                     int32 h,
                     Pixel pixel);
  void skia_fillRect(int32 skiaSurface,
                     int32 x,
                     int32 y,
                     int32 w,
                     int32 h,
                     Pixel pixel);
  void skia_drawText(int32 skiaSurface,
                     const void* text,
                     int32 chrCount,
                     int32 x0,
                     int32 y0,
                     ...
                     int32 fontSize,
                     int32 typefaceIndex);
  void skia_ellipseDrawAndFill(int32 skiaSurface,
                               int32 xc,
                               int32 yc,
                               int32 rx,
                               int32 ry,
                               ...
                               bool fill,
                               bool gradient);
  void skia_fillPolygon(int32 skiaSurface,
                        int32* xPoints,
                        int32* yPoints,
                        int32 nPoints,
                        int32 tx,
                        ...
                        bool gradient,
                        bool isPie);
  void skia_drawPolygon(int32 skiaSurface,
                        int32* xPoints,
                        int32* yPoints,
                        int32 nPoints,
                        int32 tx,
                        int32 ty,
                        Pixel pixel);
  void skia_arcPiePointDrawAndFill(int32 skiaSurface,
                                   int32 xc,
                                   int32 yc,
                                   int32 rx,
                                   int32 ry,
                                   ...
                                   bool pie,
                                   bool gradient);
  void skia_drawRoundRect(int32 skiaSurface,
                          int32 x,
                          int32 y,
                          int32 w,
                          int32 h,
                          int32 r,
                          Pixel c);
  void skia_fillRoundRect(int32 skiaSurface,
                          int32 x,
                          int32 y,
                          int32 w,
                          int32 h,
                          int32 r,
                          Pixel c);
  void skia_drawRoundGradient(int32 skiaSurface,
                              int32 startX,
                              int32 startY,
                              int32 endX,
                              int32 endY,
                              ...
                              int32 endColor,
                              bool vertical);
  int skia_getsetRGB(int32 skiaSurface,
                     void* dataObj,
                     int32 offset,
                     int32 x,
                     int32 y,
