...
struct TUserFont
{
  ...
  // gl fonts: used by the inherited font. fontP.maxHeight will contain the
  // target size
...
int32
getJCharPWidth(Context currentContext,
               TCObject fontObj,
               JCharP s,
               int32 len); // len is NOT optional, it must be given
UserFont
...
loadUserFont(Context currentContext,
             ...
             bool plain,
             int32 size,
             JChar c); // use size=-1 to load the normal size
bool
