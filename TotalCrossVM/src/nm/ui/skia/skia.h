...
enum SkiaRasterMappingRejectReasonForTest {
    SKIA_RASTER_MAPPING_REJECT_COMPILE_GEOMETRY_FOR_TEST = 0,
    SKIA_RASTER_MAPPING_REJECT_MATRIX_INVERSION_FOR_TEST = 1,
    SKIA_RASTER_MAPPING_REJECT_ROOT_TO_DEVICE_FOR_TEST = 2,
    SKIA_RASTER_MAPPING_REJECT_DESTINATION_AXIS_FOR_TEST = 3,
    SKIA_RASTER_MAPPING_REJECT_DESTINATION_FRACTIONAL_FOR_TEST = 4,
    SKIA_RASTER_MAPPING_REJECT_SOURCE_MAPPING_FOR_TEST = 5,
    SKIA_RASTER_MAPPING_REJECT_VALID_ROOT_FOR_TEST = 6,
    SKIA_RASTER_MAPPING_REJECT_UNSUPPORTED_TRANSFORM_FOR_TEST = 7,
    SKIA_RASTER_MAPPING_REJECT_EXPLICIT_CLIP_FOR_TEST = 8,
    SKIA_RASTER_MAPPING_REJECT_VISIBLE_MAPPING_FOR_TEST = 9,
    SKIA_RASTER_MAPPING_REJECT_REASON_COUNT_FOR_TEST = 10
};
