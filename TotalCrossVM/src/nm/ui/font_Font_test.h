...
TCObject testfont;
TESTCASE(tufF_fontCreate_f)
{ // totalcross/ui/font/Font native static void
  // fontCreate(Font obj);
  TNMParams p;
  ...
  hvUserFont =
    getInstanceFieldObject(font, "hv_UserFont", "totalcross.ui.font.Font");
  ...
  Font_size(font) =
    9; // do NOT change this value, or the fontmetrics tests will fail
...
TESTCASE(tufF_FontTestCleanup_f)
{ // just do cleanups on the font and
  // fontmetrics tests  #DEPENDS(Graphics)
  UNUSED(tc);
  fontDestroy();
}
