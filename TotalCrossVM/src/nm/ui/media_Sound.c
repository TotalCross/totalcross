...
void playSound(CharP filename) {
	...
	if (strEqn(filename, "device/", 7)) {
...
#ifdef ANDROID
	else if (strEqn(filename, "/sdcard", 7)) {
		...
		xstrcpy(fullpath, filename);
	}
	soundPlay(fullpath);
}

TC_API void tumS_play_s(NMParams
						p) { // totalcross/ui/media/Sound native public static void play(String filename);
	TCObject o = p->obj[0];
	if (o == null) {
...
//////////////////////////////////////////////////////////////////////////
TC_API void tumS_tone_ii(NMParams
						 p) { // totalcross/ui/media/Sound native public static void tone(int freq, int duration);
	if (soundSettings.isSoundEnabled) {
		soundTone(p->i32[0], p->i32[1]);
	}
}
//////////////////////////////////////////////////////////////////////////
TC_API void tumS_setEnabled_b(NMParams
							  p) { // totalcross/ui/media/Sound native public static void setEnabled(boolean on);
...
//////////////////////////////////////////////////////////////////////////
TC_API void tumS_toText_s(NMParams
						  p) { // totalcross/ui/media/Sound native public static String toText(String params);
#if defined(ANDROID)
	soundToText(p);
#endif
}
//////////////////////////////////////////////////////////////////////////
TC_API void tumS_fromText_s(NMParams
							p) { // totalcross/ui/media/Sound native public static void fromText(String text);
#if defined(ANDROID)
	soundFromText(p);
#endif
}
