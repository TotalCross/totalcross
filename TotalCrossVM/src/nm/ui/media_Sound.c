...
//////////////////////////////////////////////////////////////////////////
bool
getSDCardPath(char* buf, int32 idx);
void
playSound(CharP filename)
{
...
TC_API void
tumS_play_s(NMParams p)
{ // totalcross/ui/media/Sound native public
...
//////////////////////////////////////////////////////////////////////////
TC_API void
tumS_beep(NMParams p)
{ // totalcross/ui/media/Sound native public static void beep();
  UNUSED(p);
...
//////////////////////////////////////////////////////////////////////////
TC_API void
tumS_tone_ii(NMParams p)
{ // totalcross/ui/media/Sound native public static
...
//////////////////////////////////////////////////////////////////////////
TC_API void
tumS_toText_s(NMParams p)
{ // totalcross/ui/media/Sound native public static
  // String toText(String params);
#if defined(ANDROID)
  soundToText(p);
#endif
}
