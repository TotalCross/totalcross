...
TC_API void
tumC_nativeClick(NMParams p)
{ // totalcross/ui/media/Camera native
  // private String nativeClick();
#if defined(ANDROID) || defined(darwin) || defined(WP8) ||                     \
  (defined(WINCE) && _WIN32_WCE >= 300)
  cameraClick(p);
#else
  UNUSED(p);
#endif
...
//////////////////////////////////////////////////////////////////////////
TC_API void
tumC_nativeFinalize(NMParams p){
  // totalcross/ui/media/Camera native private void nativeFinalize();
  UNUSED(p)
} //////////////////////////////////////////////////////////////////////////
TC_API void tumC_getNativeResolutions(NMParams p)
{ // totalcross/ui/media/Camera static native private String
  // getNativeResolutions();
#if defined(ANDROID)
  setObjectLock(p->retO = Camera_getNativeResolutions(p->currentContext),
                UNLOCKED);
#else
  p->retO = null;
#endif
