...
TC_API void tumC_nativeClick(NMParams
							 p) { // totalcross/ui/media/Camera native private String nativeClick();
...
//////////////////////////////////////////////////////////////////////////
TC_API void tumC_nativeFinalize(NMParams
								p) { // totalcross/ui/media/Camera native private void nativeFinalize();
	UNUSED(p)
}
//////////////////////////////////////////////////////////////////////////
TC_API void tumC_getNativeResolutions(NMParams
									  p) { // totalcross/ui/media/Camera static native private String getNativeResolutions();
#if defined(ANDROID)
