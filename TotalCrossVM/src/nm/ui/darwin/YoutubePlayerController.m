...
- (void) presentYoutubeVideo: (char*)videoId autoPlay: (int)autoPlay end: (int)end start:
	(int)start {
...
void playYoutube(NMParams p) {
	...
	[[[YoutubeController alloc] initWithCallBack: &p->obj[2]] presentYoutubeVideo: url autoPlay:
								autoPlay end: end start: start];
}
