...
//////////////////////////////////////////////////////////////////////////
TC_API void tuW_isSipShown(NMParams
						   p) { // totalcross/ui/Window native public static boolean isSipShown();
	int32 ret = 0;
...
//////////////////////////////////////////////////////////////////////////
TC_API void tuW_setSIP_icb(NMParams
						   p) { // totalcross/ui/Window native public static void setSIP(int sipOption, totalcross.ui.Control control, boolean secret);
...
//////////////////////////////////////////////////////////////////////////
TC_API void tuW_pumpEvents(NMParams
						   p) { // totalcross/ui/Window native public static void pumpEvents();
	pumpEvents(p->currentContext);
}
//////////////////////////////////////////////////////////////////////////
TC_API void tuW_setDeviceTitle_s(NMParams
								 p) { // totalcross/ui/Window native public static void setDeviceTitle(String title);
	UNUSED(p);
#ifndef darwin
...
//////////////////////////////////////////////////////////////////////////
TC_API void tuW_setOrientation_i(NMParams
								 p) { // totalcross/ui/Window native public static void setOrientation(int orientation);
#ifdef ANDROID
