...
void jpegLoad(Context currentContext, TCObject imageInstance, TCObject inputStreamObj,
			  TCObject bufObj, TCZFile tcz, char* first4, int32 scale_num, int32 scale_denom);
void pngLoad(Context currentContext, TCObject imageInstance, TCObject inputStreamObj,
			 TCObject bufObj, TCZFile tcz, char* first4);

//////////////////////////////////////////////////////////////////////////
TC_API void tuiI_imageLoad_s(NMParams
							 p) { // totalcross/ui/image/Image native private void imageLoad(String path);
	char path[256];
...
//////////////////////////////////////////////////////////////////////////
TC_API void tuiI_imageParse_sB(NMParams
							   p) { // totalcross/ui/image/Image native private void imageParse(totalcross.io.Stream in, byte []buf);
	TCObject imageObj = p->obj[0];
...
//////////////////////////////////////////////////////////////////////////
TC_API void tuiI_changeColors_ii(NMParams
								 p) { // totalcross/ui/image/Image native public void changeColors(int from, int to);
...
//////////////////////////////////////////////////////////////////////////
TC_API void tuiI_getPixelRow_Bi(NMParams
								p) { // totalcross/ui/image/Image native protected void getPixelRow(byte []fillIn, int y);
	TCObject thisObj = p->obj[0];
...
TC_API void tuiI_getModifiedInstance_iiiiiii(NMParams
		p) { // totalcross/ui/image/Image native private void getModifiedInstance(totalcross.ui.image.Image newImg, int angle, int percScale, int color, int brightness, int contrast, int type);
	TCObject thisObj = p->obj[0];
...
//////////////////////////////////////////////////////////////////////////
TC_API void tuiI_setCurrentFrame_i(NMParams
								   p) { // totalcross/ui/image/Image native public void setCurrentFrame(int nr);
	TCObject obj = p->obj[0];
	setCurrentFrame(obj, p->i32[0]);
}
//////////////////////////////////////////////////////////////////////////
TC_API void tuiI_applyColor_i(NMParams
							  p) { // totalcross/ui/image/Image native public void applyColor(int color);
	TCObject thisObj = p->obj[0];
	Pixel color = makePixelRGB(p->i32[0]);
	applyColor(thisObj, color);
}
//////////////////////////////////////////////////////////////////////////
TC_API void tuiI_nativeEquals_i(NMParams
								p) { // totalcross/ui/image/Image native private boolean nativeEquals(totalcross.ui.image.Image other);
	TCObject thisObj = p->obj[0];
	TCObject otherObj = p->obj[1];
	p->retI = nativeEquals(thisObj, otherObj);
}
//////////////////////////////////////////////////////////////////////////
TC_API void tuiI_applyColor2_i(NMParams
							   p) { // totalcross/ui/image/Image native public void applyColor2(int color);
	TCObject thisObj = p->obj[0];
	Pixel color = makePixelARGB(p->i32[0]);
	applyColor2(thisObj, color);
}
//////////////////////////////////////////////////////////////////////////
TC_API void tuiI_setTransparentColor_i(NMParams
									   p) { // totalcross/ui/image/Image native public totalcross.ui.image.Image setTransparentColor(int color);
	TCObject thisObj = p->obj[0];
	Pixel color = makePixelRGB(p->i32[0]);
...
#endif
//////////////////////////////////////////////////////////////////////////
TC_API void tuiI_applyChanges(NMParams
							  p) { // totalcross/ui/image/Image native public void applyChanges();
#ifndef SKIA_H
#ifdef __gl2_h_
	TCObject thisObj = p->obj[0];
...
//////////////////////////////////////////////////////////////////////////
TC_API void tuiI_freeTexture(NMParams
							 p) { // totalcross/ui/image/Image native private void freeTexture();
#ifndef SKIA_H
#ifdef __gl2_h_
	freeTexture(p->obj[0]);
#endif
...
//////////////////////////////////////////////////////////////////////////
bool image2jpeg(Context currentContext, TCObject srcImageObj, TCObject dstStreamObj,
				int32 quality); // JpegLoader.c
TC_API void tuiI_createJpg_si(NMParams
							  p) { // totalcross/ui/image/Image native public void createJpg(totalcross.io.Stream s, int quality);
	TCObject thisObj = p->obj[0];
...
//////////////////////////////////////////////////////////////////////////
TC_API void tuiI_applyFade_i(NMParams
							 p) { // totalcross/ui/image/Image native public void applyFade(int fadeValue);
	TCObject thisObj = p->obj[0];
	int32 fadeValue = p->i32[0];
	applyFade(thisObj, fadeValue);
}
//////////////////////////////////////////////////////////////////////////
TC_API void tuiI_nativeResizeJpeg_ssi(NMParams
									  p) { // totalcross/ui/image/Image native public static void nativeResizeJpeg(String inputPath, String outputPath, int maxPixelSize);
...
//////////////////////////////////////////////////////////////////////////
TC_API void tuiI_getJpegBestFit_sii(NMParams
									p) { // totalcross/ui/image/Image native public static totalcross.ui.image.Image getJpegBestFit(String path, int targetWidth, int targetHeight) throws java.io.IOException, totalcross.ui.image.ImageException;
	...
	if ((imageObj = createObject(p->currentContext, "totalcross.ui.image.Image")) != NULL
		...
		if (tcz != null) {
			...
			fileConstructor = getMethod(OBJ_CLASS(fileObj), false, CONSTRUCTOR_NAME, 2, "java.lang.String",
										J_INT);
...
//////////////////////////////////////////////////////////////////////////
TC_API void tuiI_getJpegScaled_sii(NMParams
								   p) { // totalcross/ui/image/Image native public static totalcross.ui.image.Image getJpegScaled(String path, int scaleNumerator, int scaleDenominator) throws java.io.IOException, totalcross.ui.image.ImageException;
	TCObject pathObj = p->obj[0];
	...
	if ((imageObj = createObject(p->currentContext, "totalcross.ui.image.Image")) != NULL
		...
		if (tcz != null) {
			...
			if (fileConstructor != null) {
				...
				if (p->currentContext->thrownException == null) {
					if ((bufferObj = createByteArray(p->currentContext, 512)) != NULL) {
						jpegLoad(p->currentContext, imageObj, fileObj, bufferObj, null, null, -scaleNumerator,
								 -scaleDenominator);
					}
				}
			}
