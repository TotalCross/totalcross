...
{ // totalcross/ui/font/FontMetrics native
  ...
  descent =
    getInstanceFieldInt(fm, "descent", "totalcross.ui.font.FontMetrics");
...
TESTCASE(tufFM_charWidth_c)
{ // totalcross/ui/font/FontMetrics native public int
  // charWidth(char c); #DEPENDS(tufFM_fontMetricsCreate)
  TNMParams p;
  int32 c;
  tzero(p);
  p.currentContext = currentContext;
...
TESTCASE(tufFM_stringWidth_Cii)
{ // totalcross/ui/font/FontMetrics native public int
