...
//////////////////////////////////////////////////////////////////////////
TC_API void
tumMC_create(NMParams p)
{ // totalcross/ui/media/MediaClip native private void create();
  ...
  if ((mediaClipRef = createByteArray(p->currentContext, sizeof(TMediaData))) !=
      null) {
    media = (MediaData)ARRAYOBJ_START(mediaClipRef);
    media->readMethod = getMethod((TCClass)OBJ_CLASS(mediaStream),
                                  true,
                                  "readBytes",
                                  3,
                                  BYTE_ARRAY,
                                  J_INT,
                                  J_INT);
    media->writeMethod = getMethod((TCClass)OBJ_CLASS(mediaStream),
                                   true,
                                   "writeBytes",
                                   3,
                                   BYTE_ARRAY,
                                   ...
                                   J_INT);
    media->setPosMethod =
      getMethod((TCClass)OBJ_CLASS(mediaStream), true, "setPos", 1, J_INT);

    media->waveHeader =
      (WaveHeader)ARRAYOBJ_START(MediaClip_mediaHeader(mediaClip));
...
//////////////////////////////////////////////////////////////////////////
TC_API void
tumMC_nativeStart(NMParams p)
{ // totalcross/ui/media/MediaClip native private
  // void nativeStart();
  // XXX
#if !defined WP8
  TCObject mediaClip = p->obj[0];
...
//////////////////////////////////////////////////////////////////////////
TC_API void
tumMC_stop(NMParams p)
{ // totalcross/ui/media/MediaClip native public void stop();
  // XXX
#if !defined WP8
  TCObject mediaClip = p->obj[0];
  TCObject mediaClipData = MediaClip_mediaClipRef(mediaClip);
  ...
  } else if (MediaClip_state(mediaClip) == STARTED) {
...
//////////////////////////////////////////////////////////////////////////
TC_API void
tumMC_reset(NMParams p)
{ // totalcross/ui/media/MediaClip native public void reset();
  // XXX
#if !defined WP8
  TCObject mediaClip = p->obj[0];
...
//////////////////////////////////////////////////////////////////////////
TC_API void
tumMC_record_iib(NMParams p)
{ // totalcross/ui/media/MediaClip native public void record(int
  // samplesPerSecond, int bitsPerSample, boolean stereo);
  // XXX
#if !defined WP8
  TCObject mediaClip = p->obj[0];
  ...
  if (samplesPerSecond != 8000 && samplesPerSecond != 11025 &&
      samplesPerSecond != 22050 && samplesPerSecond != 44100) {
    ...
    mediaClipRecord(p->currentContext,
                    mediaClip,
                    media,
                    samplesPerSecond,
                    bitsPerSample,
