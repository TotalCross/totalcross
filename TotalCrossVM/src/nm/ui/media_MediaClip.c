...
//////////////////////////////////////////////////////////////////////////
TC_API void tumMC_create(NMParams
						 p) { // totalcross/ui/media/MediaClip native private void create();
	...
	if ((mediaClipRef = createByteArray(p->currentContext, sizeof(TMediaData))) != null) {
		...
		media->readMethod    = getMethod((TCClass) OBJ_CLASS(mediaStream), true, "readBytes", 3, BYTE_ARRAY,
										 J_INT, J_INT);
		media->writeMethod   = getMethod((TCClass) OBJ_CLASS(mediaStream), true, "writeBytes", 3,
...
//////////////////////////////////////////////////////////////////////////
TC_API void tumMC_nativeStart(NMParams
							  p) { // totalcross/ui/media/MediaClip native private void nativeStart();
	// XXX
#if !defined WP8
	TCObject mediaClip = p->obj[0];
...
//////////////////////////////////////////////////////////////////////////
TC_API void tumMC_nativeClose(NMParams
							  p) { // totalcross/ui/media/MediaClip native private void nativeClose();
	// XXX
#if !defined WP8
	TCObject mediaClip = p->obj[0];
	TCObject mediaClipRef = MediaClip_mediaClipRef(mediaClip);
...
//////////////////////////////////////////////////////////////////////////
TC_API void tumMC_record_iib(NMParams
							 p) { // totalcross/ui/media/MediaClip native public void record(int samplesPerSecond, int bitsPerSample, boolean stereo);
	// XXX
#if !defined WP8
	TCObject mediaClip = p->obj[0];
	...
	if (samplesPerSecond != 8000 && samplesPerSecond != 11025 && samplesPerSecond != 22050
