                       ...
                       int32 dstX, int32 dstY, int32 doClip)
{
   ...
   if (Graphics_useOpenGL(dstSurf))
   {
      ...
      glDrawTexture(Image_textureId(srcSurf), srcX+frame*srcPitch,srcY,width,height, dstX,dstY, ((fc > 1) ? Image_widthOfAllFrames(srcSurf) : srcWidth) * Image_hwScaleW(srcSurf),srcHeight, null,null);
   }
   else
#endif
