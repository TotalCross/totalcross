...
TC_API void tumC_getNativeVideoResolutions(NMParams p);
TC_API void tumYP_play_scbii(NMParams p);
TC_API void tudFP_nativePresent(NMParams p);
...
TC_API void tuiI_decodeEncodedSourceBestFit(NMParams p);
TC_API void tuiI_decodeEncodedSourceExplicit(NMParams p);
TC_API void tuiI_decodeEncodedSourceTargeted(NMParams p);
TC_API void tuiI_decodeEncodedSourceTiered_e(NMParams p);
TC_API void tuiI_decodeEncodedSourceCandidat(NMParams p);
TC_API void tuiI_failNextNativeMaterializati(NMParams p);
TC_API void tuiI_failNextZeroCopyDecodeAfter(NMParams p);
TC_API void tuiI_setDiagnosticAccountingTest(NMParams p);
TC_API void tuiI_nativeOptimizationMaskObser(NMParams p);
TC_API void tuiI_benchmarkMetricNative_il(NMParams p);
...
TC_API void tuiI_setCurrentFrameNative_i(NMParams p);
TC_API void tuiI_applyColorNative_i(NMParams p);
TC_API void tuiI_applyColor2Native_i(NMParams p);
TC_API void tuiI_setTransparentColorNative_i(NMParams p);
...
TC_API void tuiNIB_createEmptyForTestNative_iii(NMParams p);
...
TC_API void tuiNIB_backingPeakLiveTestNative(NMParams p);
TC_API void tuiNIB_backingBytesLiveTest(NMParams p);
TC_API void tuiNIB_backingPeakBytesTest(NMParams p);
TC_API void tuiNIB_writePixelsAttemptsTest(NMParams p);
...
TC_API void tuiNIB_writePixelsRejectInvalidTargetOrSourceTest(NMParams p);
TC_API void tuiNIB_writePixelsRejectAlphaMaskTest(NMParams p);
TC_API void tuiNIB_writePixelsRejectMatrixTest(NMParams p);
TC_API void tuiNIB_writePixelsRejectSaveCountTest(NMParams p);
TC_API void tuiNIB_writePixelsRejectSourceRectTest(NMParams p);
TC_API void tuiNIB_writePixelsRejectSizeMismatchTest(NMParams p);
TC_API void tuiNIB_writePixelsRejectFractionalDestinationTest(NMParams p);
TC_API void tuiNIB_writePixelsRejectDestinationBoundsTest(NMParams p);
TC_API void tuiNIB_writePixelsRejectOpacityTest(NMParams p);
TC_API void tuiNIB_writePixelsRejectSourcePixelsTest(NMParams p);
TC_API void tuiNIB_writePixelsRejectWriteFailureTest(NMParams p);
TC_API void tuiNIB_writePixelsDeviceOneToOneCandidatesTest(NMParams p);
TC_API void tuiNIB_writePixelsDeviceOneToOneKnownOpaqueCandidatesTest(NMParams p);
...
TC_API void tuiNIB_targetColorFallbacksTest(NMParams p);
TC_API void tuiNIB_targetColorBytesTest(NMParams p);
TC_API void tuiNIB_variantLookupsTest(NMParams p);
TC_API void tuiNIB_variantHitsTest(NMParams p);
TC_API void tuiNIB_variantMissesTest(NMParams p);
TC_API void tuiNIB_variantMatsTest(NMParams p);
TC_API void tuiNIB_variantEvictionsTest(NMParams p);
TC_API void tuiNIB_variantBytesTest(NMParams p);
TC_API void tuiNIB_formatBytesTest_i(NMParams p);
TC_API void tuiNIB_compactDecodeCountTest(NMParams p);
TC_API void tuiNIB_compactDecodeBytesTest(NMParams p);
TC_API void tuiNIB_temporaryRgbaBytesTest(NMParams p);
TC_API void tuiNIB_compactReadbacksTest(NMParams p);
TC_API void tuiNIB_compactScratchPeakTest(NMParams p);
TC_API void tuiNIB_promotionAttemptsTest(NMParams p);
TC_API void tuiNIB_promotionSuccessesTest(NMParams p);
TC_API void tuiNIB_promotionFailuresTest(NMParams p);
TC_API void tuiNIB_promotionBytesTest(NMParams p);
...
TC_API void tuiNIB_generationNative(NMParams p);
...
TC_API void tugG_drawImageNative_iii(NMParams p);
...
TC_API void tufFM_charWidthD_c(NMParams p);
TC_API void tufFM_stringWidth_s(NMParams p);
TC_API void tufFM_stringWidthD_s(NMParams p);
...
TC_API void tnsSSLCM_init_s(NMParams p);
TC_API void tnsSSLCM_close(NMParams p);
TC_API void tnsSSLCM_startHandshake(NMParams p);
TC_API void tnsSSLCM_readWriteBytes_sBiib(NMParams p);
