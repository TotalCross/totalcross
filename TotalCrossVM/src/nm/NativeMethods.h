...
TC_API void tssSQL4DRS_nativeCreate(NMParams p);
TC_API void tssSQL4DRS_next(NMParams p);
TC_API void tssSQL4DRS_close(NMParams p);
TC_API void tssSQL4DRS_wasNull(NMParams p);
TC_API void tssSQL4DRS_getString_i(NMParams p);
TC_API void tssSQL4DRS_getBoolean_i(NMParams p);
TC_API void tssSQL4DRS_getByte_i(NMParams p);
TC_API void tssSQL4DRS_getShort_i(NMParams p);
TC_API void tssSQL4DRS_getInt_i(NMParams p);
TC_API void tssSQL4DRS_getLong_i(NMParams p);
TC_API void tssSQL4DRS_getFloat_i(NMParams p);
TC_API void tssSQL4DRS_getDouble_i(NMParams p);
TC_API void tssSQL4DRS_getBigDecimal_ii(NMParams p);
TC_API void tssSQL4DRS_getBytes_i(NMParams p);
TC_API void tssSQL4DRS_getDate_i(NMParams p);
TC_API void tssSQL4DRS_getTime_i(NMParams p);
TC_API void tssSQL4DRS_getTimestamp_i(NMParams p);
TC_API void tssSQL4DRS_getString_s(NMParams p);
TC_API void tssSQL4DRS_getBoolean_s(NMParams p);
TC_API void tssSQL4DRS_getByte_s(NMParams p);
TC_API void tssSQL4DRS_getShort_s(NMParams p);
TC_API void tssSQL4DRS_getInt_s(NMParams p);
TC_API void tssSQL4DRS_getLong_s(NMParams p);
TC_API void tssSQL4DRS_getFloat_s(NMParams p);
TC_API void tssSQL4DRS_getDouble_s(NMParams p);
TC_API void tssSQL4DRS_getBigDecimal_si(NMParams p);
TC_API void tssSQL4DRS_getBytes_s(NMParams p);
TC_API void tssSQL4DRS_getDate_s(NMParams p);
TC_API void tssSQL4DRS_getTime_s(NMParams p);
TC_API void tssSQL4DRS_getTimestamp_s(NMParams p);
TC_API void tssSQL4DRS_getWarnings(NMParams p);
TC_API void tssSQL4DRS_clearWarnings(NMParams p);
TC_API void tssSQL4DRS_getCursorName(NMParams p);
TC_API void tssSQL4DRS_getObject_i(NMParams p);
TC_API void tssSQL4DRS_getObject_s(NMParams p);
TC_API void tssSQL4DRS_findColumn_s(NMParams p);
TC_API void tssSQL4DRS_getBigDecimal_i(NMParams p);
TC_API void tssSQL4DRS_getBigDecimal_s(NMParams p);
TC_API void tssSQL4DRS_isBeforeFirst(NMParams p);
TC_API void tssSQL4DRS_isAfterLast(NMParams p);
TC_API void tssSQL4DRS_isFirst(NMParams p);
TC_API void tssSQL4DRS_isLast(NMParams p);
TC_API void tssSQL4DRS_beforeFirst(NMParams p);
TC_API void tssSQL4DRS_afterLast(NMParams p);
TC_API void tssSQL4DRS_first(NMParams p);
TC_API void tssSQL4DRS_last(NMParams p);
TC_API void tssSQL4DRS_getRow(NMParams p);
TC_API void tssSQL4DRS_absolute_i(NMParams p);
TC_API void tssSQL4DRS_relative_i(NMParams p);
TC_API void tssSQL4DRS_previous(NMParams p);
TC_API void tssSQL4DRS_setFetchDirection_i(NMParams p);
TC_API void tssSQL4DRS_getFetchDirection(NMParams p);
TC_API void tssSQL4DRS_setFetchSize_i(NMParams p);
TC_API void tssSQL4DRS_getFetchSize(NMParams p);
TC_API void tssSQL4DRS_getType(NMParams p);
TC_API void tssSQL4DRS_getConcurrency(NMParams p);
TC_API void tssSQL4DS_nativeCreate(NMParams p);
TC_API void tssSQL4DS_executeQuery_s(NMParams p);
TC_API void tssSQL4DS_executeUpdate_s(NMParams p);
TC_API void tssSQL4DS_close(NMParams p);
TC_API void tssSQL4DS_getMaxRows(NMParams p);
TC_API void tssSQL4DS_setMaxRows_i(NMParams p);
TC_API void tssSQL4DS_getQueryTimeout(NMParams p);
TC_API void tssSQL4DS_setQueryTimeout_i(NMParams p);
TC_API void tssSQL4DS_cancel(NMParams p);
TC_API void tssSQL4DS_getWarnings(NMParams p);
TC_API void tssSQL4DS_clearWarnings(NMParams p);
TC_API void tssSQL4DS_setCursorName_s(NMParams p);
TC_API void tssSQL4DS_execute_s(NMParams p);
TC_API void tssSQL4DS_getResultSet(NMParams p);
TC_API void tssSQL4DS_getUpdateCount(NMParams p);
TC_API void tssSQL4DS_getMoreResults(NMParams p);
TC_API void tssSQL4DS_setFetchDirection_i(NMParams p);
TC_API void tssSQL4DS_getFetchDirection(NMParams p);
TC_API void tssSQL4DS_setFetchSize_i(NMParams p);
TC_API void tssSQL4DS_getFetchSize(NMParams p);
TC_API void tssSQL4DS_getResultSetConcurrenc(NMParams p);
TC_API void tssSQL4DS_getResultSetType(NMParams p);
TC_API void tssSQL4DS_addBatch_s(NMParams p);
TC_API void tssSQL4DS_clearBatch(NMParams p);
TC_API void tssSQL4DS_executeBatch(NMParams p);
TC_API void tssSQL4DS_getConnection(NMParams p);
TC_API void tssSQL4DRSMD_nativeCreate(NMParams p);
TC_API void tssSQL4DRSMD_getColumnCount(NMParams p);
TC_API void tssSQL4DRSMD_isAutoIncrement_i(NMParams p);
TC_API void tssSQL4DRSMD_isCaseSensitive_i(NMParams p);
TC_API void tssSQL4DRSMD_isSearchable_i(NMParams p);
TC_API void tssSQL4DRSMD_isCurrency_i(NMParams p);
TC_API void tssSQL4DRSMD_isNullable_i(NMParams p);
TC_API void tssSQL4DRSMD_isSigned_i(NMParams p);
TC_API void tssSQL4DRSMD_getColumnDisplaySiz(NMParams p);
TC_API void tssSQL4DRSMD_getColumnLabel_i(NMParams p);
TC_API void tssSQL4DRSMD_getColumnName_i(NMParams p);
TC_API void tssSQL4DRSMD_getSchemaName_i(NMParams p);
TC_API void tssSQL4DRSMD_getPrecision_i(NMParams p);
TC_API void tssSQL4DRSMD_getScale_i(NMParams p);
TC_API void tssSQL4DRSMD_getTableName_i(NMParams p);
TC_API void tssSQL4DRSMD_getCatalogName_i(NMParams p);
TC_API void tssSQL4DRSMD_getColumnType_i(NMParams p);
TC_API void tssSQL4DRSMD_getColumnTypeName_i(NMParams p);
TC_API void tssSQL4DRSMD_isReadOnly_i(NMParams p);
TC_API void tssSQL4DRSMD_isWritable_i(NMParams p);
TC_API void tssSQL4DRSMD_isDefinitelyWritabl(NMParams p);
TC_API void tssSQL4DRSMD_getColumnClassName_(NMParams p);
TC_API void tssSQL4DPS_nativeCreate(NMParams p);
TC_API void tssSQL4DPS_executeQuery(NMParams p);
TC_API void tssSQL4DPS_executeUpdate(NMParams p);
TC_API void tssSQL4DPS_setNull_ii(NMParams p);
TC_API void tssSQL4DPS_setBoolean_ib(NMParams p);
TC_API void tssSQL4DPS_setByte_ib(NMParams p);
TC_API void tssSQL4DPS_setShort_is(NMParams p);
TC_API void tssSQL4DPS_setInt_ii(NMParams p);
TC_API void tssSQL4DPS_setLong_il(NMParams p);
TC_API void tssSQL4DPS_setFloat_id(NMParams p);
TC_API void tssSQL4DPS_setDouble_id(NMParams p);
TC_API void tssSQL4DPS_setBigDecimal_ib(NMParams p);
TC_API void tssSQL4DPS_setString_is(NMParams p);
TC_API void tssSQL4DPS_setBytes_iB(NMParams p);
TC_API void tssSQL4DPS_setDate_id(NMParams p);
TC_API void tssSQL4DPS_setTime_it(NMParams p);
TC_API void tssSQL4DPS_setTimestamp_it(NMParams p);
TC_API void tssSQL4DPS_clearParameters(NMParams p);
TC_API void tssSQL4DPS_setObject_ioii(NMParams p);
TC_API void tssSQL4DPS_setObject_ioi(NMParams p);
TC_API void tssSQL4DPS_setObject_io(NMParams p);
TC_API void tssSQL4DPS_execute(NMParams p);
TC_API void tssSQL4DPS_addBatch(NMParams p);
TC_API void tssSQL4DPS_getMetaData(NMParams p);
TC_API void tssSQL4DPS_setNull_iis(NMParams p);
TC_API void tssSQL4DC_nativeCreate_ss(NMParams p);
TC_API void tssSQL4DC_createStatement(NMParams p);
TC_API void tssSQL4DC_prepareStatement_s(NMParams p);
TC_API void tssSQL4DC_nativeSQL_s(NMParams p);
TC_API void tssSQL4DC_setAutoCommit_b(NMParams p);
TC_API void tssSQL4DC_getAutoCommit(NMParams p);
TC_API void tssSQL4DC_commit(NMParams p);
TC_API void tssSQL4DC_rollback(NMParams p);
TC_API void tssSQL4DC_close(NMParams p);
TC_API void tssSQL4DC_isClosed(NMParams p);
TC_API void tssSQL4DC_setReadOnly_b(NMParams p);
TC_API void tssSQL4DC_isReadOnly(NMParams p);
TC_API void tssSQL4DC_setCatalog_s(NMParams p);
TC_API void tssSQL4DC_getCatalog(NMParams p);
TC_API void tssSQL4DC_setTransactionIsolatio(NMParams p);
TC_API void tssSQL4DC_getTransactionIsolatio(NMParams p);
TC_API void tssSQL4DC_getWarnings(NMParams p);
TC_API void tssSQL4DC_clearWarnings(NMParams p);
TC_API void tssSQL4DC_createStatement_ii(NMParams p);
TC_API void tssSQL4DC_prepareStatement_sii(NMParams p);
