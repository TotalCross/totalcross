...
TC_API void tdsNDB_exec_s(NMParams p);
...
TC_API void tdsNDB_result_error_ls(NMParams p);
TC_API void tdsNDB_value_bytes_fi(NMParams p);
TC_API void tdsNDB_value_text_fi(NMParams p);
TC_API void tdsNDB_value_blob_fi(NMParams p);
TC_API void tdsNDB_value_double_fi(NMParams p);
TC_API void tdsNDB_value_long_fi(NMParams p);
TC_API void tdsNDB_value_int_fi(NMParams p);
TC_API void tdsNDB_value_type_fi(NMParams p);
TC_API void tdsNDB_create_function_sf(NMParams p);
TC_API void tdsNDB_destroy_function_s(NMParams p);
TC_API void tdsNDB_free_functions(NMParams p);
