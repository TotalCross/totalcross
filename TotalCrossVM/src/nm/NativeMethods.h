...
TC_API void tuiNIB_writePixelsRegularAttemptsTest(NMParams p);
TC_API void tuiNIB_writePixelsRegularHitsTest(NMParams p);
TC_API void tuiNIB_writePixelsRegularFallbacksTest(NMParams p);
TC_API void tuiNIB_writePixelsRegularCopyBytesTest(NMParams p);
TC_API void tuiNIB_writePixelsRegularClippedHitsTest(NMParams p);
...
TC_API void tuiNIB_writePixelsRejectSave(NMParams p);
TC_API void tuiNIB_writePixelsRejectRect(NMParams p);
TC_API void tuiNIB_writePixelsRejectSize(NMParams p);
TC_API void tuiNIB_writePixelsRejectFraction(NMParams p);
TC_API void tuiNIB_writePixelsRejectBounds(NMParams p);
TC_API void tuiNIB_writePixelsRejectOpacity(NMParams p);
TC_API void tuiNIB_writePixelsRejectSource(NMParams p);
TC_API void tuiNIB_writePixelsRejectFailure(NMParams p);
TC_API void tuiNIB_writePixelsCandidates(NMParams p);
TC_API void tuiNIB_writePixelsOpaque(NMParams p);
