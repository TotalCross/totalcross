...
TC_API void tuiNIB_metricForTest_i(NMParams p);
...
TC_API void tuiNIB_writePixelsRegAttTest(NMParams p);
TC_API void tuiNIB_writePixelsRegHitTest(NMParams p);
...
TC_API void tuiNIB_writePixelsFrameMetric_i(NMParams p);
...
TC_API void tugG_getMainWindowPixelBytes(NMParams p);
