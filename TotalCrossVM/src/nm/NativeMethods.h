...
TC_API void tlrA_newInstance_ci(NMParams p);
TC_API void tlrA_newInstance_cI(NMParams p);
TC_API void tlrA_getLength_o(NMParams p);
TC_API void tlrA_get_oi(NMParams p);
TC_API void tlrA_getBoolean_oi(NMParams p);
TC_API void tlrA_getByte_oi(NMParams p);
TC_API void tlrA_getChar_oi(NMParams p);
TC_API void tlrA_getShort_oi(NMParams p);
TC_API void tlrA_getInt_oi(NMParams p);
TC_API void tlrA_getLong_oi(NMParams p);
TC_API void tlrA_getFloat_oi(NMParams p);
TC_API void tlrA_getDouble_oi(NMParams p);
TC_API void tlrA_set_oio(NMParams p);
TC_API void tlrA_setBoolean_oib(NMParams p);
TC_API void tlrA_setByte_oib(NMParams p);
TC_API void tlrA_setChar_oic(NMParams p);
TC_API void tlrA_setShort_ois(NMParams p);
TC_API void tlrA_setInt_oii(NMParams p);
TC_API void tlrA_setLong_oil(NMParams p);
TC_API void tlrA_setFloat_oif(NMParams p);
TC_API void tlrA_setDouble_oid(NMParams p);
TC_API void tlrM_getDeclaringClass(NMParams p);
TC_API void tlrM_getName(NMParams p);
TC_API void tlrM_getModifiers(NMParams p);
TC_API void tlrM_getReturnType(NMParams p);
TC_API void tlrM_getParameterTypes(NMParams p);
TC_API void tlrM_getExceptionTypes(NMParams p);
TC_API void tlrM_equals_o(NMParams p);
TC_API void tlrM_hashCode(NMParams p);
TC_API void tlrM_toString(NMParams p);
TC_API void tlrM_invoke_oO(NMParams p);
TC_API void tlrC_getDeclaringClass(NMParams p);
TC_API void tlrC_getName(NMParams p);
TC_API void tlrC_getModifiers(NMParams p);
TC_API void tlrC_getParameterTypes(NMParams p);
TC_API void tlrC_getExceptionTypes(NMParams p);
TC_API void tlrC_equals_o(NMParams p);
TC_API void tlrC_hashCode(NMParams p);
TC_API void tlrC_toString(NMParams p);
TC_API void tlrC_newInstance_O(NMParams p);
TC_API void tlrF_getDeclaringClass(NMParams p);
TC_API void tlrF_getName(NMParams p);
TC_API void tlrF_getModifiers(NMParams p);
TC_API void tlrF_getType(NMParams p);
TC_API void tlrF_equals_o(NMParams p);
TC_API void tlrF_hashCode(NMParams p);
TC_API void tlrF_toString(NMParams p);
TC_API void tlrF_get_o(NMParams p);
TC_API void tlrF_getBoolean_o(NMParams p);
TC_API void tlrF_getByte_o(NMParams p);
TC_API void tlrF_getChar_o(NMParams p);
TC_API void tlrF_getShort_o(NMParams p);
TC_API void tlrF_getInt_o(NMParams p);
TC_API void tlrF_getLong_o(NMParams p);
TC_API void tlrF_getFloat_o(NMParams p);
TC_API void tlrF_getDouble_o(NMParams p);
TC_API void tlrF_set_oo(NMParams p);
TC_API void tlrF_setBoolean_ob(NMParams p);
TC_API void tlrF_setByte_ob(NMParams p);
TC_API void tlrF_setChar_oc(NMParams p);
TC_API void tlrF_setShort_os(NMParams p);
TC_API void tlrF_setInt_oi(NMParams p);
TC_API void tlrF_setLong_ol(NMParams p);
TC_API void tlrF_setFloat_of(NMParams p);
TC_API void tlrF_setDouble_od(NMParams p);
