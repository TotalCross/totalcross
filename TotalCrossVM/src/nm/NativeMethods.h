...
TC_API void tumMC_nativeFree(NMParams p);
...
TC_API void tugG_eraseRect_iiii(NMParams p);
TC_API void tugG_drawLine_iiii(NMParams p);
TC_API void tugG_drawDots_iiii(NMParams p);
TC_API void tugG_fillCursor_iiii(NMParams p);
TC_API void tugG_drawCursor_iiii(NMParams p);
...
TC_API void tugG_drawText_siiii(NMParams p);
TC_API void tugG_drawText_siii(NMParams p);
TC_API void tugG_drawText_siiiii(NMParams p);
...
TC_API void tugG_drawHighLightFrame_iiiiiib(NMParams p);
TC_API void tugG_drawRoundGradient_iiiiiiiii(NMParams p);
TC_API void tugG_drawImage_iiiiib(NMParams p);
TC_API void tugG_copyImageRect_iiiiiiib(NMParams p);
...
TC_API void tugG_eraseRect_iiiiiii(NMParams p);
...
TC_API void tnSS_accept(NMParams p);
...
TC_API void tidPC_isOpen(NMParams p);
TC_API void tidPC_setFlowControl_b(NMParams p);
TC_API void tidPC_readBytes_Bii(NMParams p);
TC_API void tidPC_readCheck(NMParams p);
TC_API void tidPC_writeBytes_Bii(NMParams p);
...
TC_API void tiPDBF_listPDBs(NMParams p);
...
TC_API void tiF_isOpen(NMParams p);
...
TC_API void tuzZS_finish(NMParams p);
