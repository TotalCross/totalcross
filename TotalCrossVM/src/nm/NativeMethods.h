...
TC_API void jlrM_getModifiers(NMParams p);
TC_API void jlrM_getReturnType(NMParams p);
TC_API void jlrM_getParameterTypes(NMParams p);
TC_API void jlrM_getExceptionTypes(NMParams p);
TC_API void jlrM_equals_o(NMParams p);
TC_API void jlrM_hashCode(NMParams p);
TC_API void jlrM_toString(NMParams p);
TC_API void jlrM_invoke_oO(NMParams p);
TC_API void jlrC_getDeclaringClass(NMParams p);
TC_API void jlrC_getName(NMParams p);
TC_API void jlrC_getModifiers(NMParams p);
TC_API void jlrC_getParameterTypes(NMParams p);
TC_API void jlrC_getExceptionTypes(NMParams p);
TC_API void jlrC_equals_o(NMParams p);
TC_API void jlrC_hashCode(NMParams p);
TC_API void jlrC_toString(NMParams p);
TC_API void jlrC_newInstance_O(NMParams p);
TC_API void jlrF_getDeclaringClass(NMParams p);
TC_API void jlrF_getName(NMParams p);
TC_API void jlrF_getModifiers(NMParams p);
TC_API void jlrF_getType(NMParams p);
TC_API void jlrF_equals_o(NMParams p);
TC_API void jlrF_hashCode(NMParams p);
TC_API void jlrF_toString(NMParams p);
