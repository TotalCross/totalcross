...
//////////////////////////////////////////////////////////////////////////
TC_API void
tsC_equals_BB(NMParams p)
{ // totalcross/sys/Convert native public static
...
//////////////////////////////////////////////////////////////////////////
TC_API void
tsC_toInt_s(NMParams p)
{ // totalcross/sys/Convert native public
  ...
  } else if (String_charsLen(string) >=
             sizeof(
...
//////////////////////////////////////////////////////////////////////////
TC_API void
tsC_doubleToIntBits_d(NMParams p)
{ // totalcross/sys/Convert native public
...
//////////////////////////////////////////////////////////////////////////
TC_API void
tsC_intBitsToDouble_i(NMParams p)
{ // totalcross/sys/Convert native public
...
{ // totalcross/sys/Convert native public
  ...
  if (!string) {
    ...
    throwException(p->currentContext,
                   InvalidNumberException,
                   "Error (1): %s is not a valid double value (%d > %d).",
                   buffer,
                   String_charsLen(string),
    ...
    if (err) {
      ...
      if (*endPtr != 0 || result == HUGE_VAL ||
          result == -HUGE_VAL) { // guich: testing for endPtr to see if it
                                 // stopped in an invalid character
        throwException(
          p->currentContext,
          InvalidNumberException,
          "Error (2): %s is not a valid double value (%s / %f / %f).",
          buffer,
          endPtr,
          result,
          HUGE_VAL);
      ...
      throwException(p->currentContext,
                     InvalidNumberException,
                     "Error (2): %s is not a valid double value.",
                     buffer);
#endif
    }
  }
...
//////////////////////////////////////////////////////////////////////////
TC_API void
tsC_toString_si(NMParams p)
{ // totalcross/sys/Convert native public static
  // String toString(String doubleValue, int n);
...
//////////////////////////////////////////////////////////////////////////
TC_API void
tsC_doubleToLongBits_d(NMParams p)
{ // totalcross/sys/Convert native public static long
  // doubleToLongBits(double value);
  p->retL = p->i64[0];
}
//////////////////////////////////////////////////////////////////////////
TC_API void
tsC_longBitsToDouble_l(NMParams p)
{ // totalcross/sys/Convert native public static double
  // longBitsToDouble(long bits);
  tsC_doubleToLongBits_d(p);
}
//////////////////////////////////////////////////////////////////////////
TC_API void
tsC_toLowerCase_c(NMParams p)
{ // totalcross/sys/Convert native public static
...
//////////////////////////////////////////////////////////////////////////
TC_API void
tsC_unsigned2hex_ii(NMParams p)
{ // totalcross/sys/Convert native public static
  // String unsigned2hex(int b, int places);
...
//////////////////////////////////////////////////////////////////////////
TC_API void
tsC_hashCode_s(NMParams p)
{ // totalcross/sys/Convert native public static int
  // hashCode(StringBuffer sb);
  TCObject stringBuffer = p->obj[0];

  if (!stringBuffer) {
    throwNullArgumentException(p->currentContext, "sb");
  } else {
    p->retI = JCharPHashCode(StringBuffer_charsStart(stringBuffer),
                             StringBuffer_count(stringBuffer));
  }
}
//////////////////////////////////////////////////////////////////////////
TC_API void
tsC_getBreakPos_fsiib(NMParams p)
{ // totalcross/sys/Convert native public static int
  // getBreakPos(totalcross.ui.font.FontMetrics fm, StringBuffer
  // sb, int start, int width, boolean doWordWrap);
  TCObject fm = p->obj[0];
  TCObject sb = p->obj[1];
  int32 start = p->i32[0];
  int32 width = p->i32[1];
  ...
  if (!fm) {
    ...
    if (((n > 0 || width < 0) || (width == 0 && *(buf + start) != ' ')) &&
        lastSpace >=
          0) { // if the previous space is near, break at it - guich@tc114_79:
               // also if broke at a non-letter at the end of the string
      start =
        lastSpace <= start
          ? lastSpace
...
//////////////////////////////////////////////////////////////////////////
void
SB_insertAt_sic(NMParams p); // implemented in file nm/lang/StringBuffer.c
TC_API void
tsC_insertAt_sic(NMParams p)
{ // totalcross/sys/Convert native public static StringBuffer
  // insertAt(StringBuffer sb, int pos, char c)
  SB_insertAt_sic(p);
}
//////////////////////////////////////////////////////////////////////////
TC_API void
tsC_toString_l(NMParams p)
{ // totalcross/sys/Convert native public
...
{ // totalcross/sys/Convert native public
  ...
  if (!string) {
    ...
    throwException(p->currentContext,
                   InvalidNumberException,
                   "Error: %s is not a valid long value.",
                   buffer); // guich@tc123_9
  } else {
    bool err = false;
    String2CharPBuf(string, buffer);
...
//////////////////////////////////////////////////////////////////////////
TC_API void
tsC_fill_Ciic(NMParams p)
{ // totalcross/sys/Convert native public static void
  // fill(char []a, int from, int to, char value);
  TCObject ao = p->obj[0];
  int32 from = p->i32[0];
  int32 to = p->i32[1];
  int32 value = p->i32[2];
...
//////////////////////////////////////////////////////////////////////////
TC_API void
tsC_fill_Biib(NMParams p)
{ // totalcross/sys/Convert native public static void
  // fill(boolean []a, int from, int to, boolean value);
  TCObject ao = p->obj[0];
  int32 from = p->i32[0];
  int32 to = p->i32[1];
  int32 value = p->i32[2];
...
//////////////////////////////////////////////////////////////////////////
TC_API void
tsC_fill_Diid(NMParams p)
{ // totalcross/sys/Convert native public static void
  // fill(double []a, int from, int to, double value);
  TCObject ao = p->obj[0];
  int32 from = p->i32[0];
  int32 to = p->i32[1];
...
//////////////////////////////////////////////////////////////////////////
TC_API void
tsC_fill_Siii(NMParams p)
{ // totalcross/sys/Convert native public static void
  // fill(short []a, int from, int to, int value);
  TCObject ao = p->obj[0];
  int32 from = p->i32[0];
  int32 to = p->i32[1];
...
//////////////////////////////////////////////////////////////////////////
TC_API void
tsC_fill_Biii(NMParams p)
{ // totalcross/sys/Convert native public static void
  // fill(byte []a, int from, int to, int value);
  TCObject ao = p->obj[0];
  int32 from = p->i32[0];
  int32 to = p->i32[1];
...
//////////////////////////////////////////////////////////////////////////
TC_API void
tsC_fill_Liil(NMParams p)
{ // totalcross/sys/Convert native public static void
  // fill(long []a, int from, int to, long value);
  TCObject ao = p->obj[0];
  int32 from = p->i32[0];
  int32 to = p->i32[1];
  int64 value = p->i64[0];
...
//////////////////////////////////////////////////////////////////////////
TC_API void
tsC_fill_Oiio(NMParams p)
{ // totalcross/sys/Convert native public static void
  // fill(Object []a, int from, int to, Object value);
  TCObject ao = p->obj[0];
  int32 from = p->i32[0];
  int32 to = p->i32[1];
...
//////////////////////////////////////////////////////////////////////////
void
SB_delete(TCObject sb, int32 start, int32 end);
void
SB_insert(Context currentContext,
          TCObject obj,
          JCharP what,
          int32 pos,
          int32 wlen);
TCObject
S_replace(Context currentContext, TCObject me, JChar oldChar, JChar newChar);

TC_API void
tsC_replace_sss(NMParams p)
{ // totalcross/sys/Convert native public static String
  ...
  if (source == null) {
    ...
    int32 f = String_charsLen(from), t = String_charsLen(to),
          s = String_charsLen(source), last = 0, tlast = 0;
    ...
    if (f == 1 && t == 1) {
      ...
      while (last >= 0) {
        last = JCharPIndexOfJCharP(sourcec,
                                   fromc,
                                   last,
                                   s,
                                   f); // source.indexOf(from,last);
        if (last == -1) {
          break;
        }
        count++;
      ...
      if (count == 0) { // if the string doesn't appear, return itself
        ...
        TCObject target = createStringObjectWithLen(
          p->currentContext,
        ...
        while (last >= 0) {
          int32 now = JCharPIndexOfJCharP(sourcec,
                                          fromc,
                                          last,
                                          s,
                                          f); // source.indexOf(from,last);
...
//////////////////////////////////////////////////////////////////////////
TCObject
chars2bytes(Context currentContext,
            JCharP chars,
            int32 length); // CharacterConverter.c
TC_API void
tsC_getBytes_s(NMParams p)
{ // totalcross/sys/Convert native public static
  // byte[] getBytes(StringBuffer sb);
  TCObject sb = p->obj[0];
  if (sb == null) {
    throwNullArgumentException(p->currentContext, "sb");
  } else {
...
//////////////////////////////////////////////////////////////////////////
TC_API void
tsC_zeroPad_si(NMParams p)
{ // totalcross/sys/Convert native public static
  // String zeroPad(String s, int size);
  int32 size = p->i32[0];
  TCObject s = p->obj[0];
  if (s == null) {
    throwNullArgumentException(p->currentContext, "s");
...
//////////////////////////////////////////////////////////////////////////
TC_API void
tsC_zeroPad_ii(NMParams p)
{ // totalcross/sys/Convert native public static
  // String zeroPad(int s, int size);
  CharP buffer;
  IntBuf ib;
  ...
  if (n > 0) {
    ...
    setObjectLock(p->retO =
                    createStringObjectFromCharP(p->currentContext, buffer, len),
                  UNLOCKED);
  }
}
//////////////////////////////////////////////////////////////////////////
TC_API void
tsC_numberPad_si(NMParams p)
{ // totalcross/sys/Convert native public static
  // String numberPad(String s, int size);
  int32 size = p->i32[0];
  TCObject s = p->obj[0];
  if (s == null) {
    throwNullArgumentException(p->currentContext, "s");
...
//////////////////////////////////////////////////////////////////////////
TC_API void
tsC_numberPad_ii(NMParams p)
{ // totalcross/sys/Convert native public static
  // String numberPad(int s, int size);
  CharP buffer;
  IntBuf ib;
  int32 size = p->i32[1], len, n;
  buffer = int2str(p->i32[0], ib);
...
//////////////////////////////////////////////////////////////////////////
TC_API void
tsC_dup_ci(NMParams p)
{ // totalcross/sys/Convert native public
  // static String dup(char c, int count);
...
//////////////////////////////////////////////////////////////////////////
TC_API void
tsC_spacePad_sib(NMParams p)
{ // totalcross/sys/Convert native public static String
  // spacePad(String what, int size, boolean before);
  int32 size = p->i32[0];
  bool before = p->i32[1];
  TCObject s = p->obj[0];
  if (s == null) {
