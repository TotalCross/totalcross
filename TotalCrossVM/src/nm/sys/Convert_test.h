...
TESTCASE(tsC_getBreakPos_fsiib) { // totalcross/sys/Convert native public static int getBreakPos(totalcross.ui.font.FontMetrics fm, StringBuffer sb, int start, int width, boolean doWordWrap); #DEPENDS(tufFM_fontMetricsCreate)
	...
	TCObject charArray;
	CharP buf =
		"A SuperWaba � uma plataforma para desenvolvimento de aplica��es para PDA(Personal Digital Assistants) e Smartphones.";
	JCharP jbuf;
	int32* start;
	int32* width;
	int32* doWordWrap;
...
TESTCASE(tsC_toString_l) { // totalcross/sys/Convert native public static String toString(long l);
	...
	ASSERT2_EQUALS(Sz, "999999999999999999", toStringLong(currentContext, buf,
				   I64_CONST(999999999999999999)));
	ASSERT2_EQUALS(Sz, "-999999999999999999", toStringLong(currentContext, buf,
				   I64_CONST(-999999999999999999)));
	ASSERT2_EQUALS(Sz, "9223372036854775807", toStringLong(currentContext, buf,
				   I64_CONST(0x7FFFFFFFFFFFFFFF)));
	ASSERT2_EQUALS(Sz, "9223372036854775806", toStringLong(currentContext, buf,
				   I64_CONST(9223372036854775806)));
	ASSERT2_EQUALS(Sz, "-9223372036854775808", toStringLong(currentContext, buf,
...
TESTCASE(tsC_toLong_s) { // totalcross/sys/Convert native public static long toLong(String s);
	...
	ASSERT2_EQUALS(I64, I64_CONST(999999999999999999), toLongString(currentContext,
				   "999999999999999999"));
	ASSERT2_EQUALS(I64, I64_CONST(-999999999999999999), toLongString(currentContext,
				   "-999999999999999999"));
	ASSERT2_EQUALS(I64, I64_CONST(0x7FFFFFFFFFFFFFFF), toLongString(currentContext,
				   "9223372036854775807"));
	ASSERT2_EQUALS(I64, I64_CONST(9223372036854775806), toLongString(currentContext,
				   "9223372036854775806"));
	ASSERT2_EQUALS(I64, I64_CONST(0x8000000000000000), toLongString(currentContext,
				   "-9223372036854775808"));
	ASSERT2_EQUALS(I64, I64_CONST(-9223372036854775807), toLongString(currentContext,
				   "-9223372036854775807"));
