...
{ // totalcross/sys/Convert native public static int
  ...
  p.obj[0] =
    createStringObjectFromCharP(currentContext, "12345678901234567890", -1);
  setObjectLock(p.obj[0], UNLOCKED);
  tsC_toInt_s(&p);
  ASSERT2_EQUALS(I32, 0, p.retI);
...
TESTCASE(tsC_doubleToIntBits_d)
{ // totalcross/sys/Convert native public static
  // int doubleToIntBits(double d);
  TNMParams p;
  double doubleBuf[1];
  int32 i32buf[1];
...
TESTCASE(tsC_intBitsToDouble_i)
{ // totalcross/sys/Convert native public static
  // double intBitsToDouble(int i);
  TNMParams p;
  double doubleBuf[1];
  int32 i32buf[1];
...
TESTCASE(tsC_doubleToLongBits_d)
{ // totalcross/sys/Convert native public static
...
TESTCASE(tsC_longBitsToDouble_l)
...
{ // totalcross/sys/Convert native public static
  ...
  ASSERT2_EQUALS(Sz,
                 "FFEEBBAA",
                 buffer); // the number was signed, so this result is correct
...
TESTCASE(tsC_getBreakPos_fsiib)
{ // totalcross/sys/Convert native public static int
  // getBreakPos(totalcross.ui.font.FontMetrics fm,
  // StringBuffer sb, int start, int width, boolean
  // doWordWrap); #DEPENDS(tufFM_fontMetricsCreate)
  TNMParams p;
  TCObject params[2];
  int32 i32buf[3];
  TCObject sb;
  TCObject charArray;
  CharP buf = "A SuperWaba � uma plataforma para desenvolvimento de aplica��es "
              "para PDA(Personal Digital Assistants) e Smartphones.";
  JCharP jbuf;
  int32* start;
  int32* width;
  int32* doWordWrap;
...
static CharP
toStringLong(Context currentContext, CharP buf, int64 i)
{
  TNMParams p;
...
{ // totalcross/sys/Convert native public static String
  ...
  ASSERT2_EQUALS(
    Sz,
    "999999999999999999",
    toStringLong(currentContext, buf, I64_CONST(999999999999999999)));
  ASSERT2_EQUALS(
    Sz,
    "-999999999999999999",
    toStringLong(currentContext, buf, I64_CONST(-999999999999999999)));
  ASSERT2_EQUALS(
    Sz,
    "9223372036854775807",
    toStringLong(currentContext, buf, I64_CONST(0x7FFFFFFFFFFFFFFF)));
  ASSERT2_EQUALS(
    Sz,
    "9223372036854775806",
    toStringLong(currentContext, buf, I64_CONST(9223372036854775806)));
  ASSERT2_EQUALS(
    Sz,
    "-9223372036854775808",
    toStringLong(currentContext, buf, I64_CONST(0x8000000000000000)));
  ASSERT2_EQUALS(
    Sz,
    "-9223372036854775807",
    toStringLong(currentContext, buf, I64_CONST(-9223372036854775807)));
  ASSERT2_EQUALS(
    Sz,
    "-2147483648",
    toStringLong(currentContext, buf, I64_CONST(0xFFFFFFFF80000000)));
  ASSERT2_EQUALS(Sz,
                 "-2147483647",
                 toStringLong(currentContext, buf, I64_CONST(-2147483647)));
  ASSERT2_EQUALS(
    Sz, "2147483647", toStringLong(currentContext, buf, I64_CONST(2147483647)));
  ASSERT2_EQUALS(
    Sz, "2147483646", toStringLong(currentContext, buf, I64_CONST(2147483646)));
finish:;
}

static int64
toLongString(Context currentContext, CharP buf)
{
  TNMParams p;
  TCObject obj;
...
{ // totalcross/sys/Convert native public static long
  ...
  ASSERT2_EQUALS(I64,
                 I64_CONST(999999999999999999),
                 toLongString(currentContext, "999999999999999999"));
  ASSERT2_EQUALS(I64,
                 I64_CONST(-999999999999999999),
                 toLongString(currentContext, "-999999999999999999"));
  ASSERT2_EQUALS(I64,
                 I64_CONST(0x7FFFFFFFFFFFFFFF),
                 toLongString(currentContext, "9223372036854775807"));
  ASSERT2_EQUALS(I64,
                 I64_CONST(9223372036854775806),
                 toLongString(currentContext, "9223372036854775806"));
  ASSERT2_EQUALS(I64,
                 I64_CONST(0x8000000000000000),
                 toLongString(currentContext, "-9223372036854775808"));
  ASSERT2_EQUALS(I64,
                 I64_CONST(-9223372036854775807),
                 toLongString(currentContext, "-9223372036854775807"));
  ASSERT2_EQUALS(I64,
                 I64_CONST(0xFFFFFFFF80000000),
                 toLongString(currentContext, "-2147483648"));
  ASSERT2_EQUALS(
    I64, I64_CONST(-2147483647), toLongString(currentContext, "-2147483647"));
  ASSERT2_EQUALS(
    I64, I64_CONST(2147483647), toLongString(currentContext, "2147483647"));
  ASSERT2_EQUALS(
    I64, I64_CONST(2147483646), toLongString(currentContext, "2147483646"));
finish:;
}
