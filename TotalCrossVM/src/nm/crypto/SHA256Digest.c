...
//////////////////////////////////////////////////////////////////////////
TC_API void tcdSHA256D_init(NMParams
							p) { // totalcross/crypto/digest/SHA256Digest native private void init();
...
//////////////////////////////////////////////////////////////////////////
TC_API void tcdSHA256D_process_B(NMParams
								 p) { // totalcross/crypto/digest/SHA256Digest native protected final byte[] process(byte []data);
	TCObject sha256dObj = p->obj[0];
