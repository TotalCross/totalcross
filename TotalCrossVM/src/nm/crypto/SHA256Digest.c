...
//////////////////////////////////////////////////////////////////////////
TC_API void
tcdSHA256D_init(NMParams p)
{ // totalcross/crypto/digest/SHA256Digest
  // native private void init();
  TCObject sha256dObj = p->obj[0];
  TCObject digestObj;

  if ((digestObj = createByteArray(p->currentContext, sizeof(SHA256_CTX))) !=
      null) {
...
//////////////////////////////////////////////////////////////////////////
TC_API void
tcdSHA256D_process_B(NMParams p)
{ // totalcross/crypto/digest/SHA256Digest native protected
  ...
  if ((byteArrayResult = createByteArray(p->currentContext, SHA256_SIZE)) !=
      null) {
