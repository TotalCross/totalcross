...
//////////////////////////////////////////////////////////////////////////
TC_API void tccAESC_doReset(NMParams
							p) { // totalcross/crypto/cipher/AESCipher native protected final void doReset() throws totalcross.crypto.CryptoException;
	TCObject aesObj = p->obj[0];
	...
	AES_set_key(ctx, ARRAYOBJ_START(dataObj), ARRAYOBJ_START(iv),
				(keyLen * 8) == 128 ? AES_MODE_128 : AES_MODE_256); // guich@tc110_10: select the aes size
...
//////////////////////////////////////////////////////////////////////////
TC_API void tccAESC_process_B(NMParams
							  p) { // totalcross/crypto/cipher/AESCipher native protected byte[] process(byte []data) throws totalcross.crypto.CryptoException;
	TCObject aesObj = p->obj[0];
