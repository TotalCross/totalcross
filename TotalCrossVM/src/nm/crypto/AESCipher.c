...
//////////////////////////////////////////////////////////////////////////
TC_API void
tccAESC_init(NMParams p)
{ // totalcross/crypto/digest/AESCipher native void init();
  TCObject aesObj = p->obj[0];
  TCObject cipherObj;

  if ((cipherObj = createByteArray(p->currentContext, sizeof(AES_CTX))) !=
      null) {
    *Cipher_cipherRef(aesObj) =
      cipherObj; // guich@tc110_98: store in a byte array
    setObjectLock(cipherObj, UNLOCKED);
  }
}
//////////////////////////////////////////////////////////////////////////
TC_API void
tccAESC_doReset(NMParams p)
{ // totalcross/crypto/cipher/AESCipher native protected final
  ...
  AES_set_key(ctx,
              ...
              (keyLen * 8) == 128
                ? AES_MODE_128
                : AES_MODE_256); // guich@tc110_10: select the aes size
...
//////////////////////////////////////////////////////////////////////////
TC_API void
tccAESC_process_B(NMParams p)
{ // totalcross/crypto/cipher/AESCipher native
  ...
  if ((out = xmalloc(n + AES_BLOCKSIZE)) == null) {
    throwException(
      p->currentContext, OutOfMemoryError, "Can't create out buffer");
    return;
  }
  ...
  } else if ((byteArrayResult = createByteArray(p->currentContext, out_size)) !=
             null) {
