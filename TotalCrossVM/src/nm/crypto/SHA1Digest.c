...
//////////////////////////////////////////////////////////////////////////
TC_API void
tcdSHA1D_init(NMParams p)
{ // totalcross/crypto/digest/SHA1Digest
  // native private void init();
  TCObject sha1dObj = p->obj[0];
  TCObject digestObj;

  if ((digestObj = createByteArray(p->currentContext, sizeof(SHA1_CTX))) !=
      null) {
...
//////////////////////////////////////////////////////////////////////////
TC_API void
tcdSHA1D_process_B(NMParams p)
{ // totalcross/crypto/digest/SHA1Digest native
  ...
  if ((byteArrayResult = createByteArray(p->currentContext, SHA1_SIZE)) !=
      null) {
