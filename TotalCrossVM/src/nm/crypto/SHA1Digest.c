...
//////////////////////////////////////////////////////////////////////////
TC_API void tcdSHA1D_init(NMParams
						  p) { // totalcross/crypto/digest/SHA1Digest native private void init();
...
//////////////////////////////////////////////////////////////////////////
TC_API void tcdSHA1D_process_B(NMParams
							   p) { // totalcross/crypto/digest/SHA1Digest native protected final byte[] process(byte []data);
	TCObject sha1dObj = p->obj[0];
