...
//////////////////////////////////////////////////////////////////////////
TC_API void tcdMD5D_init(NMParams
						 p) { // totalcross/crypto/digest/MD5Digest native private void init();
...
//////////////////////////////////////////////////////////////////////////
TC_API void tcdMD5D_process_B(NMParams
							  p) { // totalcross/crypto/digest/MD5Digest native protected final byte[] process(byte []data);
	TCObject md5dObj = p->obj[0];
