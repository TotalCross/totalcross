...
//////////////////////////////////////////////////////////////////////////
TC_API void
tcdMD5D_init(NMParams p)
{ // totalcross/crypto/digest/MD5Digest
  // native private void init();
  TCObject md5dObj = p->obj[0];
  TCObject digestObj;

  if ((digestObj = createByteArray(p->currentContext, sizeof(MD5_CTX))) !=
      null) {
...
//////////////////////////////////////////////////////////////////////////
TC_API void
tcdMD5D_process_B(NMParams p)
{ // totalcross/crypto/digest/MD5Digest native
  ...
  if ((byteArrayResult = createByteArray(p->currentContext, MD5_SIZE)) !=
      null) {
