...
/*
   This header contains the definitions to access some instance fields of the
   classes. Note that static fields must be retrieved using the
   getStaticFieldXXX functions available in tcvm.h.

   You should declare these fields only to access the ones declared in the
   current class.
   ...
   You can use these macros (defined in class.h) to access the fields of various
   types:

      FIELD_I32(o,idx)     FIELD_OBJ(o,c,idx)    FIELD_I64(o,c,idx)
   FIELD_DBL(o,c,idx)
   ...
   In a class, at first are fields from the super classes, then the fields from
   the current class.
*/

// java.lang.String
#define String_chars(o)                                                        \
  ((o)->asObj) // String has a single field, "char[] chars", and since it is
               // widely used, we'll do an optimization here, not using
               // FIELD_OBJ
...
#define StringBuffer_charsStart(o)                                             \
  ((JCharP)(ARRAYOBJ_START(StringBuffer_chars(o))))
...
#define Method_returnType(o)                                                   \
  FIELD_OBJ(o, OBJ_CLASS(o), 6) // not for Constructor
...
#define Image_changed(o)                                                       \
  *((int32*)ARRAYOBJ_START(FIELD_OBJ(o, OBJ_CLASS(o), 4)))
#define Image_instanceCount(o)                                                 \
  *((int32*)ARRAYOBJ_START(FIELD_OBJ(o, OBJ_CLASS(o), 5)))
...
#define File_fileRef(o)                                                        \
  *getInstanceFieldObject(o, "fileRef", "totalcross.io.File")
...
#define File_dontFinalize(o)                                                   \
  *getInstanceFieldInt(o, "dontFinalize", "totalcross.io.File")
#define File_pos(o)                                                            \
  *getInstanceFieldInt(o, "pos", "totalcross.io.RandomAccessStream")
...
#define Conduit_syncTarget(o)                                                  \
  getInstanceFieldInt(o, "syncTarget", "totalcross.io.sync.Conduit")
#define Conduit_conduitHandle(o)                                               \
  getInstanceFieldObject(o, "conduitHandle", "totalcross.io.sync.Conduit")
#define Conduit_conduitName(o)                                                 \
  *getInstanceFieldObject(o, "conduitName", "totalcross.io.sync.Conduit")
#define Conduit_targetApplicationId(o)                                         \
  *getInstanceFieldObject(                                                     \
    o, "targetApplicationId", "totalcross.io.sync.Conduit")
#define Conduit_targetAppPath(o)                                               \
  getInstanceFieldObject(o, "targetAppPath", "totalcross.io.sync.Conduit")
...
#define RemotePDBRecord_remotePDBFile(o)                                       \
  getInstanceFieldObject(o, "rc", "totalcross.io.sync.RemotePDBRecord")
...
#define GPS_location(o)                                                        \
  *getInstanceFieldObject(o, "location", "totalcross.io.device.gps.GPS")
...
#define GPS_direction(o)                                                       \
  *getInstanceFieldDouble(o, "direction", "totalcross.io.device.gps.GPS")
#define GPS_velocity(o)                                                        \
  *getInstanceFieldDouble(o, "velocity", "totalcross.io.device.gps.GPS")
#define GPS_satellites(o)                                                      \
  *getInstanceFieldInt(o, "satellites", "totalcross.io.device.gps.GPS")
#define GPS_lastFix(o)                                                         \
  *getInstanceFieldObject(o, "lastFix", "totalcross.io.device.gps.GPS")
#define GPS_pdop(o)                                                            \
  *getInstanceFieldDouble(o, "pdop", "totalcross.io.device.gps.GPS")
#define GPS_lowSignalReason(o)                                                 \
  *getInstanceFieldObject(o, "lowSignalReason", "totalcross.io.device.gps.GPS")
#define GPS_messageReceived(o)                                                 \
  *getInstanceFieldObject(o, "messageReceived", "totalcross.io.device.gps.GPS")
#define GPS_precision(o)                                                       \
  *getInstanceFieldInt(o, "precision", "totalcross.io.device.gps.GPS")
...
#define SSL_nativeHeap(o)                                                      \
  getInstanceFieldObject(o, "nativeHeap", "totalcross.net.ssl.SSL")

// totalcross.net.ssl.SSLCTX
#define SSLCTX_ctxRef(o) FIELD_I64(o, OBJ_CLASS(o), 0)
#define SSLCTX_dontFinalize(o) FIELD_I32(o, 0)
#define SSLCTX_nativeHeap(o)                                                   \
  getInstanceFieldObject(o, "nativeHeap", "totalcross.net.ssl.SSLCTX")
...
// java.lang.Throwable
#define Throwable_msg(o)                                                       \
  getInstanceFieldObject(                                                      \
    o,                                                                         \
    "msg",                                                                     \
    "java.lang.Throwable") // this may be an object that extends throwable
#define Throwable_trace(o)                                                     \
  getInstanceFieldObject(o, "trace", "java.lang.Throwable")
...
#define Digest_digestRef(o)                                                    \
  getInstanceFieldObject(o, "digestRef", "totalcross.crypto.digest.Digest")

// totalcross.crypto.cipher.Cipher
#define Cipher_cipherRef(o)                                                    \
  getInstanceFieldObject(o, "cipherRef", "totalcross.crypto.cipher.Cipher")
#define Cipher_keyRef(o)                                                       \
  getInstanceFieldObject(o, "keyRef", "totalcross.crypto.cipher.Cipher")
#define Cipher_operation(o)                                                    \
  getInstanceFieldInt(o, "operation", "totalcross.crypto.cipher.Cipher")
#define Cipher_key(o)                                                          \
  getInstanceFieldObject(o, "key", "totalcross.crypto.cipher.Cipher")
#define Cipher_chaining(o)                                                     \
  getInstanceFieldInt(o, "chaining", "totalcross.crypto.cipher.Cipher")
#define Cipher_iv(o)                                                           \
  getInstanceFieldObject(o, "iv", "totalcross.crypto.cipher.Cipher")
#define Cipher_padding(o)                                                      \
  getInstanceFieldInt(o, "padding", "totalcross.crypto.cipher.Cipher")
#define Cipher_nativeHeap(o)                                                   \
  getInstanceFieldObject(o, "nativeHeap", "totalcross.crypto.cipher.Cipher")
...
#define Signature_signatureRef(o)                                              \
  getInstanceFieldObject(                                                      \
    o, "signatureRef", "totalcross.crypto.signature.Signature")
#define Signature_keyRef(o)                                                    \
  getInstanceFieldObject(o, "keyRef", "totalcross.crypto.signature.Signature")
#define Signature_operation(o)                                                 \
  getInstanceFieldInt(o, "operation", "totalcross.crypto.signature.Signature")
#define Signature_key(o)                                                       \
  getInstanceFieldObject(o, "key", "totalcross.crypto.signature.Signature")

// totalcross.crypto.signature.PKCS1Signature
#define PKCS1Signature_digest(o)                                               \
  getInstanceFieldObject(                                                      \
    o, "digest", "totalcross.crypto.signature.PKCS1Signature")
...
#define CompressedStream_streamRef(o)                                          \
  *getInstanceFieldObject(                                                     \
    o, "compressedStream", "totalcross.util.zip.CompressedStream")
#define CompressedStream_streamBuffer(o)                                       \
  *getInstanceFieldObject(                                                     \
    o, "streamBuffer", "totalcross.util.zip.CompressedStream")
#define CompressedStream_mode(o)                                               \
  *getInstanceFieldInt(o, "mode", "totalcross.util.zip.CompressedStream")
...
#define ZipStream_nativeZip(o)                                                 \
  getInstanceFieldObject(o, "nativeZip", "totalcross.util.zip.ZipStream")
#define ZipStream_lastEntry(o)                                                 \
  getInstanceFieldObject(o, "lastEntry", "totalcross.util.zip.ZipStream")
#define ZipStream_method(o)                                                    \
  *getInstanceFieldInt(o, "defaultMethod", "totalcross.util.zip.ZipStream")

// totalcross.telephony.SmsManager
#define SmsManager_smsReceiver(o)                                              \
  *getInstanceFieldObject(o, "receiver", "totalcross.telephony.SmsManager")
#define SmsMessage_displayOriginatingAddress(o)                                \
  *getInstanceFieldObject(                                                     \
    o, "displayOriginatingAddress", "totalcross.telephony.SmsMessage")
#define SmsMessage_displayMessageBody(o)                                       \
  *getInstanceFieldObject(                                                     \
    o, "displayMessageBody", "totalcross.telephony.SmsMessage")
#define SmsMessage_userData(o)                                                 \
  *getInstanceFieldObject(o, "userData", "totalcross.telephony.SmsMessage")

// totalcross.notification.Notification
#define Notification_title(o)                                                  \
  *getInstanceFieldObject(o, "title", "totalcross.notification.Notification")
#define Notification_text(o)                                                   \
  *getInstanceFieldObject(o, "text", "totalcross.notification.Notification")

#define GpiodChip_handle(o)                                                    \
  *getInstanceFieldObject(o, "handle", "totalcross.io.device.gpiod.GpiodChip")
#define GpiodLine_handle(o)                                                    \
  *getInstanceFieldObject(o, "handle", "totalcross.io.device.gpiod.GpiodLine")
