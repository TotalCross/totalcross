...
{ // totalcross/util/zip/ZLib
  ...
  File_path(tmnpFileIn.obj[0]) =
    createStringObjectFromCharP(currentContext, srcFileName, -1);
  ...
  File_path(tmnpFileOut.obj[0]) =
    createStringObjectFromCharP(currentContext, zipFileName, -1);
  ...
  ASSERT1_EQUALS(NotNull, tmnpFileOut.obj[0]);
  File_path(tmnpFileOut.obj[0]) =
    createStringObjectFromCharP(currentContext, dstFileName, -1);
  tmnpFileOut.obj[1] = File_path(tmnpFileOut.obj[0]);
  ASSERT1_EQUALS(NotNull, tmnpFileOut.obj[1]);
  tmnpFileOut.i32[0] = 5; // CREATE_EMPTY
  tmnpFileOut.i32[1] = -1;
