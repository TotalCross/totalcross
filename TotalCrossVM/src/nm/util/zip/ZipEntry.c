...
//////////////////////////////////////////////////////////////////////////
TC_API void
tuzZE_setTime_l(NMParams p)
{ // totalcross/util/zip/ZipEntry native
  ...
  ZipEntry_time(zipEntryObj) =
    (systemTime.wYear - 1980) << 25 | systemTime.wMonth << 21 |
    systemTime.wDay << 16 | systemTime.wHour << 11 | systemTime.wMinute << 5 |
  ...
  ZipEntry_time(zipEntryObj) =
    (systemTime->tm_year - 80) << 25 | (systemTime->tm_mon + 1) << 21 |
    systemTime->tm_mday << 16 | systemTime->tm_hour << 11 |
    systemTime->tm_min << 5 | systemTime->tm_sec >> 1;
#endif
}
//////////////////////////////////////////////////////////////////////////
TC_API void
tuzZE_getTime(NMParams p)
{ // totalcross/util/zip/ZipEntry native public long getTime();
  TCObject zipEntryObj = p->obj[0];
