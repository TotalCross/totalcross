...
//////////////////////////////////////////////////////////////////////////
TC_API void tuzZE_setTime_l(NMParams
							p) { // totalcross/util/zip/ZipEntry native public void setTime(long time);
...
//////////////////////////////////////////////////////////////////////////
TC_API void tuzZE_getTime(NMParams
						  p) { // totalcross/util/zip/ZipEntry native public long getTime();
	TCObject zipEntryObj = p->obj[0];
