...
//////////////////////////////////////////////////////////////////////////
TC_API void ttSM_sendTextMessage_sss(NMParams
									 p) { // totalcross/telephony/SmsManager public native void sendTextMessage(String destinationAddress, String scAddress, String text);
...
//////////////////////////////////////////////////////////////////////////
TC_API void ttSM_registerSmsReceiver_si(NMParams
										p) { // totalcross/telephony/SmsManager public native void registerSmsReceiver(totalcross.telephony.SmsReceiver receiver, int port);
	TCObject smsManager = p->obj[0];
...
//////////////////////////////////////////////////////////////////////////
TC_API void ttSM_sendDataMessage_ssiB(NMParams
									  p) { // totalcross/telephony/SmsManager public native void sendDataMessage(String destinationAddress, String scAddress, int port, byte[] data);
	TCObject smsManager = p->obj[0];
	TCObject destinationAddress = p->obj[1];
	TCObject scAddress = p->obj[2];
	int32 port = p->i32[0];
