...
extern "C"
{
  ...
  typedef BOOL(__stdcall* CeSetFileAttributesProc)(LPCWSTR lpFileName,
                                                   DWORD dwFileAttributes);
  typedef BOOL(__stdcall* CeFindAllFilesProc)(LPCWSTR szPath,
                                              DWORD dwFlags,
...
#include "../palmdb/palmdb.h"
  ...
  extern bool PDBCreateFile(TCHARP fullPath,
                            bool createIt,
                            bool readOnly,
                            PDBFileRef* fileRef);
