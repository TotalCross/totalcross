...
typedef LRESULT(CALLBACK* GetWirelessDevicesProc)(RDD** pDevices,
                                                  DWORD dwFlags);
typedef LRESULT(CALLBACK* ChangeRadioStateProc)(RDD* pDev,
                                                DWORD dwState,
                                                SAVEACTION sa);
...
#define WSAStartup(a, b)                                                       \
  (WSAStartupProc == null ? WSAVERNOTSUPPORTED : WSAStartupProc(a, b))
#define socket(a, b, c)                                                        \
  (socketProc == null ? INVALID_SOCKET : socketProc(a, b, c))
#define inet_addr(a) (inet_addrProc == null ? INADDR_NONE : inet_addrProc(a))
#define gethostbyname(a)                                                       \
  (gethostbynameProc == null ? null : gethostbynameProc(a))
#define WSAGetLastError()                                                      \
  (WSAGetLastErrorProc == null ? ERROR_CALL_NOT_IMPLEMENTED                    \
                               : WSAGetLastErrorProc())
#define htons(a) (htonsProc == null ? a : htonsProc(a))
#define ioctlsocket(a, b, c)                                                   \
  (ioctlsocketProc == null ? SOCKET_ERROR : ioctlsocketProc(a, b, c))
#define connect(a, b, c) (connectProc == null ? 1 : connectProc(a, b, c))
#define select(a, b, c, d, e)                                                  \
  (selectProc == null ? SOCKET_ERROR : selectProc(a, b, c, d, e))
#define shutdown(a, b)                                                         \
  (shutdownProc == null ? SOCKET_ERROR : shutdownProc(a, b))
#define closesocket(a)                                                         \
  (closesocketProc == null ? SOCKET_ERROR : closesocketProc(a))
#define WSACleanup() (WSACleanupProc == null ? SOCKET_ERROR : WSACleanupProc())
#define recv(a, b, c, d)                                                       \
  (recvProc == null ? SOCKET_ERROR : recvProc(a, b, c, d))
#define send(a, b, c, d)                                                       \
  (sendProc == null ? SOCKET_ERROR : sendProc(a, b, c, d))
#define bind(a, b, c) (bindProc == null ? SOCKET_ERROR : bindProc(a, b, c))
#define inet_ntoa(a) (inet_ntoaProc == null ? null : inet_ntoaProc(a))
#define gethostbyaddr(a, b, c)                                                 \
  (gethostbyaddrProc == null ? null : gethostbyaddrProc(a, b, c))
#define gethostname(a, b)                                                      \
  (gethostnameProc == null ? SOCKET_ERROR : gethostnameProc(a, b))
#define listen(a, b) (listenProc == null ? SOCKET_ERROR : listenProc(a, b))
#define accept(a, b, c)                                                        \
  (acceptProc == null ? INVALID_SOCKET : acceptProc(a, b, c))
#define ntohl(a) (ntohlProc == null ? a : ntohlProc(a))
#define htonl(a) (htonlProc == null ? a : htonlProc(a))
#define getsockname(a, b, c)                                                   \
  (getsocknameProc == null ? SOCKET_ERROR : getsocknameProc(a, b, c))

#define WSALookupServiceBegin(a, b, c)                                         \
  (WSALookupServiceBeginProc == null ? SOCKET_ERROR                            \
                                     : WSALookupServiceBeginProc(a, b, c))
#define WSALookupServiceNext(a, b, c, d)                                       \
  (WSALookupServiceNextProc == null ? SOCKET_ERROR                             \
                                    : WSALookupServiceNextProc(a, b, c, d))
#define WSALookupServiceEnd(a)                                                 \
  (WSALookupServiceEndProc == null ? SOCKET_ERROR : WSALookupServiceEndProc(a))
#define WSASetService(a, b, c)                                                 \
  (WSASetServiceProc == null ? SOCKET_ERROR : WSASetServiceProc(a, b, c))
#endif
...
#if defined(WINCE)
#define _GetWirelessDevices(a, b)                                              \
  (pGetWirelessDevices == null ? WSAVERNOTSUPPORTED : pGetWirelessDevices(a, b))
#define _ChangeRadioState(a, b, c)                                             \
  (pChangeRadioState == null ? WSAVERNOTSUPPORTED : pChangeRadioState(a, b, c))
#define _FreeDeviceList(a)                                                     \
  (pFreeDeviceList == null ? WSAVERNOTSUPPORTED : pFreeDeviceList(a))
#endif
