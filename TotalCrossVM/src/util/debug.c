...
//                                Debug                                  //
///////////////////////////////////////////////////////////////////////////
static char debugstrSmall[64]; // used during startup and exit, when debugstr is
                               // not valid, for SHORT MESSAGES!
...
#ifdef ANDROID
  if (s &&
      !strEq(s, ALTERNATIVE_DEBUG)) { // is the user asking to change the mode?
...
TC_API bool
trace(char* s)
{ // used to trace function calls. also prints the memory available
  char* buf = debugstr ? debugstr : debugstrSmall;
...
TC_API void
tcabort(char* msg, char* file, int32 line)
{
