...
typedef int32(*JCharPIndexOfJCharPFunc)(JCharP me, JCharP other, int32 start, int32 meLen,
										int32 otherLen);
TC_API int32 JCharPLastIndexOfJCharP(JCharP me, JCharP other, int32 start, int32 meLen,
									 int32 otherLen);
typedef int32(*JCharPLastIndexOfJCharPFunc)(JCharP me, JCharP other, int32 start, int32 meLen,
		int32 otherLen);
...
TC_API bool JCharPStartsWithJCharP(JCharP me, JCharP other, int32 meLen, int32 otherLen,
								   int32 from);
typedef bool (*JCharPStartsWithJCharPFunc)(JCharP me, JCharP other, int32 meLen, int32 otherLen,
		int32 from);
...
typedef bool (*JCharPEqualsIgnoreCaseJCharPFunc)(JCharP me, JCharP other, int32 meLen,
		int32 otherLen);
