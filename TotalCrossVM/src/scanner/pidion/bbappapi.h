...
#define CARDREADER_VOLUME_EVENT TEXT("CardReaderVolume")
  ...
  BBAPI DWORD WINAPI BBCardReaderReadData(HBBCARDREADER hCardReader,
                                          int track,
                                          LPBYTE buffer,
                                          int nBufferSize);
  BBAPI DWORD WINAPI BBCardReaderReadString(HBBCARDREADER hCardReader,
                                            int track,
                                            LPTSTR buf);
  BBAPI DWORD WINAPI
  BBCardReaderStartAsyncReadData(HBBCARDREADER hCardReader,
                                 CardReaderCallbackFunc pfCallback,
                                 DWORD dwCallbackArg);
  BBAPI DWORD WINAPI BBCardReaderStopAsyncReadData(HBBCARDREADER hCardReader);
  BBAPI DWORD WINAPI BBCardReaderReadCardData(HBBCARDREADER hCardReader,
                                              int track,
                                              LPTSTR buffer,
                                              DWORD* pBufferSize);
  BBAPI DWORD WINAPI BBCardReaderGetReadTrack(HBBCARDREADER hCardReader,
                                              DWORD* dwReadTrack);
  ...
  BBAPI DWORD WINAPI BBCardReaderEnableTrackSound(HBBCARDREADER hCardReader,
                                                  int track,
                                                  BOOL bOn);
/*
 * Printer
...
#define BB_PRINT_FONTSET_THAI 3
  ...
  BBAPI DWORD WINAPI BBPrinterGetDensity(HBBPRINTER hPrinter,
                                         UCHAR* pucDensity);
  BBAPI DWORD WINAPI BBPrinterSetLineSpacing(HBBPRINTER hPrinter,
                                             UCHAR ucLineSpacing);
  BBAPI DWORD WINAPI BBPrinterGetLineSpacing(HBBPRINTER hPrinter,
                                             UCHAR* pucLineSpacing);

  BBAPI DWORD WINAPI BBPrinterPrint(HBBPRINTER hPrinter,
                                    LPCTSTR lpcszData,
                                    DWORD dwOptions);
  BBAPI DWORD WINAPI BBPrinterPrintBarcode(HBBPRINTER hPrinter,
                                           LPCTSTR lpcszData,
                                           UCHAR ucHeight,
                                           UCHAR ucWidth,
                                           UCHAR ucBarcodeSystem,
                                           UCHAR ucAlign);

  BBAPI DWORD WINAPI BBPrinterPrintBitmap(HBBPRINTER hPrinter,
  ...
  */
  BBAPI DWORD WINAPI BBPrinterRegisterFontType(HBBPRINTER hPrinter,
                                               UCHAR ucFontSubCode);
  BBAPI DWORD WINAPI BBPrinterRegisterFontFromSet(HBBPRINTER hPrinter,
                                                  UCHAR ucCodeOfSet,
                                                  UCHAR ucFontSubCode);
  ...
  */
  ...
  BBAPI DWORD WINAPI BBPrinterCreateDC(HBBPRINTER hPrinter,
                                       UINT nWidth,
                                       UINT nHeight);
  BBAPI DWORD WINAPI BBPrinterDeleteDC(HBBPRINTER hPrinter);
  BBAPI DWORD WINAPI BBPrinterPrintDC(HBBPRINTER hPrinter);
  BBAPI DWORD WINAPI BBPrinterSetFont(HBBPRINTER hPrinter,
                                      LPFONTINFO lpFontInfo);
  BBAPI DWORD WINAPI BBPrinterDrawText(HBBPRINTER hPrinter,
                                       LPCTSTR lpText,
                                       int nCount,
                                       int nLeft,
                                       int nTop,
                                       ...
                                       int nBottom,
                                       UINT uFormat);
  BBAPI DWORD WINAPI BBPrinterBitBlt(HBBPRINTER hPrinter,
                                     LPCTSTR lpFilePath,
                                     int nXDest,
                                     int nYDest,
                                     int nWidth,
...
#define BB_BARCODE_SC_ERR_TOOBIGSIZE                                           \
  17 // 보낼 data의 size가 너무 클 경우의 error
#define BB_BARCODE_SC_ERR_NOPARAMVALUE                                         \
  18 //  찾고자하는 PARAMETER의 VALUE가 없을때 생기는 error
#define BB_BARCODE_SC_ERR_NOHANDLEGRABBER                                      \
  19 // 현재 Barcode를 점유하는 handle이 없을 경우 error
...
#define BB_BARCODE_MODE_MULTIPLE 0x02
  ...
  BBAPI DWORD WINAPI BBBarcodeGetDecodeData(HBBBARCODE hBarcode,
                                            LPTSTR lpcszBuf,
                                            int Bufsize,
                                            int* ReadSize);
  BBAPI DWORD WINAPI BBBarcodeGetDecodeDataNType(HBBBARCODE hBarcode,
                                                 LPTSTR lpcszBuf,
                                                 BYTE* pType,
                                                 int Bufsize,
                                                 int* ReadSize);
  BBAPI DWORD WINAPI BBBarcodeGetDecodeDataRaw(HBBBARCODE hBarcode,
                                               BYTE* pBuf,
                                               int Bufsize,
                                               int* ReadSize);
  BBAPI DWORD WINAPI BBBarcodeGetDecodeDataNTypeRaw(HBBBARCODE hBarcode,
                                                    BYTE* pBuf,
                                                    BYTE* pType,
                                                    int Bufsize,
                                                    int* ReadSize);
  ...
  BBAPI DWORD WINAPI BBBarcodeGetParameterEx(HBBBARCODE hBarcode,
                                             BYTE paramCode,
                                             BYTE extraParamCode,
                                             BYTE& paramValue);
  BBAPI DWORD WINAPI BBBarcodeSetParameterEx(HBBBARCODE hBarcode,
                                             BYTE paramCode,
                                             BYTE extraParamCode,
                                             BYTE paramValue,
                                             BOOL bPermanent);
  ...
  BBAPI DWORD WINAPI BBBarcodeSetBeep(HBBBARCODE hBarcode,
                                      int Duration,
                                      BOOL bHigh,
                                      int nNumOfBeep);
  BBAPI DWORD WINAPI BBBarcodeSetPowerMode(HBBBARCODE hBarcode,
                                           BOOL bContinuousPower);
  BBAPI DWORD WINAPI BBBarcodeSetAim(HBBBARCODE hBarcode, BOOL bOn);
  BBAPI DWORD WINAPI BBBarcodeGetMultipleParameter(HBBBARCODE hBarcode,
                                                   BYTE* paramCodes,
                                                   int RequestSize,
                                                   BYTE* paramCodeNValue,
                                                   int BufSize,
                                                   int* ReadSize);
  BBAPI DWORD WINAPI BBBarcodeSetMultipleParameter(HBBBARCODE hBarcode,
                                                   BYTE* paramCodeNValue,
                                                   int Size,
                                                   BOOL bPermanent);
  BBAPI DWORD WINAPI BBBarcodeGetParameterFromBytes(HBBBARCODE hBarcode,
                                                    BYTE paramCodes,
                                                    BYTE& paramValue,
                                                    BYTE* paramCodeNValue,
                                                    int BufSize);
  BBAPI DWORD WINAPI BBBarcodeSetParameterToBytes(HBBBARCODE hBarcode,
                                                  BYTE paramCodes,
                                                  BYTE paramValue,
                                                  BYTE* paramCodeNValue,
                                                  int BufSize);
  ...
  //   쉽게 설정할 수 있도록 한다.
  BBAPI DWORD WINAPI BBBarcodeSetPreamble(HBBBARCODE hBarcode,
                                          LPTSTR szPreamble);
  BBAPI DWORD WINAPI BBBarcodeSetPostamble(HBBBARCODE hBarcode,
                                           LPTSTR szPostamble);
  ...
  BBAPI DWORD WINAPI BBBarcodeSetOutputMode(HBBBARCODE hBarcode,
                                            BOOL bClipboard);
  ...
  BBAPI DWORD WINAPI BBBarcodeSetTimeoutBetweenSameSymbol(HBBBARCODE hBarcode,
                                                          DWORD dwMillisecond);
  BBAPI DWORD WINAPI BBBarcodeSetDecodeOnTime(HBBBARCODE hBarcode,
                                              DWORD dwDeciSecond);
  BBAPI DWORD WINAPI BBBarcodeSetPushingTriggerMode(HBBBARCODE hBarcode,
                                                    BYTE bPushingTriggerMode);
  ...
  BBAPI DWORD WINAPI BBBarcodeImagerGetImagerInfo(HBBBARCODE hBarcode,
                                                  PWORD pnCols,
                                                  PWORD pnRows,
                                                  PWORD pnBits);
  BBAPI DWORD WINAPI BBBarcodeImagerStreamInit(HBBBARCODE hBarcode,
                                               WORD nSkip,
                                               RECT* imgRect,
                                               BOOL bFlip);
  BBAPI DWORD WINAPI BBBarcodeImagerStreamStart(HBBBARCODE hBarcode,
                                                RECT* previewRect);
  BBAPI DWORD WINAPI BBBarcodeImagerStreamStop(HBBBARCODE hBarcode);
  BBAPI DWORD WINAPI BBBarcodeImagerStreamCapture(HBBBARCODE hBarcode,
                                                  TCHAR* filename,
                                                  unsigned int nFileWidth,
                                                  unsigned int nFileHeight,
                                                  BOOL bAutoSave = FALSE);
  BBAPI DWORD WINAPI
  BBBarcodeImagerSetExposureSettings(HBBBARCODE hBarcode,
                                     ExposureSettings_t* pExpsoureSettings);
  BBAPI DWORD WINAPI
  BBBarcodeImagerGetExposureSettings(HBBBARCODE hBarcode,
                                     ExposureSettings_t* pExpsoureSettings);
  BBAPI DWORD WINAPI
  BBBarcodeImagerSetScanningLightMode(HBBBARCODE hBarcode,
                                      ScanIlluminat_t LightMode);
  BBAPI DWORD WINAPI BBBarcodeImagerLeaveLightsOn(HBBBARCODE hBarcode,
                                                  BOOL bLeaveLightOn);
  BBAPI DWORD WINAPI
  BBBarcodeImagerSetDecodeMode(HBBBARCODE hBarcode,
                               ImagerDecodeMode_t DecodeMode);
...
#define MAX_TEXT_BUFFER 256
  ...
  typedef struct
  {
    ...
    union
    {
      ...
      TCHAR value_wcharbuffer[MAX_TEXT_BUFFER]; // PARAM_TEXT, PARAM_PATH,
                                                // PARAM_READONLY
    };
  ...
  BBAPI PCCHAR WINAPI BBBarcodeGetNextItemName(HBBBARCODE hBarcode,
                                               const char* item_name,
                                               BOOL* is_ignore_item);
  BBAPI BOOL WINAPI BBBarcodeGetItemString(HBBBARCODE hBarcode,
                                           const char* item_name,
                                           TCHAR* pbuffer,
                                           unsigned int buffer_length);
  BBAPI BOOL WINAPI BBBarcodeGetItemNumber(HBBBARCODE hBarcode,
                                           const char* item_name,
                                           unsigned int* item_number);

  BBAPI PCCHAR WINAPI BBBarcodeGetNextGroupName(HBBBARCODE hBarcode,
                                                const char* item_name,
                                                const char* group_name,
                                                BOOL* is_ignore_group);
  BBAPI BOOL WINAPI BBBarcodeGetGroupString(HBBBARCODE hBarcode,
                                            const char* item_name,
                                            const char* group_name,
                                            TCHAR* pbuffer,
                                            unsigned int buffer_length);

  BBAPI PCCHAR WINAPI BBBarcodeGetNextParameterName(HBBBARCODE hBarcode,
                                                    const char* item_name,
                                                    const char* group_name,
                                                    const char* parameter_name,
                                                    BOOL* is_ignore_parameter);
  BBAPI BOOL WINAPI BBBarcodeGetParameterString(HBBBARCODE hBarcode,
                                                const char* item_name,
                                                const char* group_name,
                                                const char* parameter_name,
                                                TCHAR* pbuffer,
                                                unsigned int buffer_length);
  BBAPI BOOL WINAPI BBBarcodeGetParameterState(HBBBARCODE hBarcode,
                                               const char* item_name,
                                               const char* group_name,
                                               const char* parameter_name,
                                               TCHAR* pbuffer,
                                               unsigned int buffer_length);
  BBAPI BOOL WINAPI BBBarcodeGetParameterType(HBBBARCODE hBarcode,
                                              const char* item_name,
                                              const char* group_name,
                                              const char* parameter_name,
                                              unsigned int* type);
  ...
  BBAPI PCCHAR WINAPI
  BBBarcodeGetParameterNextOptionName(HBBBARCODE hBarcode,
                                      const char* item_name,
                                      const char* group_name,
                                      const char* parameter_name,
                                      const char* option_name);
  BBAPI BOOL WINAPI
  BBBarcodeGetParameterOptionString(HBBBARCODE hBarcode,
                                    const char* item_name,
                                    const char* group_name,
                                    const char* parameter_name,
                                    const char* option_name,
                                    TCHAR* pbuffer,
                                    unsigned int buffer_length);
  BBAPI BOOL WINAPI BBBarcodeSetParameterValue(HBBBARCODE hBarcode,
  ...
  BBAPI BOOL WINAPI BBBarcodeGetWaveFilePath(HBBBARCODE hBarcode,
                                             TCHAR* file_path,
  ...
  BBAPI PCCHAR WINAPI
  BBBarcodeGetParameterStateChar(HBBBARCODE hBarcode,
                                 const char* item_name,
                                 const char* group_name,
                                 const char* parameter_name);
  BBAPI DWORD WINAPI BBBarcodeGetParameterStateDword(HBBBARCODE hBarcode,
                                                     const char* item_name,
                                                     const char* group_name,
                                                     const char* parameter_name,
                                                     DWORD* dwvalue);
  BBAPI PCCHAR WINAPI
  BBBarcodeGetParameterStateName(HBBBARCODE hBarcode,
                                 const char* item_name,
                                 const char* group_name,
                                 const char* parameter_name);
  ...
  BBAPI DWORD WINAPI BBBarcodeGetRevision(HBBBARCODE hBarcode,
                                          BYTE bRevisionType,
                                          TCHAR* wcRevision);
  BBAPI BOOL WINAPI BBBarcodeSetSoundMode(HBBBARCODE hBarcode,
                                          SoundMode nSoundMode);
  BBAPI BOOL WINAPI BBBarcodeGetSoundMode(HBBBARCODE hBarcode,
                                          SoundMode& nSoundMode);
  BBAPI BOOL WINAPI BBBarcodeSetVibrateTimeout(HBBBARCODE hBarcode,
                                               DWORD dwVibrateTimeout);
  BBAPI BOOL WINAPI BBBarcodeGetVibrateTimeout(HBBBARCODE hBarcode,
                                               DWORD& dwVibrateTimeout);
  ...
  BBAPI BOOL WINAPI BBBarcodeSetTriggerMode(HBBBARCODE hBarcode,
                                            BOOL IsContinuousMode);
  BBAPI DWORD WINAPI BBBarcodeImageGetImagerInfo(HBBBARCODE hBarcode,
                                                 PWORD pnCols,
                                                 PWORD pnRows,
                                                 PWORD pnBits);
  BBAPI DWORD WINAPI BBBarcodeImageStreamInit(HBBBARCODE hBarcode,
                                              WORD nSkip,
                                              RECT* imgRect,
                                              BOOL bFlip);
  BBAPI DWORD WINAPI BBBarcodeImageStreamStart(HBBBARCODE hBarcode,
                                               RECT* previewRect);
  BBAPI DWORD WINAPI BBBarcodeImageStreamStop(HBBBARCODE hBarcode);
  BBAPI DWORD WINAPI BBBarcodeImageStreamCapture(HBBBARCODE hBarcode,
                                                 TCHAR* filename,
                                                 int nFileWidth,
                                                 int nFileHeight);
  BBAPI DWORD WINAPI
  BBBarcodeImageSetExposureSettings(HBBBARCODE hBarcode,
                                    ExposureSettings_t* pExpsoureSettings);
  BBAPI DWORD WINAPI
  BBBarcodeImageGetExposureSettings(HBBBARCODE hBarcode,
                                    ExposureSettings_t* pExpsoureSettings);
  BBAPI DWORD WINAPI BBBarcodeGetParameter(HBBBARCODE hBarcode,
                                           BYTE paramCode,
                                           BYTE& paramValue);
  BBAPI DWORD WINAPI BBBarcodeSetParameter(HBBBARCODE hBarcode,
                                           BYTE paramCode,
                                           BYTE paramValue,
                                           BOOL bPermanent);
...
#define BB_CAMERA_CODE_ERR_INVALID_PARAMETER 3
  ...
  typedef struct _tagBBCameraParameter
  {
    ...
    BYTE* p_app_buffer;
    BYTE* p_app_capture_buffer; // still image capture에서 데이터를 받기위한
                                // 포인터
...
#define BB_ICCARD_ERR_DEVICE_ERROR 12
  ...
  BBAPI DWORD WINAPI BBICCardExchangAPDU(HBBICCARD hICCard,
                                         APDU apduSend,
                                         DWORD dwSizeOfAPDU,
                                         APDU apduReceived,
                                         DWORD* dwReturnSize);
  ...
  /*
  #define BB_RFREADER_EXCUTE_SUCCESS                                          (
  0x90 | 0x00 ) #define STATUS_INCORRECT_CLA_ERROR ( 0x6E | 0x00 ) #define
  STATUS_INCORRECT_INS_APDU_ARGUMENT_LC_ERROR                         ( 0x6D |
  0x00 ) #define STATUS_P1_P2_INCORRECT_ERROR ( 0x6B | 0x00 ) #define
  STATUS_INCORRECT_KEY_IN_ASC_ERROR                                   ( 0x6A |
  0x80 ) #define STATUS_INCORRECT_ASC_ERROR ( 0x94 | 0x0B ) #define
  STATUS_INCORRECT_LE_ERROR                                           ( 0x6C )
  // 다시 검토 해봐야 함 #define STATUS_A1_A2_OF_TARGET_BLOCK_INCORRECT_ERROR (
  0x94 | 0x0A ) #define STATUS_AUTHENTICATION_FAIL_ERROR ( 0x98 | 0x20 ) #define
  STATUS_ACCESS_CONDITION_EXCUTE_ERROR                                ( 0x98 |
  0x04 ) #define STATUS_MEMORY_FAIL_ERROR ( 0x94 | 0x02 ) #define
  STATUS_VALUE_BLOCK_OPERATION_ERROR                                  ( 0x94 |
  0x04 ) #define STATUS_VALUE_BLOCK_OPERATION_OVERFLOW_ERROR ( 0x94 | 0x05 )
  #define STATUS_COMMAND_FAIL_ERROR                                           (
  0x94 | 0x0F ) #define STATUS_COMMAND_EXCUTE_TIMEOUT_ERROR ( 0x94 | 0xFF )
  */

#define BB_RFREADER_SUCCESS 0x00
#define BB_RFREADER_ERR_COMMAND 0x01
#define BB_RFREADER_ERR_ARGUMENT                                               \
  0x03 // IFM2.0 추가 (ISO15693 : Not Supported Option )
...
#define BB_RFREADER_ERRSW1_SW2_EXCUTION_ERROR_OR_ISO15693_INVENTORY_COLLISION_DETECT_ERROR \
  0xE7
...
#define BB_RFREADER_ERR_COLLISION_DETECT_TRANSMISSION_ERROR_INCORRECT_CARD_RESPONSE \
  0xEA
...
#define BB_RFREADER_ERR_ISO15693_BLOCK_LOCK_OR_AGAIN_LOCK_ERROR                \
  0x11 // IFM2.0 추가
#define BB_RFREADER_ERR_ISO15693_BLOCK_LOCK_OR_CHANGE_CONTENT_ERROR            \
  0x12 // IFM2.0 추가
#define BB_RFREADER_ERR_ISO15693_BLOCK_PROGRAMMED_NOT_SUCCESS                  \
  0x13                                                            // IFM2.0
                                                                  // 추가
...
#define BB_RFREADER_ERR_UNKNOWN_ERROR 0x9904
  ...
  BBAPI DWORD WINAPI BBSAMPowerUpSAM(HBBICCARD hICCard,
                                     DWORD dwCFG,
                                     BBSAMATR* SAM_ATR);
  BBAPI DWORD WINAPI BBSAMPowerDownSAM(HBBICCARD hICCard);
  BBAPI DWORD WINAPI BBSAMStatus(HBBICCARD hICCard, BBCNF* Status);
  BBAPI DWORD WINAPI BBSAMCommParam(HBBICCARD hICCard,
                                    BBPRT* PRT,
                                    BBCNF* Status);

  // BBAPI DWORD WINAPI BBSAMExchangePPSSAM( HBBICCARD hICCard, BBCFG *CFG,
  // BBPPS *PPS, BBPCK *PCK, BBPPS_Response *Response);
  BBAPI DWORD WINAPI BBSAMExchangePPSSAM(HBBICCARD hICCard,
                                         BBCFG* CFG,
                                         BBPPS* PPS,
                                         BBPPS_Response* Response);
  BBAPI DWORD WINAPI BBSAMExchangeIFSDSAM(HBBICCARD hICCard,
                                          BBDummyByte* Dummy,
                                          BBIFSD* IFSD);
  // BBAPI DWORD WINAPI BBSAMExchangeIFSDSAM( HBBICCARD hICCard, BBIFSD *IFSD);

  // SAM Communication Command
  BBAPI DWORD WINAPI BBSAMISOOutputSAM(HBBICCARD hICCard,
                                       BBISOHeader* Header,
                                       BBSAMResponse* Response);
  BBAPI DWORD WINAPI BBSAMISOInputSAM(HBBICCARD hICCard,
                                      BBISOHeader* Header,
                                      BBSAMResponse* Response,
                                      BBSAMData* Data,
                                      DWORD dwDataLen);
...
#define BB_RFREADER_TG_GEMEASY8000 0x04
  ...
  typedef enum
  { //리턴된 값과 AND를 취하여 MBLI와 CID를 얻을수 있다..
...
#define FLAG_SECS_SET 8 // 0 : Not Setting  1 : Setting
  ...
  // ISO14443_A
  BBAPI DWORD WINAPI BBRFReaderISO14443_A_RequestALL_A(HBBRFREADER,
                                                       BBRFReader_ATQA*);
  BBAPI DWORD WINAPI BBRFReaderISO14443_A_RequestA(HBBRFREADER,
                                                   BBRFReader_ATQA*);
  BBAPI DWORD WINAPI
  BBRFReaderISO14443_A_Anticollision(HBBRFREADER,
                                     BBRFReader_CascadeLevel,
                                     BBRFReader_SerialNumber*,
                                     BBRFReader_Collision*);
  BBAPI DWORD WINAPI BBRFReaderISO14443_A_Select(HBBRFREADER hRFReader,
                                                 BBRFReader_CascadeLevel,
                                                 BBRFReader_SerialNumber*,
                                                 BBRFReader_SAK*);
  BBAPI DWORD WINAPI BBRFReaderISO14443_A_Halt(HBBRFREADER);
  BBAPI DWORD WINAPI
  BBRFReaderISO14443_A_RequestForAnswerToSelect(HBBRFREADER,
                                                BBRFReader_CID,
                                                BBRFReader_ATS*,
                                                DWORD*);
  BBAPI DWORD WINAPI
    BBRFReaderISO14443_A_ProtocolParameterSelection(HBBRFREADER,
                                                    BBRFReader_CID,
                                                    BBRFReader_BitRate);
  ...
  BBAPI DWORD WINAPI BBRFReaderGetReaderParam(HBBRFREADER,
                                              BBRFReader_RFBaudRateTypeA*,
                                              BBRFReader_RFBaudRateTypeB*);

  // MIFARE

  BBAPI DWORD WINAPI BBRFReaderMifare_Authenticate(HBBRFREADER,
                                                   BBRFReader_Mifare*,
                                                   BBRFReader_SW*);
  BBAPI DWORD WINAPI BBRFReaderMifare_Read(HBBRFREADER hRFReader,
                                           BBRFReader_Mifare*,
                                           BBRFReader_MifareData*,
                                           BBRFReader_SW*);
  BBAPI DWORD WINAPI BBRFReaderMifare_Write(HBBRFREADER,
                                            BBRFReader_Mifare*,
                                            BBRFReader_MifareData*,
                                            BBRFReader_SW*);
  BBAPI DWORD WINAPI BBRFReaderMifare_Subtract_Value(HBBRFREADER,
                                                     BBRFReader_Mifare*,
                                                     BBRFReader_MifareMemVal*,
                                                     BBRFReader_SW*);
  BBAPI DWORD WINAPI BBRFReaderMifare_Add_Value(HBBRFREADER,
                                                BBRFReader_Mifare*,
                                                BBRFReader_MifareMemVal*,
                                                BBRFReader_SW*);
  BBAPI DWORD WINAPI BBRFReaderMifare_Restore(HBBRFREADER,
                                              BBRFReader_Mifare*,
                                              BBRFReader_SW*);
  BBAPI DWORD WINAPI BBRFReaderMifare_Transfer(HBBRFREADER,
                                               BBRFReader_Mifare*,
                                               BBRFReader_SW*);

  // MIFARE Combine
  BBAPI DWORD WINAPI
  BBRFReaderMifareCombine_Read(HBBRFREADER hRFReader,
                               BBRFReader_Mifare* Mifare_Authenticate,
                               BBRFReader_MifareData* pData,
                               BBRFReader_SW* Status_SW);
  BBAPI DWORD WINAPI
  BBRFReaderMifareCombine_Write(HBBRFREADER hRFReader,
                                BBRFReader_Mifare* Mifare_Authenticate,
                                BBRFReader_MifareData* pData,
                                BBRFReader_SW* Status_SW);
  BBAPI DWORD WINAPI
  BBRFReaderMifareCombine_CreateValBlock(HBBRFREADER hRFReader,
                                         BBRFReader_Mifare* Mifare_Authenticate,
                                         BBRFReader_MifareData* pData,
                                         BBRFReader_SW* Status_SW);
  BBAPI DWORD WINAPI
  BBRFReaderMifareCombine_ReadValue(HBBRFREADER hRFReader,
                                    BBRFReader_Mifare* Mifare_Authenticate,
                                    BBRFReader_MifareData* pData,
                                    BBRFReader_SW* Status_SW);
  BBAPI DWORD WINAPI
  BBRFReaderMifareCombine_SubtrackValue(HBBRFREADER hRFReader,
                                        BBRFReader_Mifare* Mifare_Authenticate,
                                        BBRFReader_MifareData* pData,
                                        BBRFReader_SW* Status_SW);
  BBAPI DWORD WINAPI
  BBRFReaderMifareCombine_AddValue(HBBRFREADER hRFReader,
                                   BBRFReader_Mifare* Mifare_Authenticate,
                                   BBRFReader_MifareData* pData,
                                   BBRFReader_SW* Status_SW);
  BBAPI DWORD WINAPI
  BBRFReaderMifareCombine_CopyValue(HBBRFREADER hRFReader,
                                    BBRFReader_Mifare* Mifare_Authenticate,
                                    BBRFReader_MifareData* pData,
                                    BBRFReader_SW* Status_SW);
  BBAPI DWORD WINAPI BBRFReaderMifareCombine_DefAccessCondition(
    HBBRFREADER hRFReader,
    BBRFReader_Mifare* Mifare_Authenticate,
    BBRFReader_MifareData* pData,
    BBRFReader_SW* Status_SW);
  BBAPI DWORD WINAPI
  BBRFReaderMifareCombine_LoadKey(HBBRFREADER hRFReader,
                                  BBRFReader_Mifare* Mifare_Authenticate,
                                  BBRFReader_MifareData* pData,
                                  BBRFReader_SW* Status_SW);
  ...
  BBAPI DWORD WINAPI BBRFReaderMifarePurse_Create(HBBRFREADER,
                                                  BBRFReader_Mifare*,
                                                  BBRFReader_PurseVal*,
                                                  BBRFReader_SW*);
  BBAPI DWORD WINAPI BBRFReaderMifarePurse_Read(HBBRFREADER,
                                                BBRFReader_Mifare*,
                                                BBRFReader_PurseVal*,
                                                BBRFReader_SW*);
  BBAPI DWORD WINAPI BBRFReaderMifarePurse_Debit(HBBRFREADER,
                                                 BBRFReader_Mifare*,
                                                 BBRFReader_PurseVal*,
                                                 BBRFReader_SW*);
  BBAPI DWORD WINAPI BBRFReaderMifarePurse_Credit(HBBRFREADER,
                                                  BBRFReader_Mifare*,
                                                  BBRFReader_PurseVal*,
                                                  BBRFReader_SW*);

  // ISO14443_B
  BBAPI DWORD WINAPI BBRFReaderISO14443_B_Request_B(HBBRFREADER,
                                                    BBRFReader_AFI,
                                                    BBRFReader_NBSLOT,
                                                    BBRFReader_ATQBResponse*);
  BBAPI DWORD WINAPI
  BBRFReaderISO14443_B_RequestALL_B(HBBRFREADER,
                                    BBRFReader_AFI,
                                    BBRFReader_NBSLOT,
                                    BBRFReader_ATQBResponse*);
  BBAPI DWORD WINAPI BBRFReaderISO14443_B_SlotMarker(HBBRFREADER,
                                                     BBRFReader_SLOTNB,
                                                     BBRFReader_ATQBResponse*);
  BBAPI DWORD WINAPI BBRFReaderISO14443_B_Attrib(HBBRFREADER,
                                                 BBRFReader_PUPI*,
                                                 BBRFReader_Protocol_Info*,
                                                 BBRFReader_CID,
                                                 BBRFReader_BitRate,
                                                 BBRFReader_AttribResponse*);
  BBAPI DWORD WINAPI BBRFReaderISO14443_B_Halt_B(HBBRFREADER, BBRFReader_PUPI*);

  // ISO1443 A&B
  BBAPI DWORD WINAPI BBRFReaderISO14443_AB_DeSelect(HBBRFREADER hRFReader,
                                                    BBRFReader_CID);
  BBAPI DWORD WINAPI BBRFReaderISO14443_AB_Exchange(HBBRFREADER hRFReader,
                                                    BBRFReader_CID,
                                                    BBRFReader_NAD,
                                                    BBRFReader_CardCmd*,
                                                    DWORD dwCardCmdLen,
                                                    BBRFReader_CardResp*,
                                                    DWORD*);
  BBAPI DWORD WINAPI BBRFReaderISO14443_AB_Poll(HBBRFREADER hRFReader,
                                                BBRFReader_CID);
  BBAPI DWORD WINAPI
  BBRFReaderISO14443_AB_GetMode_15_Status(HBBRFREADER hRFReader,
                                          BBRFReader_CardResp*);

  // Transparent Communication Command
  BBAPI DWORD WINAPI BBReadControllerReg(HBBRFREADER,
                                         BBRFReader_RegAddr*,
                                         BBRFReader_RegData*);
  BBAPI DWORD WINAPI BBWriteControllerReg(HBBRFREADER,
                                          BBRFReader_RegAddr*,
                                          BBRFReader_RegData*);
  BBAPI DWORD WINAPI BBTransExchange(HBBRFREADER,
                                     BBRFReader_CardCommand*,
                                     DWORD,
                                     BBRFReader_CardData*,
                                     DWORD*);
  ...
  // ISO15693
  BBAPI DWORD WINAPI BBRFReaderISO15693_ChangeDataCordingMode(
    HBBRFREADER hRFReader,
    BBRFReader_ISO15693_DataCordingMode dwMode);
  BBAPI DWORD WINAPI BBRFReaderISO15693_InventoryRequest(
    HBBRFREADER hRFReader,
    BBRFReader_ISO15693_InventoryRequest* InventoryRequest);
  BBAPI DWORD WINAPI BBRFReaderISO15693_StayQuietRequest(
    HBBRFREADER hRFReader,
    BBRFReader_ISO15693_InventoryRequest* InventoryRequest);
  BBAPI DWORD WINAPI BBRFReaderISO15693_ReadSingleBlockRequest(
    HBBRFREADER hRFReader,
    BBRFReader_ISO15693_OptionCommand* ReadCommand);
  BBAPI DWORD WINAPI BBRFReaderISO15693_WriteSingleBlockRequest(
    HBBRFREADER hRFReader,
    BBRFReader_ISO15693_OptionCommand* WriteCommand);
  BBAPI DWORD WINAPI BBRFReaderISO15693_LockBlockRequest(
    HBBRFREADER hRFReader,
    BBRFReader_ISO15693_OptionCommand* LockCommand);
  BBAPI DWORD WINAPI BBRFReaderISO15693_ReadMultipleBlockRequest(
    HBBRFREADER hRFReader,
    BBRFReader_ISO15693_OptionCommand* ReadCommand);
  BBAPI DWORD WINAPI BBRFReaderISO15693_WriteMultipleBlockRequest(
    HBBRFREADER hRFReader,
    BBRFReader_ISO15693_OptionCommand* WriteCommand);
  BBAPI DWORD WINAPI BBRFReaderISO15693_SelectRequest(
    HBBRFREADER hRFReader,
    BBRFReader_ISO15693_OptionCommand* SelectCommand);
  BBAPI DWORD WINAPI BBRFReaderISO15693_ResetToReadyRequest(
    HBBRFREADER hRFReader,
    BBRFReader_ISO15693_OptionCommand* ResetReadyCommand);
  BBAPI DWORD WINAPI BBRFReaderISO15693_WriteAFIRequest(
    HBBRFREADER hRFReader,
    BBRFReader_ISO15693_OptionCommand* WriteAFICommand);
  BBAPI DWORD WINAPI BBRFReaderISO15693_LockAFIRequest(
    HBBRFREADER hRFReader,
    BBRFReader_ISO15693_OptionCommand* LockAFICommand);
  BBAPI DWORD WINAPI BBRFReaderISO15693_WriteDSFIDRequest(
    HBBRFREADER hRFReader,
    BBRFReader_ISO15693_OptionCommand* WriteDSFIDCommand);
  BBAPI DWORD WINAPI BBRFReaderISO15693_LockDSFIDRequest(
    HBBRFREADER hRFReader,
    BBRFReader_ISO15693_OptionCommand* LockDSFIDCommand);
  BBAPI DWORD WINAPI BBRFReaderISO15693_GetSysInfoRequest(
    HBBRFREADER hRFReader,
    BBRFReader_ISO15693_OptionCommand* GetSysInfoCommand);
  BBAPI DWORD WINAPI BBRFReaderISO15693_MultiBlockSecurityRequest(
    HBBRFREADER hRFReader,
    BBRFReader_ISO15693_OptionCommand* MultiBlockSecurity);

  // UserInput
  BBAPI DWORD WINAPI BBUserInput(HBBICCARD hRFReader,
                                 unsigned char* strCmd,
                                 DWORD CmdLen,
                                 unsigned char* strResp,
                                 DWORD* RespLen);
  ...
  BBAPI char WINAPI BBRFReader_OpenComm(const char* commDevice,
                                        char autoDetect,
  ...
  BBAPI unsigned char* WINAPI
  BBRFReader_GetReaderType(unsigned char* deviceVersion);
  ...
  BBAPI DWORD WINAPI BBRFReader_SendCommand(char* readerCmd,
                                            unsigned char* data);
  BBAPI DWORD WINAPI BBRFReader_SendCommandGetData(char* readerCmd,
                                                   unsigned char* data,
                                                   unsigned char* resultBuf);
  BBAPI DWORD WINAPI
  BBRFReader_SendCommandGetDataTimeout(char* readerCmd,
                                       unsigned char* data,
                                       unsigned char* resultBuf,
                                       long timeout);

  BBAPI DWORD WINAPI BBRFReader_GetData(unsigned char* resultBuf);
  BBAPI DWORD WINAPI BBRFReader_GetDataTimeout(unsigned char* buffer,
                                               DWORD timeout);

  // BBAPI DWORD	WINAPI BBRFReader_DESFire( DESFireCmd command, const
  // unsigned char *data, unsigned char *resultBuf );
  BBAPI DWORD WINAPI BBRFReader_DESFire(char command,
                                        const unsigned char* data,
                                        unsigned char* resultBuf);
  BBAPI DWORD WINAPI BBRFReader_Calypso(byte command,
                                        const unsigned char* data,
                                        unsigned char* resultBuf);

  BBAPI char WINAPI BBRFReader_GetDESFireSAMTimeout();
  BBAPI void WINAPI BBRFReader_SetDESFireSAMTimeout(char cTimeout);
  BBAPI char* WINAPI BBRFReader_DESEncrypt(char cOptions,
                                           char* pbyKey,
                                           char* pbyData,
                                           long lLength,
                                           char* pbyBuffer);
  BBAPI char* WINAPI BBRFReader_DESDecrypt(char cOptions,
                                           char* pbyKey,
                                           char* pbyData,
                                           long lLength,
                                           char* pbyBuffer);
  ...
  BBAPI BOOL WINAPI BBRFReader_ICPowerOn(BOOL bIsSAM,
                                         BYTE* pbyInputParam,
                                         BYTE* pbyResultBuf);
  BBAPI BOOL WINAPI BBRFReader_ICChangePPS(BOOL bIsSAM,
                                           BYTE* pbyInputParam,
                                           BYTE* pbyResultBuf);
  BBAPI BOOL WINAPI BBRFReader_ICChangebaudrate(DWORD dwBaudRate,
                                                BYTE* pbyResultBuf);
  BBAPI BOOL WINAPI BBRFReader_SAMSlotIOMode(BOOL bIsSAM,
                                             BYTE byMode,
                                             BYTE* pbyResultBuf);
  BBAPI BOOL WINAPI BBRFReader_SAMDefType(BYTE bySAMSelectType,
                                          BYTE bySlotSAM,
                                          BYTE* pbyResultBuf);
  BBAPI BOOL WINAPI BBRFReader_ICDefType(BYTE bySAMSelectType,
                                         BYTE* pbyResultBuf);
  ...
  BBAPI BOOL WINAPI BBRFReader_GetSAMDataTimeout(unsigned char* pbyResultBuf,
                                                 DWORD timeout);
  BBAPI BOOL WINAPI BBRFReader_GetICStatus(BOOL bIsSAM, BYTE* pbyResultBuf);
  BBAPI BOOL WINAPI BBRFReader_GetICVersion(char* pGetVersion,
                                            BYTE* pLengthOfData);
  ...
  BBAPI BOOL WINAPI BBKeyMapping_GetKeyData(const int nIndex,
                                            WORD* wKey,
                                            WORD* wType,
                                            TCHAR* strName,
                                            unsigned int buffer_length);
  BBAPI BOOL WINAPI BBKeyMapping_GetAllKeyData(WORD* wKey,
                                               WORD* wType,
                                               TCHAR** strName,
                                               unsigned int buffer_length);
  BBAPI BOOL WINAPI BBKeyMapping_SetKeyData(const int nIndex,
                                            const WORD wKey,
                                            const WORD wType);
  BBAPI BOOL WINAPI BBKeyMapping_SetAllKeyData(const WORD* wKey,
                                               const WORD* wType);
  ...
  BBAPI BOOL WINAPI BBKeyMapping_XMLCreateData(const WORD wCode,
                                               const UINT nType,
                                               const int nKeyname);
