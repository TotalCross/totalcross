...
typedef DWORD (__stdcall* ProcBBPrinterPrint)(HBBPRINTER hPrinter, LPCTSTR lpcszData,
		DWORD dwOptions);
typedef DWORD (__stdcall* ProcBBPrinterPrintBarcode)(HBBPRINTER hPrinter, LPCTSTR lpcszData,
		UCHAR ucHeight, UCHAR ucWidth, UCHAR ucBarcodeSystem, UCHAR ucAlign);
typedef DWORD (__stdcall* ProcBBPrinterPrintBitmap)(HBBPRINTER hPrinter, LPCTSTR lpcszFilename,
		DWORD dwMode);
...
bool PrinterLibOpen(OpenParams params) {
	TC_throwExceptionNamed = (throwExceptionNamedFunc)params->getProcAddress(null,
							 "throwExceptionNamed");
	...
	_BBPrinterSetDensity        = (ProcBBPrinterSetDensity) GetProcAddress(apidll,
								  TEXT("BBPrinterSetDensity"));
	_BBPrinterGetDensity        = (ProcBBPrinterGetDensity) GetProcAddress(apidll,
								  TEXT("BBPrinterGetDensity"));
	_BBPrinterSetLineSpacing    = (ProcBBPrinterSetLineSpacing) GetProcAddress(apidll,
								  TEXT("BBPrinterSetLineSpacing"));
	_BBPrinterGetLineSpacing    = (ProcBBPrinterGetLineSpacing) GetProcAddress(apidll,
								  TEXT("BBPrinterGetLineSpacing"));
	_BBPrinterPrint             = (ProcBBPrinterPrint) GetProcAddress(apidll, TEXT("BBPrinterPrint"));
	_BBPrinterPrintBarcode      = (ProcBBPrinterPrintBarcode) GetProcAddress(apidll,
								  TEXT("BBPrinterPrintBarcode"));
	_BBPrinterPrintBitmap       = (ProcBBPrinterPrintBitmap) GetProcAddress(apidll,
								  TEXT("BBPrinterPrintBitmap"));
	_BBPrinterWaitUntilPrintEnd = (ProcBBPrinterWaitUntilPrintEnd) GetProcAddress(apidll,
								  TEXT("BBPrinterWaitUntilPrintEnd"));
...
#endif
//////////////////////////////////////////////////////////////////////////
SCAN_API void pP_setDensity_i(NMParams
							  p) { // pidion/Printer native public static void setDensity(int value) throws PrinterException;
	if (!openPrinter()) {
		return;
	}
...
//////////////////////////////////////////////////////////////////////////
SCAN_API void pP_getDensity(NMParams
							p) { // pidion/Printer native public static int getDensity() throws PrinterException;
	UCHAR u;
	if (!openPrinter()) {
		return;
	}
...
//////////////////////////////////////////////////////////////////////////
SCAN_API void pP_setLineSpacing_i(NMParams
								  p) { // pidion/Printer native public static void setLineSpacing(int value) throws PrinterException;
	if (!openPrinter()) {
		return;
	}
...
//////////////////////////////////////////////////////////////////////////
SCAN_API void pP_getLineSpacing(NMParams
								p) { // pidion/Printer native public static int getLineSpacing() throws PrinterException;
	UCHAR u;
	if (!openPrinter()) {
		return;
	}
...
SCAN_API void pP_print_si(NMParams
						  p) { // pidion/Printer native public static void print(String text, int options) throws PrinterException;
...
//////////////////////////////////////////////////////////////////////////
SCAN_API void pP_printBarcode_siiii(NMParams
									p) { // pidion/Printer native public static void printBarcode(String data, int width, int height, int type, int align) throws PrinterException;
	TCObject text = p->obj[0];
	JCharP start = String_charsStart(text);
	int32 len = String_charsLen(text);
	TCHARP temp = buff;
	...
	check(p->currentContext, _BBPrinterPrintBarcode(handle, temp, p->i32[1], p->i32[0], p->i32[2],
...
//////////////////////////////////////////////////////////////////////////
SCAN_API void pP_printBitmap_si(NMParams
								p) { // pidion/Printer native public static void printBitmap(String filename, int mode) throws PrinterException;
	if (!openPrinter()) {
		return;
	}
...
//////////////////////////////////////////////////////////////////////////
SCAN_API void pP_flush(NMParams
					   p) { // pidion/Printer native public static void flush() throws PrinterException;
	if (!openPrinter()) {
		return;
	}
