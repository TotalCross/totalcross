...
typedef DWORD(__stdcall* ProcBBCameraPreviewStart)(HBBCAMERA,
                                                   BBCameraParameter*);
...
typedef DWORD(__stdcall* ProcBBCameraPreviewZoom)(HBBCAMERA,
                                                  BBCameraParameter*);
...
CameraLibOpen(OpenParams params)
{
  ...
  _BBCameraOpen =
    (ProcBBCameraOpen)GetProcAddress(apidll, TEXT("BBCameraOpen"));
  _BBCameraClose =
    (ProcBBCameraClose)GetProcAddress(apidll, TEXT("BBCameraClose"));
  _BBCameraPreviewStart = (ProcBBCameraPreviewStart)GetProcAddress(
    apidll, TEXT("BBCameraPreviewStart"));
  _BBCameraPreviewStop = (ProcBBCameraPreviewStop)GetProcAddress(
    apidll, TEXT("BBCameraPreviewStop"));
  _BBCameraCapture =
    (ProcBBCameraCapture)GetProcAddress(apidll, TEXT("BBCameraCapture"));
  _BBCameraPreviewZoom = (ProcBBCameraPreviewZoom)GetProcAddress(
    apidll, TEXT("BBCameraPreviewZoom"));
...
extern "C"
{
  ...
  //////////////////////////////////////////////////////////////////////////
  SCAN_API void pC_click(NMParams p)
  { // pidion/Camera native public boolean click();
  ...
  //////////////////////////////////////////////////////////////////////////
  SCAN_API void pC_setPreview_b(NMParams p)
  { // pidion/Camera native public void setPreview(boolean on);
    TCObject obj = p->obj[0];
    int32 on = p->i32[0];
    DWORD ret;
    if (on && handle == 0) {
  ...
  //////////////////////////////////////////////////////////////////////////
  SCAN_API void pC_setZoom_i(NMParams p)
  { // pidion/Camera native public void setZoom(int value);
    if (handle) {
