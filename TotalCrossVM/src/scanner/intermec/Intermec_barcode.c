...
typedef HRESULT(__stdcall* procITCSCAN_CancelRead)(INT32 pHandle, BOOL FlushBufferedData,
		DWORD* pdwTotalDiscardedMessages, DWORD* pdwTotalDiscardedBytes);
typedef void (__stdcall* procITCSCAN_GetErrorString)(HRESULT errorCode, TCHAR* pErrorString);
typedef LONG(__stdcall* procITCSCAN_GetDefaultDevice)(LPTSTR lpDeviceNameBuffer,
		DWORD* pBufferLength);
...
SCAN_API int32 LibOpen(OpenParams params) {
	...
	if ((decoderDll = LoadLibrary(TEXT("itcscan.dll"))) != null
		|| (decoderDll = LoadLibrary(TEXT("\\TotalCross\\itcscan.dll"))) != null) {
		...
		SCAN_CancelRead      = (procITCSCAN_CancelRead) GetProcAddress(decoderDll,
							   TEXT("ITCSCAN_CancelRead"));
		SCAN_GetErrorString  = (procITCSCAN_GetErrorString) GetProcAddress(decoderDll,
							   TEXT("ITCSCAN_GetErrorString"));
		SCAN_GetDefaultDevice = (procITCSCAN_GetDefaultDevice) GetProcAddress(decoderDll,
								TEXT("ITCSCAN_GetDefaultDevice"));
		SCAN_Enable          = (procITCSCAN_SetScannerEnable) GetProcAddress(decoderDll,
							   TEXT("ITCSCAN_SetScannerEnable"));
	}
	return SCAN_Open && SCAN_Close && SCAN_SyncRead && SCAN_CancelRead && SCAN_GetErrorString
		   && SCAN_GetDefaultDevice && SCAN_Enable;
}
...
//////////////////////////////////////////////////////////////////////////
SCAN_API void tidsS_scannerActivate(NMParams
									p) { // totalcross/io/device/scanner/Scanner native public static boolean scannerActivate();
	Err err;
	if ((hThread = CreateThread(null, 0, (LPTHREAD_START_ROUTINE) ScanMonitorThread, &g_handle, 0,
								null)) == null) {
...
//////////////////////////////////////////////////////////////////////////
SCAN_API void tidsS_setBarcodeParam_ib(NMParams
									   p) { // totalcross/io/device/scanner/Scanner native public static boolean setBarcodeParam(int barcodeType, boolean enable);
	p->retI = false;  // throw exception on error?
}
//////////////////////////////////////////////////////////////////////////
SCAN_API void tidsS_setParam_iii(NMParams
								 p) { // totalcross/io/device/scanner/Scanner native public static boolean setParam(int type, int barcodeType, int value);
	p->retI = false;
}
//////////////////////////////////////////////////////////////////////////
SCAN_API void tidsS_setBarcodeLength_iiii(NMParams
		p) { // totalcross/io/device/scanner/Scanner native public static boolean setBarcodeLength(int barcodeType, int lengthType, int min, int max);
	p->retI = false;
}
//////////////////////////////////////////////////////////////////////////
SCAN_API void tidsS_commitBarcodeParams(NMParams
										p) { // totalcross/io/device/scanner/Scanner native public static boolean commitBarcodeParams();
	p->retI = true;
}
//////////////////////////////////////////////////////////////////////////
SCAN_API void tidsS_getData(NMParams
							p) { // totalcross/io/device/scanner/Scanner native public static String getData();
...
//////////////////////////////////////////////////////////////////////////
SCAN_API void tidsS_getScanManagerVersion(NMParams
		p) { // totalcross/io/device/scanner/Scanner native public static String getScanManagerVersion();
	if ((p->retO = createStringObjectFromCharP(p->currentContext, "1.0", 3)) != null) {
		setObjectLock(p->retO, UNLOCKED);
	}
}
//////////////////////////////////////////////////////////////////////////
SCAN_API void tidsS_getScanPortDriverVersion(NMParams
		p) { // totalcross/io/device/scanner/Scanner native public static String getScanPortDriverVersion();
	TCHAR name[128];
...
//////////////////////////////////////////////////////////////////////////
SCAN_API void tidsS_deactivate(NMParams
							   p) { // totalcross/io/device/scanner/Scanner native public static boolean deactivate();
...
//////////////////////////////////////////////////////////////////////////
SCAN_API void tidsS_setParam_ss(NMParams
								p) { // totalcross/io/device/scanner/Scanner native public static void setParam(String what, String value);
}
...
//////////////////////////////////////////////////////////////////////////
TC_API void tidsS_scannerActivate(NMParams
								  p) { // totalcross/io/device/scanner/Scanner native public static boolean scannerActivate();
	p->retI = callBoolMethodWithoutParams("scannerActivate");
}
//////////////////////////////////////////////////////////////////////////
TC_API void tidsS_setBarcodeParam_ib(NMParams
									 p) { // totalcross/io/device/scanner/Scanner native public static boolean setBarcodeParam(int barcodeType, boolean enable);
	JNIEnv* env = getJNIEnv();
	jclass applicationClass = androidFindClass(env, "totalcross/android/Scanner4A");
	p->retI = (*env)->CallStaticBooleanMethod(env, applicationClass, (*env)->GetStaticMethodID(env,
			  applicationClass, "setBarcodeParam", "(IZ)Z"),
			  (jint)p->i32[0], (jboolean)p->i32[1]);
}
//////////////////////////////////////////////////////////////////////////
TC_API void tidsS_setParam_iii(NMParams
							   p) { // totalcross/io/device/scanner/Scanner native public static boolean setParam(int type, int barcodeType, int value);
	p->retI = false;
}
//////////////////////////////////////////////////////////////////////////
TC_API void tidsS_setBarcodeLength_iiii(NMParams
										p) { // totalcross/io/device/scanner/Scanner native public static boolean setBarcodeLength(int barcodeType, int lengthType, int min, int max);
	p->retI = false;
}
//////////////////////////////////////////////////////////////////////////
TC_API void tidsS_commitBarcodeParams(NMParams
									  p) { // totalcross/io/device/scanner/Scanner native public static boolean commitBarcodeParams();
	p->retI = true;
}
//////////////////////////////////////////////////////////////////////////
TC_API void tidsS_getData(NMParams
						  p) { // totalcross/io/device/scanner/Scanner native public static String getData();
	JNIEnv* env = getJNIEnv();
	jclass applicationClass = androidFindClass(env, "totalcross/android/Scanner4A");
...
//////////////////////////////////////////////////////////////////////////
TC_API void tidsS_getScanManagerVersion(NMParams
										p) { // totalcross/io/device/scanner/Scanner native public static String getScanManagerVersion();
...
//////////////////////////////////////////////////////////////////////////
TC_API void tidsS_getScanPortDriverVersion(NMParams
		p) { // totalcross/io/device/scanner/Scanner native public static String getScanPortDriverVersion();
...
//////////////////////////////////////////////////////////////////////////
TC_API void tidsS_deactivate(NMParams
							 p) { // totalcross/io/device/scanner/Scanner native public static boolean deactivate();
...
bool callBoolMethodWithoutParams(CharP name) {
	JNIEnv* env = getJNIEnv();
	jclass applicationClass = androidFindClass(env, "totalcross/android/Scanner4A");
	return (*env)->CallStaticBooleanMethod(env, applicationClass, (*env)->GetStaticMethodID(env,
										   applicationClass, name, "()Z"));
}
//////////////////////////////////////////////////////////////////////////
TC_API void tidsS_setParam_ss(NMParams
							  p) { // totalcross/io/device/scanner/Scanner native public static void setParam(String what, String value);
}
#endif
