...
typedef SCAN_RESULT(__stdcall* ScanRequestDataEventsProc)(HANDLE hScanner, HWND hWnd,
		UINT wmScannerData);
...
SCAN_API int32 LibOpen(OpenParams params) {
	...
	ScanInitP               = (ScanInitProc)              GetProcAddress(socketScanDll,
							  TEXT("ScanInit"));
	ScanOpenDeviceP         = (ScanOpenDeviceProc)        GetProcAddress(socketScanDll,
							  TEXT("ScanOpenDevice"));
	ScanCloseDeviceP        = (ScanCloseDeviceProc)       GetProcAddress(socketScanDll,
							  TEXT("ScanCloseDevice"));
	ScanGetDevInfoP         = (ScanGetDevInfoProc)        GetProcAddress(socketScanDll,
							  TEXT("ScanGetDevInfo"));
	ScanRequestDataEventsP  = (ScanRequestDataEventsProc) GetProcAddress(socketScanDll,
							  TEXT("ScanRequestDataEvents"));
	ScanTriggerP            = (ScanTriggerProc)           GetProcAddress(socketScanDll,
							  TEXT("ScanTrigger"));
	ScanGetDataP            = (ScanGetDataProc)           GetProcAddress(socketScanDll,
							  TEXT("ScanGetData"));
	ScanDeinitP             = (ScanDeinitProc)            GetProcAddress(socketScanDll,
							  TEXT("ScanDeinit"));
