...
SCAN_API int32 LibOpen(OpenParams params) {
	...
	ZBCRGetLastNotifyEventP = (ZBCRGetLastNotifyEventProc) GetProcAddress(bematechScanDll,
							  TEXT("ZBCRGetLastNotifyEvent"));
	ZBCRSetPowerP = (ZBCRSetPowerProc) GetProcAddress(bematechScanDll, TEXT("ZBCRSetPower"));
	ZBCRGetLastBarcodeP = (ZBCRGetLastBarcodeProc) GetProcAddress(bematechScanDll,
						  TEXT("ZBCRGetLastBarcode"));
