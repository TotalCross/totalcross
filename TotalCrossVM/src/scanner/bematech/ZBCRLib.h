...
ZBCRLIB BOOL
ZBCRGetPowerState(PBOOL lpPowerState);

ZBCRLIB BOOL
ZBCRSetPower(BOOL dwState);
...
ZBCRLIB BOOL
ZBCRGetLastNotifyEvent(PDWORD lpNotifyEvent);

ZBCRLIB BOOL
ZBCRGetLastBarcode(LPTSTR lpszBarcode);

ZBCRLIB BOOL
ZBCRGetOutputMode(PBYTE lpOutputMode);

ZBCRLIB BOOL
ZBCRSetOutputMode(BYTE dwMode);

ZBCRLIB BOOL
ZBCRGetTerminalChar(PBYTE lpTermChar);

ZBCRLIB BOOL
ZBCRSetTerminalChar(BYTE dwTermChar);

ZBCRLIB BOOL
ZBCRGetPrefix(LPTSTR lpszPrefix);

ZBCRLIB BOOL
ZBCRSetPrefix(LPCTSTR lpszPrefix);

ZBCRLIB BOOL
ZBCRGetSuffix(LPTSTR lpszSuffix);

ZBCRLIB BOOL
ZBCRSetSuffix(LPCTSTR lpszSuffix);
