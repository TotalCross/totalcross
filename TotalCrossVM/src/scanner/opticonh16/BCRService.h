...
#define BCR_FWUPD_CHK_FILE                                                     \
  (WM_USER + 101) //	Be checking	the	file of	firmware
#define BCR_FWUPD_DWNLD_2ND_LDR                                                \
  (WM_USER + 102)                              //	Be downloading the 2nd loader
#define BCR_FWUPD_ERASE_MEMORY (WM_USER + 103) //	Be erasing memory
#define BCR_FWUPD_DWNLD_MAIN_PROG                                              \
  (WM_USER + 104) //	Be downloading the main	program
#define BCR_FWUPD_PROGRESS                                                     \
  (WM_USER + 105) //	Represents the downloading progress	in percentage
#define BCR_FWUPD_RESULT                                                       \
  (WM_USER +                                                                   \
   106) //	Indicates the downloading process is stop in success or	fail.
...
#define FWUPD_UNKNOWN_MODULE_TYPE                                              \
  9 // The barcode reader module type is unknown.
...
//
// Function codes 0-2047 are reserved for Microsoft; codes 2048-4095 are
// reserved for OEMs and IHVs.
//
