...
internal:
	...
	bool loadTexture(Context currentContext, TCObject img, int32* textureId, Pixel* pixels, int32 width,
					 int32 height, bool onlyAlpha);
	void drawTexture(int32* textureId, int32 x, int32 y, int32 w, int32 h, int32 dstX, int32 dstY,
					 int32 dstW, int32 dstH, int32 imgW, int32 imgH, PixelConv* color, int32 alphaMask);
	void drawLines(Context currentContext, TCObject g, int32* x, int32* y, int32 n, int32 tx, int32 ty,
				   int color, bool fill);
	...
	void fillShadedRect(TCObject g, int32 x, int32 y, int32 w, int32 h, PixelConv c1, PixelConv c2,
						bool horiz);
...
private:
	...
	ID3D11Buffer* pBufferRect, *pBufferPixels, *pBufferLines, *pBufferColor, *texVertexBuffer,
				  *pBufferRectLC;
