...
TC_API TValue executeMethod(Context context, Method method, ...) {
	...
	*regO = null;
	if (method->oCount > 1) {
		for (regO2 = regO+method->oCount; regO2 > regO;) *--regO2 = 0;            // erase the region that will be used for objects so the gc don't confuse an object previously used with the objects in our method's frame. All methods have at least one regO
	}
#endif
...
mainLoop:
	...
	FIRST_OP
	{
	 ...
	 #endif
		OPCODE(MOV_regI_regI)       regI[code->reg_reg.reg0] = regI[code->reg_reg.reg1]; NEXT_OP OPCODE(MOV_regI_arc)        ARRAYCHECK(code->reg)// all array checks must fall throught!
		OPCODE(MOV_regI_aru)        regI[code->reg_ar.reg] = ((int32*) ARRAYOBJ_START(regO[code->reg_ar.base]))[regI[code->reg_ar.idx]]; NEXT_OP OPCODE(MOV_regI_sym)        regI[code->reg_sym.reg] = cp->i32[code->reg_sym.sym]; NEXT_OP OPCODE(MOV_regI_s18)        regI[code->s18_reg.reg] = (int32) code->s18_reg.s18; NEXT_OP OPCODE(MOV_regI_arlen)      if (regO[code->reg_ar.base] == null) {
			exceptionMsg = "On array's length object"; goto throwNullPointerException;
		}
		regI[code->reg_ar.reg] = ARRAYOBJ_LEN(regO[code->reg_ar.base]); NEXT_OP OPCODE(MOV_regO_regO)       regO[code->reg_reg.reg0] = regO[code->reg_reg.reg1]; NEXT_OP OPCODE(MOV_regO_null)       regO[code->reg.reg] = 0; NEXT_OP OPCODE(MOV_regO_arc)        ARRAYCHECK(code->reg)
		OPCODE(MOV_regO_aru)        regO[code->reg_ar.reg] = ((TCObject*) ARRAYOBJ_START(regO[code->reg_ar.base]))[regI[code->reg_ar.idx]]; NEXT_OP OPCODE(MOV_regO_sym)        regO[code->reg_sym.reg] = cp->str[code->reg_sym.sym]; NEXT_OP OPCODE(MOV_reg64_reg64)     reg64[code->reg_reg.reg0] = reg64[code->reg_reg.reg1]; NEXT_OP OPCODE(MOV_reg64_arc)       ARRAYCHECK(code->reg)
		OPCODE(MOV_reg64_aru)       REGL(reg64)[code->reg_ar.reg] = ((int64*) ARRAYOBJ_START(regO[code->reg_ar.base]))[regI[code->reg_ar.idx]]; NEXT_OP OPCODE(MOV_regD_sym)        REGD(reg64)[code->reg_sym.reg] = cp->dbl[code->reg_sym.sym]; NEXT_OP OPCODE(MOV_regL_sym)        REGL(reg64)[code->reg_sym.reg] = cp->i64[code->reg_sym.sym]; NEXT_OP OPCODE(MOV_regD_s18)        REGD(reg64)[code->s18_reg.reg] = (int32) code->s18_reg.s18; NEXT_OP OPCODE(MOV_regL_s18)        REGL(reg64)[code->s18_reg.reg] = (int64) code->s18_reg.s18; NEXT_OP OPCODE(MOV_arc_regI)        ARRAYCHECK(code->reg)
		OPCODE(MOV_aru_regI)        ((int32 *) ARRAYOBJ_START(regO[code->reg_ar.base]))[regI[code->reg_ar.idx]] = regI[code->reg_ar.reg]; NEXT_OP OPCODE(MOV_arc_regO)        ARRAYCHECK(code->reg)
		OPCODE(MOV_aru_regO)        ((TCObject*) ARRAYOBJ_START(regO[code->reg_ar.base]))[regI[code->reg_ar.idx]] = regO[code->reg_ar.reg]; NEXT_OP OPCODE(MOV_arc_reg64)       ARRAYCHECK(code->reg)
		OPCODE(MOV_aru_reg64)       ((Value64) ARRAYOBJ_START(regO[code->reg_ar.base]))[regI[code->reg_ar.idx]] = reg64[code->reg_ar.reg]; NEXT_OP OPCODE(MOV_arc_regIb)       ARRAYCHECK(code->reg)
		OPCODE(MOV_aru_regIb)       ((int8  *) ARRAYOBJ_START(regO[code->reg_ar.base]))[regI[code->reg_ar.idx]] = (int8) regI[code->reg_ar.reg]; NEXT_OP OPCODE(MOV_arc_reg16)       ARRAYCHECK(code->reg)
		OPCODE(MOV_aru_reg16)       ((uint16*) ARRAYOBJ_START(regO[code->reg_ar.base]))[regI[code->reg_ar.idx]] = (uint16) regI[code->reg_ar.reg]; NEXT_OP OPCODE(MOV_regIb_arc)       ARRAYCHECK(code->reg)
		OPCODE(MOV_regIb_aru)       regI[code->reg_ar.reg] = ((int8  *) ARRAYOBJ_START(regO[code->reg_ar.base]))[regI[code->reg_ar.idx]]; NEXT_OP OPCODE(MOV_reg16_arc)       ARRAYCHECK(code->reg)
		OPCODE(MOV_reg16_aru)       regI[code->reg_ar.reg] = ((uint16*) ARRAYOBJ_START(regO[code->reg_ar.base]))[regI[code->reg_ar.idx]]; NEXT_OP OPCODE(MOV_field_regI)      GET_INSTANCE_FIELD(RegI) FIELD_I32(o,               retv) = regI[code->field_reg.reg]; NEXT_OP OPCODE(MOV_field_regO)      GET_INSTANCE_FIELD(RegO) FIELD_OBJ(o, OBJ_CLASS(o), retv) = regO[code->field_reg.reg]; NEXT_OP OPCODE(MOV_field_reg64)     GET_INSTANCE_FIELD(RegD) FIELD_DBL(o, OBJ_CLASS(o), retv) = REGD(reg64)[code->field_reg.reg]; NEXT_OP OPCODE(MOV_regI_field)      GET_INSTANCE_FIELD(RegI) regI[code->field_reg.reg] = FIELD_I32(o,               retv); NEXT_OP OPCODE(MOV_regO_field)      GET_INSTANCE_FIELD(RegO) regO[code->field_reg.reg] = FIELD_OBJ(o, OBJ_CLASS(o), retv); NEXT_OP OPCODE(MOV_reg64_field)     GET_INSTANCE_FIELD(RegD) REGD(reg64)[code->field_reg.reg] = FIELD_DBL(o, OBJ_CLASS(o), retv); NEXT_OP OPCODE(MOV_static_regI)     GET_STATIC_FIELD(RegI) ((int32*) sf)[0] = regI[code->static_reg.reg]; NEXT_OP OPCODE(MOV_static_regO)     GET_STATIC_FIELD(RegO) ((TCObject*) sf)[0] = regO[code->static_reg.reg]; NEXT_OP OPCODE(MOV_static_reg64)    GET_STATIC_FIELD(RegD) ((double*) sf)[0] = REGD(reg64)[code->static_reg.reg]; NEXT_OP OPCODE(MOV_regI_static)     GET_STATIC_FIELD(RegI) regI[code->static_reg.reg] = ((int32*) sf)[0]; NEXT_OP OPCODE(MOV_regO_static)     GET_STATIC_FIELD(RegO) regO[code->static_reg.reg] = ((TCObject*) sf)[0]; NEXT_OP OPCODE(MOV_reg64_static)    GET_STATIC_FIELD(RegD) REGD(reg64)[code->static_reg.reg] = ((double*) sf)[0]; NEXT_OP OPCODE(ADD_regI_regI_regI)  regI[code->reg_reg_reg.reg0] = regI[code->reg_reg_reg.reg1] + regI[code->reg_reg_reg.reg2]; NEXT_OP OPCODE(ADD_regI_s12_regI)   regI[code->reg_reg_s12.reg0] = regI[code->reg_reg_s12.reg1] + (int32) code->reg_reg_s12.s12; NEXT_OP OPCODE(ADD_regD_regD_regD)  REGD(reg64)[code->reg_reg_reg.reg0] = REGD(reg64)[code->reg_reg_reg.reg1] + REGD(reg64)[code->reg_reg_reg.reg2]; NEXT_OP OPCODE(ADD_regL_regL_regL)  REGL(reg64)[code->reg_reg_reg.reg0] = REGL(reg64)[code->reg_reg_reg.reg1] + REGL(reg64)[code->reg_reg_reg.reg2]; NEXT_OP OPCODE(ADD_regI_arc_s6)     ARRAYCHECK(code->reg_s6)
		OPCODE(ADD_regI_aru_s6)     regI[code->reg_s6_ar.reg] = ((int32*) ARRAYOBJ_START(regO[code->reg_s6_ar.base]))[regI[code->reg_s6_ar.idx]] + (int32) code->reg_s6_ar.s6; NEXT_OP OPCODE(ADD_regI_regI_sym)   regI[code->reg_reg_sym.reg0] = regI[code->reg_reg_sym.reg1] + cp->i32[code->reg_reg_sym.sym]; NEXT_OP OPCODE(ADD_aru_regI_s6)     ((int32*) ARRAYOBJ_START(regO[code->reg_s6_ar.base]))[regI[code->reg_s6_ar.idx]] = regI[code->reg_s6_ar.reg] + (int32) code->reg_s6_ar.s6; NEXT_OP OPCODE(SUB_regI_regI_regI)  regI[code->reg_reg_reg.reg0] = regI[code->reg_reg_reg.reg1] - regI[code->reg_reg_reg.reg2]; NEXT_OP OPCODE(SUB_regD_regD_regD)  REGD(reg64)[code->reg_reg_reg.reg0] = REGD(reg64)[code->reg_reg_reg.reg1] - REGD(reg64)[code->reg_reg_reg.reg2]; NEXT_OP OPCODE(SUB_regL_regL_regL)  REGL(reg64)[code->reg_reg_reg.reg0] = REGL(reg64)[code->reg_reg_reg.reg1] - REGL(reg64)[code->reg_reg_reg.reg2]; NEXT_OP OPCODE(SUB_regI_s12_regI)   regI[code->reg_reg_s12.reg0] = (int32) code->reg_reg_s12.s12 - regI[code->reg_reg_s12.reg1]; NEXT_OP OPCODE(MUL_regI_regI_regI)  regI[code->reg_reg_reg.reg0] = regI[code->reg_reg_reg.reg1] * regI[code->reg_reg_reg.reg2]; NEXT_OP OPCODE(MUL_regD_regD_regD)  REGD(reg64)[code->reg_reg_reg.reg0] = REGD(reg64)[code->reg_reg_reg.reg1] * REGD(reg64)[code->reg_reg_reg.reg2]; NEXT_OP OPCODE(MUL_regL_regL_regL)  REGL(reg64)[code->reg_reg_reg.reg0] = REGL(reg64)[code->reg_reg_reg.reg1] * REGL(reg64)[code->reg_reg_reg.reg2]; NEXT_OP OPCODE(MUL_regI_regI_s12)   regI[code->reg_reg_s12.reg0] = regI[code->reg_reg_s12.reg1] * (int32) code->reg_reg_s12.s12; NEXT_OP OPCODE(DIV_regI_regI_regI)  if (regI[code->reg_reg_reg.reg2] != 0) {
			regI[code->reg_reg_reg.reg0] = regI[code->reg_reg_reg.reg1] / regI[code->reg_reg_reg.reg2];
		} else {
			goto throwArithmeticException;
		} NEXT_OP OPCODE(DIV_regD_regD_regD)  if (REGD(reg64)[code->reg_reg_reg.reg2] != 0) {
			REGD(reg64)[code->reg_reg_reg.reg0] = REGD(reg64)[code->reg_reg_reg.reg1] / REGD(reg64)[code->reg_reg_reg.reg2];
		} else {
			goto throwArithmeticException;
		} NEXT_OP OPCODE(DIV_regL_regL_regL)  if (REGL(reg64)[code->reg_reg_reg.reg2] != 0) {
			REGL(reg64)[code->reg_reg_reg.reg0] = REGL(reg64)[code->reg_reg_reg.reg1] / REGL(reg64)[code->reg_reg_reg.reg2];
		} else {
			goto throwArithmeticException;
		} NEXT_OP OPCODE(DIV_regI_regI_s12)   if (code->reg_reg_s12.s12        != 0) {
			regI[code->reg_reg_s12.reg0] = regI[code->reg_reg_s12.reg1] / (int32) code->reg_reg_s12.s12;
		} else {
			goto throwArithmeticException;
		} NEXT_OP OPCODE(MOD_regI_regI_regI)  if (regI[code->reg_reg_reg.reg2] != 0) {
			regI[code->reg_reg_reg.reg0] = regI[code->reg_reg_reg.reg1] % regI[code->reg_reg_reg.reg2];
		} else {
			goto throwArithmeticException;
		} NEXT_OP OPCODE(MOD_regD_regD_regD)  if (REGD(reg64)[code->reg_reg_reg.reg2] != 0) {
			REGD(reg64)[code->reg_reg_reg.reg0] = dmod(REGD(reg64)[code->reg_reg_reg.reg1], REGD(reg64)[code->reg_reg_reg.reg2]);
		} else {
			goto throwArithmeticException;
		} NEXT_OP OPCODE(MOD_regL_regL_regL)  if (REGL(reg64)[code->reg_reg_reg.reg2] != 0) {
			REGL(reg64)[code->reg_reg_reg.reg0] = REGL(reg64)[code->reg_reg_reg.reg1] % REGL(reg64)[code->reg_reg_reg.reg2];
		} else {
			goto throwArithmeticException;
		} NEXT_OP OPCODE(MOD_regI_regI_s12)   if (code->reg_reg_s12.s12        != 0) {
			regI[code->reg_reg_s12.reg0] = regI[code->reg_reg_s12.reg1] % (int32) code->reg_reg_s12.s12;
		} else {
			goto throwArithmeticException;
		} NEXT_OP OPCODE(SHL_regI_regI_regI)  regI[code->reg_reg_reg.reg0] = regI[code->reg_reg_reg.reg1] << (regI[code->reg_reg_reg.reg2] & 0x1F); NEXT_OP OPCODE(SHL_regL_regL_regL)  REGL(reg64)[code->reg_reg_reg.reg0] = REGL(reg64)[code->reg_reg_reg.reg1] << (REGL(reg64)[code->reg_reg_reg.reg2] & 0x3F); NEXT_OP OPCODE(SHL_regI_regI_s12)   regI[code->reg_reg_s12.reg0] = regI[code->reg_reg_s12.reg1] << (int32) code->reg_reg_s12.s12; NEXT_OP OPCODE(SHR_regI_regI_regI)  regI[code->reg_reg_reg.reg0] = regI[code->reg_reg_reg.reg1] >> (regI[code->reg_reg_reg.reg2] & 0x1F); NEXT_OP OPCODE(SHR_regL_regL_regL)  REGL(reg64)[code->reg_reg_reg.reg0] = REGL(reg64)[code->reg_reg_reg.reg1] >> (REGL(reg64)[code->reg_reg_reg.reg2] & 0x3F); NEXT_OP OPCODE(SHR_regI_regI_s12)   regI[code->reg_reg_s12.reg0] = regI[code->reg_reg_s12.reg1] >> (int32) code->reg_reg_s12.s12; NEXT_OP OPCODE(USHR_regI_regI_regI) regI[code->reg_reg_reg.reg0] = (uint32) regI[code->reg_reg_reg.reg1] >> (regI[code->reg_reg_reg.reg2] & 0x1F); NEXT_OP OPCODE(USHR_regL_regL_regL) REGL(reg64)[code->reg_reg_reg.reg0] = (uint64) REGL(reg64)[code->reg_reg_reg.reg1] >> (REGL(reg64)[code->reg_reg_reg.reg2] & 0x3F); NEXT_OP OPCODE(USHR_regI_regI_s12)  regI[code->reg_reg_s12.reg0] = (uint32) regI[code->reg_reg_s12.reg1] >> (int32) code->reg_reg_s12.s12; NEXT_OP OPCODE(AND_regI_regI_regI)  regI[code->reg_reg_reg.reg0] = regI[code->reg_reg_reg.reg1] & regI[code->reg_reg_reg.reg2]; NEXT_OP OPCODE(AND_regL_regL_regL)  REGL(reg64)[code->reg_reg_reg.reg0] = REGL(reg64)[code->reg_reg_reg.reg1] & REGL(reg64)[code->reg_reg_reg.reg2]; NEXT_OP OPCODE(AND_regI_regI_s12)   regI[code->reg_reg_s12.reg0] = regI[code->reg_reg_s12.reg1] & (int32) code->reg_reg_s12.s12; NEXT_OP OPCODE(AND_regI_aru_s6)     regI[code->reg_s6_ar.reg] = ((int32*) ARRAYOBJ_START(regO[code->reg_s6_ar.base]))[regI[code->reg_s6_ar.idx]] & (int32) code->reg_s6_ar.s6; NEXT_OP OPCODE(OR_regI_regI_regI)   regI[code->reg_reg_reg.reg0] = regI[code->reg_reg_reg.reg1] | regI[code->reg_reg_reg.reg2]; NEXT_OP OPCODE(OR_regL_regL_regL)   REGL(reg64)[code->reg_reg_reg.reg0] = REGL(reg64)[code->reg_reg_reg.reg1] | REGL(reg64)[code->reg_reg_reg.reg2]; NEXT_OP OPCODE(OR_regI_regI_s12)    regI[code->reg_reg_s12.reg0] = regI[code->reg_reg_s12.reg1] | (int32) code->reg_reg_s12.s12; NEXT_OP OPCODE(XOR_regI_regI_regI)  regI[code->reg_reg_reg.reg0] = regI[code->reg_reg_reg.reg1] ^ regI[code->reg_reg_reg.reg2]; NEXT_OP OPCODE(XOR_regL_regL_regL)  REGL(reg64)[code->reg_reg_reg.reg0] = REGL(reg64)[code->reg_reg_reg.reg1] ^ REGL(reg64)[code->reg_reg_reg.reg2]; NEXT_OP OPCODE(XOR_regI_regI_s12)   regI[code->reg_reg_s12.reg0] = regI[code->reg_reg_s12.reg1] ^ (int32) code->reg_reg_s12.s12; NEXT_OP OPCODE(JEQ_regO_regO)       if (regO[code->reg_reg_s12.reg0]        == regO[code->reg_reg_s12.reg1]) {
			code += (int32) code->reg_reg_s12.s12; NEXT_OP0
		}
		NEXT_OP OPCODE(JEQ_regO_null)       if (regO[code->reg_reg_s12.reg0]        == 0) {
			code += (int32) code->reg_reg_s12.s12; NEXT_OP0
		}
		NEXT_OP OPCODE(JEQ_regI_regI)       if (regI[code->reg_reg_s12.reg0]        == regI[code->reg_reg_s12.reg1]) {
			code += (int32) code->reg_reg_s12.s12; NEXT_OP0
		}
		NEXT_OP OPCODE(JEQ_regL_regL)       if (REGL(reg64)[code->reg_reg_s12.reg0] == REGL(reg64)[code->reg_reg_s12.reg1]) {
			code += (int32) code->reg_reg_s12.s12; NEXT_OP0
		}
		NEXT_OP OPCODE(JEQ_regD_regD)       if (REGD(reg64)[code->reg_reg_s12.reg0] == REGD(reg64)[code->reg_reg_s12.reg1]) {
			code += (int32) code->reg_reg_s12.s12; NEXT_OP0
		}
		NEXT_OP OPCODE(JEQ_regI_s6)         if (regI[code->reg_s6_desloc.reg]       == (int32)code->reg_s6_desloc.s6) {
			code += (int32) code->reg_s6_desloc.desloc; NEXT_OP0
		}
		NEXT_OP OPCODE(JEQ_regI_sym)        if (regI[code->reg_sym_sdesloc.reg]     == cp->i32[code->reg_sym_sdesloc.sym]) {
			code += (int32) code->reg_sym_sdesloc.desloc; NEXT_OP0
		}
		NEXT_OP OPCODE(JNE_regO_regO)       if (regO[code->reg_reg_s12.reg0]        != regO[code->reg_reg_s12.reg1]) {
			code += (int32) code->reg_reg_s12.s12; NEXT_OP0
		}
		NEXT_OP OPCODE(JNE_regO_null)       if (regO[code->reg_reg_s12.reg0]        != 0) {
			code += (int32) code->reg_reg_s12.s12; NEXT_OP0
		}
		NEXT_OP OPCODE(JNE_regI_regI)       if (regI[code->reg_reg_s12.reg0]        != regI[code->reg_reg_s12.reg1]) {
			code += (int32) code->reg_reg_s12.s12; NEXT_OP0
		}
		NEXT_OP OPCODE(JNE_regL_regL)       if (REGL(reg64)[code->reg_reg_s12.reg0] != REGL(reg64)[code->reg_reg_s12.reg1]) {
			code += (int32) code->reg_reg_s12.s12; NEXT_OP0
		}
		NEXT_OP OPCODE(JNE_regD_regD)       if (REGD(reg64)[code->reg_reg_s12.reg0] != REGD(reg64)[code->reg_reg_s12.reg1]) {
			code += (int32) code->reg_reg_s12.s12; NEXT_OP0
		}
		NEXT_OP OPCODE(JNE_regI_s6)         if (regI[code->reg_s6_desloc.reg]       != (int32)code->reg_s6_desloc.s6) {
			code += (int32) code->reg_s6_desloc.desloc; NEXT_OP0
		}
		NEXT_OP OPCODE(JNE_regI_sym)        if (regI[code->reg_sym_sdesloc.reg]     != cp->i32[code->reg_sym_sdesloc.sym]) {
			code += (int32) code->reg_sym_sdesloc.desloc; NEXT_OP0
		}
		NEXT_OP OPCODE(JLT_regI_regI)       if (regI[code->reg_reg_s12.reg0]        <  regI[code->reg_reg_s12.reg1]) {
			code += (int32) code->reg_reg_s12.s12; NEXT_OP0
		}
		NEXT_OP OPCODE(JLT_regL_regL)       if (REGL(reg64)[code->reg_reg_s12.reg0] <  REGL(reg64)[code->reg_reg_s12.reg1]) {
			code += (int32) code->reg_reg_s12.s12; NEXT_OP0
		}
		NEXT_OP OPCODE(JLT_regD_regD)       if (REGD(reg64)[code->reg_reg_s12.reg0] <  REGD(reg64)[code->reg_reg_s12.reg1]) {
			code += (int32) code->reg_reg_s12.s12; NEXT_OP0
		}
		NEXT_OP OPCODE(JLT_regI_s6)         if (regI[code->reg_s6_desloc.reg]       <  (int32)code->reg_s6_desloc.s6) {
			code += (int32) code->reg_s6_desloc.desloc; NEXT_OP0
		}
		NEXT_OP OPCODE(JLE_regI_regI)       if (regI[code->reg_reg_s12.reg0]        <= regI[code->reg_reg_s12.reg1]) {
			code += (int32) code->reg_reg_s12.s12; NEXT_OP0
		}
		NEXT_OP OPCODE(JLE_regL_regL)       if (REGL(reg64)[code->reg_reg_s12.reg0] <= REGL(reg64)[code->reg_reg_s12.reg1]) {
			code += (int32) code->reg_reg_s12.s12; NEXT_OP0
		}
		NEXT_OP OPCODE(JLE_regD_regD)       if (REGD(reg64)[code->reg_reg_s12.reg0] <= REGD(reg64)[code->reg_reg_s12.reg1]) {
			code += (int32) code->reg_reg_s12.s12; NEXT_OP0
		}
		NEXT_OP OPCODE(JLE_regI_s6)         if (regI[code->reg_s6_desloc.reg]       <= (int32)code->reg_s6_desloc.s6) {
			code += (int32) code->reg_s6_desloc.desloc; NEXT_OP0
		}
		NEXT_OP OPCODE(JGT_regI_regI)       if (regI[code->reg_reg_s12.reg0]        >  regI[code->reg_reg_s12.reg1]) {
			code += (int32) code->reg_reg_s12.s12; NEXT_OP0
		}
		NEXT_OP OPCODE(JGT_regL_regL)       if (REGL(reg64)[code->reg_reg_s12.reg0] >  REGL(reg64)[code->reg_reg_s12.reg1]) {
			code += (int32) code->reg_reg_s12.s12; NEXT_OP0
		}
		NEXT_OP OPCODE(JGT_regD_regD)       if (REGD(reg64)[code->reg_reg_s12.reg0] >  REGD(reg64)[code->reg_reg_s12.reg1]) {
			code += (int32) code->reg_reg_s12.s12; NEXT_OP0
		}
		NEXT_OP OPCODE(JGT_regI_s6)         if (regI[code->reg_s6_desloc.reg]       >  (int32)code->reg_s6_desloc.s6) {
			code += (int32) code->reg_s6_desloc.desloc; NEXT_OP0
		}
		NEXT_OP OPCODE(JGE_regI_regI)       if (regI[code->reg_reg_s12.reg0]        >= regI[code->reg_reg_s12.reg1]) {
			code += (int32) code->reg_reg_s12.s12; NEXT_OP0
		}
		NEXT_OP OPCODE(JGE_regL_regL)       if (REGL(reg64)[code->reg_reg_s12.reg0] >= REGL(reg64)[code->reg_reg_s12.reg1]) {
			code += (int32) code->reg_reg_s12.s12; NEXT_OP0
		}
		NEXT_OP OPCODE(JGE_regD_regD)       if (REGD(reg64)[code->reg_reg_s12.reg0] >= REGD(reg64)[code->reg_reg_s12.reg1]) {
			code += (int32) code->reg_reg_s12.s12; NEXT_OP0
		}
		NEXT_OP OPCODE(JGE_regI_s6)         if (regI[code->reg_s6_desloc.reg]       >= (int32)code->reg_s6_desloc.s6) {
			code += (int32) code->reg_s6_desloc.desloc; NEXT_OP0
		}
		NEXT_OP OPCODE(JGE_regI_arlen)      if (regI[code->reg_arl_s12.regI]        >= (int32)ARRAYOBJ_LEN(regO[code->reg_arl_s12.base])) {
			code += (int32) code->reg_arl_s12.desloc; NEXT_OP0
		}
		NEXT_OP OPCODE(DECJGTZ_regI)        if (--regI[code->reg_desloc.reg]        >  0) {
			code += (int32) code->reg_desloc.desloc; NEXT_OP0
		}
		NEXT_OP OPCODE(DECJGEZ_regI)        if (--regI[code->reg_desloc.reg]        >= 0) {
			code += (int32) code->reg_desloc.desloc; NEXT_OP0
		}
		NEXT_OP OPCODE(CALL_normal) // 33% of the calls
...
contCall:
			...
			*regO = null;
			if (newMethod->oCount > 1) {
				for (regO2 = regO+newMethod->oCount; regO2 > regO;) *--regO2 = 0;        // erase the region that will be used for objects so the gc don't confuse an object previously used with the objects in our method's frame. All methods have at least one regO
			}
...
notYetLinked:
			...
			} else if ((className == class_->name) || strEq(className, class_->name)) { // calling a method inside this class? (first comparison is always true, but keep 2nd for safety)
				c = class_;
			} else {
		...
		OPCODE(CONV_regI_regL)   regI[code->reg_reg.reg0] = (int32) REGL(reg64)[code->reg_reg.reg1]; NEXT_OP OPCODE(CONV_regI_regD)   regI[code->reg_reg.reg0] = (int32) REGD(reg64)[code->reg_reg.reg1]; NEXT_OP OPCODE(CONV_regIb_regI)  regI[code->reg_reg.reg0] = (int8) regI[code->reg_reg.reg1]; NEXT_OP OPCODE(CONV_regIc_regI)  regI[code->reg_reg.reg0] = (uint16) regI[code->reg_reg.reg1]; NEXT_OP OPCODE(CONV_regIs_regI)  regI[code->reg_reg.reg0] = (int16) regI[code->reg_reg.reg1]; NEXT_OP OPCODE(CONV_regL_regI)   REGL(reg64)[code->reg_reg.reg0] = (int64) regI[code->reg_reg.reg1]; NEXT_OP OPCODE(CONV_regL_regD)   REGL(reg64)[code->reg_reg.reg0] = (int64) REGD(reg64)[code->reg_reg.reg1]; NEXT_OP OPCODE(CONV_regD_regI)   REGD(reg64)[code->reg_reg.reg0] = (double) regI[code->reg_reg.reg1]; NEXT_OP OPCODE(CONV_regD_regL)   REGD(reg64)[code->reg_reg.reg0] = (double) REGL(reg64)[code->reg_reg.reg1]; NEXT_OP
		...
		OPCODE(RETURN_s24I)  context->callStack -= 2; /*newMethod = (Method)context->callStack[0]; if (newMethod->flags.isSynchronized) unlockMutex(newMethod->flags.isStatic? (size_t)newMethod->class_ : (size_t)regO[-method->oCount]); */ if (((int32) (context->callStack-context->callStackStart)) >= callStackMethodEnd) {
			regI       [((Code) context->callStack[-1])->mtd.retOr1stParam - ((Method) context->callStack[-2])->iCount  ] = (int32) code->s24.desloc;  goto resumePreviousMethod;
		} else {
			returnedValue.asInt32 = (int32) code->s24.desloc; goto finishMethod;
		}
		OPCODE(RETURN_null)  context->callStack -= 2; /*newMethod = (Method)context->callStack[0]; if (newMethod->flags.isSynchronized) unlockMutex(newMethod->flags.isStatic? (size_t)newMethod->class_ : (size_t)regO[-method->oCount]); */ if (((int32) (context->callStack-context->callStackStart)) >= callStackMethodEnd) {
			regO       [((Code) context->callStack[-1])->mtd.retOr1stParam - ((Method) context->callStack[-2])->oCount  ] = null;                      goto resumePreviousMethod;
		} else {
			returnedValue.asObj = null;                     goto finishMethod;
		}
		OPCODE(RETURN_s24D)  context->callStack -= 2; /*newMethod = (Method)context->callStack[0]; if (newMethod->flags.isSynchronized) unlockMutex(newMethod->flags.isStatic? (size_t)newMethod->class_ : (size_t)regO[-method->oCount]); */ if (((int32) (context->callStack-context->callStackStart)) >= callStackMethodEnd) {
			REGD(reg64)[((Code) context->callStack[-1])->mtd.retOr1stParam - ((Method) context->callStack[-2])->v64Count] = (double) code->s24.desloc;  goto resumePreviousMethod;
		} else {
			returnedValue.asDouble = (double) code->s24.desloc; goto finishMethod;
		}
		OPCODE(RETURN_s24L)  context->callStack -= 2; /*newMethod = (Method)context->callStack[0]; if (newMethod->flags.isSynchronized) unlockMutex(newMethod->flags.isStatic? (size_t)newMethod->class_ : (size_t)regO[-method->oCount]); */ if (((int32) (context->callStack-context->callStackStart)) >= callStackMethodEnd) {
			REGL(reg64)[((Code) context->callStack[-1])->mtd.retOr1stParam - ((Method) context->callStack[-2])->v64Count] = (int64) code->s24.desloc;  goto resumePreviousMethod;
		} else {
			returnedValue.asInt64 = (int64) code->s24.desloc; goto finishMethod;
		}
		OPCODE(RETURN_symI)  context->callStack -= 2; /*newMethod = (Method)context->callStack[0]; if (newMethod->flags.isSynchronized) unlockMutex(newMethod->flags.isStatic? (size_t)newMethod->class_ : (size_t)regO[-method->oCount]); */ if (((int32) (context->callStack-context->callStackStart)) >= callStackMethodEnd) {
			regI       [((Code) context->callStack[-1])->mtd.retOr1stParam - ((Method) context->callStack[-2])->iCount  ] = cp->i32[code->sym.sym];    goto resumePreviousMethod;
		} else {
			returnedValue.asInt32 = cp->i32[code->sym.sym];   goto finishMethod;
		}
		OPCODE(RETURN_symO)  context->callStack -= 2; /*newMethod = (Method)context->callStack[0]; if (newMethod->flags.isSynchronized) unlockMutex(newMethod->flags.isStatic? (size_t)newMethod->class_ : (size_t)regO[-method->oCount]); */ if (((int32) (context->callStack-context->callStackStart)) >= callStackMethodEnd) {
			regO       [((Code) context->callStack[-1])->mtd.retOr1stParam - ((Method) context->callStack[-2])->oCount  ] = cp->str[code->sym.sym];    goto resumePreviousMethod;
		} else {
			returnedValue.asObj = cp->str[code->sym.sym];   goto finishMethod;
		}
		OPCODE(RETURN_symD)  context->callStack -= 2; /*newMethod = (Method)context->callStack[0]; if (newMethod->flags.isSynchronized) unlockMutex(newMethod->flags.isStatic? (size_t)newMethod->class_ : (size_t)regO[-method->oCount]); */ if (((int32) (context->callStack-context->callStackStart)) >= callStackMethodEnd) {
			REGD(reg64)[((Code) context->callStack[-1])->mtd.retOr1stParam - ((Method) context->callStack[-2])->v64Count] = cp->dbl[code->sym.sym];    goto resumePreviousMethod;
		} else {
			returnedValue.asDouble = cp->dbl[code->sym.sym];   goto finishMethod;
		}
		OPCODE(RETURN_symL)  context->callStack -= 2; /*newMethod = (Method)context->callStack[0]; if (newMethod->flags.isSynchronized) unlockMutex(newMethod->flags.isStatic? (size_t)newMethod->class_ : (size_t)regO[-method->oCount]); */ if (((int32) (context->callStack-context->callStackStart)) >= callStackMethodEnd) {
			REGL(reg64)[((Code) context->callStack[-1])->mtd.retOr1stParam - ((Method) context->callStack[-2])->v64Count] = cp->i64[code->sym.sym];    goto resumePreviousMethod;
		} else {
			returnedValue.asInt64 = cp->i64[code->sym.sym];   goto finishMethod;
		}
		OPCODE(RETURN_regI)  context->callStack -= 2; /*newMethod = (Method)context->callStack[0]; if (newMethod->flags.isSynchronized) unlockMutex(newMethod->flags.isStatic? (size_t)newMethod->class_ : (size_t)regO[-method->oCount]); */ if (((int32) (context->callStack-context->callStackStart)) >= callStackMethodEnd) {
			regI       [((Code) context->callStack[-1])->mtd.retOr1stParam - ((Method) context->callStack[-2])->iCount  ] = regI[code->reg.reg];       goto resumePreviousMethod;
		} else {
			returnedValue.asInt32 = regI[code->reg.reg];      goto finishMethod;
		}
		OPCODE(RETURN_regO)  context->callStack -= 2; /*newMethod = (Method)context->callStack[0]; if (newMethod->flags.isSynchronized) unlockMutex(newMethod->flags.isStatic? (size_t)newMethod->class_ : (size_t)regO[-method->oCount]); */ if (((int32) (context->callStack-context->callStackStart)) >= callStackMethodEnd) {
			regO       [((Code) context->callStack[-1])->mtd.retOr1stParam - ((Method) context->callStack[-2])->oCount  ] = regO[code->reg.reg];       goto resumePreviousMethod;
		} else {
			returnedValue.asObj = regO[code->reg.reg];      goto finishMethod;
		}
		OPCODE(RETURN_reg64) context->callStack -= 2; /*newMethod = (Method)context->callStack[0]; if (newMethod->flags.isSynchronized) unlockMutex(newMethod->flags.isStatic? (size_t)newMethod->class_ : (size_t)regO[-method->oCount]); */ if (((int32) (context->callStack-context->callStackStart)) >= callStackMethodEnd) {
			reg64      [((Code) context->callStack[-1])->mtd.retOr1stParam - ((Method) context->callStack[-2])->v64Count] = reg64[code->reg.reg];      goto resumePreviousMethod;
		} else {
			returnedValue.asInt64 = reg64[code->reg.reg];     goto finishMethod;
		}
returnVoid:
		OPCODE(RETURN_void)
		context->callStack -= 2;
...
resumePreviousMethod:
		...
		goto finishMethod;
		OPCODE(JUMP_s24)  code += (int32) code->s24.desloc;  NEXT_OP0 OPCODE(JUMP_regI) code = method->code + regI[code->reg.reg]; NEXT_OP0 OPCODE(SWITCH) {// switch (regI)
		...
		OPCODE(NEWARRAY_len)   if ((regO[code->newarray.regO] = createArrayObject(context, cp->cls[code->newarray.sym], code->newarray.lenOrRegIOrDims)) == null) {
			exceptionMsg = "When creating array with length"; goto throwOutOfMemoryError;
		}
		setObjectLock(regO[code->newarray.regO], UNLOCKED); NEXT_OP OPCODE(NEWARRAY_regI)  if ((regO[code->newarray.regO] = createArrayObject(context, cp->cls[code->newarray.sym], regI[code->newarray.lenOrRegIOrDims])) == null) {
			exceptionMsg = "When creating array with register"; goto throwOutOfMemoryError;
		}
		setObjectLock(regO[code->newarray.regO], UNLOCKED); NEXT_OP OPCODE(NEWARRAY_multi) if ((regO[code->newarray.regO] = createArrayObjectMulti(context, cp->cls[code->newarray.sym], code->newarray.lenOrRegIOrDims, (uint8*)(code+1), regI)) == null) {
			exceptionMsg = "When creating multiple arrays"; goto throwOutOfMemoryError;
		}
		setObjectLock(regO[code->newarray.regO], UNLOCKED); code += (code->newarray.lenOrRegIOrDims+3)>>2; NEXT_OP OPCODE(NEWOBJ)         if ((regO[code->reg_sym.reg] = createObjectWithoutCallingDefaultConstructor(context, cp->cls[code->reg_sym.sym])) == null) {
			exceptionMsg = "When creating object"; goto throwOutOfMemoryError;
		}
		setObjectLock(regO[code->reg_sym.reg], UNLOCKED); NEXT_OP                                                                                                                                                                                                                // do not call default constructor
		OPCODE(THROW)
...
handleException:
		...
		OPCODE(TEST_regO) if (regO[code->reg.reg] == null) {
			exceptionMsg = "Testing object."; goto throwNullPointerException;
		}
		NEXT_OP OPCODE(INC_regI)  regI[code->inc.reg] += (int32) code->inc.s16; NEXT_OP OPCODE(MONITOR_Enter)
		OPCODE(MONITOR_Enter2)
		{
			...
			if (o == null) {
				exceptionMsg = "On synchronized object's enter"; goto throwNullPointerException;
			}
		...
		OPCODE(MONITOR_Exit2)
		{
			...
			if (o == null) {
				exceptionMsg = "On synchronized object's exit"; goto throwNullPointerException;
			}
			if (OBJ_CLASS(o) != lockClass) { // check for totalcross.util.concurrent.Lock
...
#ifdef ENABLE_TRACE
	if (traceOn) {
		debug("T 5 %08d %05d            %X-%X %X %s final - %s (%X)", getTimeStamp(), ++context->ccon, (int) regO, context->regO, context->callStack, getSpaces(context,context->depth), regO[0] == null ? "" : OBJ_CLASS(regO[0])->name,regO[0]);
	}
	context->depth--;
