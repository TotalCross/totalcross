...
typedef enum TCIRDiagnosticCode
{
   ...
   TCIR_DIAGNOSTIC_EXECUTION_LIMIT
} TCIRDiagnosticCode;
...
#define TCIR_METHOD_CALL_EFFECTS \
   (TCIR_EFFECT_READS_HEAP | TCIR_EFFECT_WRITES_HEAP | TCIR_EFFECT_MAY_THROW | \
    TCIR_EFFECT_MAY_GC | TCIR_EFFECT_MAY_LOCK | TCIR_EFFECT_RESOLVES_SYMBOL | \
    TCIR_EFFECT_CALLS_UNKNOWN)

#define TCIR_OBJECT_ALLOCATION_EFFECTS TCIR_METHOD_CALL_EFFECTS

typedef enum TCIRCallKind
{
   TCIR_CALL_STATIC = 0,
   TCIR_CALL_INSTANCE,
   TCIR_CALL_VIRTUAL
...
typedef enum TCIROperation
{
   ...
   TCIR_OP_OR_I32,
   TCIR_OP_XOR_I32,
   TCIR_OP_TRUNC_I32_I8,
   TCIR_OP_TRUNC_I32_I16,
   TCIR_OP_SEXT_I8_I32,
   TCIR_OP_SEXT_I16_I32,
   TCIR_OP_ZEXT_I16_I32,
   TCIR_OP_CMP_EQ_I32,
   TCIR_OP_CMP_LT_I32,
   TCIR_OP_CMP_LE_I32,
   TCIR_OP_CMP_GT_I32,
