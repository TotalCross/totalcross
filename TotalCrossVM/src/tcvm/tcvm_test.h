...
{ // #6
  ...
  xstrcpy(testtcz,
          "Test.tcz"); // copy to a temp buffer, it may be truncated in tczLoad
...
TESTCASE(VM_PrimitiveTypeSizes)
{ // #1
...
TESTCASE(VM_CodeUnion)
{
	...
	c.u32.u32 = 0;
	ASSERT2_EQUALS(I32, 0, c.u32.u32);
	c.u32.u32 = 0x12345678;
	ASSERT2_EQUALS(I32, 0x12345678, c.u32.u32); // TODO must check endians too!

	c.s24.op = 255;
	ASSERT2_EQUALS(I32, 255, c.s24.op);
	c.s24.desloc = 0;
	ASSERT2_EQUALS(I32, 0, c.s24.desloc);
	c.s24.desloc = -1234567;
	ASSERT2_EQUALS(I32, -1234567, c.s24.desloc);
	c.s24.desloc = 1234567;
	ASSERT2_EQUALS(I32, 1234567, c.s24.desloc);

	c.reg_reg.reg0 = 63;
	ASSERT2_EQUALS(I32, 63, c.reg_reg.reg0);
	c.reg_reg.reg0 = 0;
	ASSERT2_EQUALS(I32, 0, c.reg_reg.reg0);
	c.reg_reg.reg1 = 63;
	ASSERT2_EQUALS(I32, 63, c.reg_reg.reg1);
	c.reg_reg.reg1 = 0;
	ASSERT2_EQUALS(I32, 0, c.reg_reg.reg1);

	c.field_reg.this = 63;
	ASSERT2_EQUALS(I32, 63, c.field_reg.this);
	c.field_reg.this = 0;
	ASSERT2_EQUALS(I32, 0, c.field_reg.this);
	c.field_reg.reg  = 63;
	ASSERT2_EQUALS(I32, 63, c.field_reg.reg);
	c.field_reg.reg  = 0;
	ASSERT2_EQUALS(I32, 0, c.field_reg.reg);
	c.field_reg.sym = 4095;
	ASSERT2_EQUALS(I32, 4095, c.field_reg.sym);
	c.field_reg.sym = 0;
	ASSERT2_EQUALS(I32, 0, c.field_reg.sym);

	c.mtd.this = 63;
	ASSERT2_EQUALS(I32, 63, c.mtd.this);
	c.mtd.this = 0;
	ASSERT2_EQUALS(I32, 0, c.mtd.this);
	c.mtd.retOr1stParam  = 63;
	ASSERT2_EQUALS(I32, 63, c.mtd.retOr1stParam);
	c.mtd.retOr1stParam  = 0;
	ASSERT2_EQUALS(I32, 0, c.mtd.retOr1stParam);
	c.mtd.sym = 4095;
	ASSERT2_EQUALS(I32, 4095, c.mtd.sym);
	c.mtd.sym = 0;
	ASSERT2_EQUALS(I32, 0, c.mtd.sym);

	c.static_reg.reg  = 63;
	ASSERT2_EQUALS(I32, 63, c.static_reg.reg);
	c.static_reg.reg  = 0;
	ASSERT2_EQUALS(I32, 0, c.static_reg.reg);
	c.static_reg.sym = 65535;
	ASSERT2_EQUALS(I32, 65535, c.static_reg.sym);
	c.static_reg.sym = 0;
	ASSERT2_EQUALS(I32, 0, c.static_reg.sym);

	c.reg_ar.base = 63;
	ASSERT2_EQUALS(I32, 63, c.reg_ar.base);
	c.reg_ar.base = 0;
	ASSERT2_EQUALS(I32, 0, c.reg_ar.base);
	c.reg_ar.reg = 63;
	ASSERT2_EQUALS(I32, 63, c.reg_ar.reg);
	c.reg_ar.reg = 0;
	ASSERT2_EQUALS(I32, 0, c.reg_ar.reg);
	c.reg_ar.idx = 63;
	ASSERT2_EQUALS(I32, 63, c.reg_ar.idx);
	c.reg_ar.idx = 0;
	ASSERT2_EQUALS(I32, 0, c.reg_ar.idx);

	c.reg_sym.sym = 65535;
	ASSERT2_EQUALS(I32, 65535, c.reg_sym.sym);
	c.reg_sym.sym = 0;
	ASSERT2_EQUALS(I32, 0, c.reg_sym.sym);
	c.reg_sym.reg = 63;
	ASSERT2_EQUALS(I32, 63, c.reg_sym.reg);
	c.reg_sym.reg = 0;
	ASSERT2_EQUALS(I32, 0, c.reg_sym.reg);

	c.s18_reg.s18 = -131072;
	ASSERT2_EQUALS(I32, -131072, c.s18_reg.s18);
	c.s18_reg.s18 = 131071;
	ASSERT2_EQUALS(I32, 131071, c.s18_reg.s18);
	c.s18_reg.reg = 63;
	ASSERT2_EQUALS(I32, 63, c.s18_reg.reg);
	c.s18_reg.reg = 0;
	ASSERT2_EQUALS(I32, 0, c.s18_reg.reg);

	// OPERATIONS

	c.reg_reg_reg.reg0 = 63;
	ASSERT2_EQUALS(I32, 63, c.reg_reg_reg.reg0);
	c.reg_reg_reg.reg0 = 0;
	ASSERT2_EQUALS(I32, 0,  c.reg_reg_reg.reg0);
	c.reg_reg_reg.reg1 = 63;
	ASSERT2_EQUALS(I32, 63, c.reg_reg_reg.reg1);
	c.reg_reg_reg.reg1 = 0;
	ASSERT2_EQUALS(I32, 0,  c.reg_reg_reg.reg1);
	c.reg_reg_reg.reg2 = 63;
	ASSERT2_EQUALS(I32, 63, c.reg_reg_reg.reg2);
	c.reg_reg_reg.reg2 = 0;
	ASSERT2_EQUALS(I32, 0,  c.reg_reg_reg.reg2);

	c.reg_reg_s12.reg0 = 63;
	ASSERT2_EQUALS(I32, 63, c.reg_reg_s12.reg0);
	c.reg_reg_s12.reg0 = 0;
	ASSERT2_EQUALS(I32, 0,  c.reg_reg_s12.reg0);
	c.reg_reg_s12.reg1 = 63;
	ASSERT2_EQUALS(I32, 63, c.reg_reg_s12.reg1);
	c.reg_reg_s12.reg1 = 0;
	ASSERT2_EQUALS(I32, 0,  c.reg_reg_s12.reg1);
	c.reg_reg_s12.s12  = -2048;
	ASSERT2_EQUALS(I32, -2048,  c.reg_reg_s12.s12);
	c.reg_reg_s12.s12  = 2047;
	ASSERT2_EQUALS(I32, 2047, c.reg_reg_s12.s12);

	c.reg_s6_ar.reg  = 63;
	ASSERT2_EQUALS(I32, 63, c.reg_s6_ar.reg);
	c.reg_s6_ar.reg  = 0;
	ASSERT2_EQUALS(I32, 0,  c.reg_s6_ar.reg);
	c.reg_s6_ar.base = 63;
	ASSERT2_EQUALS(I32, 63, c.reg_s6_ar.base);
	c.reg_s6_ar.base = 0;
	ASSERT2_EQUALS(I32, 0,  c.reg_s6_ar.base);
	c.reg_s6_ar.idx  = 63;
	ASSERT2_EQUALS(I32, 63, c.reg_s6_ar.idx);
	c.reg_s6_ar.idx  = 0;
	ASSERT2_EQUALS(I32, 0,  c.reg_s6_ar.idx);
	c.reg_s6_ar.s6   = -32;
	ASSERT2_EQUALS(I32, -32, c.reg_s6_ar.s6);
	c.reg_s6_ar.s6   = 31;
	ASSERT2_EQUALS(I32, 31, c.reg_s6_ar.s6);

	c.reg_reg_sym.reg0  = 63;
	ASSERT2_EQUALS(I32, 63, c.reg_reg_sym.reg0);
	c.reg_reg_sym.reg0  = 0;
	ASSERT2_EQUALS(I32, 0,  c.reg_reg_sym.reg0);
	c.reg_reg_sym.sym = 4095;
	ASSERT2_EQUALS(I32, 4095, c.reg_reg_sym.sym);
	c.reg_reg_sym.sym = 0;
	ASSERT2_EQUALS(I32, 0,  c.reg_reg_sym.sym);
	c.reg_reg_sym.reg1  = 63;
	ASSERT2_EQUALS(I32, 63, c.reg_reg_sym.reg1);
	c.reg_reg_sym.reg1  = 0;
	ASSERT2_EQUALS(I32, 0,  c.reg_reg_sym.reg1);

	c.this_reg_reg.this = 4095;
	ASSERT2_EQUALS(I32, 4095, c.this_reg_reg.this);
	c.this_reg_reg.this = 0;
	ASSERT2_EQUALS(I32, 0,  c.this_reg_reg.this);
	c.this_reg_reg.reg0  = 63;
	ASSERT2_EQUALS(I32, 63, c.this_reg_reg.reg0);
	c.this_reg_reg.reg0  = 0;
	ASSERT2_EQUALS(I32, 0,  c.this_reg_reg.reg0);
	c.this_reg_reg.reg1  = 63;
	ASSERT2_EQUALS(I32, 63, c.this_reg_reg.reg1);
	c.this_reg_reg.reg1  = 0;
	ASSERT2_EQUALS(I32, 0,  c.this_reg_reg.reg1);

	c.this_reg_s6.this = 4095;
	ASSERT2_EQUALS(I32, 4095, c.this_reg_s6.this);
	c.this_reg_s6.this = 0;
	ASSERT2_EQUALS(I32, 0,  c.this_reg_s6.this);
	c.this_reg_s6.regI  = 63;
	ASSERT2_EQUALS(I32, 63, c.this_reg_s6.regI);
	c.this_reg_s6.regI  = 0;
	ASSERT2_EQUALS(I32, 0,  c.this_reg_s6.regI);
	c.this_reg_s6.s6   = -32;
	ASSERT2_EQUALS(I32, -32, c.this_reg_s6.s6);
	c.this_reg_s6.s6   = 31;
	ASSERT2_EQUALS(I32, 31, c.this_reg_s6.s6);
	...
	c.reg_sym_sdesloc.reg  = 63;
	ASSERT2_EQUALS(I32, 63, c.reg_sym_sdesloc.reg);
	c.reg_sym_sdesloc.reg  = 0;
	ASSERT2_EQUALS(I32, 0,  c.reg_sym_sdesloc.reg);
	c.reg_sym_sdesloc.sym = 4095;
	ASSERT2_EQUALS(I32, 4095, c.reg_sym_sdesloc.sym);
	c.reg_sym_sdesloc.sym = 0;
	ASSERT2_EQUALS(I32, 0,  c.reg_sym_sdesloc.sym);
	c.reg_sym_sdesloc.desloc = -32;
	ASSERT2_EQUALS(I32, -32, c.reg_sym_sdesloc.desloc);
	c.reg_sym_sdesloc.desloc = 31;
	ASSERT2_EQUALS(I32, 31,  c.reg_sym_sdesloc.desloc);

	c.reg_this_sdesloc.reg  = 63;
	ASSERT2_EQUALS(I32, 63, c.reg_this_sdesloc.reg);
	c.reg_this_sdesloc.reg  = 0;
	ASSERT2_EQUALS(I32, 0,  c.reg_this_sdesloc.reg);
	c.reg_this_sdesloc.this = 4095;
	ASSERT2_EQUALS(I32, 4095, c.reg_this_sdesloc.this);
	c.reg_this_sdesloc.this = 0;
	ASSERT2_EQUALS(I32, 0,  c.reg_this_sdesloc.this);
	c.reg_this_sdesloc.desloc = -32;
	ASSERT2_EQUALS(I32, -32, c.reg_this_sdesloc.desloc);
	c.reg_this_sdesloc.desloc = 31;
	ASSERT2_EQUALS(I32, 31,  c.reg_this_sdesloc.desloc);

	c.reg_arl_s12.regI  = 63;
	ASSERT2_EQUALS(I32, 63, c.reg_arl_s12.regI);
	c.reg_arl_s12.regI  = 0;
	ASSERT2_EQUALS(I32, 0,  c.reg_arl_s12.regI);
	c.reg_arl_s12.base  = 63;
	ASSERT2_EQUALS(I32, 63, c.reg_arl_s12.base);
	c.reg_arl_s12.base  = 0;
	ASSERT2_EQUALS(I32, 0,  c.reg_arl_s12.base);
	c.reg_arl_s12.desloc  = -2048;
	ASSERT2_EQUALS(I32, -2048, c.reg_arl_s12.desloc);
	c.reg_arl_s12.desloc  = 2047;
	ASSERT2_EQUALS(I32, 2047,  c.reg_arl_s12.desloc);

	c.reg.reg = 63;
	ASSERT2_EQUALS(I32, 63, c.reg.reg);
	c.reg.reg = 0;
	ASSERT2_EQUALS(I32, 0,  c.reg.reg);

	c.sym.sym = 65535;
	ASSERT2_EQUALS(I32, 65535, c.sym.sym);
	c.sym.sym = 0;
	ASSERT2_EQUALS(I32, 0,  c.sym.sym);

	// others
	c.newarray.regO = 0;
	ASSERT2_EQUALS(I32, 0, c.newarray.regO);
	c.newarray.regO = 63;
	ASSERT2_EQUALS(I32, 63, c.newarray.regO);
	c.newarray.sym = 0;
	ASSERT2_EQUALS(I32, 0, c.newarray.sym);
	c.newarray.sym = 4095;
	ASSERT2_EQUALS(I32, 4095, c.newarray.sym);
	c.newarray.lenOrRegIOrDims  = 0;
	ASSERT2_EQUALS(I32, 0, c.newarray.lenOrRegIOrDims);
	c.newarray.lenOrRegIOrDims  = 63;
	ASSERT2_EQUALS(I32, 63, c.newarray.lenOrRegIOrDims);
#else
  TEST_SKIP;
#endif
finish:;
...
static TCObject
newTestTypesInstance(Context currentContext)
{
  CharP tt = "TestTypes"; // for class definitions, see classinfo.test, function
                          // createTestTypesClass
  TCClass c;
  TCObject o;

  o = createObjectWithoutCallingDefaultConstructor(
    currentContext,
    tt); // do NOT call the default constructor, it is buggy
  ...
  if (!objTestValue) {
    objTestValue =
      createStringObjectFromCharP(currentContext, "TotalCross", 10);
  ...
  c->i32StaticValues =
    newPtrArrayOf(Int32, ARRAYLENV(c->i32StaticFields), null);
  c->objStaticValues =
    newPtrArrayOf(TCObject, ARRAYLENV(c->objStaticFields), null);
  c->v64StaticValues =
    newPtrArrayOf(Double, ARRAYLENV(c->v64StaticFields), null);
  return o;
}
...
static Method
initMethod(Context currentContext, int op)
{
  ...
  xmemzero(currentContext->regIStart,
           STARTING_REGI_SIZE * sizeof(currentContext->regI[0]));
  xmemzero(currentContext->reg64Start,
           STARTING_REG64_SIZE * sizeof(currentContext->reg64[0]));
  xmemzero(currentContext->regOStart,
           STARTING_REGO_SIZE * sizeof(currentContext->regO[0]));

  currentContext->thrownException = null;
  currentContext->regO[0] =
    testTypesInstance; // instance fields assume that the class instance is in
                       // regO[0]
  code[0].s24.op = op;
...
static void*
newArrayTest(Context currentContext, Type t)
{ // returns the start of the array
  TCObject array = null;
  switch (t) {
    case Type_Byte:
      array = FIELD_OBJ(testTypesInstance, testTypesClass, 1);
      break;
    case Type_Short:
      array = FIELD_OBJ(testTypesInstance, testTypesClass, 2);
      break;
    case Type_Int:
      array = FIELD_OBJ(testTypesInstance, testTypesClass, 3);
      break;
    case Type_Char:
      array = FIELD_OBJ(testTypesInstance, testTypesClass, 4);
      break;
    case Type_Double:
      array = FIELD_OBJ(testTypesInstance, testTypesClass, 5);
      break;
    case Type_Long:
      array = FIELD_OBJ(testTypesInstance, testTypesClass, 6);
      break;
    case Type_Object:
      array = FIELD_OBJ(testTypesInstance, testTypesClass, 7);
      break;
    default:
      break;
  }
...
static bool
arCheck(Context currentContext, struct TestSuite* tc, int op)
{
  Method m = &testMethod;
  ...
  ASSERT2_EQUALS(Sz,
                 OBJ_CLASS(currentContext->thrownException)->name,
                 throwableAsCharP[ArrayIndexOutOfBoundsException]);
  currentContext->thrownException = null;
  ...
  ASSERT2_EQUALS(Sz,
                 OBJ_CLASS(currentContext->thrownException)->name,
                 throwableAsCharP[NullPointerException]);
  return true;
finish:
  return false;
}
...
static TCObject
initExtTest(Context currentContext,
            struct TestSuite* tc,
            Method m,
            RegType t,
            bool isStatic)
{
  ...
  if (!isStatic) {
    ...
    ASSERT2_EQUALS(Sz,
                   OBJ_CLASS(currentContext->thrownException)->name,
                   throwableAsCharP[isStatic ? ClassNotFoundException
  ...
  if (isStatic) {
    ...
    currentContext->regO[m->code[0].field_reg.this_ = 2] =
      ext; // instance fields assume that the class instance is in regO
...
TESTCASE(VM_BREAK)
{ // must make this test run before the other instruction
  // tests. #7
...
TESTCASE(VM_MOV_regI_arc)
{ // #DEPENDS(VM_MOV_regI_aru)
  newArrayTest(currentContext, Type_Int);
  if (!arCheck(currentContext, tc, MOV_regI_arc)) {
    TEST_OUTPUT_SOURCELINE;
  }
}
...
TESTCASE(VM_MOV_regO_arc)
{ // #DEPENDS(VM_MOV_regO_aru)
  newArrayTest(currentContext, Type_Object);
  if (!arCheck(currentContext, tc, MOV_regO_arc)) {
    TEST_OUTPUT_SOURCELINE;
  }
}
...
TESTCASE(VM_MOV_reg64_arc)
{ // #DEPENDS(VM_MOV_reg64_aru)
  newArrayTest(currentContext, Type_Double);
  if (!arCheck(currentContext, tc, MOV_reg64_arc)) {
    TEST_OUTPUT_SOURCELINE;
  }
  currentContext->thrownException = null;
...
TESTCASE(VM_MOV_arc_regI)
{ // #DEPENDS(VM_MOV_aru_regI)
  newArrayTest(currentContext, Type_Int);
  if (!arCheck(currentContext, tc, MOV_arc_regI)) {
    TEST_OUTPUT_SOURCELINE;
  }
}
...
TESTCASE(VM_MOV_arc_regO)
{ // #DEPENDS(VM_MOV_aru_regO)
  newArrayTest(currentContext, Type_Object);
  if (!arCheck(currentContext, tc, MOV_arc_regO)) {
    TEST_OUTPUT_SOURCELINE;
  }
}
...
TESTCASE(VM_MOV_arc_reg64)
{ // #DEPENDS(VM_MOV_aru_reg64)
  newArrayTest(currentContext, Type_Long);
  if (!arCheck(currentContext, tc, MOV_arc_reg64)) {
    TEST_OUTPUT_SOURCELINE;
  }
  currentContext->thrownException = null;
  newArrayTest(currentContext, Type_Double);
...
TESTCASE(VM_MOV_arc_regIb)
{ // #DEPENDS(VM_MOV_aru_regIb)
  newArrayTest(currentContext, Type_Byte);
  if (!arCheck(currentContext, tc, MOV_arc_regIb)) {
    TEST_OUTPUT_SOURCELINE;
  }
}
...
TESTCASE(VM_MOV_arc_reg16)
{
  ...
  if (!arCheck(currentContext, tc, MOV_arc_reg16)) {
    TEST_OUTPUT_SOURCELINE;
  }
finish:;
}
...
TESTCASE(VM_MOV_regIb_arc)
{ // #DEPENDS(VM_MOV_reg16_aru)
  newArrayTest(currentContext, Type_Byte);
  if (!arCheck(currentContext, tc, MOV_regIb_arc)) {
    TEST_OUTPUT_SOURCELINE;
  }
}
...
TESTCASE(VM_MOV_reg16_arc)
{
  ...
  if (!arCheck(currentContext, tc, MOV_reg16_arc)) {
    TEST_OUTPUT_SOURCELINE;
  }
finish:;
}
...
TESTCASE(VM_MOV_regI_field)
{ // #DEPENDS(VM_MOV_field_regI)
...
TESTCASE(VM_MOV_regO_field)
{ // #DEPENDS(VM_MOV_field_regO)
...
TESTCASE(VM_MOV_reg64_field)
{ // #DEPENDS(VM_MOV_field_reg64)
...
TESTCASE(VM_MOV_field_regO)
{
  ...
  ASSERT1_EQUALS(Null, currentContext->thrownException);
  ASSERT2_EQUALS(
    Obj, FIELD_OBJ(ext, OBJ_CLASS(ext), DEF_O_FIELD), OBJECT_TEST_VALUE);
finish:;
}
TESTCASE(VM_MOV_field_reg64)
{
  ...
  ASSERT1_EQUALS(Null, currentContext->thrownException);
  ASSERT2_EQUALS(
    Dbl, FIELD_DBL(ext, OBJ_CLASS(ext), DEF_D_FIELD), DOUBLE_TEST_VALUE);
  ...
  ASSERT1_EQUALS(Null, currentContext->thrownException);
  ASSERT2_EQUALS(
    I64, FIELD_I64(ext, OBJ_CLASS(ext), DEF_L_FIELD), INT64_TEST_VALUE);
finish:;
}
...
TESTCASE(VM_MOV_regO_static)
{ // #DEPENDS(VM_MOV_static_regO)
...
TESTCASE(VM_MOV_static_regO)
{
  ...
  ASSERT1_EQUALS(Null, currentContext->thrownException);
  ASSERT2_EQUALS(
    Obj, OBJ_CLASS(ext)->objStaticValues[DEF_O_FIELD], OBJECT_TEST_VALUE);
finish:;
}
TESTCASE(VM_MOV_static_reg64)
{
  ...
  ASSERT1_EQUALS(Null, currentContext->thrownException);
  ASSERT2_EQUALS(
    Dbl, OBJ_CLASS(ext)->v64StaticValues[DEF_D_FIELD], DOUBLE_TEST_VALUE);
...
TESTCASE(VM_ADD_regI_arc_s6)
{ // #DEPENDS(VM_ADD_regI_aru_s6)
  TCObject array = FIELD_OBJ(testTypesInstance, testTypesClass, 3);
  ...
  if (!arCheck(currentContext, tc, ADD_regI_arc_s6)) {
    TEST_OUTPUT_SOURCELINE;
  }
}
...
TESTCASE(VM_ADD_aru_regI_s6)
{ // this is the first lexicographically ordered
  // testcase. so we make CodeUnion appear before
  // us, since it must be the first test case:
  // #DEPENDS(VM_CodeUnion)
...
TESTCASE(VM_DIV_regI_regI_s12)
{ // TESTAR DIVISAO POR ZERO EM TODOS OS DIVs!
  ...
  ASSERT2_EQUALS(Sz,
                 OBJ_CLASS(currentContext->thrownException)->name,
                 throwableAsCharP[ArithmeticException]);
finish:;
}
...
TESTCASE(VM_USHR_regL_regL_regL)
{
  ...
  REGL(currentContext->reg64)[2] = 3;
  res =
    ((uint64)REGL(currentContext->reg64)[1]) >> REGL(currentContext->reg64)[2];
  executeMethod(currentContext, m);
  ASSERT1_EQUALS(Null, currentContext->thrownException);
  ASSERT2_EQUALS(I64, REGL(currentContext->reg64)[0], res);
finish:;
...
static Method
initContext(Context c, int32 op, int32 retReg)
{
  Method m = initMethod(c, op);
  // the retReg now stays on the method call instruction, which is stored in the
  // call stack
...
TESTCASE(VM_z3_RETURN_regI)
{
  ...
  Context c = currentContext;
  // int
  c->regI[m->code[0].reg.reg = 4] =
    INT32_TEST_VALUE; // regI's already in the next method's frame
...
TESTCASE(VM_z3_RETURN_reg64)
{
  ...
  REGD(c->reg64)
  [m->code[0].reg.reg = 2] =
    DOUBLE_TEST_VALUE; // regI's already in the next method's frame
  ...
  REGL(c->reg64)
  [m->code[0].reg.reg = 1] =
    INT64_TEST_VALUE; // regI's already in the next method's frame
...
TESTCASE(VM_z4_RETURN_s24I)
{
  ...
  // int
  m->code[0].s24.desloc =
    S24_TEST_VALUE; // regI's already in the next method's frame
...
TESTCASE(VM_z5_RETURN_symI)
{
  ...
  Context c = currentContext;
  // int
  m->class_->cp->i32[m->code[0].sym.sym = 0] =
    INT32_TEST_VALUE; // regI's already in the next method's frame
...
static int32
getExtMethodIndex(ConstantPool cp, uint16 nameidx)
{ // this
...
TESTCASE(VM_z7_CALL_virtual)
{
	...
	// method call
	m->code[0].mtd.sym = getExtMethodIndex(m->class_->cp, (uint16)getIndexInCP(m->class_->cp,
										   "substring"));
...
TC_API void
TT_printException_s(NMParams p)
{
  throwableTrace = String2CharP(p->obj[0]);
}

TESTCASE(VM_THROW)
{ // throw new Exception() -> newObj regO,
  // java.lang.Exception; throw regO;
  Method testException;
  TCObject aioobe;

  // NOTE: THESE TESTS WILL GENERATE A "Warning! NullPointerException" in the
  // output, due to the call of printStackTrace in Java's code
  ...
  throwExceptionNamed(
    currentContext, "java.lang.IndexOutOfBoundsException", "%s %d", "here", 3);
  aioobe = currentContext->thrownException;
  ASSERT1_EQUALS(NotNull, currentContext->thrownException);
  executeMethod(currentContext, testException);
  ASSERT2_EQUALS(Ptr,
                 currentContext->thrownException,
                 aioobe); // the exception must not have been changed
finish:
  xfree(ttprintRes);
  xfree(throwableTrace);
}
TESTCASE(VM_INSTANCEOF)
{ // if (other instanceof Rect) -> mov regI, regO
  // instanceof sym; jeq regI,1;
  Method m = initMethod(currentContext, INSTANCEOF);
  // byte array
  currentContext->regO[m->code[0].instanceof.regO = 1] =
    FIELD_OBJ(testTypesInstance, testTypesClass, 1);
  ...
  m->code[0].instanceof
    .sym = getIndexInCP(testTypesClass->cp, "[java.lang.String");
  executeMethod(currentContext, m);
  ASSERT1_EQUALS(Null, currentContext->thrownException);
  ASSERT2_EQUALS(I32, currentContext->regI[0], 0);
  m->code[0].instanceof
    .sym = getIndexInCP(testTypesClass->cp, "java.lang.Object");
  executeMethod(currentContext, m);
  ASSERT1_EQUALS(Null, currentContext->thrownException);
  ASSERT2_EQUALS(I32, currentContext->regI[0], 1);
  // String array
...
TESTCASE(VM_CHECKCAST)
{ // PenEvent pe = (PenEvent)event; -> checkcast event,
  // PenEvent; mov pe, event;
  ...
  ASSERT2_EQUALS(Sz,
                 OBJ_CLASS(currentContext->thrownException)->name,
                 throwableAsCharP[ClassCastException]);
  currentContext->thrownException = null;
  m->code[0].instanceof
    .sym = getIndexInCP(testTypesClass->cp, "[java.lang.String");
  executeMethod(currentContext, m);
...
TESTCASE(VM_SWITCH)
{
  ...
  // format: default_addr (2 bytes) / exit_addr (2 bytes) / key-array (4*n
  bytes) / value-array (2*n bytes)
  ...
  */
  ...
  m->code[12].s24.desloc =
    exit - 12; // note: jump is always relative to the current instruction
               // pointer, which is the switch opcode.
