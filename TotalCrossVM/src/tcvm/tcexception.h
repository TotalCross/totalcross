...
TC_API void throwExceptionNamed(Context currentContext, CharP exceptionClassName, CharP message,
								...);
typedef void (*throwExceptionNamedFunc)(Context currentContext, CharP exceptionClassName,
										CharP message, ...);
...
TC_API void throwIllegalArgumentExceptionI(Context currentContext, CharP argName,
		int32 illegalValue);
typedef void (*throwIllegalArgumentExceptionIFunc)(Context currentContext, CharP argName,
		int32 illegalValue);
...
typedef void (*throwIllegalArgumentIOExceptionFunc)(Context currentContext, CharP argName,
		CharP argValue);
...
TC_API TCObject createException(Context currentContext, Throwable t, bool fillStack, CharP message,
								...);
typedef TCObject(*createExceptionFunc)(Context currentContext, Throwable t, bool fillStack,
									   CharP message, ...);
