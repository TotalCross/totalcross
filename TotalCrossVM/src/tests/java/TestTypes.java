...
public class TestTypes extends Object
{
  ...
  {
    return -1234.567; // DOUBLE_TEST_VALUE
  }

  public TestTypes()
  {
    print("Vera Nardelli");
    // these will be tested, so we must place the code here so that the extMtd
    // tables can be correctly generated
  ...
  public static void testException2() { methodA2(); }
  ...
  public static void methodB2() { methodC2(); }
  ...
  // tests exception being explicitly thrown in a method and handled in another
  // one
  public static void testException3() { methodA3(); }
  ...
  public static void methodB3() throws Exception { methodC3(); }
