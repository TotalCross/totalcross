...
java.exe -classpath p:\TotalCrossSDK\output\eclipse;. tc.Deploy Test.jar -palm -win32 /a TCvm /d %1 >out.txt
copy install\win32\Test.tcz P:\TotalCrossVM\builders\vc6\Debug
