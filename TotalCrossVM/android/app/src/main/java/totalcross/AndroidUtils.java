...
public class AndroidUtils {
	static class Config {
		...
		public void save() {
			try {
				FileOutputStream f = new FileOutputStream(getRealPath(pinfo.applicationInfo.dataDir) +
						"/config.bin");
	...
	private static final String VM_PARAMS = getRealPath("/data/data/totalcross.android") +
