...
/**
 * This is the main class of a TotalCross package. It is useful to create
 * headless applications. Note that totalcross.ui.MainWindow implements this
 * interface, so you must implement it yourself only if you're creating a
 * headless (no user interface) application.
 */
