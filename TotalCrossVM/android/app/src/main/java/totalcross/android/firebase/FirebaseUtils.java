...
public class FirebaseUtils
{
  ...
  public static String getTokenFromRegisteredFirebaseApp()
  {
    if (registeredFirebaseApp != null) {
      FirebaseInstanceId instanceId =
        FirebaseInstanceId.getInstance(registeredFirebaseApp);
  ...
  {
    try {
      String ret = cnt.getPackageManager()
                     .getPackageInfo(cnt.getPackageName(), 0)
  ...
  ///// send to application
  public static void writeToken(Context cnt, String id, String token)
    throws IOException
  {
  ...
  {
    String ret =
      c.getSharedPreferences("push_token", 0).getString("push_token", null);
  ...
  public static void setToken(Context c, String tok)
  {
    ...
    c.getSharedPreferences("push_token", 0)
      .edit()
      .putString("push_token", tok)
      .commit();
  }

  private static void writeChars(String name, boolean append, String msg)
    throws IOException
  {
    try {
