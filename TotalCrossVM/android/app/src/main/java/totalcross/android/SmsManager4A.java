...
public class SmsManager4A
{
  ...
  public static void sendTextMessage(String destinationAddress,
                                     String scAddress,
                                     String text)
  {
  ...
  public static void sendDataMessage(String destinationAddress,
                                     String scAddress,
                                     int port,
                                     byte[] data)
  {
    ...
    smsManager.sendDataMessage(
      destinationAddress, null, (short)port, data, null, null);
  }
}
