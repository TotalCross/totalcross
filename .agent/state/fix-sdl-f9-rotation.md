...
- Active milestone: complete; native smoke fixture unavailable.
- Last functional commit: `40d127c46 fix(windowing,sdl): handle void window
  size API`.
- Active paths: Window backend headers and `Window.c`, graphics screen-change
  ...
  contract tests.
- Next action: none; retain evidence and do not push.
