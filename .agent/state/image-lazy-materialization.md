...
- Current functional tip: `72e539c44` (`test(sdk,macos): cover lazy image decoding`).
- Logical commits: `bb034835b` added Java lazy materialization; `57df779ed`
  ...
  coverage and the initial completion records; the final bookkeeping commit
  updated this resumable state.
