...
- Current functional tip: `380231224` (`fix(sdk): avoid caching transient image failures`).
- Logical commits: `bb034835b` added Java lazy materialization; `57df779ed`
  ...
  `303b246d0` kept explicit JPEG scaling eager; and `380231224` made
  transient materialization failures retryable.
...
- Validation evidence: see `.agent/evidence/image-lazy-materialization.jsonl`. Final macOS dylib is `build-image-lazy-materialization/libtcvm.dylib` with SHA-256 `adb53b4365f2505e8a27870b2e131c8e69c0a2f3a58ed1633fb2dd320f37ba61`, validated against functional HEAD `380231224`.
