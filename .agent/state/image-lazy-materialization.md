...
- Current functional tip: `af62bb123` (`fix(vm,sdk): preserve retryable native decode failures`).
...
- Validation evidence: final exact-HEAD records were appended to
