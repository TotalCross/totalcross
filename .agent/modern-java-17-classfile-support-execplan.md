...
- [ ] Review remaining Java 8 runtime/API gaps outside the aggregate smoke failures, especially `Predicate.and` and serializable lambda deserialization, and either implement or document precise unsupported diagnostics.
...
2026-07-08 / Codex: Generated record equality now passes runtime smoke execution. Validation passed with `./gradlew-agent test --tests tc.tools.converter.modernjava.Java17FeatureTest`, `./gradlew-agent dist -x test`, `./gradlew-agent deployModernJavaFeatureSmoke`, and the generated macOS `FeatureSmokeApp` executable. The runtime smoke now passes Java 16 record construction, accessors, generated `toString`, generated `equals`, generated `hashCode`, equals mismatch, and instanceof pattern matching. Remaining runtime failures are Java 8 default interface method calls, Java 8 static interface method calls, Java 9 private interface method calls, and Java 9 private static interface method calls.
