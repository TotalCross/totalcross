...
- [ ] Build a class-file compatibility test harness that compiles fixtures for Java 8, 11, 17, 21, 25, and 26 when matching JDKs are available, and otherwise runs prebuilt byte-array fixtures generated by tests.
