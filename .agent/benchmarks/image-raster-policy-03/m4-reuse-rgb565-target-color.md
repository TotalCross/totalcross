...
| bundle ZIP SHA-256 | `6a47282ca22f5c3f423d0ebb5442d94609232aa2ca9d734b2f640fc973ad9602` |
...
|---|---|---|---|---:|---:|---|
| diagnostic | `0,32,8192,8224` | off/on | on | `1 / 8` | `24` | `887295c8732ab81b893d8d42c458db35dc4e3312821e2cf6fd47cb960ac7154c` |
| performance | `0,32,8192,8224` | off/on | off | `3 / 24` | `72` | `002a9d9adc246fdaf975adef6c18daeee5c6513f1aaa0e2c40c14669903ccb` |
...
The files are preserved inside the corresponding result ZIPs. The final
performance CSV SHA-256 is
`d296be3d90d85f3dd4b87354758a32bf9a29764ef76a9803b7b5780e5659f430`, and its
pairwise CSV SHA-256 is
...
target-color counters summed to `1014` attempts, `1014` fallbacks, zero hits,
...
The largest scoped target-key set observed `204` source keys and `202` full,
...
`226439128` to `746163264` across the per-pass artifacts.
...
The performance pairwise file contains 72 rows: 30 were classified
`CONSISTENT_DIRECTION` and 42 were `INCONCLUSIVE_VARIANCE`. The plan permits
