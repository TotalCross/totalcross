...
$decode_manifest_fields
  ...
  "seed": 73001,
  "matrixProcessCount": 30,
  "selfTestPhaseCount": 1,
  "expectedProcessCount": 30,
  "profiles": {
    "reduced-image-optimizations": {"masks":[0,6,8,16,32,8192,16384,32768,32795,32799],"prefetch":["on"],"accounting":["off"],"renderingReuse":[],"rounds":1,"passes":3,"processCount":10,"workloadImages":663},
