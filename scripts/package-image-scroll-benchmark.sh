...
$decode_manifest_fields
  "columns": 3,
  "masks": [4,5,6,7,38,8198,16390,24582,32774,57350,32799],
  "prefetchProfiles": ["on"],
  "rounds": 3,
  ...
  "prefetchThreadDiagnosticConfigurations": [["legacy",0],["worker-poll",1],["worker-semaphore",0]],
  "prefetchThreadDiagnosticProcessCount": 6,
  "seed": 73001,
  "matrixProcessCount": 31,
  "selfTestPhaseCount": 1,
  "expectedProcessCount": 31,
  "profiles": {
    "reduced-image-optimizations": {"masks":[4,5,6,7,38,8198,16390,24582,32774,57350,32799],"prefetch":["on"],"accounting":["off"],"renderingReuse":[],"rounds":1,"passes":3,"processCount":11,"workloadImages":663},
    ...
    "prefetch-thread-diagnostics": {"masks":[6,38],"prefetch":["on"],"accounting":["on"],"renderingReuse":[],"rounds":1,"passes":1,"processCount":6,"appProfile":"pft","threadConfigurations":[["legacy",0],["worker-poll",1],["worker-semaphore",0]],"workloadImages":663}
  },
  ...
  "sdkSourceAttestation": $sdk_source_commit_json,
